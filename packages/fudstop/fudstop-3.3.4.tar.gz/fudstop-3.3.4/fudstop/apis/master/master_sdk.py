...
class MasterSDK:
    def __init__(self):
        ...
        self.markets = WebullMarkets(host='localhost', database='market_data', password='fud', port=5432, user='chuck')
        self.occ = occSDK(host='localhost', database='market_data', password='fud', port=5432, user='chuck')
        self.fed = FedNewyork()
