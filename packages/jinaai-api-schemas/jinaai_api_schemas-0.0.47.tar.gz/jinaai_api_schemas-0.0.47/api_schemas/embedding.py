...
class Url(AnyUrl):
    ...
    def _docarray_validate(
        ...
        if isinstance(value, str):
            if not urllib.parse.urlparse(value).scheme in {'http', 'https'}:
                raise ValueError(
...
class TextEmbeddingInput(BaseDocWithoutId):
    ...
    model: str = Field(
        ...
        '- `jina-embedding-v2-base-en`,\t137M,\t768\n'
        '- `jina-embedding-v2-base-es`,\t161M,\t768\n'
        '- `jina-embedding-v2-base-de`,\t161M,\t768\n'
        '- `jina-embedding-v2-base-zh`,\t161M,\t768\n'
        '- `jina-embedding-v2-base-code`,\t137M,\t768\n'
    ...
    task_type: Optional[
        Literal['query', 'passage', 'sts', 'classification', 'clustering']
    ] = Field(
    ...
    embedding_dimension: Optional[
        Literal[32, 64, 128, 256, 512, 1024]
    ] = Field(
