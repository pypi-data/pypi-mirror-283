...
class DataLabCompute(
    RootModel[Union[DataLabCompute1, DataLabCompute2, DataLabCompute3, DataLabCompute4]]
):
    root: Union[DataLabCompute1, DataLabCompute2, DataLabCompute3, DataLabCompute4]
