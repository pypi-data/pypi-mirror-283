# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb.

# %% auto 0
__all__ = ['ddp', 'total_batch_size', 'B', 'T', 'grad_accum_steps', 'train_loader', 'model', 'raw_model', 'optimizer', 'losses',
           'norms', 'lrs', 'num_return_sequences', 'max_length', 'enc', 'tokens', 'x', 'GPTConfig', 'GPT', 'Block',
           'MLP', 'CausalSelfAttention', 'DataLoaderLite']

# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 11
import math
...
# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 13
@dataclass
class GPTConfig:
...
# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 19
class GPT(nn.Module):
...
# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 23
...
# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 27
class MLP(nn.Module):
...
# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 31
...
# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 34
...
# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 40
#|eval: false
torch.manual_seed(1337)
if torch.cuda.is_available():
    torch.cuda.manual_seed(1337)

# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 43
#|eval: false
...
# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 44
#|eval: false
# simple launch:
...
# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 46
#|eval: false
...
# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 47
#|eval: false
train_loader = DataLoaderLite(B=B, T=T, process_rank=ddp_rank, num_processes=ddp_world_size)

# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 49
#|eval: false
...
model = GPT(GPTConfig(vocab_size=50264))
...
# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 54
#|eval: false
...
for step in range(max_steps):
    ...
    # print(f"step {i:4d} | loss: {loss.item():.6f} | norm: {norm.item():.4f} | dt: {dt*1000:.2f}ms | tok/sec: {tokens_per_sec:.2f}")
    # print(f"step {step:4d} | loss: {loss_accum.item():.6f} | lr {lr:.4e} | norm: {norm.item():.4f} | dt: {dt*1000:.2f}ms | tok/sec: {tokens_per_sec:.2f}")
    if master_process:
        print(f"step {step:4d} | loss: {loss_accum.item():.6f} | lr {lr:.4e} | norm: {norm.item():.4f} | dt: {dt*1000:.2f}ms | tok/sec: {tokens_per_sec:.2f}")
if ddp:
    destroy_process_group()

# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 62
#|eval: false
num_return_sequences = 1
max_length = 256
model.eval()

# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 63
#|eval: false
# prefix tokens
enc = tiktoken.get_encoding('gpt2')
...
# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 64
#|eval: false
...
# %% ../nbs/nanoGPT_P1_devNotes/51_nanogpt08.ipynb 65
#|eval: false
