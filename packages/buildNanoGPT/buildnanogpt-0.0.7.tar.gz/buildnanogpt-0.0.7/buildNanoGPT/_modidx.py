...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'buildNanoGPT.data': { 'buildNanoGPT.data.download': ('nanoGPT_P2_PyPI/data.html#download', 'buildNanoGPT/data.py'),
            ...
            'buildNanoGPT.train': { 'buildNanoGPT.train.get_lr': ('nanoGPT_P2_PyPI/train.html#get_lr', 'buildNanoGPT/train.py'),
                                    'buildNanoGPT.train.plot_log': ('nanoGPT_P2_PyPI/train.html#plot_log', 'buildNanoGPT/train.py'),
                                    'buildNanoGPT.train.read_log': ('nanoGPT_P2_PyPI/train.html#read_log', 'buildNanoGPT/train.py')}}}
