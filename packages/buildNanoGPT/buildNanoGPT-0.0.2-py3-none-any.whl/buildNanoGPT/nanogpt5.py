# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/Dev_Notes/51_nanogpt05.ipynb.
...
# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 11
import math
...
# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 13
@dataclass
class GPTConfig:
...
# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 19
class GPT(nn.Module):
...
# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 23
...
# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 27
class MLP(nn.Module):
...
# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 31
...
# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 35
...
# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 37
...
# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 41
#|eval: false
model = GPT(GPTConfig())
# model.eval() # commented out since we are training
model.to(device)

# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 43
#|eval: false
num_return_sequences = 1
max_length = 100
model.eval()

# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 44
#|eval: false
# prefix tokens
enc = tiktoken.get_encoding('gpt2')
...
# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 45
#|eval: false
...
# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 46
#|eval: false
...
# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 51
#|eval: false
...
# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 55
#|eval: false
num_return_sequences = 1
max_length = 256
model.eval()

# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 56
#|eval: false
# prefix tokens
enc = tiktoken.get_encoding('gpt2')
# visuliazing the encoded tokens here at https://tiktokenizer.vercel.app/?model=gpt2
...
# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 57
#|eval: false
# generate! right now x is (B, T) where B = 5, T = 8
# set the seed to 42
torch.manual_seed(42)
...
# %% ../nbs/Dev_Notes/51_nanogpt05.ipynb 58
#|eval: false
# print the generated text
for i in range(num_return_sequences):
    tokens = x[i, :max_length].tolist()
