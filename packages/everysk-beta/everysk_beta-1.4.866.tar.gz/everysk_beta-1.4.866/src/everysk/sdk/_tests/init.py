...
class InitTestCase(TestCase):
    ...
    def test_sdk_modules_path(self):
        ...
        self.assertListEqual(list(modules), ['CustomIndex', 'Datastore', 'File', 'Portfolio', 'PrivateSecurity', 'Query', 'Report', 'Script', 'Securities', 'Security', 'WorkerTemplate'])

    def test_import_inexistent_module(self):
        with self.assertRaisesRegex(ImportError, "cannot import name 'inexistent_module' from 'everysk.sdk'"):
            from everysk.sdk import inexistent_module

    def test_import_worker_template(self):
        from everysk.sdk.entities.worker_template.base import WorkerTemplate as TopLevelWorkerTemplate
        from everysk.sdk import WorkerTemplate
        self.assertEqual(WorkerTemplate, TopLevelWorkerTemplate)

    def test_import_portfolio(self):
        from everysk.sdk.entities.portfolio.base import Portfolio as TopLevelPortfolio
        from everysk.sdk import Portfolio
    ...
    def test_import_security(self):
        ...
        from everysk.sdk import Security
    ...
    def test_import_securities(self):
        ...
        from everysk.sdk import Securities
    ...
    def test_import_datastore(self):
        ...
        from everysk.sdk import Datastore
    ...
    def test_import_private_security(self):
        ...
        from everysk.sdk import PrivateSecurity
    ...
    def test_import_report(self):
        ...
        from everysk.sdk import Report
