...
from everysk.core.http import HttpConnection, HttpConnectionConfig, HttpGETConnection, HttpPOSTConnection, HttpSDKPOSTConnection, requests, time,log
...
class HttpConnectionConfigTestCase(TestCase):
    ...
    def test_default_attributes(self):
        ...
        self.assertIsInstance(HttpConnection.config, HttpConnectionConfig)
...
class HttpSDKPOSTConnectionTestCase(TestCase):
    ...
    def test_get_payload(self):
        ...
        self.assertEqual(http.get_payload(), dumps({'class_name': 'class_name', 'method_name': 'method_name', 'self_obj': {'self_obj': 'obj'}, 'params': {}}))
