...
class RequestsClientTestCase(TestCase):
    ...
    def test_request_method(self):
        ...
        mock_request.assert_called_once_with("GET", "http://example.com", headers={}, params=None, json=None, timeout=3600, verify=True, allow_redirects=False)

###############################################################################
#   Standard HTTP Client TestCase Implementation
###############################################################################
class StandardHTTPClientTestCase(TestCase):
    @patch('everysk.api.http_client.RequestsClient')
