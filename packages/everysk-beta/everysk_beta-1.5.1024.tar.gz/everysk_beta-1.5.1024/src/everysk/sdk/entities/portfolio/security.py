...
class Security(BaseDict, BaseSDK):
    ...
    def __init__(self, **kwargs):
        ...
        for key, value in kwargs.items():
            if key == 'extra_data':
                self.extra_data.update(value or BaseDict())
                continue
    ...
    def to_legacy_dict(self, with_internals: bool = True) -> dict:
        ...
        """
        dct: dict = _parser_out(self._to_dict(add_class_path=False), with_internals=with_internals)
