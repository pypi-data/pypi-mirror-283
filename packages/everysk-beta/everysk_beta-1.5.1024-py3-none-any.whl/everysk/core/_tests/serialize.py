...
class SerializeDumpsTestCase(TestCase):
    ...
    def test_sdk_entities_objects(self):
        ...
        DateTime.now = mock.MagicMock(return_value=DateTime(2024, 6, 20, 14, 38, 59, 360554))
        ...
        self.assertEqual(dumps(WorkerTemplate(), sort_keys=True, use_undefined=True), '{"__class_path__": "everysk.sdk.entities.worker_template.base.WorkerTemplate", "category": {"__undefined__": null}, "created_on": {"__datetime__": "2024-06-20T14:38:59.360554+00:00"}, "default_output": null, "description": null, "form_functions": null, "form_inputs": null, "form_outputs": null, "icon": {"__undefined__": null}, "name": null, "path_name": null, "ports": null, "script_entry_point": null, "script_runtime": "python", "script_source": null, "script_visible_source": null, "sort_index": null, "tags": [], "type": "BASIC", "updated_on": {"__datetime__": "2024-06-20T14:38:59.360554+00:00"}, "version": "v1", "visible": false}')
...
class SerializeLoadsTestCase(TestCase):
    ...
    def test_sdk_entities_objects(self):
        ...
        self.assertDictEqual(
            loads(
                '{"__class_path__": "app.var.sdk.entities.worker_template.base.WorkerTemplate", "category": {"__undefined__": null}, "created_on": {"__datetime__": "2024-06-20T14:38:59.360554+00:00"}, "default_output": null, "description": null, "form_functions": null, "form_inputs": null, "form_outputs": null, "icon": {"__undefined__": null}, "name": null, "path_name": null, "ports": null, "script_entry_point": null, "script_runtime": "python", "script_source": null, "script_visible_source": null, "sort_index": null, "tags": [], "type": "BASIC", "updated_on": {"__datetime__": "2024-06-20T14:38:59.360554+00:00"}, "version": "v1", "visible": false}',
                use_undefined=True
            ),
            WorkerTemplate()
        )
