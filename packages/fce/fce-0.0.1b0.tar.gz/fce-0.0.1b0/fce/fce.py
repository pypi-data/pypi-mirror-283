from PyQt6.QtCore import QDateTime, Qt, QTimer, QRect, QPoint, QFile, QIODevice, QPropertyAnimation, QEasingCurve
...
class WidgetGallery(QDialog):
    ...
    def showHelp(self):
        ...
        def createPopupHelp():
            ...
            'nelectrons': 'Number of electrons', 'nmuons': 'Number of muons', 'njets': 'Number of jets',
            'electrons[nelectrons]': 'Collection of electrons', 'muons[nmuons]': 'Collection of muons', 'jets[njets]': 'Collection of jets',
            '': '', 'Object variables': 'Description',
            '.p4': 'Four-momentum', '.pt': 'Transverse momentum', '.eta': 'Pseudorapidity', '.phi': 'Azimuthal angle', '.e': 'Energy',
            '.isbtag': 'Is jet b-tagged (jets only)',
            ' ': ' ', 'Output variables':  'Description',
            'passevent': 'Boolean flag for selected events', 'observable': 'Variable definition to plot'}
...
#            else: self.runModule.run()
    ...
    def createSettingsWindow(self):
        ...
        min.setValidator(QDoubleValidator())
        ...
        max.setValidator(QDoubleValidator())
