...
// This is a threaded version of the iex_parser.cpp file. The main difference is that the parsing of price level updates and writing to output file is done in separate threads.
