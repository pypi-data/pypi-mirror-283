...
class Suews_Driver(f90wrap.runtime.FortranModule):
    ...
    """
    @staticmethod
    def suews_cal_main_dts(self, forcing, config, siteinfo, modstate):
        """
        debugstate, outputline = suews_cal_main_dts(self, forcing, config, siteinfo, \
            modstate)
        ...
        debugstate, outputline = \
            _supy_driver.f90wrap_suews_driver__suews_cal_main_dts(timer=self._handle, \
    ...
    @staticmethod
    def suews_cal_biogenco2_dts(self, config, forcing, siteinfo, modstate):
        """
        suews_cal_biogenco2_dts(self, config, forcing, siteinfo, modstate)
        ...
        """
        _supy_driver.f90wrap_suews_driver__suews_cal_biogenco2_dts(timer=self._handle, \
            config=config._handle, forcing=forcing._handle, siteinfo=siteinfo._handle, \
            modstate=modstate._handle)
    ...
    @staticmethod
    def suews_cal_qn_dts(self, config, forcing, siteinfo, modstate, \
        dataoutlinespartacus):
        """
        suews_cal_qn_dts(self, config, forcing, siteinfo, modstate, \
            dataoutlinespartacus)
        ...
        """
        _supy_driver.f90wrap_suews_driver__suews_cal_qn_dts(timer=self._handle, \
            config=config._handle, forcing=forcing._handle, siteinfo=siteinfo._handle, \
    ...
    @staticmethod
    def suews_cal_qs_dts(self, config, forcing, siteinfo, modstate, \
        dataoutlineestm):
        """
        suews_cal_qs_dts(self, config, forcing, siteinfo, modstate, dataoutlineestm)
        ...
        """
        _supy_driver.f90wrap_suews_driver__suews_cal_qs_dts(timer=self._handle, \
            config=config._handle, forcing=forcing._handle, siteinfo=siteinfo._handle, \
    ...
    @staticmethod
    def suews_cal_water_dts(self, config, forcing, siteinfo, modstate):
        """
        suews_cal_water_dts(self, config, forcing, siteinfo, modstate)
        ...
        """
        _supy_driver.f90wrap_suews_driver__suews_cal_water_dts(timer=self._handle, \
            config=config._handle, forcing=forcing._handle, siteinfo=siteinfo._handle, \
            modstate=modstate._handle)
    ...
    @staticmethod
    def suews_cal_snow_dts(self, config, forcing, siteinfo, modstate, \
        dataoutlinesnow):
        """
        suews_cal_snow_dts(self, config, forcing, siteinfo, modstate, dataoutlinesnow)
        ...
        """
        _supy_driver.f90wrap_suews_driver__suews_cal_snow_dts(timer=self._handle, \
            config=config._handle, forcing=forcing._handle, siteinfo=siteinfo._handle, \
    ...
    def suews_cal_qe(diagnose, storageheatmethod, nlayer, tstep, evapmethod, avdens, \
        ...
        state_grid, nwstate_grid, qe, ev_grid, runoff_grid, surf_chang_grid, \
            ...
            rss_surf=rss_surf, snowfrac_in=snowfrac_in)
        return state_grid, nwstate_grid, qe, ev_grid, runoff_grid, surf_chang_grid, \
            runoffpipes_grid, runoffwaterbody_grid, runoffagveg_grid, \
            runoffagimpervious_grid
    
    @staticmethod
    def suews_cal_qe_dts(self, config, forcing, siteinfo, modstate):
        """
        suews_cal_qe_dts(self, config, forcing, siteinfo, modstate)
        ...
        """
        _supy_driver.f90wrap_suews_driver__suews_cal_qe_dts(timer=self._handle, \
            config=config._handle, forcing=forcing._handle, siteinfo=siteinfo._handle, \
            modstate=modstate._handle)
    ...
    @staticmethod
    def suews_cal_qh_dts(self, config, forcing, siteinfo, modstate):
        """
        suews_cal_qh_dts(self, config, forcing, siteinfo, modstate)
        ...
        """
        _supy_driver.f90wrap_suews_driver__suews_cal_qh_dts(timer=self._handle, \
            config=config._handle, forcing=forcing._handle, siteinfo=siteinfo._handle, \
            modstate=modstate._handle)
    ...
    @staticmethod
    def suews_cal_resistance_dts(self, config, forcing, siteinfo, modstate):
        """
        suews_cal_resistance_dts(self, config, forcing, siteinfo, modstate)
        ...
        """
        _supy_driver.f90wrap_suews_driver__suews_cal_resistance_dts(timer=self._handle, \
            config=config._handle, forcing=forcing._handle, siteinfo=siteinfo._handle, \
            modstate=modstate._handle)
    ...
    def suews_cal_multitsteps(metforcingblock, len_sim, ah_min, ahprof_24hr, \
        ...
        lai_id, laimax, laimin, laipower, laitype, lat, lng, localclimatemethod, \
        maxconductance, maxfcmetab, maxqfmetab, snowwater, minfcmetab, minqfmetab, \
        min_res_bioco2, narp_emis_snow, narp_trans_site, netradiationmethod, \
        ohm_coef, ohmincqf, ohm_threshsw, ohm_threshwd, pipecapacity, \
        popdensdaytime, popdensnighttime, popprof_24hr, pormax_dec, pormin_dec, \
        preciplimit, preciplimitalb, qf0_beu, qf_a, qf_b, qf_c, nlayer, \
        n_vegetation_region_urban, n_stream_sw_urban, n_stream_lw_urban, \
        sw_dn_direct_frac, air_ext_sw, air_ssa_sw, veg_ssa_sw, air_ext_lw, \
        air_ssa_lw, veg_ssa_lw, veg_fsd_const, veg_contact_fraction_const, \
        ground_albedo_dir_mult_fact, use_sw_direct_albedo, height, building_frac, \
        ...
        """
        output_block_suews, debug_state = suews_cal_multitsteps(metforcingblock, \
