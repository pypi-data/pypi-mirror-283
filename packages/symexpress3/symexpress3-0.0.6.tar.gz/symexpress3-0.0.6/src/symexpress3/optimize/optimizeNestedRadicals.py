...
class OptimizeNestedRadicals( optimizeBase.OptimizeBase ):
  ...
  def optimize( self, symExpr, action ):
    ...
    # add the radicals
    # for iCnt in range( 0, len( elemRadicals )):
    for elem in elemRadicals :
      # elem = elemRadicals[ iCnt ]
      ...
      # if ( elem.powerSign != exprNormal.powerSign ):
      #   elem.powerCounter     *= exprNormal.powerDenominator
      #   elem.powerDenominator *= exprNormal.powerCounter
      # else:
      #   elem.powerCounter     *= exprNormal.powerCounter
      #   elem.powerDenominator *= exprNormal.powerDenominator
