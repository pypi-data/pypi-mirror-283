...
from prodt_lan.app.models.desktop_login_log import DesktopLoginLog
from prodt_lan.app.models.entity import Entity, EntityLink, EntityVersion
from prodt_lan.app.models.event import ApiEvent
from prodt_lan.app.models.metadata_descriptor import MetadataDescriptor
from prodt_lan.app.models.login_log import LoginLog
...
from prodt_lan.app.models.output_file import OutputFile
...
from prodt_lan.app.models.working_file import WorkingFile

from prodt_lan.app.utils import events, fields
from prodt_lan.app.stores import file_store
from prodt_lan.app import config

from prodt_lan.app.services.exception import (
...
def remove_task(task_id, force=False):
    ...
    """
    from prodt_lan.app.services import tasks_service
...
def remove_project(project_id):
    from prodt_lan.app.services import playlists_service
...
def remove_episode(episode_id, force=False):
    ...
    """
    from prodt_lan.app.services import shots_service, assets_service, tasks_service
