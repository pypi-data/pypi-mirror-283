...
from prodt_lan.app import config, swagger
from prodt_lan.app.stores import auth_tokens_store, file_store
...
from prodt_lan.app.utils import cache, fs, logs, monitoring
from prodt_lan.app.utils.flask import ParsedUserAgent, ORJSONProvider
...
def configure_auth():
    from prodt_lan.app.services import persons_service
