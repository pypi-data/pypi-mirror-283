...
from prodt_lan.app.blueprints.crud.asset_instance import (
    AssetInstanceResource,
    AssetInstancesResource,
)
from prodt_lan.app.blueprints.crud.attachment_file import (
    AttachmentFilesResource,
    AttachmentFileResource,
)
from prodt_lan.app.blueprints.crud.comments import CommentsResource, CommentResource
from prodt_lan.app.blueprints.crud.custom_action import (
    CustomActionsResource,
    CustomActionResource,
)
from prodt_lan.app.blueprints.crud.status_automation import (
    StatusAutomationsResource,
    StatusAutomationResource,
)
from prodt_lan.app.blueprints.crud.day_off import DayOffsResource, DayOffResource
from prodt_lan.app.blueprints.crud.department import (
    DepartmentsResource,
    DepartmentResource,
)
from prodt_lan.app.blueprints.crud.entity import EntityResource, EntitiesResource
from prodt_lan.app.blueprints.crud.entity_type import (
    EntityTypesResource,
    EntityTypeResource,
)
from prodt_lan.app.blueprints.crud.entity_link import (
    EntityLinksResource,
    EntityLinkResource,
)
from prodt_lan.app.blueprints.crud.event import EventsResource, EventResource
from prodt_lan.app.blueprints.crud.file_status import (
    FileStatusesResource,
    FileStatusResource,
)
from prodt_lan.app.blueprints.crud.metadata_descriptor import (
    MetadataDescriptorsResource,
    MetadataDescriptorResource,
)
from prodt_lan.app.blueprints.crud.milestone import (
    MilestonesResource,
    MilestoneResource,
)
from prodt_lan.app.blueprints.crud.notification import (
    NotificationsResource,
    NotificationResource,
)
from prodt_lan.app.blueprints.crud.organisation import (
    OrganisationsResource,
    OrganisationResource,
)
from prodt_lan.app.blueprints.crud.output_file import (
    OutputFilesResource,
    OutputFileResource,
)
from prodt_lan.app.blueprints.crud.output_type import (
    OutputTypeResource,
    OutputTypesResource,
)
from prodt_lan.app.blueprints.crud.news import NewssResource, NewsResource
from prodt_lan.app.blueprints.crud.person import PersonResource, PersonsResource
from prodt_lan.app.blueprints.crud.preview_file import (
    PreviewFilesResource,
    PreviewFileResource,
)
from prodt_lan.app.blueprints.crud.playlist import (
    PlaylistsResource,
    PlaylistResource,
)
from prodt_lan.app.blueprints.crud.project import (
    ProjectResource,
    ProjectsResource,
    ProjectTaskTypeLinksResource,
)
from prodt_lan.app.blueprints.crud.project_status import (
    ProjectStatusResource,
    ProjectStatussResource,
)
from prodt_lan.app.blueprints.crud.schedule_item import (
    ScheduleItemsResource,
    ScheduleItemResource,
)
from prodt_lan.app.blueprints.crud.subscription import (
    SubscriptionsResource,
    SubscriptionResource,
)
from prodt_lan.app.blueprints.crud.search_filter import (
    SearchFiltersResource,
    SearchFilterResource,
)
from prodt_lan.app.blueprints.crud.search_filter_group import (
    SearchFilterGroupsResource,
    SearchFilterGroupResource,
)
from prodt_lan.app.blueprints.crud.software import (
    SoftwaresResource,
    SoftwareResource,
)
from prodt_lan.app.blueprints.crud.task_type import (
    TaskTypesResource,
    TaskTypeResource,
)
from prodt_lan.app.blueprints.crud.task_status import (
    TaskStatusesResource,
    TaskStatusResource,
)
from prodt_lan.app.blueprints.crud.task import TasksResource, TaskResource
from prodt_lan.app.blueprints.crud.time_spent import (
    TimeSpentsResource,
    TimeSpentResource,
)
from prodt_lan.app.blueprints.crud.working_file import (
    WorkingFilesResource,
    WorkingFileResource,
)
from prodt_lan.app.blueprints.crud.preview_background_file import (
