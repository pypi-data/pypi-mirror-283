...
from prodt_lan.app.utils import dbhelpers
from prodt_lan.app.utils.env import envtobool, env_with_semicolon_to_list
...
DATABASE = {
    ...
    "database": os.getenv("DB_DATABASE", "prodt_landb"),
}
...
TMP_DIR = os.getenv("TMP_DIR", os.path.join(tempfile.gettempdir(), "prodt_lan"))
...
JOB_QUEUE_NOMAD_PLAYLIST_JOB = os.getenv(
    "JOB_QUEUE_NOMAD_PLAYLIST_JOB", "prodt_lan-playlist"
)
JOB_QUEUE_NOMAD_NORMALIZE_JOB = os.getenv("JOB_QUEUE_NOMAD_NORMALIZE_JOB", "")
JOB_QUEUE_NOMAD_HOST = os.getenv("JOB_QUEUE_NOMAD_HOST", "prodt_lan-nomad-01.prodt_lan")
...
LDAP_BASE_DN = os.getenv("LDAP_BASE_DN", "cn=Users,dc=prodt_lan,dc=local")
LDAP_GROUP = os.getenv("LDAP_GROUP", "")
LDAP_DOMAIN = os.getenv("LDAP_DOMAIN", "prodt_lan.local")
