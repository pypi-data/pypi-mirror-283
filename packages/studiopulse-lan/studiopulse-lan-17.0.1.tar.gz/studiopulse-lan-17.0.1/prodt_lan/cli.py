...
from prodt_lan.app.utils import dbhelpers, auth, commands
from prodt_lan.app.services import persons_service, auth_service
...
from prodt_lanimport __file__ as root_path
...
def version():
    ...
    """
    from prodt_lanimport __version__

    print(f"prodt_lanversion: {__version__}")
...
def clear_memory_cache():
    ...
    from prodt_lan.app import cache
...
def dump_database(store=False):
    """
    Dump database described in prodt_lanenvironment variables and save it to
