...
from ytb2audiobot.utils import remove_m4a_file_if_exists
...
async def processing_commands(command: dict, movie_meta: dict):
    ...
    for idx, audio_part in enumerate(audios, start=1):
        ...
        audio_data = {
            ...
            'caption': caption if len(caption) < config.TG_CAPTION_MAX_LONG else caption[:config.TG_CAPTION_MAX_LONG - 12] + ' ✂️ ...',
        }
