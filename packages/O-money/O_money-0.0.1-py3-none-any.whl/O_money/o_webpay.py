...
#     parser = argparse.ArgumentParser(description="Generate Orange Money Webpay link")
#     parser.add_argument(
#         "-v", "--verbose", action="store_true", help="Activate verbosity"
#     )

#     args = parser.parse_args()

#     webpay_api = Webpay(verbose=args.verbose)
#     webpay_api._get_token
#     # webpay_api.token
#     webpay_link = webpay_api.init_pay(2500, "order8", "ref1")
#     print(webpay_link)

#     # webpay_api.payment_status(
#     #     "order2",
#     #     2500,
#     #     "v1qyve8pxxsn3sbmxifi4lhy0knvxgcrudi7vubm8guzcceghkww1okpcdexv7nb",
#     # )
