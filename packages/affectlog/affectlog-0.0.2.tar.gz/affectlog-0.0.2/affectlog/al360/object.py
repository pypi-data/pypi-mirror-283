...
class AL360:
    ...
    Notes
    --------
    For tutorial look at https://al360.drwhy.ai/docs/guide/first-datasource
    ...
    def run_server(self,
                   ...
                   port=8181,
                   append_data=False,
                   al360_url='https://al360.drwhy.ai/',
                   disable_logs=True):
        ...
        Notes
        --------
        Read more about data sources https://al360.drwhy.ai/docs/guide/basic-concepts
    ...
    def get_params(self, param_type):
        ...
        Notes
        --------
        Information about params https://al360.drwhy.ai/docs/guide/params
    ...
    def print_options(self, options_category=None):
        ...
        Notes
        --------
        List of plots with described options for each one https://al360.drwhy.ai/docs/guide/observation-level
        """
    ...
    def get_params_attributes(self, param_type=None):
        ...
        Notes
        --------
        Attribused are used for dynamicly modifying observations https://al360.drwhy.ai/docs/guide/modifying-observations
    ...
    def upload(self, token=None, al360_url='https://al360.drwhy.ai/', open_browser=True):
