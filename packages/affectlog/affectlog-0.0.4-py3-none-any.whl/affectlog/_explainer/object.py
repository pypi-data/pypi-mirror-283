import numpy as np
import pandas as pd
from affectlog.model_explanations import ModelPerformance, VariableImportance, AggregatedProfiles, ResidualDiagnostics
from affectlog.predict_explanations import BreakDown, Shap, CeterisParibus
from affectlog.wrappers import ShapWrapper
from affectlog.fairness import GroupFairnessClassification, GroupFairnessRegression
...
class Explainer:
    ...
    def model_surrogate(self,
        ...
        the model, so that it can be easily interpreted. 
