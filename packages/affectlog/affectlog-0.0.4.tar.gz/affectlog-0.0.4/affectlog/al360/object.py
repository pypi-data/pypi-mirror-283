...
from affectlog._explainer.object import Explainer
...
from .static import get_json, upload_al360, generate_token
from ._resource_manager import ResourceManager
from ._plots_manager import PlotsManager

class AL360:
    """ Creates AL360 object

    This class should be used to create Python connector for AL360 dashboard. Initialized
    ...
    enable_attributes : bool
        ...
        display details of observation in AL360, but it also increases generated
        file size.
    ...
    mutex : _thread.lock
        Mutex for params, plots and resources cache. Common to AL360, PlotsManager and ResourcesManager class.
    options : dict
        Options for plots
    ...
    Notes
    --------
    For tutorial look at https://affectlog.com/al360/docs/guide/first-datasource
    ...
    def get_supported_plots(self):
        """Returns plots classes that can produce at least one valid chart for this AL360.
    ...
    def run_server(self,
                   ...
                   port=8181,
                   append_data=False,
                   al360_url='https://affectlog.com/al360/',
                   disable_logs=True):
        """Starts server for live mode of AL360
        ...
        append_data : bool
            if generated link should append data to already existing AL360 window.
        al360_url : str
            URl of AL360 dhasboard
        disable_logs : str
            if logs should be muted

        Notes
        --------
        Read more about data sources https://affectlog.com/al360/docs/guide/basic-concepts
        ...
        if self.server_thread:
            raise Exception('Server is already running. To stop ip use al360.stop_server().')
        ...
        if append_data:
            print(al360_url + '?append=http://' + host + ':' + str(port) + '/')
        else:
            print(al360_url + '?data=http://' + host + ':' + str(port) + '/')
    ...
    def push_model(self, explainer, precalculate=None):
        ...
        Parameters
        -----------
        explainer : affectlog.Explainer
            Explainer created using affectlog package
    ...
    def get_params(self, param_type):
        ...
        Notes
        --------
        Information about params https://affectlog.com/al360/docs/guide/params
    ...
    def print_options(self, options_category=None):
        ...
        Notes
        --------
        List of plots with described options for each one https://affectlog.com/al360/docs/guide/observation-level
        """
    ...
    def get_option(self, options_category, option):
        ...
        options_category : str
           ...
           Categories are underlined in the output of al360.print_options()
        option : str
            Name of the option
    ...
    def get_params_attributes(self, param_type=None):
        ...
        Notes
        --------
        Attribused are used for dynamicly modifying observations https://affectlog.com/al360/docs/guide/modifying-observations
    ...
    def upload(self, token=None, al360_url='https://affectlog.com/al360/', open_browser=True):
        ...
        al360_url : str
            Address of AL360 dashboard instance
        open_browser : bool
            Whether to open AL360 after upload.
        ...
        data_url = upload_al360(self, token)
        url = al360_url + '?data=' + data_url
        if open_browser:
            webbrowser.open(url)
        return url
