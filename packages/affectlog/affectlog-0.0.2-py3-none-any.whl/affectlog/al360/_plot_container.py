...
class PlotContainer(OptionBase):
    ...
    plot_component : str
        Identifier of AL360's component that should render this chart
    plot_category : str
    ...
    use_cache : bool
        If this object is allowed to use cache when requesting resources
    """
    def __init__(self, al360, cache=True):
        super().__init__(al360)
    ...
    def serialize(self):
        ...
        Returned dict is meant to be directly put into AL360 data file.
    ...
    def test_al360(al360):
        ...
        there is at least one classification model in al360.

        Parameters
        -----------
        al360 : affectlog.AL360
            Object of class affectlog.AL360
