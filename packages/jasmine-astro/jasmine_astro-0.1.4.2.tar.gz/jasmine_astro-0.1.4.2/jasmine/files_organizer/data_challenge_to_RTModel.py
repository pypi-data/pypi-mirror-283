...
if __name__ == '__main__':
    folder_to_be_created = '/Users/stela/Documents/Scripts/RTModel_project/datachallenge/events'
    master_input_folder = '/Users/stela/Documents/Scripts/RTModel_project/datachallenge'

    creating_directories(data_challenge_lc_number_=4, folder_path_=folder_to_be_created)
    creating_files(data_challenge_lc_number_=4, output_folder_path_=folder_to_be_created,
                   master_input_folder_path_=master_input_folder, data_input_folder_path_=f'{master_input_folder}/lc')
    # ephtools.creating_ephemerides(satellite_folder_path_=folder_to_be_created, ephemerides_path_=master_input_folder)
