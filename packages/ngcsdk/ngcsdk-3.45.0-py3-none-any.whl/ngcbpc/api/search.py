...
class SearchAPI:  # noqa: D101
    ...
    def _get_search_endpoint(resource_name, org=None, team=None):
        ...
        parts = ["v2", "search", org_team or "catalog", "resources", resource_name]
        return "/".join([part for part in parts if part])

    def _run_search_query(
        self, resource_type, resource_matcher, org, team, filter_list=None
    ) -> List[SearchResponseResultResource]:
        query = self._get_search_endpoint(resource_type, org=org, team=team)
