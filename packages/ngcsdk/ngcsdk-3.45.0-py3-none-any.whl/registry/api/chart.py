...
class ChartAPI:
    ...
    def list(
        ...
        """Lists resources or versions in the chart repository based on the provided target, \
        ...
        Raises:
            ResourceNotFoundException: If no matching resources or versions could be found.
        """  # noqa: D205, D401
    ...
    def update(
        ...
        Raises:
            ...
            ArgumentTypeError: If no updateable arguments are provided, indicating that no update needs to be performed.
        """  # noqa: D205, D401
        self.config.validate_configuration()
        crt = ChartRegistryTarget(target, org_required=True, name_required=True)
