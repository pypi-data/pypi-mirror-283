...
def _do_extract_activities_from_log(hashes_traces: list[list[int]],
                                    ...
                                    activity_filter: ActivityInTraceFilter = default_activity_in_trace_filter) -> list[list[ActivityInTraceInfo]]:
...
def full_fill_activities(log: MyEventLog,
                         activities: list[list[ActivityInTraceInfo]],
                         activities_creator: Callable[[list[MyEvent]], list[ActivityInTraceInfo]]) -> list[list[ActivityInTraceInfo]]:
    new_activities = []
    for trace_activities, trace in zip(activities, log):
