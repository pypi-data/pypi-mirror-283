...
Refer to the Terraform Registry for docs: [`akeyless_dfc_key`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key).
'''
import abc
import builtins
import datetime
...
class DfcKey(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key akeyless_dfc_key}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key akeyless_dfc_key} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param alg: DFCKey type; options: [AES128GCM, AES256GCM, AES128SIV, AES256SIV, AES128CBC, AES256CBC, RSA1024, RSA2048, RSA3072, RSA4096]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#alg DfcKey#alg}
        :param name: DFCKey name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#name DfcKey#name}
        :param cert_data_base64: PEM Certificate in a Base64 format. Used for updating RSA keys' certificates. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#cert_data_base64 DfcKey#cert_data_base64}
        :param certificate_common_name: Common name for the generated certificate. Relevant only for generate-self-signed-certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#certificate_common_name DfcKey#certificate_common_name}
        :param certificate_country: Country name for the generated certificate. Relevant only for generate-self-signed-certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#certificate_country DfcKey#certificate_country}
        :param certificate_locality: Locality for the generated certificate. Relevant only for generate-self-signed-certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#certificate_locality DfcKey#certificate_locality}
        :param certificate_organization: Organization name for the generated certificate. Relevant only for generate-self-signed-certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#certificate_organization DfcKey#certificate_organization}
        :param certificate_province: Province name for the generated certificate. Relevant only for generate-self-signed-certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#certificate_province DfcKey#certificate_province}
        :param certificate_ttl: TTL in days for the generated certificate. Required only for generate-self-signed-certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#certificate_ttl DfcKey#certificate_ttl}
        :param customer_frg_id: The customer fragment ID that will be used to create the DFC key (if empty, the key will be created independently of a customer fragment). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#customer_frg_id DfcKey#customer_frg_id}
        :param delete_protection: Protection from accidental deletion of this item, [true/false]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#delete_protection DfcKey#delete_protection}
        :param description: Description of the object. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#description DfcKey#description}
        :param generate_self_signed_certificate: Whether to generate a self signed certificate with the key. If set, certificate-ttl must be provided. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#generate_self_signed_certificate DfcKey#generate_self_signed_certificate}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#id DfcKey#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param split_level: The number of fragments that the item will be split into (not includes customer fragment). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#split_level DfcKey#split_level}
        :param tags: List of the tags attached to this DFC key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#tags DfcKey#tags}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DfcKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#import import section} in the documentation of this resource for the id to use
...
class DfcKeyConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def alg(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#alg DfcKey#alg}
        '''
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#name DfcKey#name}
        '''
    ...
    def cert_data_base64(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#cert_data_base64 DfcKey#cert_data_base64}
        '''
    ...
    def certificate_common_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#certificate_common_name DfcKey#certificate_common_name}
        '''
    ...
    def certificate_country(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#certificate_country DfcKey#certificate_country}
        '''
    ...
    def certificate_locality(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#certificate_locality DfcKey#certificate_locality}
        '''
    ...
    def certificate_organization(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#certificate_organization DfcKey#certificate_organization}
        '''
    ...
    def certificate_province(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#certificate_province DfcKey#certificate_province}
        '''
    ...
    def certificate_ttl(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#certificate_ttl DfcKey#certificate_ttl}
        '''
    ...
    def customer_frg_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#customer_frg_id DfcKey#customer_frg_id}
        '''
    ...
    def delete_protection(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#delete_protection DfcKey#delete_protection}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#description DfcKey#description}
        '''
    ...
    def generate_self_signed_certificate(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#generate_self_signed_certificate DfcKey#generate_self_signed_certificate}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#id DfcKey#id}.
    ...
    def split_level(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#split_level DfcKey#split_level}
        '''
    ...
    def tags(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dfc_key#tags DfcKey#tags}
        '''
