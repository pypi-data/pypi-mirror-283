...
Refer to the Terraform Registry for docs: [`akeyless_target_zerossl`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl).
'''
import abc
import builtins
import datetime
...
class TargetZerossl(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl akeyless_target_zerossl}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl akeyless_target_zerossl} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param api_key: API Key of the ZeroSSLTarget account. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#api_key TargetZerossl#api_key}
        :param imap_fqdn: FQDN of the IMAP service. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#imap_fqdn TargetZerossl#imap_fqdn}
        :param imap_password: Password to access the IMAP service. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#imap_password TargetZerossl#imap_password}
        :param imap_username: Username to access the IMAP service. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#imap_username TargetZerossl#imap_username}
        :param name: Target name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#name TargetZerossl#name}
        :param description: Description of the object. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#description TargetZerossl#description}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#id TargetZerossl#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param imap_port: Port of the IMAP service. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#imap_port TargetZerossl#imap_port}
        :param imap_target_email: Email to use when asking ZeroSSL to send a validation email, if empty will use username. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#imap_target_email TargetZerossl#imap_target_email}
        :param key: Key name. The key will be used to encrypt the target secret value. If key name is not specified, the account default protection key is used Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#key TargetZerossl#key}
        :param timeout: Timeout waiting for certificate validation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#timeout TargetZerossl#timeout}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing TargetZerossl that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#import import section} in the documentation of this resource for the id to use
...
class TargetZerosslConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def api_key(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#api_key TargetZerossl#api_key}
        '''
    ...
    def imap_fqdn(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#imap_fqdn TargetZerossl#imap_fqdn}
        '''
    ...
    def imap_password(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#imap_password TargetZerossl#imap_password}
        '''
    ...
    def imap_username(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#imap_username TargetZerossl#imap_username}
        '''
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#name TargetZerossl#name}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#description TargetZerossl#description}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#id TargetZerossl#id}.
    ...
    def imap_port(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#imap_port TargetZerossl#imap_port}
        '''
    ...
    def imap_target_email(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#imap_target_email TargetZerossl#imap_target_email}
        '''
    ...
    def key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#key TargetZerossl#key}
        '''
    ...
    def timeout(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/target_zerossl#timeout TargetZerossl#timeout}
        '''
