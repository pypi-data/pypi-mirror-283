...
Refer to the Terraform Registry for docs: [`akeyless_dynamic_secret_gcp`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp).
'''
import abc
import builtins
import datetime
...
class DynamicSecretGcp(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp akeyless_dynamic_secret_gcp}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp akeyless_dynamic_secret_gcp} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Dynamic secret name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#name DynamicSecretGcp#name}
        :param delete_protection: Protection from accidental deletion of this item, [true/false]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#delete_protection DynamicSecretGcp#delete_protection}
        :param encryption_key_name: Encrypt dynamic secret details with following key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#encryption_key_name DynamicSecretGcp#encryption_key_name}
        :param gcp_cred_type: Credentials type, options are [token, key]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#gcp_cred_type DynamicSecretGcp#gcp_cred_type}
        :param gcp_key: Base64-encoded service account private key text. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#gcp_key DynamicSecretGcp#gcp_key}
        :param gcp_key_algo: Service account key algorithm, e.g. KEY_ALG_RSA_1024. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#gcp_key_algo DynamicSecretGcp#gcp_key_algo}
        :param gcp_sa_email: GCP service account email. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#gcp_sa_email DynamicSecretGcp#gcp_sa_email}
        :param gcp_token_scopes: Access token scopes list, e.g. scope1,scope2. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#gcp_token_scopes DynamicSecretGcp#gcp_token_scopes}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#id DynamicSecretGcp#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param role_binding: Role binding definitions in json format. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#role_binding DynamicSecretGcp#role_binding}
        :param service_account_type: The type of the gcp dynamic secret. Options[fixed, dynamic]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#service_account_type DynamicSecretGcp#service_account_type}
        :param tags: List of the tags attached to this secret. To specify multiple tags use argument multiple times: --tag Tag1 --tag Tag2 Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#tags DynamicSecretGcp#tags}
        :param target_name: Name of existing target to use in dynamic secret creation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#target_name DynamicSecretGcp#target_name}
        :param user_ttl: User TTL (<=60m for access token). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#user_ttl DynamicSecretGcp#user_ttl}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DynamicSecretGcp that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#import import section} in the documentation of this resource for the id to use
...
class DynamicSecretGcpConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#name DynamicSecretGcp#name}
        '''
    ...
    def delete_protection(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#delete_protection DynamicSecretGcp#delete_protection}
        '''
    ...
    def encryption_key_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#encryption_key_name DynamicSecretGcp#encryption_key_name}
        '''
    ...
    def gcp_cred_type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#gcp_cred_type DynamicSecretGcp#gcp_cred_type}
        '''
    ...
    def gcp_key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#gcp_key DynamicSecretGcp#gcp_key}
        '''
    ...
    def gcp_key_algo(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#gcp_key_algo DynamicSecretGcp#gcp_key_algo}
        '''
    ...
    def gcp_sa_email(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#gcp_sa_email DynamicSecretGcp#gcp_sa_email}
        '''
    ...
    def gcp_token_scopes(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#gcp_token_scopes DynamicSecretGcp#gcp_token_scopes}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#id DynamicSecretGcp#id}.
    ...
    def role_binding(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#role_binding DynamicSecretGcp#role_binding}
        '''
    ...
    def service_account_type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#service_account_type DynamicSecretGcp#service_account_type}
        '''
    ...
    def tags(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#tags DynamicSecretGcp#tags}
        '''
    ...
    def target_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#target_name DynamicSecretGcp#target_name}
        '''
    ...
    def user_ttl(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_gcp#user_ttl DynamicSecretGcp#user_ttl}
        '''
