...
Refer to the Terraform Registry for docs: [`akeyless_gateway_log_forwarding_stdout`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_log_forwarding_stdout).
'''
import abc
import builtins
import datetime
...
class GatewayLogForwardingStdout(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_log_forwarding_stdout akeyless_gateway_log_forwarding_stdout}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_log_forwarding_stdout akeyless_gateway_log_forwarding_stdout} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param enable: Enable Log Forwarding [true/false]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_log_forwarding_stdout#enable GatewayLogForwardingStdout#enable}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_log_forwarding_stdout#id GatewayLogForwardingStdout#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param output_format: Logs format [text/json]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_log_forwarding_stdout#output_format GatewayLogForwardingStdout#output_format}
        :param pull_interval: Pull interval in seconds. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_log_forwarding_stdout#pull_interval GatewayLogForwardingStdout#pull_interval}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing GatewayLogForwardingStdout that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_log_forwarding_stdout#import import section} in the documentation of this resource for the id to use
...
class GatewayLogForwardingStdoutConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def enable(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_log_forwarding_stdout#enable GatewayLogForwardingStdout#enable}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_log_forwarding_stdout#id GatewayLogForwardingStdout#id}.
    ...
    def output_format(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_log_forwarding_stdout#output_format GatewayLogForwardingStdout#output_format}
        '''
    ...
    def pull_interval(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_log_forwarding_stdout#pull_interval GatewayLogForwardingStdout#pull_interval}
        '''
