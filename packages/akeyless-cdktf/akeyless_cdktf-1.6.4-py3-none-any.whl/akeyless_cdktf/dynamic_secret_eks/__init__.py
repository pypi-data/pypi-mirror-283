...
Refer to the Terraform Registry for docs: [`akeyless_dynamic_secret_eks`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks).
'''
import abc
import builtins
import datetime
...
class DynamicSecretEks(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks akeyless_dynamic_secret_eks}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks akeyless_dynamic_secret_eks} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Dynamic secret name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#name DynamicSecretEks#name}
        :param eks_access_key_id: EKS Access Key ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#eks_access_key_id DynamicSecretEks#eks_access_key_id}
        :param eks_assume_role: Role ARN. Role to assume when connecting to the EKS cluster. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#eks_assume_role DynamicSecretEks#eks_assume_role}
        :param eks_cluster_ca_cert: EKS Cluster certificate. Base 64 encoded certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#eks_cluster_ca_cert DynamicSecretEks#eks_cluster_ca_cert}
        :param eks_cluster_endpoint: EKS Cluster endpoint. https:// , <DNS / IP> of the cluster. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#eks_cluster_endpoint DynamicSecretEks#eks_cluster_endpoint}
        :param eks_cluster_name: EKS cluster name. Must match the EKS cluster name you want to connect to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#eks_cluster_name DynamicSecretEks#eks_cluster_name}
        :param eks_region: EKS Region. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#eks_region DynamicSecretEks#eks_region}
        :param eks_secret_access_key: EKS Secret Access Key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#eks_secret_access_key DynamicSecretEks#eks_secret_access_key}
        :param encryption_key_name: Encrypt dynamic secret details with following key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#encryption_key_name DynamicSecretEks#encryption_key_name}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#id DynamicSecretEks#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param secure_access_allow_port_forwading: Enable Port forwarding while using CLI access. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#secure_access_allow_port_forwading DynamicSecretEks#secure_access_allow_port_forwading}
        :param secure_access_bastion_issuer: Path to the SSH Certificate Issuer for your Akeyless Bastion. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#secure_access_bastion_issuer DynamicSecretEks#secure_access_bastion_issuer}
        :param secure_access_cluster_endpoint: The K8s cluster endpoint URL. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#secure_access_cluster_endpoint DynamicSecretEks#secure_access_cluster_endpoint}
        :param secure_access_enable: Enable/Disable secure remote access, [true/false]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#secure_access_enable DynamicSecretEks#secure_access_enable}
        :param secure_access_web: Enable Web Secure Remote Access. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#secure_access_web DynamicSecretEks#secure_access_web}
        :param tags: List of the tags attached to this secret. To specify multiple tags use argument multiple times: -t Tag1 -t Tag2 Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#tags DynamicSecretEks#tags}
        :param target_name: Name of existing target to use in dynamic secret creation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#target_name DynamicSecretEks#target_name}
        :param user_ttl: User TTL. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#user_ttl DynamicSecretEks#user_ttl}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DynamicSecretEks that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#import import section} in the documentation of this resource for the id to use
...
class DynamicSecretEksConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#name DynamicSecretEks#name}
        '''
    ...
    def eks_access_key_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#eks_access_key_id DynamicSecretEks#eks_access_key_id}
        '''
    ...
    def eks_assume_role(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#eks_assume_role DynamicSecretEks#eks_assume_role}
        '''
    ...
    def eks_cluster_ca_cert(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#eks_cluster_ca_cert DynamicSecretEks#eks_cluster_ca_cert}
        '''
    ...
    def eks_cluster_endpoint(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#eks_cluster_endpoint DynamicSecretEks#eks_cluster_endpoint}
        '''
    ...
    def eks_cluster_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#eks_cluster_name DynamicSecretEks#eks_cluster_name}
        '''
    ...
    def eks_region(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#eks_region DynamicSecretEks#eks_region}
        '''
    ...
    def eks_secret_access_key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#eks_secret_access_key DynamicSecretEks#eks_secret_access_key}
        '''
    ...
    def encryption_key_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#encryption_key_name DynamicSecretEks#encryption_key_name}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#id DynamicSecretEks#id}.
    ...
    def secure_access_allow_port_forwading(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#secure_access_allow_port_forwading DynamicSecretEks#secure_access_allow_port_forwading}
        '''
    ...
    def secure_access_bastion_issuer(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#secure_access_bastion_issuer DynamicSecretEks#secure_access_bastion_issuer}
        '''
    ...
    def secure_access_cluster_endpoint(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#secure_access_cluster_endpoint DynamicSecretEks#secure_access_cluster_endpoint}
        '''
    ...
    def secure_access_enable(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#secure_access_enable DynamicSecretEks#secure_access_enable}
        '''
    ...
    def secure_access_web(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#secure_access_web DynamicSecretEks#secure_access_web}
        '''
    ...
    def tags(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#tags DynamicSecretEks#tags}
        '''
    ...
    def target_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#target_name DynamicSecretEks#target_name}
        '''
    ...
    def user_ttl(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/dynamic_secret_eks#user_ttl DynamicSecretEks#user_ttl}
        '''
