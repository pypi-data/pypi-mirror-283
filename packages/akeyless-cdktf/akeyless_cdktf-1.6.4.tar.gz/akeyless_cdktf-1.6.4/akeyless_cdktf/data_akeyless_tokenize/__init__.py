...
Refer to the Terraform Registry for docs: [`data_akeyless_tokenize`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/tokenize).
'''
import abc
import builtins
import datetime
...
class DataAkeylessTokenize(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/tokenize akeyless_tokenize}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/tokenize akeyless_tokenize} Data Source.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param plaintext: Data to be encrypted. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/tokenize#plaintext DataAkeylessTokenize#plaintext}
        :param tokenizer_name: The name of the tokenizer to use in the encryption process. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/tokenize#tokenizer_name DataAkeylessTokenize#tokenizer_name}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/tokenize#id DataAkeylessTokenize#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param tweak: Base64 encoded tweak for vaultless encryption. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/tokenize#tweak DataAkeylessTokenize#tweak}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataAkeylessTokenize that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/tokenize#import import section} in the documentation of this resource for the id to use
...
class DataAkeylessTokenizeConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def plaintext(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/tokenize#plaintext DataAkeylessTokenize#plaintext}
        '''
    ...
    def tokenizer_name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/tokenize#tokenizer_name DataAkeylessTokenize#tokenizer_name}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/tokenize#id DataAkeylessTokenize#id}.
    ...
    def tweak(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/tokenize#tweak DataAkeylessTokenize#tweak}
        '''
