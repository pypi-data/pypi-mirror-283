...
Refer to the Terraform Registry for docs: [`akeyless_k8s_auth_config`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config).
'''
import abc
import builtins
import datetime
...
class K8SAuthConfig(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config akeyless_k8s_auth_config}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config akeyless_k8s_auth_config} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param access_id: The access ID of the Kubernetes auth method. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#access_id K8SAuthConfig#access_id}
        :param name: K8S Auth config name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#name K8SAuthConfig#name}
        :param cluster_api_type: Cluster access type. options: [native_k8s, rancher]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#cluster_api_type K8SAuthConfig#cluster_api_type}
        :param disable_issuer_validation: Disable issuer validation [true/false]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#disable_issuer_validation K8SAuthConfig#disable_issuer_validation}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#id K8SAuthConfig#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param k8_s_ca_cert: The CA Certificate (base64 encoded) to use to call into the kubernetes API server. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#k8s_ca_cert K8SAuthConfig#k8s_ca_cert}
        :param k8_s_host: The URL of the kubernetes API server. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#k8s_host K8SAuthConfig#k8s_host}
        :param k8_s_issuer: The Kubernetes JWT issuer name. If not set, this <kubernetes/serviceaccount> will be used by default. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#k8s_issuer K8SAuthConfig#k8s_issuer}
        :param rancher_api_key: The api key used to access the TokenReview API to validate other JWTs (relevant for rancher only). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#rancher_api_key K8SAuthConfig#rancher_api_key}
        :param rancher_cluster_id: The cluster id as define in rancher (relevant for rancher only). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#rancher_cluster_id K8SAuthConfig#rancher_cluster_id}
        :param signing_key: The private key (in base64 encoded of the PEM format) associated with the public key defined in the Kubernetes auth. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#signing_key K8SAuthConfig#signing_key}
        :param token_exp: Time in seconds of expiration of the Akeyless Kube Auth Method token. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#token_exp K8SAuthConfig#token_exp}
        :param token_reviewer_jwt: A Kubernetes service account JWT used to access the TokenReview API to validate other JWTs. If not set, the JWT submitted in the authentication process will be used to access the Kubernetes TokenReview API. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#token_reviewer_jwt K8SAuthConfig#token_reviewer_jwt}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing K8SAuthConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#import import section} in the documentation of this resource for the id to use
...
class K8SAuthConfigConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def access_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#access_id K8SAuthConfig#access_id}
        '''
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#name K8SAuthConfig#name}
        '''
    ...
    def cluster_api_type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#cluster_api_type K8SAuthConfig#cluster_api_type}
        '''
    ...
    def disable_issuer_validation(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#disable_issuer_validation K8SAuthConfig#disable_issuer_validation}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#id K8SAuthConfig#id}.
    ...
    def k8_s_ca_cert(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#k8s_ca_cert K8SAuthConfig#k8s_ca_cert}
        '''
    ...
    def k8_s_host(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#k8s_host K8SAuthConfig#k8s_host}
        '''
    ...
    def k8_s_issuer(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#k8s_issuer K8SAuthConfig#k8s_issuer}
        '''
    ...
    def rancher_api_key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#rancher_api_key K8SAuthConfig#rancher_api_key}
        '''
    ...
    def rancher_cluster_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#rancher_cluster_id K8SAuthConfig#rancher_cluster_id}
        '''
    ...
    def signing_key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#signing_key K8SAuthConfig#signing_key}
        '''
    ...
    def token_exp(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#token_exp K8SAuthConfig#token_exp}
        '''
    ...
    def token_reviewer_jwt(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/k8s_auth_config#token_reviewer_jwt K8SAuthConfig#token_reviewer_jwt}
        '''
