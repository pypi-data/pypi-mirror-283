...
Refer to the Terraform Registry for docs: [`data_akeyless_target_details`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/target_details).
'''
import abc
import builtins
import datetime
...
class DataAkeylessTargetDetails(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/target_details akeyless_target_details}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/target_details akeyless_target_details} Data Source.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Target name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/target_details#name DataAkeylessTargetDetails#name}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/target_details#id DataAkeylessTargetDetails#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param show_versions: Include all target versions in reply. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/target_details#show_versions DataAkeylessTargetDetails#show_versions}
        :param target_version: Target version. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/target_details#target_version DataAkeylessTargetDetails#target_version}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataAkeylessTargetDetails that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/target_details#import import section} in the documentation of this resource for the id to use
...
class DataAkeylessTargetDetailsConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/target_details#name DataAkeylessTargetDetails#name}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/target_details#id DataAkeylessTargetDetails#id}.
    ...
    def show_versions(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/target_details#show_versions DataAkeylessTargetDetails#show_versions}
        '''
    ...
    def target_version(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/data-sources/target_details#target_version DataAkeylessTargetDetails#target_version}
        '''
