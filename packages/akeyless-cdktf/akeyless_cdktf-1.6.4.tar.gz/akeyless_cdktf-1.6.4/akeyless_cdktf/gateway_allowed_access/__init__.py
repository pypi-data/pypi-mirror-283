...
Refer to the Terraform Registry for docs: [`akeyless_gateway_allowed_access`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_allowed_access).
'''
import abc
import builtins
import datetime
...
class GatewayAllowedAccess(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_allowed_access akeyless_gateway_allowed_access}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_allowed_access akeyless_gateway_allowed_access} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param access_id: The access id to be attached to this allowed access. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_allowed_access#access_id GatewayAllowedAccess#access_id}
        :param name: Allowed access name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_allowed_access#name GatewayAllowedAccess#name}
        :param description: Allowed access description. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_allowed_access#description GatewayAllowedAccess#description}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_allowed_access#id GatewayAllowedAccess#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param permissions: Comma-seperated list of permissions for this allowed access. Available permissions: [defaults,targets,classic_keys,automatic_migration,ldap_auth,dynamic_secret,k8s_auth,log_forwarding,zero_knowledge_encryption,rotated_secret,caching,event_forwarding,admin,kmip,general]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_allowed_access#permissions GatewayAllowedAccess#permissions}
        :param sub_claims: key/val of sub claims, e.g group=admins,developers. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_allowed_access#sub_claims GatewayAllowedAccess#sub_claims}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing GatewayAllowedAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_allowed_access#import import section} in the documentation of this resource for the id to use
...
class GatewayAllowedAccessConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def access_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_allowed_access#access_id GatewayAllowedAccess#access_id}
        '''
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_allowed_access#name GatewayAllowedAccess#name}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_allowed_access#description GatewayAllowedAccess#description}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_allowed_access#id GatewayAllowedAccess#id}.
    ...
    def permissions(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_allowed_access#permissions GatewayAllowedAccess#permissions}
        '''
    ...
    def sub_claims(self) -> typing.Optional[typing.Mapping[builtins.str, builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/gateway_allowed_access#sub_claims GatewayAllowedAccess#sub_claims}
        '''
