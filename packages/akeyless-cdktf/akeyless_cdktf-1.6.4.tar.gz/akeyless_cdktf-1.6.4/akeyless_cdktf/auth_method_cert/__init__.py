...
Refer to the Terraform Registry for docs: [`akeyless_auth_method_cert`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert).
'''
import abc
import builtins
import datetime
...
class AuthMethodCert(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert akeyless_auth_method_cert}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert akeyless_auth_method_cert} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Auth Method name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#name AuthMethodCert#name}
        :param unique_identifier: A unique identifier (ID) value should be configured for OIDC, OAuth2, LDAP and SAML authentication method types and is usually a value such as the email, username, or upn for example. Whenever a user logs in with a token, these authentication types issue a sub claim that contains details uniquely identifying that user. This sub claim includes a key containing the ID value that you configured, and is used to distinguish between different users from within the same organization. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#unique_identifier AuthMethodCert#unique_identifier}
        :param access_expires: Access expiration date in Unix timestamp (select 0 for access without expiry date). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#access_expires AuthMethodCert#access_expires}
        :param access_id: Auth Method access ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#access_id AuthMethodCert#access_id}
        :param bound_common_names: A list of names. At least one must exist in the Common Name. Supports globbing. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#bound_common_names AuthMethodCert#bound_common_names}
        :param bound_dns_sans: A list of DNS names. At least one must exist in the SANs. Supports globbing. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#bound_dns_sans AuthMethodCert#bound_dns_sans}
        :param bound_email_sans: A list of Email Addresses. At least one must exist in the SANs. Supports globbing. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#bound_email_sans AuthMethodCert#bound_email_sans}
        :param bound_extensions: A list of extensions formatted as 'oid:value'. Expects the extension value to be some type of ASN1 encoded string. All values much match. Supports globbing on 'value'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#bound_extensions AuthMethodCert#bound_extensions}
        :param bound_ips: A comma-separated CIDR block list to allow client access. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#bound_ips AuthMethodCert#bound_ips}
        :param bound_organizational_units: A list of Organizational Units names. At least one must exist in the OU field. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#bound_organizational_units AuthMethodCert#bound_organizational_units}
        :param bound_uri_sans: A list of URIs. At least one must exist in the SANs. Supports globbing. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#bound_uri_sans AuthMethodCert#bound_uri_sans}
        :param certificate_data: The certificate data in base64, if no file was provided. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#certificate_data AuthMethodCert#certificate_data}
        :param force_sub_claims: enforce role-association must include sub claims. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#force_sub_claims AuthMethodCert#force_sub_claims}
        :param gw_bound_ips: A comma-separated CIDR block list as a trusted Gateway entity. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#gw_bound_ips AuthMethodCert#gw_bound_ips}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#id AuthMethodCert#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param jwt_ttl: Creds expiration time in minutes. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#jwt_ttl AuthMethodCert#jwt_ttl}
        :param revoked_cert_ids: A list of revoked cert ids. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#revoked_cert_ids AuthMethodCert#revoked_cert_ids}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing AuthMethodCert that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#import import section} in the documentation of this resource for the id to use
...
class AuthMethodCertConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#name AuthMethodCert#name}
        '''
    ...
    def unique_identifier(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#unique_identifier AuthMethodCert#unique_identifier}
        '''
    ...
    def access_expires(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#access_expires AuthMethodCert#access_expires}
        '''
    ...
    def access_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#access_id AuthMethodCert#access_id}
        '''
    ...
    def bound_common_names(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#bound_common_names AuthMethodCert#bound_common_names}
        '''
    ...
    def bound_dns_sans(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#bound_dns_sans AuthMethodCert#bound_dns_sans}
        '''
    ...
    def bound_email_sans(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#bound_email_sans AuthMethodCert#bound_email_sans}
        '''
    ...
    def bound_extensions(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#bound_extensions AuthMethodCert#bound_extensions}
        '''
    ...
    def bound_ips(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#bound_ips AuthMethodCert#bound_ips}
        '''
    ...
    def bound_organizational_units(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#bound_organizational_units AuthMethodCert#bound_organizational_units}
        '''
    ...
    def bound_uri_sans(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#bound_uri_sans AuthMethodCert#bound_uri_sans}
        '''
    ...
    def certificate_data(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#certificate_data AuthMethodCert#certificate_data}
        '''
    ...
    def force_sub_claims(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#force_sub_claims AuthMethodCert#force_sub_claims}
        '''
    ...
    def gw_bound_ips(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#gw_bound_ips AuthMethodCert#gw_bound_ips}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#id AuthMethodCert#id}.
    ...
    def jwt_ttl(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#jwt_ttl AuthMethodCert#jwt_ttl}
        '''
    ...
    def revoked_cert_ids(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.4/docs/resources/auth_method_cert#revoked_cert_ids AuthMethodCert#revoked_cert_ids}
        '''
