...
class OrderBaseModel(FrameBaseModel):
    ...
    def get_horseracelamp_list(self, app_id, act_id, module_id, is_search_module=False, condition="", params=[], page_size=30):
        ...
        if total == 0:
            ...
            user_info_list_dict = UserInfoModel(context=self.context).set_sub_table(app_id).get_dict_list("act_id=%s and " + SevenHelper.get_condition_by_int_list(user_ids), params=[act_id])
