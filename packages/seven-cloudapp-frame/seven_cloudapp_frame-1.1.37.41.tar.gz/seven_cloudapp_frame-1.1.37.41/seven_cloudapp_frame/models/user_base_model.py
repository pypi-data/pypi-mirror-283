...
@LastEditTime: 2024-02-28 14:45:55
...
class UserBaseModel(FrameBaseModel):
    ...
    def save_user_by_openid(self, app_id, act_id, open_id, user_nick, avatar, union_id="", login_ip="", is_update_user_nick=True, mix_nick='', plat_type=0, continue_request_expire=1):
        """
