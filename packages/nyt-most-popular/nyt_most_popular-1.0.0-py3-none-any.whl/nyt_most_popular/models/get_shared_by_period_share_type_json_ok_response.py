...
@JsonMap({})
class GetSharedByPeriodShareTypeJsonOkResponse(BaseModel):
    ...
    :type results: List[SharedArticle], optional
    """
    ...
    def __init__(
        ...
        results: List[SharedArticle] = None,
    ):
        ...
        if results is not None:
            self.results = self._define_list(results, SharedArticle)
