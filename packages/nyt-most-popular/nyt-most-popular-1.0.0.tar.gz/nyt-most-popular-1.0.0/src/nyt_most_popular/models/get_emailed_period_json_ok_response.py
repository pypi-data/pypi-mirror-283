...
@JsonMap({})
class GetEmailedPeriodJsonOkResponse(BaseModel):
    ...
    :type results: List[EmailedArticle], optional
    """
    ...
    def __init__(
        ...
        results: List[EmailedArticle] = None,
    ):
        ...
        if results is not None:
            self.results = self._define_list(results, EmailedArticle)
