...
class SkatersService(BaseService):

    @cast_models
    def get_skater_leaders(self, attribute: str, lang: str) -> dict:
        """Retrieve skater leaders for a specific attribute.

        :param attribute: Skater attribute
        :type attribute: str
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/{{lang}}/leaders/skaters/{{attribute}}",
    ...
    @cast_models
    def get_skater_milestones(self, lang: str) -> dict:
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/{{lang}}/milestones/skaters",
                self.get_default_headers(),
            )
            .add_path("lang", lang)
            .serialize()
    ...
    @cast_models
    def get_skater_information(self, lang: str) -> dict:
        ...
        serialized_request = (
            Serializer(f"{self.base_url}/{{lang}}/skater", self.get_default_headers())
            .add_path("lang", lang)
            .serialize()
            .set_method("GET")
        )
    ...
    def get_skater_stats(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/{{lang}}/skater/{{report}}",
                self.get_default_headers(),
            )
