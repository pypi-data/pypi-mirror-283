...
setup(
    ...
    description='A generic, spec-compliant, thorough & ASYNC implementation of the OAuth request-signing logic',
    long_description=fread('README.rst'),
    long_description_content_type='text/x-rst',
    author='The OAuthlib Community',
    author_email='r.furmanski@gmail.com',
    maintainer='Rafał Furmański',
    maintainer_email='r.furmanski@gmail.com',
    url='https://github.com/r4fek/oauthlib',
    platforms='any',
