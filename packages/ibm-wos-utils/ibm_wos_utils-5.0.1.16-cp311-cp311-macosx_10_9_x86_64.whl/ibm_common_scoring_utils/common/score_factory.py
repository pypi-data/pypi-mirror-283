...
class ScoreFactory():
    ...
    def __validate_inputs(self):
        if self.config.is_foundation_model and self.service_type != ServiceProviderType.WML.value:
            raise Exception(f"Scoring is not support for service type {self.service_type}.Acceptable values are :[{ServiceProviderType.WML.value}]")
