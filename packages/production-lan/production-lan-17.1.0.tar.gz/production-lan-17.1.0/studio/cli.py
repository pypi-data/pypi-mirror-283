...
from studio.app.utils import dbhelpers, auth, commands
from studio.app.services import persons_service, auth_service
...
from studio import __file__ as root_path
...
def version():
    ...
    print(f"studio version: {__version__}")
...
def dump_database(store=False):
    """
    Dump database described in studio environment variables and save it to
