...
from studio.app import config, swagger
from studio.app.stores import auth_tokens_store, file_store
...
from studio.app.utils import cache, fs, logs, monitoring
from studio.app.utils.flask import ParsedUserAgent, ORJSONProvider
...
def configure_auth():
    from studio.app.services import persons_service
