...
from studio.app.models.desktop_login_log import DesktopLoginLog
from studio.app.models.entity import Entity, EntityLink, EntityVersion
from studio.app.models.event import ApiEvent
from studio.app.models.metadata_descriptor import MetadataDescriptor
from studio.app.models.login_log import LoginLog
...
from studio.app.models.output_file import OutputFile
...
from studio.app.models.working_file import WorkingFile

from studio.app.utils import events, fields
from studio.app.stores import file_store
from studio.app import config

from studio.app.services.exception import (
...
def remove_task(task_id, force=False):
    ...
    """
    from studio.app.services import tasks_service
...
def remove_project(project_id):
    from studio.app.services import playlists_service
...
def remove_episode(episode_id, force=False):
    ...
    """
    from studio.app.services import shots_service, assets_service, tasks_service
