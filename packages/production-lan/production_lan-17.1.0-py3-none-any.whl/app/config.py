...
from studio.app.utils import dbhelpers
from studio.app.utils.env import envtobool, env_with_semicolon_to_list
...
DATABASE = {
    ...
    "database": os.getenv("DB_DATABASE", "studiodb"),
}
...
TMP_DIR = os.getenv("TMP_DIR", os.path.join(tempfile.gettempdir(), "studio"))
...
JOB_QUEUE_NOMAD_PLAYLIST_JOB = os.getenv(
    "JOB_QUEUE_NOMAD_PLAYLIST_JOB", "studio-playlist"
)
JOB_QUEUE_NOMAD_NORMALIZE_JOB = os.getenv("JOB_QUEUE_NOMAD_NORMALIZE_JOB", "")
JOB_QUEUE_NOMAD_HOST = os.getenv("JOB_QUEUE_NOMAD_HOST", "studio-nomad-01.studio")
...
LDAP_DOMAIN = os.getenv("LDAP_DOMAIN", "studio.local")
