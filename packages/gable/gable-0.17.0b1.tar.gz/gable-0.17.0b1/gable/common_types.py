# this file is copied from cli/gable to control-plane/packages/core/python/types/control_plane_types
# as part of generating oas types. Edits should only be made to the original in cli/gable/
