...
class UpdateConnector(BrynQ):
                ...
                "AfasEmployee": {
                    "Element": {
                        ...
                        "Objects": {
                            "AfasBankInfo": {
                                "Element": {
                                    "@NoBk": data['cash_payment'] if 'cash_payment' in data else False,
                                    "Fields": {
                                        "IbCk":  data['iban_check'] if 'iban_check' in data else True,  # IBAN check (always true)
    ...
    def new_employee_with_first_contract(self, data: dict, overload_fields: dict = None) -> requests.Response:
        ...
        allowed_fields_person = ['employee_id', 'employee_status', 'employee_blocked', 'date_of_death', 'initials', 'email_work', 'email_home', 'country_of_birth', 'place_of_birth', 'prefix',
                                 ...
                                 'secure_email_attachment', 'email_password', 'date_of_divorce', 'title_salutation', 'second_title_salutation',
                ...
                "Element": {
                    ...
                    "Objects": {
                        ...
                        "AfasAgencyFiscus": {
                            "Element": {
                                "@DaBe": data['date_effective'],
                                "@AyId": data['tax_authority_code'] if 'tax_authority_code' in data.keys() else "F"
                            }
                        }
                    }
                }
        ...
        fields_to_update_employee.update({"SeAt": data['secure_email_attachment']}) if 'employee_blocked' in data else fields_to_update_employee
