...
class TaskManager:
    ...
    def __init__(self, user_task_manager_path):
        """
        Initializes the TaskManager instance, setting up the logger and user-defined tasks.
        """
        self.logger = logging.getLogger(__name__)
        self.user_task_manager_path = user_task_manager_path
    ...
    def load_user_tasks(self):
        ...
        register_user_functions(personal_function_mapping, assistant_function_mapping, self.user_task_manager_path)
