...
__all__ = ["MarketListInstrumentsResponse", "MarketListInstrumentsResponseItem"]


class MarketListInstrumentsResponseItem(BaseModel):
...
MarketListInstrumentsResponse = List[MarketListInstrumentsResponseItem]
