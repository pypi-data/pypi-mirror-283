...
__all__ = ["PortfolioListCreditResponse", "PortfolioListCreditResponseItem"]


class PortfolioListCreditResponseItem(BaseModel):
...
PortfolioListCreditResponse = List[PortfolioListCreditResponseItem]
