...
from cadenza_sdk import CadenzaClient, AsyncCadenzaClient, APIResponseValidationError
from cadenza_sdk._models import BaseModel, FinalRequestOptions
from cadenza_sdk._constants import RAW_RESPONSE_HEADER
from cadenza_sdk._exceptions import APIStatusError, APITimeoutError, CadenzaClientError, APIResponseValidationError
...
def _get_open_connections(client: CadenzaClient | AsyncCadenzaClient) -> int:
...
class TestCadenzaClient:
    client = CadenzaClient(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(CadenzaClientError):
            client2 = CadenzaClient(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: CadenzaClient) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(CADENZA_CLIENT_BASE_URL="http://localhost:5000/from/env"):
            client = CadenzaClient(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(CADENZA_CLIENT_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                CadenzaClient(bearer_token=bearer_token, _strict_response_validation=True, environment="prod")
    ...
    def test_base_url_trailing_slash(self, client: CadenzaClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: CadenzaClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: CadenzaClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = CadenzaClient(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = CadenzaClient(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/api/v2/client/getInfo").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.get(
                "/api/v2/client/getInfo", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}}
            )
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/api/v2/client/getInfo").mock(return_value=httpx.Response(500))
...
class TestAsyncCadenzaClient:
    client = AsyncCadenzaClient(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(CadenzaClientError):
            client2 = AsyncCadenzaClient(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncCadenzaClient) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(CADENZA_CLIENT_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncCadenzaClient(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(CADENZA_CLIENT_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                AsyncCadenzaClient(bearer_token=bearer_token, _strict_response_validation=True, environment="prod")
    ...
    def test_base_url_trailing_slash(self, client: AsyncCadenzaClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncCadenzaClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncCadenzaClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncCadenzaClient(
        ...
        client = AsyncCadenzaClient(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
