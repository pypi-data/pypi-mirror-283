...
class TestOrderbook:
    ...
    @parametrize
    def test_method_get(self, client: CadenzaClient) -> None:
    ...
    @parametrize
    def test_method_get_with_all_params(self, client: CadenzaClient) -> None:
        orderbook = client.market.orderbook.get(
            exchange_type="BINANCE",
            symbol="BTC/USDT",
            limit=100,
    ...
    @parametrize
    def test_raw_response_get(self, client: CadenzaClient) -> None:
    ...
    @parametrize
    def test_streaming_response_get(self, client: CadenzaClient) -> None:
...
class TestAsyncOrderbook:
    ...
    @parametrize
    async def test_method_get(self, async_client: AsyncCadenzaClient) -> None:
    ...
    @parametrize
    async def test_method_get_with_all_params(self, async_client: AsyncCadenzaClient) -> None:
        orderbook = await async_client.market.orderbook.get(
            exchange_type="BINANCE",
            symbol="BTC/USDT",
            limit=100,
    ...
    @parametrize
    async def test_raw_response_get(self, async_client: AsyncCadenzaClient) -> None:
    ...
    @parametrize
    async def test_streaming_response_get(self, async_client: AsyncCadenzaClient) -> None:
