...
from pyrockoeost import util, scenario, guts, gf
from pyrockoeost import __version__


logger = logging.getLogger('pyrockoeost.apps.colosseo')
km = 1000.
...
Colosseo is part of pyrockoeost. Version %s.
''' % __version__
