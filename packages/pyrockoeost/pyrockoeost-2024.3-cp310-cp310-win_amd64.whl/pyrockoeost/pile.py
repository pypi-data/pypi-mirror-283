...
pjoin = os.path.join
logger = logging.getLogger('pyrockoeost.pile')
...
class TracesGroup(object):
    ...
    def add(self, content):
        ...
        Accepts :py:class:`pyrockoeost.trace.Trace` objects and
        :py:class:`pyrockoeost.pile.TracesGroup` objects.
        '''
    ...
    def relevant(self, tmin, tmax, group_selector=None, trace_selector=None):
        '''
        Return list of :py:class:`pyrockoeost.trace.Trace` objects where given
...
class Pile(TracesGroup):
    ...
    def chopper(
        ...
        :param style: set to ``'batch'`` to yield waveforms and information
            ...
            lists of :py:class:`pyrockoeost.trace.Trace` objects are yielded.
    ...
    def snuffle(self, **kwargs):
        ...
        from pyrockoeost.gui.snuffler.snuffler import snuffle
        snuffle(self, **kwargs)
