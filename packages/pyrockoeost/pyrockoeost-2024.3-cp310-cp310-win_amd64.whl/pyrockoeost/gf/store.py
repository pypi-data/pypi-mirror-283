...
try:
    ...
    store_ext = None
from pyrockoeost import util, spit

logger = logging.getLogger('pyrockoeost.gf.store')
op = os.path
...
class Store(BaseStore):
    ...
    :py:class:`pyrockoeost.gf.meta.Config` subclass object associated with the
    ...
    .. attribute:: config
        ...
        The :py:class:`pyrockoeost.gf.meta.Config` derived object associated with
    ...
    def create(cls, store_dir, config, force=False, extra=None):
        ...
        object of a subclass of :py:class:`~pyrockoeost.gf.meta.Config`. This
        ...
        *guts* type objects.
        ...
        :type config: :py:class:`~pyrockoeost.gf.meta.Config`
    ...
    def upgrade(self):
        '''
        Upgrade store config and files to latest pyrockoeost version.
        '''
    ...
    def put(self, args, trace):
        ...
        :param args: :py:class:`~pyrockoeost.gf.meta.Config` index tuple, e.g.
            ``(source_depth, distance, component)`` as in
            :py:class:`~pyrockoeost.gf.meta.ConfigTypeA`.
        :type args: tuple
        :returns: GF trace at ``args``
        :rtype: :py:class:`~pyrockoeost.gf.store.GFTrace`
        '''
    ...
    def make_decimated(self, decimate, config=None, force=False,
        ...
        :type config: :py:class:`~pyrockoeost.gf.meta.Config` or None
        :param force: Force overwrite, defaults to ``False``
        :type force: bool
    ...
    def get_stored_phase(self, phase_def, attribute='phase'):
        ...
        :rtype: :py:class:`pyrockoeost.spit.SPTree`
        '''
    ...
    def t(self, timing, *args, attributes=None):
        ...
        **Examples:**
        ...
        If ``test_store`` is a :py:class:`Type A<pyrockoeost.gf.meta.ConfigTypeA>`
        store::
        ...
        If ``test_store`` is a :py:class:`Type B<pyrockoeost.gf.meta.ConfigTypeB>`
        store::
        ...
        :type timing: str or :py:class:`~pyrockoeost.gf.meta.Timing`
        :param \\*args: if ``len(args) == 1``, ``args[0]`` must be a
            :py:class:`GF index tuple <pyrockoeost.gf.meta.Config>`, e.g.
            ``(source_depth, distance, component)`` for a
            :py:class:`Type A<pyrockoeost.gf.meta.ConfigTypeA>` store. If
        ...
        :type \\*args: (:py:class:`tuple`,) or
            (:py:class:`~pyrockoeost.model.Location`,
            :py:class:`~pyrockoeost.model.Location`)
    ...
    def make_stored_table(self, attribute, force=False):
        ...
        :py:attr:`~pyrockoeost.gf.meta.Config.earthmodel_1d` for each defined phase
        in :py:attr:`~pyrockoeost.gf.meta.Config.tabulated_phases`.
        '''
...
use `fomosto tttlsd` to fix holes.''' % w
    ...
    def make_travel_time_tables(self, force=False):
        ...
        :py:attr:`~pyrockoeost.gf.meta.Config.earthmodel_1d` for each defined phase
        in :py:attr:`~pyrockoeost.gf.meta.Config.tabulated_phases`. The accuracy of
    ...
    def make_takeoff_angle_tables(self, force=False):
        ...
        defined in :py:attr:`~pyrockoeost.gf.meta.Config.earthmodel_1d` for each
        defined phase in :py:attr:`~pyrockoeost.gf.meta.Config.tabulated_phases`.
