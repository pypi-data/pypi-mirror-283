...
from pyrockoeost import gf, trace, cake, util, plot
from pyrockoeost.response import DifferentiationResponse
from pyrockoeost.plot import beachball
from pyrockoeost.guts import load, Object, String, List, Float, Int, Bool, Dict
from pyrockoeost.gf import Source, Target
from pyrockoeost.gf.meta import OutOfBounds
...
ja_latex_env = Environment(block_start_string='\\BLOCK{',
                           ...
                           line_comment_prefix='%%',
                           trim_blocks=True,
                           loader=PackageLoader('pyrockoeost',
                                                'data/fomosto_report'))
...
class GreensFunctionTest(Object):
        ...
        for sr_id in self.src_ids:
            ...
            for sn_id in self.sen_ids:
                ...
                try:
                    ...
                    trcs = response.pyrockoeost_traces()
    ...
    def __drawBeachball(self, trc_id, ax):
        src_id, sen_id = trc_id.split('|')
        src = self.sources[src_id]
        mt = src.pyrockoeost_moment_tensor()
