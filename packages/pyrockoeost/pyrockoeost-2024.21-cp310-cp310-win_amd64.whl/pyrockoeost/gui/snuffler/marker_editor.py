...
from pyrockoeost.plot.beachball import mt2beachball, BeachballError
from pyrockoeost.moment_tensor import kagan_angle
from pyrockoeost.plot import tango_colors
from pyrockoeost import orthodrome
from pyrockoeost.util import time_to_str
...
logger = logging.getLogger('pyrockoeost.gui.snuffler.marker_editor')
