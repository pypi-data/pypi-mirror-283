...
'''
Utility functions and defintions for a common plot style throughout pyrockoeost.
...
in the pyrockoeost source directory)::

    from matplotlib import pyplot as plt

    from pyrockoeost.plot import mpl_init, mpl_margins, mpl_papersize
    # from pyrockoeost.plot import mpl_labelspace

    fontsize = 9.   # in points

    # set some pyrockoeost style defaults
...
from pyrockoeost.util import parse_md, time_to_str, arange2, to_time_float
from pyrockoeost.guts import StringChoice, Float, Int, Bool, Tuple, Object
...
def mpl_init(fontsize=10):
    '''
    Initialize Matplotlib rc parameters pyrockoeost style.
