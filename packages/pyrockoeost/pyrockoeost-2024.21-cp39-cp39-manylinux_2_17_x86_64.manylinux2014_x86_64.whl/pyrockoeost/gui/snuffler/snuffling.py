...
from pyrockoeost import pile, config
from pyrockoeost.util import quote
...
logger = logging.getLogger('pyrockoeost.gui.snuffler.snuffling')
...
class Text(object):
    '''
    Definition of a text box for the snuffling. The snuffling
...
class Snuffling(object):
    ...
    :py:class:`pyrockoeost.pile_viewer.PileOverview` class defined in
    ...
    def init_gui(self, viewer, panel_parent, menu_parent, reloaded=False):
        ...
        :py:class:`pyrockoeost.pile_viewer.PileOverview` object. Calls
        :py:meth:`setup_gui`.
        '''
    ...
    def figure_frame(self, name=None, figure_cls=None):
        '''
        Create a :py:class:`pyrockoeost.gui.util.FigureFrame`.
    ...
    def smartplot_frame(self, name, *args, plot_cls=None, **kwargs):
        '''
        Create a :py:class:`pyrockoeost.gui.util.SmartplotFrame`.

        :param name: labels the tab
        :param *args, **kwargs:
            passed to :py:class:`pyrockoeost.plot.smartplot.Plot`
        :param plot_cls:
            if given, subclass to be used instead of
            :py:class:`pyrockoeost.plot.smartplot.Plot`
        '''
    ...
    def pixmap_frame(self, filename=None, name=None):
        '''
        Create a :py:class:`pyrockoeost.gui.util.PixmapFrame`.
    ...
    def vtk_frame(self, name=None, actors=None):
        '''
        Create a :py:class:`pyrockoeost.gui.util.VTKFrame` to render interactive 3D
        graphics.
    ...
    def chopper_selected_traces(self, fallback=False, marker_selector=None,
        ...
        :py:meth:`pyrockoeost.pile.Pile.chopper` is called with the arguments
    ...
    def make_pile(self):
        ...
        :py:func:`pyrockoeost.pile.make_pile` to create a pile from command line
        arguments.
        '''
    ...
    def make_panel(self, parent):
        ...
        if params or self._force_panel:
            ...
            butframe.setObjectName(self._name)
...
<pre style="white-space: pre-wrap"><code>%s
    ...
    def add_traces(self, traces):
        ...
        :param traces: list of objects of type :py:class:`pyrockoeost.trace.Trace`

        The traces are put into a :py:class:`pyrockoeost.pile.MemTracesFile` and
    ...
    def add_markers(self, markers):
        ...
        :py:class:`pyrockoeost.gui.snuffler.marker.Marker` and adds these to the
        viewer.
        '''
...
class SnufflingModule(object):
    ...
    use of the snufflings (e.g. :py:class:`pyrockoeost.pile_viewer.PileOverwiew`
...
class TextControl(qw.QLabel):
    def __init__(self, ident, default, *args):
        qw.QLabel.__init__(self, *args)
        self.ident = ident
        ...
        self.setAlignment(qc.Qt.AlignLeading|qc.Qt.AlignCenter|qc.Qt.AlignTop)
        self.setTextInteractionFlags(qc.Qt.TextSelectableByKeyboard|qc.Qt.TextSelectableByMouse)
...
class ChoiceControl(qw.QFrame):
    ...
    def set_choices(self, choices):
        ...
        if icur != -1 and icur < len(choices):
