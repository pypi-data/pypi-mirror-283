...
from pyrockoeost import util, moment_tensor

from pyrockoeost.guts import Float, String, Timestamp, Unicode, \
    StringPattern, List, Dict, Any
from .location import Location

logger = logging.getLogger('pyrockoeost.model.event')
...
def load_gfz_event_list(filename):
    from pyrockoeost import catalog
    cat = catalog.Geofon()
