...
from pyrockoeost.guts import (Object, Float, Bool, Int, Tuple, String, List,
                          Unicode, Dict)
...
logger = logging.getLogger('pyrockoeost.plot.automap')
...
class Map(Object):
    ...
    def draw_plates(self):
        from pyrockoeost.dataset import tectonics
...
if __name__ == '__main__':
    ...
    util.setup_logging('pyrockoeost.automap', 'info')
