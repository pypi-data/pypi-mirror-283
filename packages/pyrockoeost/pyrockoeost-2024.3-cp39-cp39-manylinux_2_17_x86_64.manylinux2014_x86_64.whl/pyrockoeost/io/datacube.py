...
from pyrockoeost import trace, util, plot
from pyrockoeost.guts import Object, Int, String, Timestamp
...
def plot_gnss_location_timeline(fns):
    ...
    from pyrockoeost.orthodrome import latlon_to_ne_numpy
...
def extract_stations(fns):
    import io
    import sys
    from pyrockoeost.model import Station
    from pyrockoeost.guts import dump_all
...
def context(fn):
    from pyrockoeost import datacube_ext
...
if __name__ == '__main__':
    ...
    util.setup_logging('pyrockoeost.io.datacube', args.loglevel)
