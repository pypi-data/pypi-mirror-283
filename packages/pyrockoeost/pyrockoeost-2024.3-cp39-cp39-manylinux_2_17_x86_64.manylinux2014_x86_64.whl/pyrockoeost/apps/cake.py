...
import numpy as num
# import logger
from pyrockoeost import cake, util, orthodrome
from pyrockoeost.plot import cake_plot as plot
from optparse import OptionParser, OptionGroup
import matplotlib.pyplot as plt
from pyrockoeost.plot import mpl_init, mpl_papersize, mpl_margins
    ...
    if 'model' in want:
        ...
        if options.crust2loc or options.crust2profile:
            ...
            if 'model' in d:
                ...
                from pyrockoeost import crust2x2
