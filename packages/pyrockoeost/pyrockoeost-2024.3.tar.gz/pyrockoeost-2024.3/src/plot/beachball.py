...
from pyrockoeost import moment_tensor as mtm
from pyrockoeost.util import num_full

logger = logging.getLogger('pyrockoeost.plot.beachball')
...
def plot_beachball_mpl(
    ...
    :param mt: :py:class:`pyrockoeost.moment_tensor.MomentTensor` object or an
...
def plot_fuzzy_beachball_mpl_pixmap(
    ...
    :param mts: list of
        :py:class:`pyrockoeost.moment_tensor.MomentTensor` object or an
        array or sequence which can be converted into an MT object
    :param best_mt: :py:class:`pyrockoeost.moment_tensor.MomentTensor` object or
