...
from pyrockoeost import util, orthodrome, pchain, model
from pyrockoeost.util import reuse
from pyrockoeost.guts import Object, Float, Int, String, List, \
    StringChoice, Timestamp
from pyrockoeost.guts_array import Array
from pyrockoeost.model import squirrel_content

# backward compatibility
from pyrockoeost.util import UnavailableDecimation  # noqa
from pyrockoeost.response import (  # noqa
...
logger = logging.getLogger('pyrockoeost.trace')
...
class Trace(Object):
    ...
    @property
    def codes(self):
        from pyrockoeost.squirrel import model
    ...
    def downsample_to(self, deltat, snap=False, allow_upsample_max=1,
        ...
        :py:exc:`pyrockoeost.util.UnavailableDecimation` is raised.
    ...
    def stretch(self, tmin_new, tmax_new):
        ...
        from pyrockoeost import signal_ext
    ...
    def differentiate(self, n=1, order=4, inplace=True):
        ...
        See :py:func:`~pyrockoeost.util.diff_fd` for implementation details.
        '''
    ...
    def snuffle(self, **kwargs):
        ...
        :param stations: list of :py:class:`pyrockoeost.model.Station` objects or
            ``None``
        :param events: list of :py:class:`pyrockoeost.model.Event` objects or
            ``None``
        :param markers: list of :py:class:`pyrockoeost.gui.snuffler.marker.Marker`
            objects or ``None``
...
def snuffle(traces, **kwargs):
    ...
    :param stations: list of :py:class:`pyrockoeost.model.Station` objects or
        ``None``
    :param events: list of :py:class:`pyrockoeost.model.Event` objects or ``None``
    :param markers: list of :py:class:`pyrockoeost.gui.snuffler.marker.Marker`
        objects or ``None``
...
def rotate_to_rt(n, e, source, receiver, out_channels=('R', 'T')):
    ...
    :type source:
        :py:class:`pyrockoeost.gf.seismosizer.Source`

    :param receiver:
        Receiver of the recorded signal.
    :type receiver:
        :py:class:`pyrockoeost.model.location.Location`
...
def correlate(a, b, mode='valid', normalization=None, use_fft=False):
    ...
    Example::
        ...
        c = pyrockoeost.trace.correlate(a,b)
...
def co_lfilter(target, b, a):
    ...
    Use it like this::
      ...
      from pyrockoeost.trace import co_lfilter, co_list_append
