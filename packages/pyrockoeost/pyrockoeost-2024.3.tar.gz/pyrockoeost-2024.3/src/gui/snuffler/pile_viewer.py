...
def MakePileViewerMainClass(base):
    ...
    class PileViewerMain(base):
        ...
        def open_waveforms(self):
            caption = 'Sélectionner un ou plusieurs fichiers à ouvrir'
        ...
        def open_config(self):
            username = os.getlogin()  # Pour obtenir le nom d'utilisateur actuellement connecté
            config_path = os.path.join(os.path.expanduser("~"), ".pyrockoeost")
            ...
            if os.path.exists(config_path):
                ...
                print(f"Le répertoire {config_path} n'existe pas.")
        ...
        def keyPressEvent(self, key_event):
            ...
            elif key == qc.Qt.Key_Enter or key == qc.Qt.Key_Return:
                self.deselect_all()
                self.emit_selected_markers()
