...
class CakePhase(Snuffling):
    ...
    <p>
    This snuffling uses pyrockoeost's
    <a href="http://emolch.github.io/pyrockoeost/v0.3/cake_doc.html">Cake</a>
    ...
    found in the
    <a href="http://emolch.github.io/pyrockoeost/
    ...
    def call(self, plot_rays=False):
        ...
        if plot_rays:
            ...
            from pyrockoeost.plot import cake_plot
