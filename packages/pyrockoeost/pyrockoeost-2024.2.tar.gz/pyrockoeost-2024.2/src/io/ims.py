...
logger = logging.getLogger('pyrockoeost.io.ims')
...
class WID2Section(Section):
    ...
    def pyrockoeost_trace(self, checksum_error='raise'):
        from pyrockoeost import ims_ext, trace
    ...
    @classmethod
    def from_pyrockoeost_trace(cls, tr,
                           lat=None, lon=None, elevation=None, depth=None):

        from pyrockoeost import ims_ext
        ydata = tr.get_ydata()
...
if __name__ == '__main__':
    ...
    usage = 'python -m pyrockoeost.ims <filenames>'

    util.setup_logging('pyrockoeost.ims.__main__', 'warning')
        ...
        with open(fn, 'rb') as f:
            ...
            for sec in r:
                ...
                if isinstance(sec, WID2Section) and options.load_data:
                    tr = sec.pyrockoeost_trace(checksum_error='warn')
