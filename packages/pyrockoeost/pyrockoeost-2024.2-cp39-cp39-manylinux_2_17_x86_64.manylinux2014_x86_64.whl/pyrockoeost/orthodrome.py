...
def cosdelta(*args):
    ...
    :type a: :py:class:`pyrockoeost.orthodrome.Loc`
    :param b: Location point B.
    :type b: :py:class:`pyrockoeost.orthodrome.Loc`
...
def cosdelta_numpy(a_lats, a_lons, b_lats, b_lons):
    ...
    the function :py:func:`pyrockoeost.orthodrome.cosdelta` above.
...
def azimuth_numpy(a_lats, a_lons, b_lats, b_lons, _cosdelta=None):
    ...
    function :py:func:`pyrockoeost.orthodrome.azimuth`.
...
def azibazi(*args, **kwargs):
    ...
    if implementation == 'c':
        from pyrockoeost import orthodrome_ext
...
def azidist_numpy(*args):
    ...
    The assisting functions used are :py:func:`pyrockoeost.orthodrome.cosdelta` and
    :py:func:`pyrockoeost.orthodrome.azimuth`
...
def distance_accurate50m(*args, **kwargs):
    ...
    (``f_oblate``) are defined in the pyrockoeost configuration file
    :py:class:`pyrockoeost.config`.
...
def ne_to_latlon_alternative_method(lat0, lon0, north_m, east_m):
    ...
    Like :py:func:`pyrockoeost.orthodrome.ne_to_latlon`,
...
def latlon_to_ne(*args):
    ...
    Assisting functions are :py:func:`pyrockoeost.orthodrome.azimuth` and
    :py:func:`pyrockoeost.orthodrome.distance_accurate50m`.
    ...
    :type refloc: :py:class:`pyrockoeost.orthodrome.Loc`
    :param loc: Location of interest.
    :type loc: :py:class:`pyrockoeost.orthodrome.Loc`
