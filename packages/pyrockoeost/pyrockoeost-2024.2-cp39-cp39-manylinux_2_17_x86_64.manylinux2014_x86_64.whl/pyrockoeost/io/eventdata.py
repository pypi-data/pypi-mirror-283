...
from pyrockoeost import model, response

import logging
import copy
import pickle

logger = logging.getLogger('pyrockoeost.io.eventdata')
...
class EventDataAccess(object):
    ...
    def get_pyrockoeost_station(self, tr, relative_event=None):
        '''
    ...
    def get_pyrockoeost_channel(self, tr):
        '''
    ...
    def get_pyrockoeost_stations(self):
        '''
