...
from .study import ImagingStudy, WaveformStudy, PathToImagingStudy, PathToECGXML
...
class Record(BaseModel):
    ...
    modality_data: Union[WaveformStudy, ImagingStudy, PathToImagingStudy, PathToECGXML]
