...
from meutils.schemas.jina_types import BASE_URL, RerankerRequest


@alru_cache()
async def rerank(request: RerankerRequest, api_key: Optional[str] = None):
...
if __name__ == '__main__':
    ...
    with timer():
        print(arun(rerank(RerankerRequest(**payload))))
