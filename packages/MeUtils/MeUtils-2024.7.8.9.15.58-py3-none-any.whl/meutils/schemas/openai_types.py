...
class ImageRequest(BaseModel):
    ...
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.size = self.image_size or self.size
...
class ASRRequest(BaseModel):
    file: Union[FileTypes, UploadFile]  # FileTypes： flac, mp3, mp4, mpeg, mpga, m4a, ogg, wav, or webm

    model: str = "whisper-1"  # whisper-large-v3
