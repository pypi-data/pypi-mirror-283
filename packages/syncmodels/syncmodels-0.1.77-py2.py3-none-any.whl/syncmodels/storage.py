...
class iMemConnection(iConnection):
    ...
    #         log.error("query(%s) is not implemented yet for storage: [%s]", thing, self)
    #         return []
    #
    #     def select(self, thing, data, record_id=None):
    #         log.error("select(%s) is not implemented yet for storage: [%s]", thing, self)
    #         return []
