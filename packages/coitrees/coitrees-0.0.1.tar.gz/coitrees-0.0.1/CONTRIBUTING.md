...
Welcome to `coitrees` contributor's guide.
...
If you experience bugs or general issues with `coitrees`, please have a look
...
You can help improve `coitrees` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`coitrees` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `coitrees`'s files. While this mechanism can
...
```
conda create -n coitrees python=3 six virtualenv pytest pytest-cov
conda activate coitrees
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/coitrees.git
   cd coitrees
   ```
...
5. Install [pre-commit]:
   ...
   `coitrees` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/coitrees
[issue tracker]: https://github.com/<USERNAME>/coitrees/issues
