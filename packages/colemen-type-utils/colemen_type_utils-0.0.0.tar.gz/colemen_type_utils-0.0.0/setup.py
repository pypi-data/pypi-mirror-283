...
VERSION = '0.0.0'
DESCRIPTION = 'colemen_type_utils'
LONG_DESCRIPTION = 'None'


_root_path = f"{os.getcwd()}/colemen_type_utils"
...
DATA_FILES = [
    # ('Lib/site-packages/colemen_type_utils/documentation', glob('documentation/*.md')),
    # ('where the files will be installed', glob('where to get the files to include')),
]

# Setting up
setup(
    name="colemen_type_utils",
    version=VERSION,
