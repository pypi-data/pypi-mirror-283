...
def find_all_paths(mst_children, sources, sinks):
...
def determine_topological_tree(adata, embedding_key, cell_type_key, time_key, start_cell_type, time_constrain=True):
...
def adjust_time_by_structure(adata, mst_children, time_key):
    ...
    lineages = find_all_paths(mst_children, sources, sinks)
