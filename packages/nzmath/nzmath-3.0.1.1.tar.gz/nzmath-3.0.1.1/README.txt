NZMATH 3.0.1.1 (Python Calculator on Number Theory)
===================================================
...
First, you must have Python 3.8 or later.  Ensure you can run Python
...
Finally, install NZMATH from PyPI.  Usually, you must have appropriate
write permission::
...
by using sdist.  You may use wheel nzmath-3.0.1.1-py3-none-any.whl or
