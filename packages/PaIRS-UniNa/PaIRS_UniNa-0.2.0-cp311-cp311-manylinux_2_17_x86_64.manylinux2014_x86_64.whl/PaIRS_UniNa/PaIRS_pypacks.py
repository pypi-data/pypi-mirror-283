...
developerIDs={
    'GP_Win_Office': '140626882900161', #'0x7824af430781',
...
if currentID==developerIDs['GP_Win_Office']: #gerardo windows
...
def warningDialog(self:QWidget,Message,time_milliseconds=0,flagScreenCenter=False,icon:QIcon=QIcon(),palette=None,pixmap=None,title='Warning!',flagRichText=False,flagNoButtons=False,addButton=None):  #addButton=['Print Message',lambda: print(Message)]
    dlg=None
    if Message:
...
if FlagAddMotherBoard and Flag_DEBUG:
