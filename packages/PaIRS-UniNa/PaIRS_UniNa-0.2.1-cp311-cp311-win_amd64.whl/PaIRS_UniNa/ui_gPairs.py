...
################################################################################
## Form generated from reading UI file 'gPairsySExFC.ui'
##
...
from .addwidgets_ps import (EditableLabel, MyQSpin, MyTabLabel, RichTextPushButton,
    myQSplitter)
...
class Ui_gPairs(object):
    def setupUi(self, gPairs):
        ...
        icon15 = QIcon()
        icon15.addFile(u""+ icons_path +"pause.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon16 = QIcon()
        icon16.addFile(u""+ icons_path +"play.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon17 = QIcon()
        icon17.addFile(u""+ icons_path +"abort.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon18 = QIcon()
        icon18.addFile(u""+ icons_path +"reset.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon19 = QIcon()
        icon19.addFile(u""+ icons_path +"copy_process.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon20 = QIcon()
        icon20.addFile(u""+ icons_path +"unlink.png", QSize(), QIcon.Normal, QIcon.Off)
        icon20.addFile(u""+ icons_path +"link.png", QSize(), QIcon.Normal, QIcon.On)
        ...
        icon21 = QIcon()
        icon21.addFile(u""+ icons_path +"workspace.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.subtitle_workspace = QLabel(self.w_workspace)
        ...
        self.title = MyTabLabel(self.w_title)
        ...
        self.subtitle = QLabel(self.w_title)
        ...
        icon22 = QIcon()
        icon22.addFile(u""+ icons_path +"project.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.menuSoftware.setIcon(icon23)
        self.menuPaIRS = QMenu(self.menuSoftware)
        ...
        self.menuSoftware.addAction(self.menuPaIRS.menuAction())
