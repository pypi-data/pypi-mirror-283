...
@jsii.interface(
    jsii_type="@cdklabs/cdk-verified-permissions.IStaticPolicyFromFileProps"
)
class IStaticPolicyFromFileProps(typing_extensions.Protocol):
    '''
    :stability: experimental
    '''
...
class _IStaticPolicyFromFilePropsProxy:
    '''
    :stability: experimental
    '''

    __jsii_type__: typing.ClassVar[str] = "@cdklabs/cdk-verified-permissions.IStaticPolicyFromFileProps"
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IStaticPolicyFromFileProps).__jsii_proxy_class__ = lambda : _IStaticPolicyFromFilePropsProxy


@jsii.interface(jsii_type="@cdklabs/cdk-verified-permissions.ITemplateFromFileProps")
class ITemplateFromFileProps(typing_extensions.Protocol):
    '''
    :stability: experimental
    '''
...
class _ITemplateFromFilePropsProxy:
    '''
    :stability: experimental
    '''

    __jsii_type__: typing.ClassVar[str] = "@cdklabs/cdk-verified-permissions.ITemplateFromFileProps"
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ITemplateFromFileProps).__jsii_proxy_class__ = lambda : _ITemplateFromFilePropsProxy
...
__all__ = [
    ...
    "IPolicyTemplate",
    "ISchema",
    "IStaticPolicyFromFileProps",
    "ITemplateFromFileProps",
    "IValidationSettings",
    "IdentitySource",
