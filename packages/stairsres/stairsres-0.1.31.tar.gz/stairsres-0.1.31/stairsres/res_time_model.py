...
from schema import ResourceDict, WorkerReqs, WorkUnit
...
class ResTimeModel:
    ...
    def estimate_time(self,
        ...
        :param work_unit: work_name and its volume
        ...
        return self.get_time(work_volume={work_name: work_volume}, resources=res_dict, measurement=measurement,
                             quantile=mode)
