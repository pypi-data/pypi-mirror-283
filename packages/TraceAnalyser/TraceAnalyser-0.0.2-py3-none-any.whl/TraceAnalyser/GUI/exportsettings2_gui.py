...
# Form implementation generated from reading ui file 'C:\Users\turnerp\PycharmProjects\TraceAnalyser\src\TraceAnalyser\GUI\GUI_windows\exportsettings2_gui.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.export_mode.setItemText(1, _translate("Form", "OriginLab (.opju)"))
        self.export_mode.setItemText(2, _translate("Form", "DAT (.dat)"))
        self.export_mode.setItemText(3, _translate("Form", "Text (.txt)"))
        self.export_mode.setItemText(4, _translate("Form", "CSV (.csv)"))
