...
class SmartlinkLocal(QueueWorker, metaclass=MetaLogger, object=logger_object):
    ...
    def _generate_session(length: int = SESSION_LENGTH) -> str:
        # TODO session is alpha numeric, shall we have this generic function in python-sdk? I mean general location such as python-sdk? Why should we have this function in smartlink.py? Is it the same for all entities?
