...
class Pipeline:
    ...
    def run(
        ...
        """Run a Pipeline on the VectorShift platform. The Pipeline must already exist on the VectorShift platform.

        Parameters:
            inputs: A dictionary of inputs to pass to the Pipeline. The keys should correspond to the names of the Pipeline's defined inputs and the values should correspond to the defined data types for the inputs.
            api_key: The API key to use for authentication.
            public_key: The public key to use for authentication, if applicable.
            private_key: The private key to use for authentication, if applicable.
    ...
    async def run_async(
        ...
        """Run a Pipeline on the VectorShift platform asynchronously. The Pipeline must already exist on the VectorShift platform.
