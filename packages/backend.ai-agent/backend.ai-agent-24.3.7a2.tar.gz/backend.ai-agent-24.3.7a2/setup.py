...
setup(**{
    ...
    'install_requires': (
        ...
        'async_timeout~=4.0',
        'attrs>=20.3',
        """backend.ai-cli==24.03.7a2
""",
        """backend.ai-common==24.03.7a2
""",
        """backend.ai-kernel-binary==24.03.7a2
""",
        """backend.ai-kernel-helper==24.03.7a2
""",
        """backend.ai-kernel==24.03.7a2
""",
        'backend.ai-krunner-static-gnu==4.2.0',
        """backend.ai-plugin==24.03.7a2
""",
        'cachetools~=5.3.3',
        'callosum~=1.0.3',
        'cattrs~=23.2.3',
