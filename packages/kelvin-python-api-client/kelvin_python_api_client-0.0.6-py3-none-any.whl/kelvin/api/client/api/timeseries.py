    ...
    def create_timeseries(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"201": None, "207": None, "400": None, "401": None},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def get_timeseries_last(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": List[responses.TimeseriesLastGet], "400": None, "401": None},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def get_timeseries_range(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.TimeseriesRangeGet, "400": None, "401": None},
            True,
            _dry_run,
            kwargs,
        )
