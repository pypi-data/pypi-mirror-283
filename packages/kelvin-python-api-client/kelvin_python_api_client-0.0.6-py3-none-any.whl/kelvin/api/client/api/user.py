    ...
    def get_user_me(cls, _dry_run: bool = False, _client: Any = None) -> responses.UserMeGet:
        ...
        **Permission Required:** `n/a`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.UserMeGet, "400": None, "404": None},
            False,
            _dry_run,
        )
        return result
    ...
    def get_user_settings(
        ...
        **Permission Required:** `kelvin.permission.users.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.UserSettingsGet, "400": None, "401": None},
            False,
            _dry_run,
        )
        return result
    ...
    def update_user_settings(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.UserSettingsUpdate, "400": None, "401": None, "404": None},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def get_user(cls, user_id: str, _dry_run: bool = False, _client: Any = None) -> responses.UserGet:
        ...
        **Permission Required:** `kelvin.permission.user.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.UserGet, "400": None, "401": None, "404": None},
            False,
            _dry_run,
        )
        return result
