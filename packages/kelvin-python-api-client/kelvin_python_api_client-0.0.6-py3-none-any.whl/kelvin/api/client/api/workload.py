    ...
    def apply_workload(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": None, "400": None, "401": None, "404": None, "406": None, "500": None},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def deploy_workload(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"201": responses.WorkloadDeploy, "400": None, "401": None, "404": None, "409": None, "500": None},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def list_workloads(
        ...
        **Permission Required:** `kelvin.permission.workload.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.WorkloadsListPaginatedResponseCursor, "400": None, "401": None, "500": None},
            False,
            _dry_run,
        )
        return (
    ...
    def download_workload(cls, workload_name: str, _dry_run: bool = False, _client: Any = None) -> str:
        ...
        **Permission Required:** `kelvin.permission.workload.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": str, "202": None, "400": None, "401": None, "404": None, "409": None, "412": None, "500": None},
            False,
            _dry_run,
        )
        return result
    ...
    def get_workload(cls, workload_name: str, _dry_run: bool = False, _client: Any = None) -> responses.WorkloadGet:
        ...
        **Permission Required:** `kelvin.permission.workload.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.WorkloadGet, "400": None, "401": None, "404": None, "500": None},
            False,
            _dry_run,
        )
        return result
    ...
    def get_workload_logs(
        ...
        **Permission Required:** `kelvin.permission.workload.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.WorkloadLogsGet, "400": None, "401": None, "404": None, "409": None, "500": None},
            False,
            _dry_run,
        )
        return result
    ...
    def start_workload(cls, workload_name: str, _dry_run: bool = False, _client: Any = None) -> None:
        ...
        **Permission Required:** `kelvin.permission.workload.update`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": None, "400": None, "401": None, "404": None, "409": None, "500": None},
            False,
            _dry_run,
        )
        return result
    ...
    def undeploy_workload(
        ...
        **Permission Required:** `kelvin.permission.workload.delete`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": None, "400": None, "401": None, "404": None, "500": None},
            False,
            _dry_run,
        )
        return result
