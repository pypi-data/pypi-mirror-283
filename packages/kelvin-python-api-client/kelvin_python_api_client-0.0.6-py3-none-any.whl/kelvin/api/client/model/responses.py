...
class AppManagerResource(DataModelBase):
    ...
    name: Optional[str] = Field(None, description="Unique identifier key `name` of the Asset.", example="well_01")
    title: Optional[str] = Field(None, description="Display name (`title`) of the Asset.", example="Well 01")
...
class AppManagerResourceAppWorkload(DataModelBase):
    ...
    Parameters
    ----------
    cluster: Optional[constr(max_length=64)]
    name: Optional[constr(max_length=32)]
    warnings: Optional[List[str]]

    """

    cluster: Optional[constr(max_length=64)] = Field(
        None,
...
class AppManagerAppResourcesListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[AppManagerResourceContext]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Assets associated with Applications and its associated Workload and status, that matches the query parameters.",
    )
...
class AppIO(DataModelBase):
    ...
    data_type_name: Optional[constr(max_length=64)]
    name: Optional[constr(max_length=64)]
    ...
    data_type_name: Optional[constr(max_length=64)] = Field(
        None,
...
class DSContext(DataModelBase):
    ...
    writable: Optional[bool] = Field(None, description="Can write to the Asset / Data Stream pair.", example=False)
...
class IODataStreamContext(DataModelBase):
    ...
    datastream_name: Optional[constr(max_length=64)]
    ...
    datastream_name: Optional[constr(max_length=64)] = Field(
        None,
...
class AppManagerAppVersionDeploy(DataModelBase):
    ...
    success: Optional[bool] = Field(None, description="Whether the deploy was successful.", example=True)
...
class AppManagerListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[type.AppManagerApp]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Applications and associated context objects that matches the query parameters.",
    )
...
class AppManagerResourceGetPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[type.AppManagerAppVersionSummary]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Application objects associated with the Asset (`resource`). More detailed information on the Applications can be retrieved from the App Manager Get Application API.",
    )
...
class ErrorMessage(DataModelBase):
    ...
    http_status_code: Optional[int] = Field(None, description="HTTP status error code.", example="4XX")
...
class AppRegistryAppsListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[AppItem]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Data Type objects that matches the query parameters.",
    )
...
class AssetsListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[type.Asset]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Assets objects, that matches the query parameters.",
    )
...
class AssetPropertyDefinitionsListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[type.Property]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Asset Property objects, that matches the query parameters.",
    )
...
class AssetPropertyValuesGet(DataModelBase):
    ...
    properties: Optional[Dict[str, List[str]]] = Field(
        None,
...
class AssetStatusCountGet(DataModelBase):
    ...
    online: Optional[int] = Field(None, description="Count of all Assets that are receiving active data.", example=2787)
    total: Optional[int] = Field(None, description="Count of all Assets.", example=3429)
...
class AssetTypesListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[type.AssetType]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Asset Types objects, that matches the query parameters.",
    )
...
class BridgesListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[BridgeItem]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Bridge (Connection) objects that matches the query parameters.",
    )
...
class ControlChangeCreate(DataModelBase):
    ...
    payload: Optional[Union[float, str, bool, Dict[str, Any]]]
    resource: Optional[KRNAssetDataStream]
    source: Optional[KRN]
    ...
    payload: Optional[Union[float, str, bool, Dict[str, Any]]] = Field(
        None,
...
class ControlChangeLastGetPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[ControlChangeGet]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Control Changes and associated context objects that matches the query parameters.",
    )
...
class ControlChangesListPaginatedResponseStream(DataModelBase):
    """
...
class ControlChangeRangeGetPaginatedResponseStream(DataModelBase):
    """
...
class DataStreamsDataTypesListPaginatedResponseStream(DataModelBase):
    """
...
class DataStreamsSemanticTypesListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[type.DataStreamSemanticType]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Semantic Type objects, that matches the query parameters.",
    )
...
class DataStreamsUnitsListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[type.Unit]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Unit objects, that matches the query parameters.",
    )
...
class DataStreamsListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[DataStream]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Data Streams objects, that matches the query parameters.",
    )
...
class DataStreamContextsListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[DataStreamContext]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Data Streams and associated context objects, that matches the query parameters.",
    )
...
class DataTagListPaginatedResponseStream(DataModelBase):
    ...
    data: Optional[List[type.DataTag]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Data Tag objects, that matches the query parameters.",
    )
...
class TagListPaginatedResponseStream(DataModelBase):
    ...
    data: Optional[List[type.Tag]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Tag objects, that matches the query parameters.",
    )
...
class FilesListPaginatedStream(DataModelBase):
    """
    ...
    data: Optional[List[type.FileStorage]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all file objects, that matches the query parameters.",
    )
...
class InstanceAuditLogGet(DataModelBase):
    ...
    Parameters
    ----------
    action: Optional[constr(min_length=1, max_length=64)]
    created: Optional[datetime]
    id: Optional[int]
    identifier: Optional[constr(min_length=1, max_length=64)]
    meta: Optional[Dict[str, Any]]
    namespace: Optional[constr(min_length=1, max_length=64)]
    ...
    action: Optional[constr(min_length=1, max_length=64)] = Field(
    ...
    id: Optional[int] = Field(None, description="Unique ID of the Audit Log entry.", example=4739892)
    identifier: Optional[constr(min_length=1, max_length=64)] = Field(
    ...
    namespace: Optional[constr(min_length=1, max_length=64)] = Field(
        None, description="In which service the audit log was created.", example="api-workload"
    )
    request_id: Optional[str] = Field(None, description="Deprecated. Not being used.")
    user_id: Optional[UUID] = Field(
        None, description="User ID that initiated the action.", example="0002bc79-b42f-461b-95d6-cf0a28ba87aa"
    )
    username: Optional[constr(min_length=1, max_length=64)] = Field(
...
class InstanceSettingsListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[type.InstanceSettings]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Instance Setting objects, that matches the query parameters.",
    )
...
class ComponentStatus(DataModelBase):
    ...
    status: Optional[bool] = Field(None, description="Current status of the service on the Instance.", example=True)
...
class InstanceStatusGet(DataModelBase):
    ...
    status: Optional[bool] = Field(None, description="Overall status of the Instance.", example=True)
...
class OrchestrationClustersListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[OrchestrationClustersCreateItem]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Clusters and associated context objects that matches the query parameters.",
    )
...
class OrchestrationClustersCreateManifestImageItem(DataModelBase):
    ...
    args: Optional[str] = Field(None, description="Additional arguments for the image, if any.", example="--help")
...
class OrchestrationClustersCreateManifestItem(DataModelBase):
    ...
    file_name: Optional[str] = Field(None, description="Name of the manifest file.", example="certificate.yaml")
...
class OrchestrationClustersCreateManifestUpgrade(DataModelBase):
    ...
    upgrade_type: Optional[str] = Field(None, description="Type of upgrade process.", example="instantly")
...
class OrchestrationClustersNodesGetItem(DataModelBase):
    ...
    updated: Optional[datetime]
    warnings: Optional[Union[float, str, bool, Dict[str, Any]]]
    ...
    main: Optional[bool] = Field(None, description="Whether the Node is the Master Node in the Cluster.", example=True)
    name: Optional[constr(max_length=64)] = Field(
    ...
    warnings: Optional[Union[float, str, bool, Dict[str, Any]]] = Field(
        None,
...
class OrchestrationClustersNodeListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[OrchestrationClustersNodesGetItem]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Nodes and associated context objects that matches the query parameters.",
    )
...
class OrchestrationClustersNodesGetConditionItem(DataModelBase):
    ...
    name: Optional[str] = Field(None, description="Unique name identifying the resource.", example="Disk Pressure")
    ...
    status_message: Optional[str] = Field(None, description="Detailed status message.", example="ready")
    type: Optional[str] = Field(None, description="Type of the condition.", example="DiskPressure")
...
class OrchestrationClustersNodesGetSystemInfo(DataModelBase):
    ...
    host_name: Optional[str] = Field(None, description="Hostname of the node.", example="node01")
    kernel_version: Optional[str] = Field(None, description="Version of the node's kernel.", example="5.15.0-1050-aws")
    ...
    operating_system: Optional[str] = Field(None, description="Operating system running on the node.", example="linux")
...
class OrchestrationClustersNodesGet(DataModelBase):
    ...
    k8s_version: Optional[constr(max_length=64)]
    ...
    k8s_version: Optional[constr(max_length=64)] = Field(
...
class OrchestrationClustersServiceListPaginatedResponseStream(DataModelBase):
    """
...
class ParameterValueItem(DataModelBase):
    ...
    app_name: Optional[constr(max_length=64)]
    app_version: Optional[str]
    comment: Optional[constr(max_length=200)]
    created: Optional[datetime]
    parameter_name: Optional[constr(max_length=64)]
    resource: Optional[KRNAsset]
    source: Optional[KRN]
    updated: Optional[datetime]
    ...
    comment: Optional[constr(max_length=200)] = Field(
        None,
    ...
    parameter_name: Optional[constr(max_length=64)] = Field(
...
class ParametersAppVersionAssetListPaginatedResponseStream(DataModelBase):
    """
...
class ParameterJSONSchemaProperties(DataModelBase):
    ...
    Parameters
    ----------
    default: Optional[Union[float, str, bool, Dict[str, Any]]]
    description: Optional[constr(max_length=200)]
    examples: Optional[Union[float, str, bool, Dict[str, Any]]]
    ...
    default: Optional[Union[float, str, bool, Dict[str, Any]]] = Field(
    ...
    examples: Optional[Union[float, str, bool, Dict[str, Any]]] = None
...
class ParamtersAppVersionSchemaGet(DataModelBase):
    ...
    required: Optional[List[constr(min_length=1, max_length=64)]]
    ...
    required: Optional[List[constr(min_length=1, max_length=64)]] = Field(
        None,
...
class ParameterDefinitionItem(DataModelBase):
    ...
    app_name: Optional[constr(max_length=64)]
    created: Optional[datetime]
    last_title: Optional[constr(max_length=64)]
    name: Optional[constr(max_length=64)]
    ...
    last_title: Optional[constr(max_length=64)] = Field(
...
class ParametersDefinitionsListPaginatedResponseStream(DataModelBase):
    """
...
class ParametersValuesGet(DataModelBase):
    ...
    Parameters
    ----------
    app_parameter_values: Optional[Dict[str, Dict[str, List[Union[float, str, bool, Dict[str, Any]]]]]]

    """

    app_parameter_values: Optional[Dict[str, Dict[str, List[Union[float, str, bool, Dict[str, Any]]]]]] = Field(
        None,
...
class ParametersScheduleListPaginatedResponseStream(DataModelBase):
    """
...
class RecommendationLastGetPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[type.Recommendation]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Last Recommendation for each Asset and its associated context objects that matches the query parameters.",
    )
...
class RecommendationsListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[type.Recommendation]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Recommendations and associated context objects that matches the query parameters.",
    )
...
class RecommendationRangeGetPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[type.Recommendation]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Recommendations for each Asset and its associated context objects over the time range that matches the query parameters.",
    )
...
class RecommendationTypesListPaginatedStream(DataModelBase):
    """
    ...
    data: Optional[List[type.RecommendationType]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Recommendation Types and associated context objects that matches the query parameters.",
    )
...
class SecretsListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[SecretItem]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Secret objects, that matches the query parameters.",
    )
...
class TimeseriesListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[type.TimeseriesData]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Time Series objects. Each object is a separate last value that matches the query parameters.",
    )
...
class UserItem(DataModelBase):
    ...
    username: Optional[constr(max_length=64)]
    ...
    first_name: Optional[constr(max_length=64)] = Field(None, description="First name of the User.", example="John")
    id: Optional[UUID] = Field(
        None,
        description="A unique random generated UUID as the key `id` for the User.",
        example="0002bc79-b42f-461b-95d6-cf0a28ba87aa",
    )
    last_name: Optional[constr(max_length=64)] = Field(None, description="Last name of the User.", example="Doe")
    username: Optional[constr(max_length=64)] = Field(None, description="Username of the User.", example="johndoe")
...
class UsersListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[UserItem]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all User objects, that matches the query parameters.",
    )
...
class UserMeGet(DataModelBase):
    ...
    id: Optional[UUID]
    last_name: Optional[constr(max_length=64)]
    permissions: Optional[List[constr(min_length=1, max_length=64)]]
    username: Optional[constr(max_length=64)]
    ...
    permissions: Optional[List[constr(min_length=1, max_length=64)]] = Field(
        None,
...
class UserSettingsListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[type.UserSetting]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all User Setting objects, that matches the query parameters.",
    )
...
class UserGet(DataModelBase):
    ...
    created: Optional[datetime]
    email: Optional[EmailStr]
    first_name: Optional[constr(min_length=1, max_length=64)]
    id: Optional[UUID]
    last_name: Optional[constr(min_length=1, max_length=64)]
    username: Optional[constr(min_length=1, max_length=64)]
    ...
    email: Optional[EmailStr] = Field(None, description="Email of the user.", example="john.doe@kelvin.ai")
    first_name: Optional[constr(min_length=1, max_length=64)] = Field(
    ...
    last_name: Optional[constr(min_length=1, max_length=64)] = Field(
...
class WorkloadItem(DataModelBase):
    ...
    Parameters
    ----------
    acp_name: Optional[constr(max_length=64)]
    app_name: Optional[constr(max_length=64)]
    app_version: Optional[str]
    cluster_name: Optional[constr(max_length=64)]
    created: Optional[datetime]
    ...
    acp_name: Optional[constr(max_length=64)] = Field(
...
class WorkloadsListPaginatedResponseStream(DataModelBase):
    """
...
class WorkloadLogsGet(DataModelBase):
    ...
    logs: Optional[Dict[str, List[str]]] = Field(
        None,
        example={
            "bp-opcua-bridge-0": [
...
class InstanceAuditLogsListPaginatedResponseCursor(PaginatorDataModel[InstanceAuditLogGet]):
    """
    InstanceAuditLogsListPaginatedResponseCursor object.

    Parameters
    ----------
    data: Optional[List[InstanceAuditLogGet]]
    pagination: Optional[pagination.PaginationCursor]

    """

    data: Optional[List[InstanceAuditLogGet]] = Field(
        None,
...
class InstanceAuditLogsListPaginatedResponseLimits(PaginatorDataModel[InstanceAuditLogGet]):
    """
...
class InstanceAuditLogsListPaginatedResponseStream(DataModelBase):
    """
    ...
    data: Optional[List[InstanceAuditLogGet]] = Field(
        None,
        description="A dictionary with a data property that contains an array of all Audit Log objects, that matches the query parameters.",
    )
