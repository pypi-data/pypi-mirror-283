...
import text_pre_process.dd.symbol_convert as symbol_convert
import text_pre_process.dd.frequent_chars as frequent_chars
import text_pre_process.dd.chinese_digits as chinese_digits
...
class TextProcess:
    ...
    @classmethod
    def remove_html_tag(cls, sentence: str):
        sentence = re.sub(cls.regex_html_tag, "", sentence)
        return sentence

    @classmethod
    def purify(cls, sentence: str, allow_ambiguous=False):
        """
    ...
    @classmethod
    def scan_separator(cls, sentence: str, comma_sep="，", para_sep="|"):
        """
    ...
    @classmethod
    def replace_continuous_symbol(cls, sentence: str):
        """
        替换连续字符，如将"--~"替换为"-"，"   "替换为" "
    ...
    @classmethod
    def numerate_chinese_digit(cls, sentence: str):
        """
    ...
    @classmethod
    def chinese_digit_count(cls, sentence: str):
        """
        统计一个字符串中出现的零到九的次数
    ...
    @classmethod
    def regulate_digits(cls, sentence: str, keep_decimal=True):
        """
