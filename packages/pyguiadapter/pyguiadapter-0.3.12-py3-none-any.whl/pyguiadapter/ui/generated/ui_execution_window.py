...
class Ui_ExecutionWindow(object):
    def setupUi(self, ExecutionWindow):
        ...
        self.widget_progressbar_panel = QtWidgets.QWidget(parent=self.dockwidget_content)
        self.widget_progressbar_panel.setObjectName("widget_progressbar_panel")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.widget_progressbar_panel)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.progressbar = QtWidgets.QProgressBar(parent=self.widget_progressbar_panel)
        self.progressbar.setProperty("value", 0)
        self.progressbar.setAlignment(QtCore.Qt.AlignmentFlag.AlignBottom|QtCore.Qt.AlignmentFlag.AlignJustify)
        self.progressbar.setTextDirection(QtWidgets.QProgressBar.Direction.TopToBottom)
        self.progressbar.setObjectName("progressbar")
        self.verticalLayout_2.addWidget(self.progressbar)
        self.label_progressbar_info = QtWidgets.QLabel(parent=self.widget_progressbar_panel)
        self.label_progressbar_info.setText("")
        self.label_progressbar_info.setScaledContents(False)
        self.label_progressbar_info.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignTop)
        self.label_progressbar_info.setWordWrap(True)
        self.label_progressbar_info.setOpenExternalLinks(True)
        self.label_progressbar_info.setObjectName("label_progressbar_info")
        self.verticalLayout_2.addWidget(self.label_progressbar_info)
        self.vlayout_3.addWidget(self.widget_progressbar_panel)
