<%def name="make_config_item(param_name, widget_class_name, widget_args_class_name, widget_args_fields)">
    "${param_name}": {
        "widget_class": ${widget_class_name}.__name__,
...
${configs_varname} = {
    ...
    widget_class_name = param_widget_config.widget_class.__name__
    widget_args_class_name = param_widget_config.widget_args_class.__name__
    widget_args_fields = param_widget_config.widget_args_fields
    %>
    ${make_config_item(param_name, widget_class_name, widget_args_class_name, widget_args_fields) | trim}
    %endfor
}