...
class NRLMSISE00AtmosphericModel(AtmosphericModel):
    ...
    solar_activity_strengh_level: Optional[StrictStr] = Field(default='AVERAGE', description="An optional solar activity strength level to use for the NRLMSISE00 atmosphere model with the MSAFE data source.", alias="solarActivityStrenghLevel")
    __properties: ClassVar[List[str]] = ["type", "solarActivityDataSource", "solarActivityStrenghLevel"]
    ...
    @field_validator('solar_activity_strengh_level')
    def solar_activity_strengh_level_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "solarActivityStrenghLevel": obj.get("solarActivityStrenghLevel") if obj.get("solarActivityStrenghLevel") is not None else 'AVERAGE'
        })
        return _obj
