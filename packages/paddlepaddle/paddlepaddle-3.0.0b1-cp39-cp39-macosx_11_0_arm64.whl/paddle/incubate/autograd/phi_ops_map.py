op_map = {
    ...
    "detection_map": {
        "phi_name": "detection_map",
        "inputs": {
            "detect_res": "DetectRes",
            "label": "Label",
            "has_state": "HasState",
            "pos_count": "PosCount",
            "true_pos": "TruePos",
        ...
        "outputs": {
            "accum_pos_count": "AccumPosCount",
            "accum_true_pos": "AccumTruePos",
            "accum_false_pos": "AccumFalsePos",
            "m_ap": "MAP"
        }
    },
    "dgc": {
    ...
    "distributed_fused_lamb": {
        "phi_name": "distributed_fused_lamb",
        "inputs": {
            "param": "Param",
            "grad": "Grad",
        ...
        "outputs": {
            "param_out": "ParamOut",
            "fp32_fused_param_out": "FP32FusedParamOut",
            "fp16_fused_param_out": "FP16FusedParamOut",
            "fp32_acc_fused_grad": "FP32AccFusedGrad",
            "fp16_acc_fused_grad": "FP16AccFusedGrad",
            "moment1_out": "Moment1Out",
            "moment2_out": "Moment2Out",
            "beta1pow_out": "Beta1PowOut",
            "beta2pow_out": "Beta2PowOut",
            "found_inf": "FoundInf",
            "acc_step": "AccStep",
...
op_info = {
    ...
    "accuracy_check": {
        "args": "Tensor x, Tensor y, str fn_name, int64_t res_idx",
        "output": "Tensor(out)"
    },
    "acos": {
        "args": "Tensor x",
    ...
    "detection_map": {
        "args": "Tensor detect_res, Tensor label, Tensor has_state, Tensor pos_count, Tensor true_pos, Tensor false_pos, int class_num, int background_label = 0, float overlap_threshold = .5f, bool evaluate_difficult = true, str ap_type = \"integral\"",
        "output": "Tensor (accum_pos_count), Tensor (accum_true_pos), Tensor (accum_false_pos), Tensor (m_ap)"
    },
    "dgc": {
    ...
    "moe": {
        "args": "Tensor x, Tensor gate, Tensor bmm0, Tensor bias0, Tensor bmm1, Tensor bias1, str act_type = \"gelu\"",
        "output": "Tensor (out)"
    },
    "number_count": {
