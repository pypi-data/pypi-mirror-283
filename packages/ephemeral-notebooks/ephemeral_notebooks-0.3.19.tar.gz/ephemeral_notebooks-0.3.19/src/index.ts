...
class SettingsDialog extends Widget {
  ...
  private buildDialog() {
    ...
    copyOutputLabel.appendChild(
      document.createTextNode(' Copy notebook output')
    );
...
function addSaveToUrlButton(
  ...
  notebookTracker.widgetAdded.connect((sender, panel) => {
    ...
    panel.toolbar.insertItem(10, 'settingsButton', saveToUrlButton);
  });
