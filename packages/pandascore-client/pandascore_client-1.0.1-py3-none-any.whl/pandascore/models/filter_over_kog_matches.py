...
class FilterOverKogMatchesOpponentIdGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str, "int": int, "str": str}


FilterOverKogMatchesOpponentId = Union[int, str, int, str]


class FilterOverKogMatchesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverKogMatchesVideogameTitle = Union[int, str]


class FilterOverKogMatchesVideogameVersionGuard(OneOfBaseModel):
    class_list = {"str": str, "any": any, "any": any}


FilterOverKogMatchesVideogameVersion = Union[str, any, any]


@JsonMap({"id_": "id"})
class FilterOverKogMatches(BaseModel):
    ...
    :type opponent_id: List[FilterOverKogMatchesOpponentId], optional
    ...
    :type videogame_title: List[FilterOverKogMatchesVideogameTitle], optional
    ...
    :type videogame_version: List[FilterOverKogMatchesVideogameVersion], optional
    ...
    def __init__(
        ...
        opponent_id: List[FilterOverKogMatchesOpponentId] = None,
        ...
        videogame_title: List[FilterOverKogMatchesVideogameTitle] = None,
        videogame_version: List[FilterOverKogMatchesVideogameVersion] = None,
        ...
        if opponent_id is not None:
            self.opponent_id = self._define_list(
                opponent_id, FilterOverKogMatchesOpponentId
            )
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverKogMatchesVideogameTitle
            )
        if videogame_version is not None:
            self.videogame_version = self._define_list(
                videogame_version, FilterOverKogMatchesVideogameVersion
            )
