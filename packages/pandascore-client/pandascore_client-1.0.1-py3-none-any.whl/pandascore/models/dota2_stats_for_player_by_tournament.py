...
@JsonMap({"id_": "id"})
class Dota2StatsForPlayerByTournamentCurrentTeam(BaseModel):
...
@JsonMap({"id_": "id"})
class Dota2StatsForPlayerByTournament(BaseModel):
    ...
    :type current_team: Dota2StatsForPlayerByTournamentCurrentTeam
    ...
    :type slug: str
    :param stats: Player's statistics for a tournament
    :type stats: Dota2PlayerByTournamentStat
    :param teams: teams
    ...
    def __init__(
        ...
        self.role = role
        self.slug = self._pattern_matching(slug, "^[a-z0-9_-]+$", "slug")
        self.stats = self._define_object(stats, Dota2PlayerByTournamentStat)
