...
class FilterOverValorantShortTournamentsVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverValorantShortTournamentsVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverValorantShortTournaments(BaseModel):
    ...
    :type videogame_title: List[FilterOverValorantShortTournamentsVideogameTitle], optional
    ...
    def __init__(
        ...
        videogame_title: List[FilterOverValorantShortTournamentsVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverValorantShortTournamentsVideogameTitle
            )
