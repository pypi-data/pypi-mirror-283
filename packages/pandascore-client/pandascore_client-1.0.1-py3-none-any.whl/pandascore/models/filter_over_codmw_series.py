...
class FilterOverCodmwSeriesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverCodmwSeriesVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverCodmwSeries(BaseModel):
    ...
    :type videogame_title: List[FilterOverCodmwSeriesVideogameTitle], optional
    ...
    def __init__(
        ...
        slug: List[str] = None,
        videogame_title: List[FilterOverCodmwSeriesVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverCodmwSeriesVideogameTitle
            )
