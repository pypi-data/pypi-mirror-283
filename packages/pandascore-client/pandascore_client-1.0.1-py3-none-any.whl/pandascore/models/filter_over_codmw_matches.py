...
class FilterOverCodmwMatchesOpponentIdGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str, "int": int, "str": str}


FilterOverCodmwMatchesOpponentId = Union[int, str, int, str]


class FilterOverCodmwMatchesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverCodmwMatchesVideogameTitle = Union[int, str]


class FilterOverCodmwMatchesVideogameVersionGuard(OneOfBaseModel):
    class_list = {"str": str, "any": any, "any": any}


FilterOverCodmwMatchesVideogameVersion = Union[str, any, any]


@JsonMap({"id_": "id"})
class FilterOverCodmwMatches(BaseModel):
    ...
    :type opponent_id: List[FilterOverCodmwMatchesOpponentId], optional
    ...
    :type videogame_title: List[FilterOverCodmwMatchesVideogameTitle], optional
    ...
    :type videogame_version: List[FilterOverCodmwMatchesVideogameVersion], optional
    ...
    def __init__(
        ...
        opponent_id: List[FilterOverCodmwMatchesOpponentId] = None,
        ...
        videogame_title: List[FilterOverCodmwMatchesVideogameTitle] = None,
        videogame_version: List[FilterOverCodmwMatchesVideogameVersion] = None,
        ...
        if opponent_id is not None:
            self.opponent_id = self._define_list(
                opponent_id, FilterOverCodmwMatchesOpponentId
            )
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverCodmwMatchesVideogameTitle
            )
        if videogame_version is not None:
            self.videogame_version = self._define_list(
                videogame_version, FilterOverCodmwMatchesVideogameVersion
            )
