...
class FilterOverValorantSeriesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverValorantSeriesVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverValorantSeries(BaseModel):
    ...
    :type videogame_title: List[FilterOverValorantSeriesVideogameTitle], optional
    ...
    def __init__(
        ...
        slug: List[str] = None,
        videogame_title: List[FilterOverValorantSeriesVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverValorantSeriesVideogameTitle
            )
