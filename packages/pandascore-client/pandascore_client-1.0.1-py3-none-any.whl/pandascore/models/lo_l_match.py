...
@JsonMap({"id_": "id"})
class LoLMatchVideogameTitle(BaseModel):
...
@JsonMap({})
class LoLMatchVideogameVersion(BaseModel):
...
class LoLMatchWinnerGuard(OneOfBaseModel):
    class_list = {"Winner1_5": Winner1_5, "Winner2_5": Winner2_5}


LoLMatchWinner = Union[Winner1_5, Winner2_5]


class LoLMatchWinnerIdGuard(OneOfBaseModel):
    class_list = {"int": int, "int": int}


LoLMatchWinnerId = Union[int, int]
...
class LoLMatch(BaseModel):
    ...
    :type players: List[LoLMatchPlayer]
    ...
    :type videogame_title: LoLMatchVideogameTitle
    :param videogame_version: videogame_version
    :type videogame_version: LoLMatchVideogameVersion
    :param winner: winner
    :type winner: LoLMatchWinner
    :param winner_id: winner_id
    :type winner_id: LoLMatchWinnerId
    ...
    def __init__(
        ...
        self.games = self._define_list(games, LoLMatchGame)
        self.id_ = id_
        ...
        self.players = self._define_list(players, LoLMatchPlayer)
        ...
        self.winner = LoLMatchWinnerGuard.return_one_of(winner)
        self.winner_id = LoLMatchWinnerIdGuard.return_one_of(winner_id)
