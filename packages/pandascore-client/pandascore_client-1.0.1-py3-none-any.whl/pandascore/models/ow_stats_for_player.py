...
@JsonMap({"id_": "id"})
class OwStatsForPlayerCurrentTeam(BaseModel):
...
@JsonMap({"id_": "id"})
class OwStatsForPlayer(BaseModel):
    ...
    :type current_team: OwStatsForPlayerCurrentTeam
    ...
    def __init__(
        ...
        self.role = role
        self.slug = self._pattern_matching(slug, "^[a-z0-9_-]+$", "slug")
        self.stats = self._define_object(stats, OwPlayerStats)
