...
class Player(BaseModel):
    ...
    :type active: bool
    :param age: Age of the player, `null` if unknown. When `birthday` is `null`, `age` is an approxiamation. Read more about [players' age](/docs/about-players-age) <br/>**Note**: This field is only present for users running the Historical plan or above., defaults to None
    ...
    :type current_team: PlayerCurrentTeam
    ...
    def __init__(
        ...
        self.current_team = self._define_object(current_team, PlayerCurrentTeam)
