...
class FilterOverRlMatchesOpponentIdGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str, "int": int, "str": str}


FilterOverRlMatchesOpponentId = Union[int, str, int, str]


class FilterOverRlMatchesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverRlMatchesVideogameTitle = Union[int, str]


class FilterOverRlMatchesVideogameVersionGuard(OneOfBaseModel):
    class_list = {"str": str, "any": any, "any": any}


FilterOverRlMatchesVideogameVersion = Union[str, any, any]


@JsonMap({"id_": "id"})
class FilterOverRlMatches(BaseModel):
    """FilterOverRlMatches
    ...
    :type opponent_id: List[FilterOverRlMatchesOpponentId], optional
    ...
    :type videogame_title: List[FilterOverRlMatchesVideogameTitle], optional
    ...
    :type videogame_version: List[FilterOverRlMatchesVideogameVersion], optional
    ...
    def __init__(
        ...
        opponent_id: List[FilterOverRlMatchesOpponentId] = None,
        ...
        videogame_title: List[FilterOverRlMatchesVideogameTitle] = None,
        videogame_version: List[FilterOverRlMatchesVideogameVersion] = None,
        ...
        if opponent_id is not None:
            self.opponent_id = self._define_list(
                opponent_id, FilterOverRlMatchesOpponentId
            )
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverRlMatchesVideogameTitle
            )
        if videogame_version is not None:
            self.videogame_version = self._define_list(
                videogame_version, FilterOverRlMatchesVideogameVersion
            )
