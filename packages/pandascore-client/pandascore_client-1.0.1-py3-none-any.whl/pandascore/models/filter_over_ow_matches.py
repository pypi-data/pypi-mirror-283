...
class FilterOverOwMatchesOpponentIdGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str, "int": int, "str": str}


FilterOverOwMatchesOpponentId = Union[int, str, int, str]


class FilterOverOwMatchesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverOwMatchesVideogameTitle = Union[int, str]


class FilterOverOwMatchesVideogameVersionGuard(OneOfBaseModel):
    class_list = {"str": str, "any": any, "any": any}


FilterOverOwMatchesVideogameVersion = Union[str, any, any]


@JsonMap({"id_": "id"})
class FilterOverOwMatches(BaseModel):
    """FilterOverOwMatches
    ...
    :type opponent_id: List[FilterOverOwMatchesOpponentId], optional
    ...
    :type videogame_title: List[FilterOverOwMatchesVideogameTitle], optional
    ...
    :type videogame_version: List[FilterOverOwMatchesVideogameVersion], optional
    ...
    def __init__(
        ...
        opponent_id: List[FilterOverOwMatchesOpponentId] = None,
        ...
        videogame_title: List[FilterOverOwMatchesVideogameTitle] = None,
        videogame_version: List[FilterOverOwMatchesVideogameVersion] = None,
        ...
        if opponent_id is not None:
            self.opponent_id = self._define_list(
                opponent_id, FilterOverOwMatchesOpponentId
            )
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverOwMatchesVideogameTitle
            )
        if videogame_version is not None:
            self.videogame_version = self._define_list(
                videogame_version, FilterOverOwMatchesVideogameVersion
            )
