...
class FilterOverLolWildRiftMatchesOpponentIdGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str, "int": int, "str": str}


FilterOverLolWildRiftMatchesOpponentId = Union[int, str, int, str]


class FilterOverLolWildRiftMatchesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverLolWildRiftMatchesVideogameTitle = Union[int, str]


class FilterOverLolWildRiftMatchesVideogameVersionGuard(OneOfBaseModel):
    class_list = {"str": str, "any": any, "any": any}


FilterOverLolWildRiftMatchesVideogameVersion = Union[str, any, any]


@JsonMap({"id_": "id"})
class FilterOverLolWildRiftMatches(BaseModel):
    ...
    :type opponent_id: List[FilterOverLolWildRiftMatchesOpponentId], optional
    ...
    :type videogame_title: List[FilterOverLolWildRiftMatchesVideogameTitle], optional
    ...
    :type videogame_version: List[FilterOverLolWildRiftMatchesVideogameVersion], optional
    ...
    def __init__(
        ...
        opponent_id: List[FilterOverLolWildRiftMatchesOpponentId] = None,
        ...
        videogame_title: List[FilterOverLolWildRiftMatchesVideogameTitle] = None,
        videogame_version: List[FilterOverLolWildRiftMatchesVideogameVersion] = None,
        ...
        if opponent_id is not None:
            self.opponent_id = self._define_list(
                opponent_id, FilterOverLolWildRiftMatchesOpponentId
            )
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverLolWildRiftMatchesVideogameTitle
            )
        if videogame_version is not None:
            self.videogame_version = self._define_list(
                videogame_version, FilterOverLolWildRiftMatchesVideogameVersion
            )
