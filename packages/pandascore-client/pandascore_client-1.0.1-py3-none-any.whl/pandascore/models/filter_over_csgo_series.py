...
class FilterOverCsgoSeriesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverCsgoSeriesVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverCsgoSeries(BaseModel):
    ...
    :type videogame_title: List[FilterOverCsgoSeriesVideogameTitle], optional
    ...
    def __init__(
        ...
        slug: List[str] = None,
        videogame_title: List[FilterOverCsgoSeriesVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverCsgoSeriesVideogameTitle
            )
