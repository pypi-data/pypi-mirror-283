...
class FilterOverStarcraftBroodWarSeriesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverStarcraftBroodWarSeriesVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverStarcraftBroodWarSeries(BaseModel):
    ...
    :type videogame_title: List[FilterOverStarcraftBroodWarSeriesVideogameTitle], optional
    ...
    def __init__(
        ...
        slug: List[str] = None,
        videogame_title: List[FilterOverStarcraftBroodWarSeriesVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverStarcraftBroodWarSeriesVideogameTitle
            )
