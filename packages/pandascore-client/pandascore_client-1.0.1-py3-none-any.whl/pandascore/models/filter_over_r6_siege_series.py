...
class FilterOverR6SiegeSeriesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverR6SiegeSeriesVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverR6SiegeSeries(BaseModel):
    ...
    :type videogame_title: List[FilterOverR6SiegeSeriesVideogameTitle], optional
    ...
    def __init__(
        ...
        slug: List[str] = None,
        videogame_title: List[FilterOverR6SiegeSeriesVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverR6SiegeSeriesVideogameTitle
            )
