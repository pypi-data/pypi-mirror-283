...
class FilterOverRlSeriesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverRlSeriesVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverRlSeries(BaseModel):
    """FilterOverRlSeries
    ...
    :type videogame_title: List[FilterOverRlSeriesVideogameTitle], optional
    ...
    def __init__(
        ...
        slug: List[str] = None,
        videogame_title: List[FilterOverRlSeriesVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverRlSeriesVideogameTitle
            )
