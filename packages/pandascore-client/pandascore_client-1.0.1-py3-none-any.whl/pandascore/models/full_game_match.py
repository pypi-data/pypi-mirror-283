...
@JsonMap({})
class FullGameMatchVideogameVersion(BaseModel):
...
class FullGameMatchWinnerGuard(OneOfBaseModel):
    class_list = {"Winner1_2": Winner1_2, "Winner2_2": Winner2_2}


FullGameMatchWinner = Union[Winner1_2, Winner2_2]


class FullGameMatchWinnerIdGuard(OneOfBaseModel):
    class_list = {"int": int, "int": int}


FullGameMatchWinnerId = Union[int, int]


@JsonMap({"id_": "id"})
class FullGameMatch(BaseModel):
    """A match
    ...
    :type videogame_version: FullGameMatchVideogameVersion
    :param winner: winner
    :type winner: FullGameMatchWinner
    :param winner_id: winner_id
    :type winner_id: FullGameMatchWinnerId
    ...
    def __init__(
        ...
        self.winner = FullGameMatchWinnerGuard.return_one_of(winner)
        self.winner_id = FullGameMatchWinnerIdGuard.return_one_of(winner_id)
