...
@JsonMap({"id_": "id"})
class LoLPlayerForAllStatsPlayers(BaseModel):
    ...
    :type stats: LoLPlayerStatsForAllPlayersByMatch
    """
    ...
    def __init__(
        ...
        self.name = name
        self.stats = self._define_object(stats, LoLPlayerStatsForAllPlayersByMatch)
