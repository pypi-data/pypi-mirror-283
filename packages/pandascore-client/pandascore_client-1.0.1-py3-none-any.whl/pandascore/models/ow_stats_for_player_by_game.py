...
@JsonMap({"id_": "id"})
class OwStatsForPlayerByGameCurrentTeam(BaseModel):
...
@JsonMap({"id_": "id"})
class OwStatsForPlayerByGame(BaseModel):
    ...
    :type current_team: OwStatsForPlayerByGameCurrentTeam
    ...
    :type slug: str
    :param stats: Player's statistics for a game
    :type stats: OwPlayerStatsByGame
    """
    ...
    def __init__(
        ...
        self.role = role
        self.slug = self._pattern_matching(slug, "^[a-z0-9_-]+$", "slug")
        self.stats = self._define_object(stats, OwPlayerStatsByGame)
