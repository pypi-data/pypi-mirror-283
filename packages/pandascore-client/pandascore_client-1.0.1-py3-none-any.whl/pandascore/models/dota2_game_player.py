...
class Dota2GamePlayerFaction(Enum):
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, Dota2GamePlayerFaction._member_map_.values())
        )


@JsonMap({"id_": "id"})
class Dota2GamePlayerHero(BaseModel):
    """Dota2GamePlayerHero
...
class Dota2GamePlayerOpponentGuard(OneOfBaseModel):
    class_list = {"Opponent1_2": Opponent1_2, "Opponent2_2": Opponent2_2}


Dota2GamePlayerOpponent = Union[Opponent1_2, Opponent2_2]


@JsonMap({})
class Dota2GamePlayer(BaseModel):
    ...
    :type faction: Dota2GamePlayerFaction
    ...
    :type opponent: Dota2GamePlayerOpponent
    :param player: player
    ...
    def __init__(
        ...
        self.faction = self._enum_matching(
            faction, Dota2GamePlayerFaction.list(), "faction"
        )
        ...
        self.heal = heal
        self.hero = self._define_object(hero, Dota2GamePlayerHero)
        ...
        self.opponent = Dota2GamePlayerOpponentGuard.return_one_of(opponent)
