...
class FilterOverPubgShortTournamentsVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverPubgShortTournamentsVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverPubgShortTournaments(BaseModel):
    ...
    :type videogame_title: List[FilterOverPubgShortTournamentsVideogameTitle], optional
    ...
    def __init__(
        ...
        videogame_title: List[FilterOverPubgShortTournamentsVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverPubgShortTournamentsVideogameTitle
            )
