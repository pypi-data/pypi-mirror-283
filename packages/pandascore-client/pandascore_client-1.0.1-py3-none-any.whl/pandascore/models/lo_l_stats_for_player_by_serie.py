...
@JsonMap({"id_": "id"})
class LoLStatsForPlayerBySerieCurrentTeam(BaseModel):
...
@JsonMap({"id_": "id"})
class LoLStatsForPlayerBySerie(BaseModel):
    ...
    :type current_team: LoLStatsForPlayerBySerieCurrentTeam
    ...
    :type stats: LoLPlayerBySerieStat
    :param teams: teams
    ...
    def __init__(
        ...
        self.role = role
        self.slug = self._pattern_matching(slug, "^[a-z0-9_-]+$", "slug")
        self.stats = self._define_object(stats, LoLPlayerBySerieStat)
