...
class FilterOverPubgSeriesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverPubgSeriesVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverPubgSeries(BaseModel):
    ...
    :type videogame_title: List[FilterOverPubgSeriesVideogameTitle], optional
    ...
    def __init__(
        ...
        slug: List[str] = None,
        videogame_title: List[FilterOverPubgSeriesVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverPubgSeriesVideogameTitle
            )
