...
class FilterOverSeriesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverSeriesVideogameTitle = Union[int, str]
...
class FilterOverSeries(BaseModel):
    ...
    :type videogame_title: List[FilterOverSeriesVideogameTitle], optional
    ...
    def __init__(
        ...
        slug: List[str] = None,
        videogame_title: List[FilterOverSeriesVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverSeriesVideogameTitle
            )
