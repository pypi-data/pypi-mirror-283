...
class FilterOverPubgMatchesOpponentIdGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str, "int": int, "str": str}


FilterOverPubgMatchesOpponentId = Union[int, str, int, str]


class FilterOverPubgMatchesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverPubgMatchesVideogameTitle = Union[int, str]


class FilterOverPubgMatchesVideogameVersionGuard(OneOfBaseModel):
    class_list = {"str": str, "any": any, "any": any}


FilterOverPubgMatchesVideogameVersion = Union[str, any, any]


@JsonMap({"id_": "id"})
class FilterOverPubgMatches(BaseModel):
    ...
    :type opponent_id: List[FilterOverPubgMatchesOpponentId], optional
    ...
    :type videogame_title: List[FilterOverPubgMatchesVideogameTitle], optional
    ...
    :type videogame_version: List[FilterOverPubgMatchesVideogameVersion], optional
    ...
    def __init__(
        ...
        opponent_id: List[FilterOverPubgMatchesOpponentId] = None,
        ...
        videogame_title: List[FilterOverPubgMatchesVideogameTitle] = None,
        videogame_version: List[FilterOverPubgMatchesVideogameVersion] = None,
        ...
        if opponent_id is not None:
            self.opponent_id = self._define_list(
                opponent_id, FilterOverPubgMatchesOpponentId
            )
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverPubgMatchesVideogameTitle
            )
        if videogame_version is not None:
            self.videogame_version = self._define_list(
                videogame_version, FilterOverPubgMatchesVideogameVersion
            )
