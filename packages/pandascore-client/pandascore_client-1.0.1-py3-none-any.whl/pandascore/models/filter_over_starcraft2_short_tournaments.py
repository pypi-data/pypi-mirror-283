...
class FilterOverStarcraft2ShortTournamentsVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverStarcraft2ShortTournamentsVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverStarcraft2ShortTournaments(BaseModel):
    ...
    :type videogame_title: List[FilterOverStarcraft2ShortTournamentsVideogameTitle], optional
    ...
    def __init__(
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverStarcraft2ShortTournamentsVideogameTitle
            )
