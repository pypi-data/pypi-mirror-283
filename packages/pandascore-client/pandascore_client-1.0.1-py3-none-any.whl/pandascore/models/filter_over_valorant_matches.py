...
class FilterOverValorantMatchesOpponentIdGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str, "int": int, "str": str}


FilterOverValorantMatchesOpponentId = Union[int, str, int, str]


class FilterOverValorantMatchesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverValorantMatchesVideogameTitle = Union[int, str]


class FilterOverValorantMatchesVideogameVersionGuard(OneOfBaseModel):
    class_list = {"str": str, "any": any, "any": any}


FilterOverValorantMatchesVideogameVersion = Union[str, any, any]


@JsonMap({"id_": "id"})
class FilterOverValorantMatches(BaseModel):
    ...
    :type opponent_id: List[FilterOverValorantMatchesOpponentId], optional
    ...
    :type videogame_title: List[FilterOverValorantMatchesVideogameTitle], optional
    ...
    :type videogame_version: List[FilterOverValorantMatchesVideogameVersion], optional
    ...
    def __init__(
        ...
        opponent_id: List[FilterOverValorantMatchesOpponentId] = None,
        ...
        videogame_title: List[FilterOverValorantMatchesVideogameTitle] = None,
        videogame_version: List[FilterOverValorantMatchesVideogameVersion] = None,
        ...
        if opponent_id is not None:
            self.opponent_id = self._define_list(
                opponent_id, FilterOverValorantMatchesOpponentId
            )
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverValorantMatchesVideogameTitle
            )
        if videogame_version is not None:
            self.videogame_version = self._define_list(
                videogame_version, FilterOverValorantMatchesVideogameVersion
            )
