...
from ..models.get_ow_series_upcoming_page import GetOwSeriesUpcomingPage
from ..models.get_ow_series_running_page import GetOwSeriesRunningPage
from ..models.get_ow_series_past_page import GetOwSeriesPastPage
from ..models.get_ow_series_page import GetOwSeriesPage
...
class OwSeriesService(BaseService):
    ...
    def get_ow_series(
        ...
        :type page: GetOwSeriesPage, optional
        ...
        Validator(GetOwSeriesPage).is_optional().validate(page)
    ...
    def get_ow_series_past(
        ...
        :type search: SearchOverOwSeries, optional
        :param page: Pagination in the form of `page=2` or `page[size]=30&page[number]=2`, defaults to None
        :type page: GetOwSeriesPastPage, optional
        :param per_page: Equivalent to `page[size]`, defaults to None
        :type per_page: int, optional
        ...
        :raises RequestError: Raised when a request fails, with optional HTTP status code and details.
        ...
        Validator(any).is_array().is_optional().validate(sort)
        Validator(SearchOverOwSeries).is_optional().validate(search)
        Validator(GetOwSeriesPastPage).is_optional().validate(page)
        Validator(int).is_optional().min(1).max(100).validate(per_page)
    ...
    def get_ow_series_running(
        ...
        sort: List[any] = None,
        search: SearchOverOwSeries = None,
        page: GetOwSeriesRunningPage = None,
        per_page: int = None,
    ) -> List[Serie]:
        ...
        :type search: SearchOverOwSeries, optional
        :param page: Pagination in the form of `page=2` or `page[size]=30&page[number]=2`, defaults to None
        :type page: GetOwSeriesRunningPage, optional
        :param per_page: Equivalent to `page[size]`, defaults to None
        :type per_page: int, optional
        ...
        :raises RequestError: Raised when a request fails, with optional HTTP status code and details.
        ...
        Validator(any).is_array().is_optional().validate(sort)
        Validator(SearchOverOwSeries).is_optional().validate(search)
        Validator(GetOwSeriesRunningPage).is_optional().validate(page)
        Validator(int).is_optional().min(1).max(100).validate(per_page)
    ...
    def get_ow_series_upcoming(
        ...
        sort: List[any] = None,
        search: SearchOverOwSeries = None,
        page: GetOwSeriesUpcomingPage = None,
        per_page: int = None,
    ) -> List[Serie]:
        ...
        :type search: SearchOverOwSeries, optional
        :param page: Pagination in the form of `page=2` or `page[size]=30&page[number]=2`, defaults to None
        :type page: GetOwSeriesUpcomingPage, optional
        :param per_page: Equivalent to `page[size]`, defaults to None
        :type per_page: int, optional
        ...
        :raises RequestError: Raised when a request fails, with optional HTTP status code and details.
        ...
        Validator(any).is_array().is_optional().validate(sort)
        Validator(SearchOverOwSeries).is_optional().validate(search)
        Validator(GetOwSeriesUpcomingPage).is_optional().validate(page)
        Validator(int).is_optional().min(1).max(100).validate(per_page)
