...
from ..models.get_fifa_series_upcoming_page import GetFifaSeriesUpcomingPage
from ..models.get_fifa_series_running_page import GetFifaSeriesRunningPage
from ..models.get_fifa_series_past_page import GetFifaSeriesPastPage
from ..models.get_fifa_series_page import GetFifaSeriesPage
...
class EaSportsFcSeriesService(BaseService):
    ...
    def get_fifa_series(
        ...
        :type page: GetFifaSeriesPage, optional
        ...
        Validator(GetFifaSeriesPage).is_optional().validate(page)
    ...
    def get_fifa_series_past(
        ...
        sort: List[any] = None,
        search: SearchOverFifaSeries = None,
        page: GetFifaSeriesPastPage = None,
        per_page: int = None,
    ) -> List[Serie]:
        ...
        :type search: SearchOverFifaSeries, optional
        :param page: Pagination in the form of `page=2` or `page[size]=30&page[number]=2`, defaults to None
        :type page: GetFifaSeriesPastPage, optional
        :param per_page: Equivalent to `page[size]`, defaults to None
        :type per_page: int, optional
        ...
        :raises RequestError: Raised when a request fails, with optional HTTP status code and details.
        ...
        Validator(any).is_array().is_optional().validate(sort)
        Validator(SearchOverFifaSeries).is_optional().validate(search)
        Validator(GetFifaSeriesPastPage).is_optional().validate(page)
        Validator(int).is_optional().min(1).max(100).validate(per_page)
    ...
    def get_fifa_series_running(
        ...
        sort: List[any] = None,
        search: SearchOverFifaSeries = None,
        page: GetFifaSeriesRunningPage = None,
        per_page: int = None,
    ) -> List[Serie]:
        ...
        :type search: SearchOverFifaSeries, optional
        :param page: Pagination in the form of `page=2` or `page[size]=30&page[number]=2`, defaults to None
        :type page: GetFifaSeriesRunningPage, optional
        :param per_page: Equivalent to `page[size]`, defaults to None
        :type per_page: int, optional
        ...
        :raises RequestError: Raised when a request fails, with optional HTTP status code and details.
        ...
        Validator(any).is_array().is_optional().validate(sort)
        Validator(SearchOverFifaSeries).is_optional().validate(search)
        Validator(GetFifaSeriesRunningPage).is_optional().validate(page)
        Validator(int).is_optional().min(1).max(100).validate(per_page)
    ...
    def get_fifa_series_upcoming(
        ...
        sort: List[any] = None,
        search: SearchOverFifaSeries = None,
        page: GetFifaSeriesUpcomingPage = None,
        per_page: int = None,
    ) -> List[Serie]:
        ...
        :type search: SearchOverFifaSeries, optional
        :param page: Pagination in the form of `page=2` or `page[size]=30&page[number]=2`, defaults to None
        :type page: GetFifaSeriesUpcomingPage, optional
        :param per_page: Equivalent to `page[size]`, defaults to None
        :type per_page: int, optional
        ...
        :raises RequestError: Raised when a request fails, with optional HTTP status code and details.
        ...
        Validator(any).is_array().is_optional().validate(sort)
        Validator(SearchOverFifaSeries).is_optional().validate(search)
        Validator(GetFifaSeriesUpcomingPage).is_optional().validate(page)
        Validator(int).is_optional().min(1).max(100).validate(per_page)
