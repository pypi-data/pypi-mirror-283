...
from ..models.get_codmw_teams_page import GetCodmwTeamsPage
...
class CodmwTeamsService(BaseService):
    ...
    def get_codmw_teams(
        ...
        :type page: GetCodmwTeamsPage, optional
        ...
        Validator(GetCodmwTeamsPage).is_optional().validate(page)
