...
from ..models.get_ow_leagues_page import GetOwLeaguesPage
...
class OwLeaguesService(BaseService):
    ...
    def get_ow_leagues(
        ...
        :type page: GetOwLeaguesPage, optional
        ...
        Validator(GetOwLeaguesPage).is_optional().validate(page)
