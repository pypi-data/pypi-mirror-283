...
@JsonMap({"id_": "id"})
class OwStatsForPlayerByMatchCurrentTeam(BaseModel):
...
@JsonMap({"id_": "id"})
class OwStatsForPlayerByMatch(BaseModel):
    ...
    :type current_team: OwStatsForPlayerByMatchCurrentTeam
    ...
    :type slug: str
    :param stats: Player's statistics for a match
    :type stats: OwPlayerStatsByMatch
    :param teams: teams
    ...
    def __init__(
        ...
        self.role = role
        self.slug = self._pattern_matching(slug, "^[a-z0-9_-]+$", "slug")
        self.stats = self._define_object(stats, OwPlayerStatsByMatch)
