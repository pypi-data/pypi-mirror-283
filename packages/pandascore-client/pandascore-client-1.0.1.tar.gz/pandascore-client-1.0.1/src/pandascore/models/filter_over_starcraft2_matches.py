...
class FilterOverStarcraft2MatchesOpponentIdGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str, "int": int, "str": str}


FilterOverStarcraft2MatchesOpponentId = Union[int, str, int, str]


class FilterOverStarcraft2MatchesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverStarcraft2MatchesVideogameTitle = Union[int, str]


class FilterOverStarcraft2MatchesVideogameVersionGuard(OneOfBaseModel):
    class_list = {"str": str, "any": any, "any": any}


FilterOverStarcraft2MatchesVideogameVersion = Union[str, any, any]


@JsonMap({"id_": "id"})
class FilterOverStarcraft2Matches(BaseModel):
    ...
    :type opponent_id: List[FilterOverStarcraft2MatchesOpponentId], optional
    ...
    :type videogame_title: List[FilterOverStarcraft2MatchesVideogameTitle], optional
    ...
    :type videogame_version: List[FilterOverStarcraft2MatchesVideogameVersion], optional
    ...
    def __init__(
        ...
        opponent_id: List[FilterOverStarcraft2MatchesOpponentId] = None,
        ...
        videogame_title: List[FilterOverStarcraft2MatchesVideogameTitle] = None,
        videogame_version: List[FilterOverStarcraft2MatchesVideogameVersion] = None,
        ...
        if opponent_id is not None:
            self.opponent_id = self._define_list(
                opponent_id, FilterOverStarcraft2MatchesOpponentId
            )
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverStarcraft2MatchesVideogameTitle
            )
        if videogame_version is not None:
            self.videogame_version = self._define_list(
                videogame_version, FilterOverStarcraft2MatchesVideogameVersion
            )
