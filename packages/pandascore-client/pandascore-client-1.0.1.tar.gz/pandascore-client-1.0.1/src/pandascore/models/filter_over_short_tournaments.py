...
class FilterOverShortTournamentsVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverShortTournamentsVideogameTitle = Union[int, str]
...
class FilterOverShortTournaments(BaseModel):
    ...
    :type videogame_title: List[FilterOverShortTournamentsVideogameTitle], optional
    ...
    def __init__(
        ...
        videogame_title: List[FilterOverShortTournamentsVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverShortTournamentsVideogameTitle
            )
