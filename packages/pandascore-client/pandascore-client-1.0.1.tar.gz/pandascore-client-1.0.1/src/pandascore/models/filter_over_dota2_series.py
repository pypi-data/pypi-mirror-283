...
class FilterOverDota2SeriesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverDota2SeriesVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverDota2Series(BaseModel):
    ...
    :type videogame_title: List[FilterOverDota2SeriesVideogameTitle], optional
    ...
    def __init__(
        ...
        slug: List[str] = None,
        videogame_title: List[FilterOverDota2SeriesVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverDota2SeriesVideogameTitle
            )
