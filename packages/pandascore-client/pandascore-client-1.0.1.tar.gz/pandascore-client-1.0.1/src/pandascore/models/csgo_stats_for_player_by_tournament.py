...
@JsonMap({"id_": "id"})
class CsgoStatsForPlayerByTournamentCurrentTeam(BaseModel):
...
@JsonMap({"id_": "id"})
class CsgoStatsForPlayerByTournament(BaseModel):
    ...
    :type current_team: CsgoStatsForPlayerByTournamentCurrentTeam
    ...
    :type stats: CsgoPlayerStatsByTournament
    :param teams: teams
    ...
    def __init__(
        ...
        self.role = role
        self.slug = self._pattern_matching(slug, "^[a-z0-9_-]+$", "slug")
        self.stats = self._define_object(stats, CsgoPlayerStatsByTournament)
