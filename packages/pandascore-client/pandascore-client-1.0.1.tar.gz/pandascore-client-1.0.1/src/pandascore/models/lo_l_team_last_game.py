...
class LoLTeamLastGameWinnerType(Enum):
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, LoLTeamLastGameWinnerType._member_map_.values())
        )


@JsonMap({"id_": "id"})
class LoLTeamLastGame(BaseModel):
    """A team's last game
    ...
    :type winner_type: LoLTeamLastGameWinnerType
    """
    ...
    def __init__(
        ...
        self.winner_type = self._enum_matching(
            winner_type, LoLTeamLastGameWinnerType.list(), "winner_type"
        )
