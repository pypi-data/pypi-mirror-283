...
class FilterOverLoLMatchesOpponentIdGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str, "int": int, "str": str}


FilterOverLoLMatchesOpponentId = Union[int, str, int, str]


class FilterOverLoLMatchesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverLoLMatchesVideogameTitle = Union[int, str]


class FilterOverLoLMatchesVideogameVersionGuard(OneOfBaseModel):
    class_list = {"str": str, "any": any, "any": any}


FilterOverLoLMatchesVideogameVersion = Union[str, any, any]


@JsonMap({"id_": "id"})
class FilterOverLoLMatches(BaseModel):
    ...
    :type opponent_id: List[FilterOverLoLMatchesOpponentId], optional
    ...
    :type videogame_title: List[FilterOverLoLMatchesVideogameTitle], optional
    ...
    :type videogame_version: List[FilterOverLoLMatchesVideogameVersion], optional
    ...
    def __init__(
        ...
        opponent_id: List[FilterOverLoLMatchesOpponentId] = None,
        ...
        videogame_title: List[FilterOverLoLMatchesVideogameTitle] = None,
        videogame_version: List[FilterOverLoLMatchesVideogameVersion] = None,
        ...
        if opponent_id is not None:
            self.opponent_id = self._define_list(
                opponent_id, FilterOverLoLMatchesOpponentId
            )
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverLoLMatchesVideogameTitle
            )
        if videogame_version is not None:
            self.videogame_version = self._define_list(
                videogame_version, FilterOverLoLMatchesVideogameVersion
            )
