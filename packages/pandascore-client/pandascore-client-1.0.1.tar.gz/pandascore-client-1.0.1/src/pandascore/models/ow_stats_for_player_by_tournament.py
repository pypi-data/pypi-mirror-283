...
@JsonMap({"id_": "id"})
class OwStatsForPlayerByTournamentCurrentTeam(BaseModel):
...
@JsonMap({"id_": "id"})
class OwStatsForPlayerByTournament(BaseModel):
    ...
    :type current_team: OwStatsForPlayerByTournamentCurrentTeam
    ...
    :type stats: OwPlayerStatsByTournament
    :param teams: teams
    ...
    def __init__(
        ...
        self.role = role
        self.slug = self._pattern_matching(slug, "^[a-z0-9_-]+$", "slug")
        self.stats = self._define_object(stats, OwPlayerStatsByTournament)
