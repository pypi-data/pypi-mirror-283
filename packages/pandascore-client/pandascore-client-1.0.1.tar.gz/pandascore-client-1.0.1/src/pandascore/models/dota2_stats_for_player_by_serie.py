...
@JsonMap({"id_": "id"})
class Dota2StatsForPlayerBySerieCurrentTeam(BaseModel):
...
@JsonMap({"id_": "id"})
class Dota2StatsForPlayerBySerie(BaseModel):
    ...
    :type current_team: Dota2StatsForPlayerBySerieCurrentTeam
    ...
    :type stats: Dota2PlayerBySerieStat
    :param teams: teams
    ...
    def __init__(
        ...
        self.role = role
        self.slug = self._pattern_matching(slug, "^[a-z0-9_-]+$", "slug")
        self.stats = self._define_object(stats, Dota2PlayerBySerieStat)
