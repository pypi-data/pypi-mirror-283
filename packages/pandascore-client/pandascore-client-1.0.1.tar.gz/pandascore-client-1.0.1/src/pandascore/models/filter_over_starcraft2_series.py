...
class FilterOverStarcraft2SeriesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverStarcraft2SeriesVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverStarcraft2Series(BaseModel):
    ...
    :type videogame_title: List[FilterOverStarcraft2SeriesVideogameTitle], optional
    ...
    def __init__(
        ...
        slug: List[str] = None,
        videogame_title: List[FilterOverStarcraft2SeriesVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverStarcraft2SeriesVideogameTitle
            )
