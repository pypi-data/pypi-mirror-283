...
class FilterOverR6SiegeShortTournamentsVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverR6SiegeShortTournamentsVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverR6SiegeShortTournaments(BaseModel):
    ...
    :type videogame_title: List[FilterOverR6SiegeShortTournamentsVideogameTitle], optional
    ...
    def __init__(
        ...
        videogame_title: List[FilterOverR6SiegeShortTournamentsVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverR6SiegeShortTournamentsVideogameTitle
            )
