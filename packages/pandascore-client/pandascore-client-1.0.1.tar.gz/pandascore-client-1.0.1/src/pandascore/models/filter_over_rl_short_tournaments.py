...
class FilterOverRlShortTournamentsVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverRlShortTournamentsVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverRlShortTournaments(BaseModel):
    ...
    :type videogame_title: List[FilterOverRlShortTournamentsVideogameTitle], optional
    ...
    def __init__(
        ...
        videogame_title: List[FilterOverRlShortTournamentsVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverRlShortTournamentsVideogameTitle
            )
