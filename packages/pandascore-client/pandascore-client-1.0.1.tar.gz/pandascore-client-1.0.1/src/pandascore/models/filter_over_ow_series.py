...
class FilterOverOwSeriesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverOwSeriesVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverOwSeries(BaseModel):
    """FilterOverOwSeries
    ...
    :type videogame_title: List[FilterOverOwSeriesVideogameTitle], optional
    ...
    def __init__(
        ...
        slug: List[str] = None,
        videogame_title: List[FilterOverOwSeriesVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverOwSeriesVideogameTitle
            )
