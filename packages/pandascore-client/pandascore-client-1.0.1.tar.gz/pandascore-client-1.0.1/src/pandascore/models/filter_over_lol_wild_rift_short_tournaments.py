...
class FilterOverLolWildRiftShortTournamentsVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverLolWildRiftShortTournamentsVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverLolWildRiftShortTournaments(BaseModel):
    ...
    :type videogame_title: List[FilterOverLolWildRiftShortTournamentsVideogameTitle], optional
    ...
    def __init__(
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverLolWildRiftShortTournamentsVideogameTitle
            )
