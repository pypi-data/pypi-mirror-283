...
class FilterOverCodmwShortTournamentsVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverCodmwShortTournamentsVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverCodmwShortTournaments(BaseModel):
    ...
    :type videogame_title: List[FilterOverCodmwShortTournamentsVideogameTitle], optional
    ...
    def __init__(
        ...
        videogame_title: List[FilterOverCodmwShortTournamentsVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverCodmwShortTournamentsVideogameTitle
            )
