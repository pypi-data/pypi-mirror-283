...
class FilterOverFifaMatchesOpponentIdGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str, "int": int, "str": str}


FilterOverFifaMatchesOpponentId = Union[int, str, int, str]


class FilterOverFifaMatchesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverFifaMatchesVideogameTitle = Union[int, str]


class FilterOverFifaMatchesVideogameVersionGuard(OneOfBaseModel):
    class_list = {"str": str, "any": any, "any": any}


FilterOverFifaMatchesVideogameVersion = Union[str, any, any]


@JsonMap({"id_": "id"})
class FilterOverFifaMatches(BaseModel):
    ...
    :type opponent_id: List[FilterOverFifaMatchesOpponentId], optional
    ...
    :type videogame_title: List[FilterOverFifaMatchesVideogameTitle], optional
    ...
    :type videogame_version: List[FilterOverFifaMatchesVideogameVersion], optional
    ...
    def __init__(
        ...
        opponent_id: List[FilterOverFifaMatchesOpponentId] = None,
        ...
        videogame_title: List[FilterOverFifaMatchesVideogameTitle] = None,
        videogame_version: List[FilterOverFifaMatchesVideogameVersion] = None,
        ...
        if opponent_id is not None:
            self.opponent_id = self._define_list(
                opponent_id, FilterOverFifaMatchesOpponentId
            )
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverFifaMatchesVideogameTitle
            )
        if videogame_version is not None:
            self.videogame_version = self._define_list(
                videogame_version, FilterOverFifaMatchesVideogameVersion
            )
