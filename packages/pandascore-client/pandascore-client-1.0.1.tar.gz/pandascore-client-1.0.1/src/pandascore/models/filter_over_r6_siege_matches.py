...
class FilterOverR6SiegeMatchesOpponentIdGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str, "int": int, "str": str}


FilterOverR6SiegeMatchesOpponentId = Union[int, str, int, str]


class FilterOverR6SiegeMatchesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverR6SiegeMatchesVideogameTitle = Union[int, str]


class FilterOverR6SiegeMatchesVideogameVersionGuard(OneOfBaseModel):
    class_list = {"str": str, "any": any, "any": any}


FilterOverR6SiegeMatchesVideogameVersion = Union[str, any, any]


@JsonMap({"id_": "id"})
class FilterOverR6SiegeMatches(BaseModel):
    ...
    :type opponent_id: List[FilterOverR6SiegeMatchesOpponentId], optional
    ...
    :type videogame_title: List[FilterOverR6SiegeMatchesVideogameTitle], optional
    ...
    :type videogame_version: List[FilterOverR6SiegeMatchesVideogameVersion], optional
    ...
    def __init__(
        ...
        opponent_id: List[FilterOverR6SiegeMatchesOpponentId] = None,
        ...
        videogame_title: List[FilterOverR6SiegeMatchesVideogameTitle] = None,
        videogame_version: List[FilterOverR6SiegeMatchesVideogameVersion] = None,
        ...
        if opponent_id is not None:
            self.opponent_id = self._define_list(
                opponent_id, FilterOverR6SiegeMatchesOpponentId
            )
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverR6SiegeMatchesVideogameTitle
            )
        if videogame_version is not None:
            self.videogame_version = self._define_list(
                videogame_version, FilterOverR6SiegeMatchesVideogameVersion
            )
