...
class FilterOverKogSeriesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverKogSeriesVideogameTitle = Union[int, str]


@JsonMap({"id_": "id"})
class FilterOverKogSeries(BaseModel):
    """FilterOverKogSeries
    ...
    :type videogame_title: List[FilterOverKogSeriesVideogameTitle], optional
    ...
    def __init__(
        ...
        slug: List[str] = None,
        videogame_title: List[FilterOverKogSeriesVideogameTitle] = None,
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverKogSeriesVideogameTitle
            )
