...
class FilterOverDota2MatchesOpponentIdGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str, "int": int, "str": str}


FilterOverDota2MatchesOpponentId = Union[int, str, int, str]


class FilterOverDota2MatchesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverDota2MatchesVideogameTitle = Union[int, str]


class FilterOverDota2MatchesVideogameVersionGuard(OneOfBaseModel):
    class_list = {"str": str, "any": any, "any": any}


FilterOverDota2MatchesVideogameVersion = Union[str, any, any]


@JsonMap({"id_": "id"})
class FilterOverDota2Matches(BaseModel):
    ...
    :type opponent_id: List[FilterOverDota2MatchesOpponentId], optional
    ...
    :type videogame_title: List[FilterOverDota2MatchesVideogameTitle], optional
    ...
    :type videogame_version: List[FilterOverDota2MatchesVideogameVersion], optional
    ...
    def __init__(
        ...
        opponent_id: List[FilterOverDota2MatchesOpponentId] = None,
        ...
        videogame_title: List[FilterOverDota2MatchesVideogameTitle] = None,
        videogame_version: List[FilterOverDota2MatchesVideogameVersion] = None,
        ...
        if opponent_id is not None:
            self.opponent_id = self._define_list(
                opponent_id, FilterOverDota2MatchesOpponentId
            )
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverDota2MatchesVideogameTitle
            )
        if videogame_version is not None:
            self.videogame_version = self._define_list(
                videogame_version, FilterOverDota2MatchesVideogameVersion
            )
