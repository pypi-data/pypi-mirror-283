...
@JsonMap({"id_": "id"})
class LoLStatsForPlayerByTournamentCurrentTeam(BaseModel):
...
@JsonMap({"id_": "id"})
class LoLStatsForPlayerByTournament(BaseModel):
    ...
    :type current_team: LoLStatsForPlayerByTournamentCurrentTeam
    ...
    :type stats: LoLPlayerByTournamentStat
    :param teams: teams
    ...
    def __init__(
        ...
        self.role = role
        self.slug = self._pattern_matching(slug, "^[a-z0-9_-]+$", "slug")
        self.stats = self._define_object(stats, LoLPlayerByTournamentStat)
