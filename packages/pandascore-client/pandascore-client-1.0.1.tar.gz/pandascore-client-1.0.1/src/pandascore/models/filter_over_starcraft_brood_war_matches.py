...
class FilterOverStarcraftBroodWarMatchesOpponentIdGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str, "int": int, "str": str}


FilterOverStarcraftBroodWarMatchesOpponentId = Union[int, str, int, str]


class FilterOverStarcraftBroodWarMatchesVideogameTitleGuard(OneOfBaseModel):
    class_list = {"int": int, "str": str}


FilterOverStarcraftBroodWarMatchesVideogameTitle = Union[int, str]


class FilterOverStarcraftBroodWarMatchesVideogameVersionGuard(OneOfBaseModel):
    class_list = {"str": str, "any": any, "any": any}


FilterOverStarcraftBroodWarMatchesVideogameVersion = Union[str, any, any]


@JsonMap({"id_": "id"})
class FilterOverStarcraftBroodWarMatches(BaseModel):
    ...
    :type opponent_id: List[FilterOverStarcraftBroodWarMatchesOpponentId], optional
    ...
    :type videogame_title: List[FilterOverStarcraftBroodWarMatchesVideogameTitle], optional
    ...
    :type videogame_version: List[FilterOverStarcraftBroodWarMatchesVideogameVersion], optional
    ...
    def __init__(
        ...
        opponent_id: List[FilterOverStarcraftBroodWarMatchesOpponentId] = None,
        ...
        videogame_title: List[FilterOverStarcraftBroodWarMatchesVideogameTitle] = None,
        videogame_version: List[
        ...
        if opponent_id is not None:
            self.opponent_id = self._define_list(
                opponent_id, FilterOverStarcraftBroodWarMatchesOpponentId
            )
        ...
        if videogame_title is not None:
            self.videogame_title = self._define_list(
                videogame_title, FilterOverStarcraftBroodWarMatchesVideogameTitle
            )
        if videogame_version is not None:
            self.videogame_version = self._define_list(
                videogame_version, FilterOverStarcraftBroodWarMatchesVideogameVersion
            )
