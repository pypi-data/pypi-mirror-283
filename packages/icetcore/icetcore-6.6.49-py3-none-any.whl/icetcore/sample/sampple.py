...
#获取合约信息
print(api.getsymbol_allinfo("TC.O.SSE.510050.202309.C.2.5"))
#获取合约到期日
print(api.getexpirationdate("TC.O.SSE.510050.202309.C.2.5"))
#获取合约最小跳动
print(api.getsymbol_ticksize("TC.O.SSE.510050.202309.C.2.5"))
#获取合约乘数，合约规格大小
print(api.getsymbolvolume_multiple("TC.O.SSE.510050.202309.C.2.5"))
#获取合约编码
print(api.getsymbol_id("TC.O.SSE.510050.202309.C.2.5"))
...
print(api.gettradeingdate("TC.O.SSE.510050.202311.C.2.5",20230122,20230822))
#获取合约剩余交易日还有多少天
print(api.gettradeingdays("TC.O.SSE.510050.202311.C.2.5"))
...
api.subbar(BarType.MINUTE,5,"TC.O.SSE.510050.202309.C.2.5",starttime="2023082201")#TC.F.SHFE.rb.HOT
...
# print(datetime.now()
#获取历史Greeks
print(api.getgreekshistory(GreeksType.GREEKS1K,1,"TC.F.U_SSE.510050.202309","2023082201"))
#获取合约的greeks数据
print(api.getgreekshistory(GreeksType.DOGSK,5,"TC.O.SSE.510050.202309.C.2.5","2023082200","2023082207"))
#订阅实时greeks数据
api.subgreeksreal("TC.O.SSE.510050.202309.C.2.5")
#订阅实时行情数据
api.subquote("TC.O.SSE.510050.202309.C.2.5")
#订阅动态Greeks线图数据
api.subgreeksline(GreeksType.DOGSK,5,"TC.O.SSE.510050.202309.C.2.75",starttime="2023082201")#TC.F.SHFE.rb.HOT
...
if accoutlist:
    ...
    if strAccountMask !="" :
        ...
        #建组合持仓
        api.optcomb(strAccountMask,'TC.O.SSE.510050.202309.C.2.65','TC.O.SSE.510050.202309.C.2.7',1,4)
