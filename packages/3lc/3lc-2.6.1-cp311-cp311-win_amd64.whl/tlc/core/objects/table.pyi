...
from tlc.client.utils import RangeSampler as RangeSampler, SubsetSequentialSampler as SubsetSequentialSampler, standardized_transforms as standardized_transforms
...
class Table(Object):
    ...
    **STATE MUTABILITY:**
    ...
    def create_sampler(self, exclude_zero_weights: bool = True, weighted: bool = True, shuffle: bool = True) -> Sampler[int]:
    ...
    def from_image_folder(root: str | Path | Url, image_column_name: str = 'image', label_column_name: str = 'label', include_label_column: bool = True, extensions: str | tuple[str, ...] | None = None, table_name: str | None = None, dataset_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None, if_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'reuse', add_weight_column: bool = True, description: str | None = None, extra_columns: dict[str, _SampleTypeStructure] | None = None, *, table_url: Url | Path | str | None = None) -> Table:
        ...
        When `include_label_column` is True, the dataset elements are returned as tuples of a PIL.Image and the integer
        class label. When `include_label_column` is False, images are returned without labels. In this case, `root` will
