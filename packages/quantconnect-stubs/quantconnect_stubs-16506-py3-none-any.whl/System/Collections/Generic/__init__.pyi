...
System_Collections_Generic_OrderedDictionary_TValue = typing.TypeVar("System_Collections_Generic_OrderedDictionary_TValue")
System_Collections_Generic_OrderedDictionary_TKey = typing.TypeVar("System_Collections_Generic_OrderedDictionary_TKey")
...
class OrderedDictionary(typing.Generic[System_Collections_Generic_OrderedDictionary_TKey, System_Collections_Generic_OrderedDictionary_TValue], System.Object, System.Collections.Generic.IDictionary[System_Collections_Generic_OrderedDictionary_TKey, System_Collections_Generic_OrderedDictionary_TValue], System.Collections.Generic.IReadOnlyDictionary[System_Collections_Generic_OrderedDictionary_TKey, System_Collections_Generic_OrderedDictionary_TValue], System.Collections.IDictionary, System.Collections.Generic.IList[System.Collections.Generic.KeyValuePair[System_Collections_Generic_OrderedDictionary_TKey, System_Collections_Generic_OrderedDictionary_TValue]], System.Collections.Generic.IReadOnlyList[System.Collections.Generic.KeyValuePair[System_Collections_Generic_OrderedDictionary_TKey, System_Collections_Generic_OrderedDictionary_TValue]], System.Collections.IList, typing.Iterable[System.Collections.Generic.KeyValuePair[System_Collections_Generic_OrderedDictionary_TKey, System_Collections_Generic_OrderedDictionary_TValue]]):
    ...
    class Enumerator(System.Collections.IDictionaryEnumerator):
        ...
        @property
        def current(self) -> System.Collections.Generic.KeyValuePair[System_Collections_Generic_OrderedDictionary_TKey, System_Collections_Generic_OrderedDictionary_TValue]:
            ...

        def move_next(self) -> bool:
            ...

    class KeyCollection(System.Object, System.Collections.Generic.IList[System_Collections_Generic_OrderedDictionary_TKey], System.Collections.Generic.IReadOnlyList[System_Collections_Generic_OrderedDictionary_TKey], System.Collections.IList, typing.Iterable[System_Collections_Generic_OrderedDictionary_TKey]):
        """Represents the collection of keys in a OrderedDictionary{TKey, TValue}."""

        class Enumerator:
            """Enumerates the elements of a OrderedDictionary{TKey, TValue}.KeyCollection."""

            @property
            def current(self) -> System_Collections_Generic_OrderedDictionary_TKey:
                ...
        ...
        def __contains__(self, key: System_Collections_Generic_OrderedDictionary_TKey) -> bool:
            ...

        def __len__(self) -> int:
            ...

        def contains(self, key: System_Collections_Generic_OrderedDictionary_TKey) -> bool:
            ...

        def copy_to(self, array: typing.List[System_Collections_Generic_OrderedDictionary_TKey], array_index: int) -> None:
            ...

        def get_enumerator(self) -> System.Collections.Generic.OrderedDictionary.KeyCollection.Enumerator:
            """
            Returns an enumerator that iterates through the OrderedDictionary{TKey, TValue}.KeyCollection.
            
            :returns: A OrderedDictionary{TKey, TValue}.KeyCollection.Enumerator for the OrderedDictionary{TKey, TValue}.KeyCollection.
            """
            ...

    class ValueCollection(System.Object, System.Collections.Generic.IList[System_Collections_Generic_OrderedDictionary_TValue], System.Collections.Generic.IReadOnlyList[System_Collections_Generic_OrderedDictionary_TValue], System.Collections.IList, typing.Iterable[System_Collections_Generic_OrderedDictionary_TValue]):
        """Represents the collection of values in a OrderedDictionary{TKey, TValue}."""

        class Enumerator:
            """Enumerates the elements of a OrderedDictionary{TKey, TValue}.ValueCollection."""

            @property
            def current(self) -> System_Collections_Generic_OrderedDictionary_TValue:
                ...
        ...
        def copy_to(self, array: typing.List[System_Collections_Generic_OrderedDictionary_TValue], array_index: int) -> None:
            ...

        def get_enumerator(self) -> System.Collections.Generic.OrderedDictionary.ValueCollection.Enumerator:
            """
            Returns an enumerator that iterates through the OrderedDictionary{TKey, TValue}.ValueCollection.
            
            :returns: A OrderedDictionary{TKey, TValue}.ValueCollection.Enumerator for the OrderedDictionary{TKey, TValue}.ValueCollection.
            """
            ...
    ...
    @property
    def comparer(self) -> System.Collections.Generic.IEqualityComparer[System_Collections_Generic_OrderedDictionary_TKey]:
        """Gets the IEqualityComparer{TKey} that is used to determine equality of keys for the dictionary."""
        ...

    @property
    def count(self) -> int:
        """Gets the number of key/value pairs contained in the OrderedDictionary{TKey, TValue}."""
        ...

    @property
    def keys(self) -> System.Collections.Generic.OrderedDictionary.KeyCollection:
        """Gets a collection containing the keys in the OrderedDictionary{TKey, TValue}."""
        ...

    @property
    def values(self) -> System.Collections.Generic.OrderedDictionary.ValueCollection:
    ...
    def __contains__(self, key: System_Collections_Generic_OrderedDictionary_TKey) -> bool:
        ...
        :param key: The key to locate in the OrderedDictionary{TKey, TValue}.
        :returns: true if the OrderedDictionary{TKey, TValue} contains an element with the specified key; otherwise, false.
        """
        ...

    def __getitem__(self, key: System_Collections_Generic_OrderedDictionary_TKey) -> System_Collections_Generic_OrderedDictionary_TValue:
        """
        Gets or sets the value associated with the specified key.
        
        :param key: The key of the value to get or set.
        :returns: The value associated with the specified key. If the specified key is not found, a get operation throws a KeyNotFoundException, and a set operation creates a new element with the specified key.
        """
        ...
    ...
    def __init__(self, capacity: int) -> None:
        ...
        :param capacity: The initial number of elements that the OrderedDictionary{TKey, TValue} can contain.
        """
        ...

    @overload
    def __init__(self, comparer: System.Collections.Generic.IEqualityComparer[System_Collections_Generic_OrderedDictionary_TKey]) -> None:
        """
        Initializes a new instance of the OrderedDictionary{TKey, TValue} class that is empty,
        has the default initial capacity, and uses the specified IEqualityComparer{TKey}.
        
        :param comparer: The IEqualityComparer{TKey} implementation to use when comparing keys, or null to use the default EqualityComparer{TKey} for the type of the key.
        """
        ...

    @overload
    def __init__(self, capacity: int, comparer: System.Collections.Generic.IEqualityComparer[System_Collections_Generic_OrderedDictionary_TKey]) -> None:
        """
        Initializes a new instance of the OrderedDictionary{TKey, TValue} class that is empty,
        has the specified initial capacity, and uses the specified IEqualityComparer{TKey}.
    ...
    @overload
    def __init__(self, dictionary: System.Collections.Generic.IDictionary[System_Collections_Generic_OrderedDictionary_TKey, System_Collections_Generic_OrderedDictionary_TValue]) -> None:
        """
        ...
        :param dictionary: The IDictionary{TKey, TValue} whose elements are copied to the new OrderedDictionary{TKey, TValue}. The initial order of the elements in the new collection is the order the elements are enumerated from the supplied dictionary.
        """
        ...

    @overload
    def __init__(self, dictionary: System.Collections.Generic.IDictionary[System_Collections_Generic_OrderedDictionary_TKey, System_Collections_Generic_OrderedDictionary_TValue], comparer: System.Collections.Generic.IEqualityComparer[System_Collections_Generic_OrderedDictionary_TKey]) -> None:
        """
        Initializes a new instance of the OrderedDictionary{TKey, TValue} class that contains elements copied from
        the specified IDictionary{TKey, TValue} and uses the specified IEqualityComparer{TKey}.
    ...
    @overload
    def __init__(self, collection: System.Collections.Generic.IEnumerable[System.Collections.Generic.KeyValuePair[System_Collections_Generic_OrderedDictionary_TKey, System_Collections_Generic_OrderedDictionary_TValue]]) -> None:
        """
        ...
        :param collection: The IEnumerable{T} whose elements are copied to the new OrderedDictionary{TKey, TValue}. The initial order of the elements in the new collection is the order the elements are enumerated from the supplied collection.
        """
        ...

    @overload
    def __init__(self, collection: System.Collections.Generic.IEnumerable[System.Collections.Generic.KeyValuePair[System_Collections_Generic_OrderedDictionary_TKey, System_Collections_Generic_OrderedDictionary_TValue]], comparer: System.Collections.Generic.IEqualityComparer[System_Collections_Generic_OrderedDictionary_TKey]) -> None:
        """
        Initializes a new instance of the OrderedDictionary{TKey, TValue} class that contains elements copied
        from the specified IEnumerable{T} and uses the specified IEqualityComparer{TKey}.
    ...
    def __setitem__(self, key: System_Collections_Generic_OrderedDictionary_TKey, value: System_Collections_Generic_OrderedDictionary_TValue) -> None:
        """
        Gets or sets the value associated with the specified key.
    ...
    def add(self, key: System_Collections_Generic_OrderedDictionary_TKey, value: System_Collections_Generic_OrderedDictionary_TValue) -> None:
        """
    ...
    def clear(self) -> None:
        """Removes all keys and values from the OrderedDictionary{TKey, TValue}."""
        ...

    def contains_key(self, key: System_Collections_Generic_OrderedDictionary_TKey) -> bool:
        """
        Determines whether the OrderedDictionary{TKey, TValue} contains the specified key.
    ...
    def contains_value(self, value: System_Collections_Generic_OrderedDictionary_TValue) -> bool:
        """
        Determines whether the OrderedDictionary{TKey, TValue} contains a specific value.
        
        :param value: The value to locate in the OrderedDictionary{TKey, TValue}. The value can be null for reference types.
        :returns: true if the OrderedDictionary{TKey, TValue} contains an element with the specified value; otherwise, false.
        """
        ...
    ...
    def ensure_capacity(self, capacity: int) -> int:
        ...
        :param capacity: The desired minimum capacity of the dictionary. The actual capacity provided may be larger.
        :returns: The new capacity of the dictionary.
        """
        ...

    def get_at(self, index: int) -> System.Collections.Generic.KeyValuePair[System_Collections_Generic_OrderedDictionary_TKey, System_Collections_Generic_OrderedDictionary_TValue]:
        """
        Gets the key/value pair at the specified index.
        
        :param index: The zero-based index of the pair to get.
        :returns: The element at the specified index.
        """
        ...

    def get_enumerator(self) -> System.Collections.Generic.OrderedDictionary.Enumerator:
        """
        Returns an enumerator that iterates through the OrderedDictionary{TKey, TValue}.
        
        :returns: A OrderedDictionary{TKey, TValue}.Enumerator structure for the OrderedDictionary{TKey, TValue}.
        """
        ...

    def index_of(self, key: System_Collections_Generic_OrderedDictionary_TKey) -> int:
        """
        Determines the index of a specific key in the OrderedDictionary{TKey, TValue}.
        
        :param key: The key to locate.
        :returns: The index of  if found; otherwise, -1.
        """
        ...

    def insert(self, index: int, key: System_Collections_Generic_OrderedDictionary_TKey, value: System_Collections_Generic_OrderedDictionary_TValue) -> None:
        """
    ...
    @overload
    def remove(self, key: System_Collections_Generic_OrderedDictionary_TKey) -> bool:
        """
        Removes the value with the specified key from the OrderedDictionary{TKey, TValue}.
    ...
    @overload
    def remove(self, key: System_Collections_Generic_OrderedDictionary_TKey, value: typing.Optional[System_Collections_Generic_OrderedDictionary_TValue]) -> typing.Union[bool, System_Collections_Generic_OrderedDictionary_TValue]:
        """
    ...
    @overload
    def set_at(self, index: int, value: System_Collections_Generic_OrderedDictionary_TValue) -> None:
        """
    ...
    @overload
    def set_at(self, index: int, key: System_Collections_Generic_OrderedDictionary_TKey, value: System_Collections_Generic_OrderedDictionary_TValue) -> None:
        """
    ...
    def trim_excess(self, capacity: int) -> None:
        ...
        :param capacity: The desired capacity to which to shrink the dictionary.
        """
        ...

    def try_add(self, key: System_Collections_Generic_OrderedDictionary_TKey, value: System_Collections_Generic_OrderedDictionary_TValue) -> bool:
        """
        Adds the specified key and value to the dictionary if the key doesn't already exist.
        
        :param key: The key of the element to add.
        :param value: The value of the element to add. The value can be null for reference types.
        :returns: true if the key didn't exist and the key and value were added to the dictionary; otherwise, false.
        """
        ...

    def try_get_value(self, key: System_Collections_Generic_OrderedDictionary_TKey, value: typing.Optional[System_Collections_Generic_OrderedDictionary_TValue]) -> typing.Union[bool, System_Collections_Generic_OrderedDictionary_TValue]:
        """
