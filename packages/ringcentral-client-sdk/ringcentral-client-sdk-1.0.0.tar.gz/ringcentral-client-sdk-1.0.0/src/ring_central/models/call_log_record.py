...
class CallLogRecord(BaseModel):
    ...
    :param last_modified_time: For 'Detailed' view only. The datetime when the call log record<br>was modified in (ISO 8601)[https://en.wikipedia.org/wiki/ISO_8601] format<br>including timezone, for example *2016-03-10T18:07:52.534Z*<br>, defaults to None
