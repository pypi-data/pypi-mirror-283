...
@JsonMap({})
class WirelessPointsList(BaseModel):
    """WirelessPointsList

    :param uri: Link to a wireless points resource, defaults to None
    :type uri: str, optional
    :param records: List of wireless points with assigned emergency addresses, defaults to None
    ...
    def __init__(
        self,
        uri: str = None,
        records: List[WirelessPointInfo] = None,
