...
class ServiceInfoPlanFreemiumProductType(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ServiceInfoPlanFreemiumProductType._member_map_.values(),
            )
        )


@JsonMap({"id_": "id", "freemium_product_type": "freemiumProductType"})
class ServiceInfoPlan(BaseModel):
    ...
    :type freemium_product_type: ServiceInfoPlanFreemiumProductType, optional
    """
    ...
    def __init__(
        ...
        name: str = None,
        edition: str = None,
        freemium_product_type: ServiceInfoPlanFreemiumProductType = None,
    ):
        if id_ is not None:
            self.id_ = id_
        if name is not None:
        ...
        if freemium_product_type is not None:
            self.freemium_product_type = self._enum_matching(
                ...
                ServiceInfoPlanFreemiumProductType.list(),
                "freemium_product_type",
            )
