...
@JsonMap({})
class CallRecordingExtensions(BaseModel):
    """CallRecordingExtensions

    :param uri: Link to call recording extension list resource, defaults to None
    :type uri: str, optional
    :param records: records, defaults to None
    :type records: List[CallRecordingExtensionInfo], optional
    ...
    def __init__(
        self,
        uri: str = None,
        records: List[CallRecordingExtensionInfo] = None,
        ...
        if records is not None:
            self.records = self._define_list(records, CallRecordingExtensionInfo)
