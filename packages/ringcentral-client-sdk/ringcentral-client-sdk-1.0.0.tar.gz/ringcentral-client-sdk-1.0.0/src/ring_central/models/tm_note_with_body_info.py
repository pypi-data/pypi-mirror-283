...
class TmNoteWithBodyInfoStatus(Enum):
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, TmNoteWithBodyInfoStatus._member_map_.values())
        )


class TmNoteWithBodyInfoType(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, TmNoteWithBodyInfoType._member_map_.values())
        )
...
class TmNoteWithBodyInfo(BaseModel):
    """TmNoteWithBodyInfo
    ...
    :type status: TmNoteWithBodyInfoStatus, optional
    ...
    :type type_: TmNoteWithBodyInfoType, optional
    :param body: Text of a note, defaults to None
    ...
    def __init__(
        ...
        status: TmNoteWithBodyInfoStatus = None,
        creation_time: str = None,
        last_modified_time: str = None,
        type_: TmNoteWithBodyInfoType = None,
        body: str = None,
    ):
        if id_ is not None:
            self.id_ = id_
        ...
        if status is not None:
            self.status = self._enum_matching(
                status, TmNoteWithBodyInfoStatus.list(), "status"
            )
        ...
        if type_ is not None:
            self.type_ = self._enum_matching(
                type_, TmNoteWithBodyInfoType.list(), "type_"
            )
        if body is not None:
            self.body = body
