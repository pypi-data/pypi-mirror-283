...
class ScimUserResponseSchemas(Enum):
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, ScimUserResponseSchemas._member_map_.values())
        )
...
class ScimUserResponse(BaseModel):
    ...
    :type schemas: List[ScimUserResponseSchemas]
    ...
    def __init__(
        ...
        self.schemas = self._define_list(schemas, ScimUserResponseSchemas)
