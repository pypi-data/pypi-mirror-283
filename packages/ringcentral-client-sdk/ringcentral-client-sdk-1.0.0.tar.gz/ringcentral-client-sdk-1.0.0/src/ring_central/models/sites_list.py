...
class SitesList(BaseModel):
    ...
    :param uri: Link to a sites resource, defaults to None
    :type uri: str, optional
    :param records: records, defaults to None
    :type records: List[SiteInfo], optional
    ...
    def __init__(
        ...
        if records is not None:
            self.records = self._define_list(records, SiteInfo)
