...
class AggregationRequest(BaseModel):
    ...
    :param response_options: This field provides mapping of possible breakdown options for call aggregation and aggregation formula
    :type response_options: AggregationResponseOptions
    """
    ...
    def __init__(
        ...
        grouping: Grouping,
        time_settings: TimeSettings,
        response_options: AggregationResponseOptions,
