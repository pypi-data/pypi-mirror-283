...
class ScimResourceTypeSearchResponseSchemas(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ScimResourceTypeSearchResponseSchemas._member_map_.values(),
            )
        )
...
class ScimResourceTypeSearchResponse(BaseModel):
    """ScimResourceTypeSearchResponse

    :param resources: Resource type list, defaults to None
    :type resources: List[ScimResourceTypeResponse], optional
    ...
    :type schemas: List[ScimResourceTypeSearchResponseSchemas], optional
    ...
    def __init__(
        self,
        resources: List[ScimResourceTypeResponse] = None,
        items_per_page: int = None,
        schemas: List[ScimResourceTypeSearchResponseSchemas] = None,
        start_index: int = None,
        total_results: int = None,
    ):
        if resources is not None:
            self.resources = self._define_list(resources, ScimResourceTypeResponse)
        if items_per_page is not None:
            self.items_per_page = items_per_page
        if schemas is not None:
            self.schemas = self._define_list(
                schemas, ScimResourceTypeSearchResponseSchemas
            )
