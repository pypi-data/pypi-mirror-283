...
@JsonMap({})
class GetStateListResponse(BaseModel):
    """GetStateListResponse

    :param uri: Link to a states list resource, defaults to None
    :type uri: str, optional
    :param records: List of states, defaults to None
    :type records: List[GetStateInfoResponse], optional
    ...
    def __init__(
        self,
        uri: str = None,
        records: List[GetStateInfoResponse] = None,
        ...
        if records is not None:
            self.records = self._define_list(records, GetStateInfoResponse)
