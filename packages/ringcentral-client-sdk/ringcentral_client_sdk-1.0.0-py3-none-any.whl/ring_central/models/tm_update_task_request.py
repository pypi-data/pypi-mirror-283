...
@JsonMap({"id_": "id"})
class TmUpdateTaskRequestAssignees(BaseModel):
...
class TmUpdateTaskRequestCompletenessCondition(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                TmUpdateTaskRequestCompletenessCondition._member_map_.values(),
            )
        )


class TmUpdateTaskRequestColor(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, TmUpdateTaskRequestColor._member_map_.values())
        )
...
class TmUpdateTaskRequest(BaseModel):
    """TmUpdateTaskRequest

    :param subject: Task name/subject. Max allowed length is 250 characters., defaults to None
    :type subject: str, optional
    :param assignees: assignees, defaults to None
    :type assignees: List[TmUpdateTaskRequestAssignees], optional
    :param completeness_condition: completeness_condition, defaults to None
    :type completeness_condition: TmUpdateTaskRequestCompletenessCondition, optional
    ...
    :type color: TmUpdateTaskRequestColor, optional
    ...
    def __init__(
        self,
        subject: str = None,
        assignees: List[TmUpdateTaskRequestAssignees] = None,
        completeness_condition: TmUpdateTaskRequestCompletenessCondition = None,
        start_date: str = None,
        due_date: str = None,
        color: TmUpdateTaskRequestColor = None,
        section: str = None,
        ...
        if assignees is not None:
            self.assignees = self._define_list(assignees, TmUpdateTaskRequestAssignees)
        if completeness_condition is not None:
            self.completeness_condition = self._enum_matching(
                completeness_condition,
                TmUpdateTaskRequestCompletenessCondition.list(),
                "completeness_condition",
            )
        ...
        if color is not None:
            self.color = self._enum_matching(
                color, TmUpdateTaskRequestColor.list(), "color"
            )
