...
class IdentifyInputEncoding(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, IdentifyInputEncoding._member_map_.values()))


class IdentifyInputAudioType(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, IdentifyInputAudioType._member_map_.values())
        )
...
class IdentifyInput(BaseModel):
    ...
    :type encoding: IdentifyInputEncoding, optional
    ...
    :type audio_type: IdentifyInputAudioType, optional
    :param speaker_ids: Set of enrolled speakers to be identified from the media., defaults to None
    ...
    def __init__(
        ...
        encoding: IdentifyInputEncoding = None,
        language_code: str = None,
        source: str = None,
        audio_type: IdentifyInputAudioType = None,
        ...
        if encoding is not None:
            self.encoding = self._enum_matching(
                encoding, IdentifyInputEncoding.list(), "encoding"
            )
        ...
        if audio_type is not None:
            self.audio_type = self._enum_matching(
                audio_type, IdentifyInputAudioType.list(), "audio_type"
            )
