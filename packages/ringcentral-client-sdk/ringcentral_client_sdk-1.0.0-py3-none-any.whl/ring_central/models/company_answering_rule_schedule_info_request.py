...
class CompanyAnsweringRuleScheduleInfoRequestRef(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                CompanyAnsweringRuleScheduleInfoRequestRef._member_map_.values(),
            )
        )


@JsonMap({"weekly_ranges": "weeklyRanges"})
class CompanyAnsweringRuleScheduleInfoRequest(BaseModel):
    ...
    :param ref: Reference to Business Hours or After Hours schedule, defaults to None
    :type ref: CompanyAnsweringRuleScheduleInfoRequestRef, optional
    """
    ...
    def __init__(
        ...
        ref: CompanyAnsweringRuleScheduleInfoRequestRef = None,
    ):
        ...
        if ref is not None:
            self.ref = self._enum_matching(
                ref, CompanyAnsweringRuleScheduleInfoRequestRef.list(), "ref"
            )
