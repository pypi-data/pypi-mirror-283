...
@JsonMap({})
class IvrPrompts(BaseModel):
    """IvrPrompts

    :param uri: Link to prompts library resource, defaults to None
    :type uri: str, optional
    :param records: List of Prompts, defaults to None
    :type records: List[PromptInfo], optional
    ...
    def __init__(
        ...
        if records is not None:
            self.records = self._define_list(records, PromptInfo)
