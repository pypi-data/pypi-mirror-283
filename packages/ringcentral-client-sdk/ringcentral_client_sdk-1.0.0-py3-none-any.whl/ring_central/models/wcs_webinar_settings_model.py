...
class WcsWebinarSettingsModel(BaseModel):
    ...
    :param recording_deletion_enabled: DEPRECATED AND REPLACED BY 'pastSessionDeletionEnabled' setting.<br>Indicates if recording can be deleted (this setting is read-only at webinar level)<br>, defaults to None
    ...
    :param password: Webinar password. If company-level "passwordEnabled" is true and "password" is null / omitted,<br>the backend generates the password<br>, defaults to None
