...
@JsonMap({})
class AutomaticLocationUpdatesUserList(BaseModel):
    """AutomaticLocationUpdatesUserList

    :param uri: Link to the users list resource, defaults to None
    :type uri: str, optional
    :param records: records, defaults to None
    :type records: List[AutomaticLocationUpdatesUserInfo], optional
    ...
    def __init__(
        self,
        uri: str = None,
        records: List[AutomaticLocationUpdatesUserInfo] = None,
        ...
        if records is not None:
            self.records = self._define_list(records, AutomaticLocationUpdatesUserInfo)
