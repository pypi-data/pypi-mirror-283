...
class AsrInputEncoding(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, AsrInputEncoding._member_map_.values()))


class AsrInputAudioType(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, AsrInputAudioType._member_map_.values()))
...
class AsrInput(BaseModel):
    ...
    :type encoding: AsrInputEncoding, optional
    ...
    :type audio_type: AsrInputAudioType, optional
    :param separate_speaker_per_channel: Indicates that the input audio is multi-channel and each channel has a separate speaker., defaults to None
    ...
    :param enable_punctuation: Enables Smart Punctuation API., defaults to None
    :type enable_punctuation: bool, optional
    :param enable_speaker_diarization: Tags each word corresponding to the speaker., defaults to None
    :type enable_speaker_diarization: bool, optional
    ...
    def __init__(
        ...
        encoding: AsrInputEncoding = None,
        language_code: str = None,
        source: str = None,
        audio_type: AsrInputAudioType = None,
        ...
        if encoding is not None:
            self.encoding = self._enum_matching(
                encoding, AsrInputEncoding.list(), "encoding"
            )
        ...
        if audio_type is not None:
            self.audio_type = self._enum_matching(
                audio_type, AsrInputAudioType.list(), "audio_type"
            )
