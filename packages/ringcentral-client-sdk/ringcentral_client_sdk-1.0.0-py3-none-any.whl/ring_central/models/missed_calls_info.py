...
class MissedCallsInfo(BaseModel):
    ...
    :param advanced_email_addresses: List of recipient email addresses for missed call notifications.<br>Returned if specified, in both modes (advanced/basic). Applied in advanced<br>mode only<br>, defaults to None
    :type advanced_email_addresses: List[str], optional
    :param advanced_sms_email_addresses: List of recipient phone numbers for missed call notifications.<br>Returned if specified, in both modes (advanced/basic). Applied in advanced<br>mode only<br>, defaults to None
