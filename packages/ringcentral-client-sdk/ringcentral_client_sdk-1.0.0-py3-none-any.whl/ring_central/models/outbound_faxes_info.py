...
class OutboundFaxesInfo(BaseModel):
    ...
    :param advanced_email_addresses: List of recipient email addresses for outbound fax notifications.<br>Returned if specified, in both modes (advanced/basic). Applied in advanced<br>mode only<br>, defaults to None
    :type advanced_email_addresses: List[str], optional
    :param advanced_sms_email_addresses: List of recipient phone numbers for outbound fax notifications.<br>Returned if specified, in both modes (advanced/basic). Applied in advanced<br>mode only<br>, defaults to None
