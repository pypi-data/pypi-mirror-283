...
class CallsCounters(BaseModel):
    ...
    :param calls_actions: Data for calls with breakdown by action (HoldOff, HoldOn, ParkOn, ParkOff, BlindTransfer, WarmTransfer, DTMFTransfer), defaults to None
    :type calls_actions: CallsByActions, optional
    ...
    :param queue_opportunities: Queue opportunities data for the specified grouping, defaults to None
    :type queue_opportunities: QueueOpportunities, optional
    """
    ...
    def __init__(
        ...
        if calls_actions is not None:
            self.calls_actions = self._define_object(calls_actions, CallsByActions)
