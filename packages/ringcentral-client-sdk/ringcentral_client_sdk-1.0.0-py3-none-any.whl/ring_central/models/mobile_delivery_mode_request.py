...
class MobileDeliveryModeRequestTransportType(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                MobileDeliveryModeRequestTransportType._member_map_.values(),
            )
        )
...
class MobileDeliveryModeRequest(BaseModel):
    ...
    :type transport_type: MobileDeliveryModeRequestTransportType
    ...
    def __init__(
        self,
        transport_type: MobileDeliveryModeRequestTransportType,
        certificate_name: str,
        registration_id: str,
    ):
        self.transport_type = self._enum_matching(
            transport_type,
            MobileDeliveryModeRequestTransportType.list(),
            "transport_type",
        )
