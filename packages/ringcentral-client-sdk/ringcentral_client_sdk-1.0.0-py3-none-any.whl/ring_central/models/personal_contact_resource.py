...
class PersonalContactResource(BaseModel):
    ...
    :param availability: This property has a special meaning only on Address Book Sync<br>(e.g. a contact can be `Deleted`). For simple contact list reading it<br>has always the default value - `Alive`<br>, defaults to None
