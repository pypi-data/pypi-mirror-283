...
class RolesCollectionResource(BaseModel):
    ...
    def __init__(
        self,
        uri: str = None,
        records: List[RoleResource] = None,
        ...
        if records is not None:
            self.records = self._define_list(records, RoleResource)
