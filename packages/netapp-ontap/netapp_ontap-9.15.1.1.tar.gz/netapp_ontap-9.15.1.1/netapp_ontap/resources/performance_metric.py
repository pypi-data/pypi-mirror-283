...
[
    PerformanceMetric(
        {
            "latency": {"read": 148, "other": 0, "write": 216, "total": 199},
            "timestamp": "2019-01-01T23:33:00+00:00",
            "status": "ok",
            "duration": "PT15S",
            "iops": {"read": 1, "other": 0, "write": 5, "total": 6},
            "throughput": {"read": 6826, "other": 0, "write": 205892, "total": 212718},
        }
    )
]
...
[
    PerformanceMetric(
        {
            "latency": {"read": 156, "other": 0, "write": 430, "total": 318},
            "timestamp": "2019-01-01T23:30:00+00:00",
            "status": "ok",
            "duration": "PT30M",
            "iops": {"read": 18, "other": 0, "write": 26, "total": 45},
            "throughput": {
                "read": 268328,
                "other": 0,
                "write": 5556255,
    ...
    PerformanceMetric(
        {
            "latency": {"read": 154, "other": 0, "write": 448, "total": 262},
            "timestamp": "2019-01-01T23:00:00+00:00",
            "status": "ok",
            "duration": "PT30M",
            "iops": {"read": 48, "other": 0, "write": 28, "total": 76},
            "throughput": {
                "read": 474266,
                "other": 0,
                "write": 6121908,
    ...
    PerformanceMetric(
        {
            "latency": {"read": 159, "other": 192, "write": 394, "total": 193},
            "timestamp": "2019-01-01T22:30:00+00:00",
            "status": "ok",
            "duration": "PT30M",
            "iops": {"read": 94, "other": 437, "write": 16, "total": 548},
            "throughput": {
                "read": 540164,
                "other": 26244685,
                "write": 2411356,
    ...
    PerformanceMetric(
        {
            "latency": {"read": 189, "other": 0, "write": 540, "total": 523},
            "timestamp": "2019-01-01T22:00:00+00:00",
            "status": "ok",
            "duration": "PT30M",
            "iops": {"read": 0, "other": 0, "write": 13, "total": 13},
            "throughput": {
                "read": 2842,
                "other": 0,
                "write": 2765407,
