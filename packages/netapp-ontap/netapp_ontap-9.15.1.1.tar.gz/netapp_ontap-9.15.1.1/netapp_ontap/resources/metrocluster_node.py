...
"""
    ...
    if RECLINE_INSTALLED:
        ...
        def metrocluster_node_show(
            fields: List[Choices.define(["automatic_uso", "configuration_state", "dr_group_id", "dr_mirroring_state", "dr_operation_state", "encryption_enabled", "is_mccip", "limit_enforcement", "*"])]=None,
        ) -> ResourceTable:
