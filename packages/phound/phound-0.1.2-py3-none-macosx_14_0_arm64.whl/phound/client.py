...
class Client:
    ...
    def send_message(self,
        ...
        if wait_sent and channel_id == _DEFAULT_CHANNEL_ID:
            chat_event = self._event_listener.wait_event(EventType.CHAT_MESSAGE_SENT)
    ...
    def record_call(
        ...
        self._write(f"record {call_id} {file_path} sgm:{min_smg_len}:{max_sgm_len}:{sgm_overlap}")
    ...
    def _connect(self) -> None:
        ...
        self._write(f"connect {settings.sbc} {uid} {api_key} {settings.persons}", log=False)
