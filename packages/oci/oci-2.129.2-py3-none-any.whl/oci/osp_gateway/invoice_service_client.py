...
class InvoiceServiceClient(object):
    ...
    def download_pdf_content(self, osp_home_region, compartment_id, internal_invoice_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ospgateway/download_pdf_content.py.html>`__ to see an example of how to use download_pdf_content API.
        """
    ...
    def get_invoice(self, osp_home_region, compartment_id, internal_invoice_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ospgateway/get_invoice.py.html>`__ to see an example of how to use get_invoice API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['internalInvoiceId', 'ospHomeRegion', 'compartmentId']
    ...
    def list_invoice_lines(self, osp_home_region, compartment_id, internal_invoice_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ospgateway/list_invoice_lines.py.html>`__ to see an example of how to use list_invoice_lines API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['internalInvoiceId', 'ospHomeRegion', 'compartmentId']
    ...
    def list_invoices(self, osp_home_region, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ospgateway/list_invoices.py.html>`__ to see an example of how to use list_invoices API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def pay_invoice(self, osp_home_region, internal_invoice_id, compartment_id, pay_invoice_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ospgateway/pay_invoice.py.html>`__ to see an example of how to use pay_invoice API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['internalInvoiceId', 'ospHomeRegion', 'compartmentId']
