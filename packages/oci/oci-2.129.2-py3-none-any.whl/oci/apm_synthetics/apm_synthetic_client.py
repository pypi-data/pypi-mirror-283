...
class ApmSyntheticClient(object):
    ...
    def aggregate_network_data(self, apm_domain_id, monitor_id, aggregate_network_data_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/aggregate_network_data.py.html>`__ to see an example of how to use aggregate_network_data API.
        """
    ...
    def create_dedicated_vantage_point(self, apm_domain_id, create_dedicated_vantage_point_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/create_dedicated_vantage_point.py.html>`__ to see an example of how to use create_dedicated_vantage_point API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_monitor(self, apm_domain_id, create_monitor_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/create_monitor.py.html>`__ to see an example of how to use create_monitor API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
    ...
    def create_on_premise_vantage_point(self, apm_domain_id, create_on_premise_vantage_point_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/create_on_premise_vantage_point.py.html>`__ to see an example of how to use create_on_premise_vantage_point API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
    ...
    def create_script(self, apm_domain_id, create_script_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/create_script.py.html>`__ to see an example of how to use create_script API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
    ...
    def create_worker(self, apm_domain_id, on_premise_vantage_point_id, create_worker_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/create_worker.py.html>`__ to see an example of how to use create_worker API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_dedicated_vantage_point(self, apm_domain_id, dedicated_vantage_point_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/delete_dedicated_vantage_point.py.html>`__ to see an example of how to use delete_dedicated_vantage_point API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_monitor(self, apm_domain_id, monitor_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/delete_monitor.py.html>`__ to see an example of how to use delete_monitor API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['monitorId', 'apmDomainId']
    ...
    def delete_on_premise_vantage_point(self, apm_domain_id, on_premise_vantage_point_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/delete_on_premise_vantage_point.py.html>`__ to see an example of how to use delete_on_premise_vantage_point API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['onPremiseVantagePointId', 'apmDomainId']
    ...
    def delete_script(self, apm_domain_id, script_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/delete_script.py.html>`__ to see an example of how to use delete_script API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_worker(self, apm_domain_id, on_premise_vantage_point_id, worker_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/delete_worker.py.html>`__ to see an example of how to use delete_worker API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_dedicated_vantage_point(self, apm_domain_id, dedicated_vantage_point_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/get_dedicated_vantage_point.py.html>`__ to see an example of how to use get_dedicated_vantage_point API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dedicatedVantagePointId', 'apmDomainId']
        resource_path = "/dedicatedVantagePoints/{dedicatedVantagePointId}"
    ...
    def get_monitor(self, apm_domain_id, monitor_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/get_monitor.py.html>`__ to see an example of how to use get_monitor API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['monitorId', 'apmDomainId']
        resource_path = "/monitors/{monitorId}"
    ...
    def get_monitor_result(self, apm_domain_id, monitor_id, vantage_point, result_type, result_content_type, execution_time, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/get_monitor_result.py.html>`__ to see an example of how to use get_monitor_result API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_on_premise_vantage_point(self, apm_domain_id, on_premise_vantage_point_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/get_on_premise_vantage_point.py.html>`__ to see an example of how to use get_on_premise_vantage_point API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['onPremiseVantagePointId', 'apmDomainId']
        resource_path = "/onPremiseVantagePoints/{onPremiseVantagePointId}"
    ...
    def get_script(self, apm_domain_id, script_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/get_script.py.html>`__ to see an example of how to use get_script API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['scriptId', 'apmDomainId']
        resource_path = "/scripts/{scriptId}"
    ...
    def get_worker(self, apm_domain_id, on_premise_vantage_point_id, worker_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/get_worker.py.html>`__ to see an example of how to use get_worker API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['onPremiseVantagePointId', 'workerId', 'apmDomainId']
        resource_path = "/onPremiseVantagePoints/{onPremiseVantagePointId}/workers/{workerId}"
    ...
    def list_dedicated_vantage_points(self, apm_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/list_dedicated_vantage_points.py.html>`__ to see an example of how to use list_dedicated_vantage_points API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
        resource_path = "/dedicatedVantagePoints"
    ...
    def list_monitors(self, apm_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/list_monitors.py.html>`__ to see an example of how to use list_monitors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
        resource_path = "/monitors"
    ...
    def list_on_premise_vantage_points(self, apm_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/list_on_premise_vantage_points.py.html>`__ to see an example of how to use list_on_premise_vantage_points API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
        resource_path = "/onPremiseVantagePoints"
    ...
    def list_public_vantage_points(self, apm_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/list_public_vantage_points.py.html>`__ to see an example of how to use list_public_vantage_points API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
    ...
    def list_scripts(self, apm_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/list_scripts.py.html>`__ to see an example of how to use list_scripts API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
        resource_path = "/scripts"
    ...
    def list_workers(self, apm_domain_id, on_premise_vantage_point_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/list_workers.py.html>`__ to see an example of how to use list_workers API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['onPremiseVantagePointId', 'apmDomainId']
        resource_path = "/onPremiseVantagePoints/{onPremiseVantagePointId}/workers"
    ...
    def update_dedicated_vantage_point(self, apm_domain_id, dedicated_vantage_point_id, update_dedicated_vantage_point_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/update_dedicated_vantage_point.py.html>`__ to see an example of how to use update_dedicated_vantage_point API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dedicatedVantagePointId', 'apmDomainId']
        resource_path = "/dedicatedVantagePoints/{dedicatedVantagePointId}"
    ...
    def update_monitor(self, apm_domain_id, monitor_id, update_monitor_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/update_monitor.py.html>`__ to see an example of how to use update_monitor API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['monitorId', 'apmDomainId']
        resource_path = "/monitors/{monitorId}"
    ...
    def update_on_premise_vantage_point(self, apm_domain_id, on_premise_vantage_point_id, update_on_premise_vantage_point_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/update_on_premise_vantage_point.py.html>`__ to see an example of how to use update_on_premise_vantage_point API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['onPremiseVantagePointId', 'apmDomainId']
        resource_path = "/onPremiseVantagePoints/{onPremiseVantagePointId}"
    ...
    def update_script(self, apm_domain_id, script_id, update_script_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/update_script.py.html>`__ to see an example of how to use update_script API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['scriptId', 'apmDomainId']
        resource_path = "/scripts/{scriptId}"
    ...
    def update_worker(self, apm_domain_id, on_premise_vantage_point_id, worker_id, update_worker_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmsynthetics/update_worker.py.html>`__ to see an example of how to use update_worker API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['onPremiseVantagePointId', 'workerId', 'apmDomainId']
        resource_path = "/onPremiseVantagePoints/{onPremiseVantagePointId}/workers/{workerId}"
