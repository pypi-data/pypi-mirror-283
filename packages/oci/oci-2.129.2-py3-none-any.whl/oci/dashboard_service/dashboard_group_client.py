...
class DashboardGroupClient(object):
    ...
    **Important:** Resources for the Dashboards service are created in the tenacy's home region.
    ...
    def change_dashboard_group_compartment(self, dashboard_group_id, change_dashboard_group_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dashboardservice/change_dashboard_group_compartment.py.html>`__ to see an example of how to use change_dashboard_group_compartment API.
        """
    ...
    def create_dashboard_group(self, create_dashboard_group_details, **kwargs):
        ...
        **Caution:** Resources for the Dashboard service are created in the tenacy's home region.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dashboardservice/create_dashboard_group.py.html>`__ to see an example of how to use create_dashboard_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_dashboard_group(self, dashboard_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dashboardservice/delete_dashboard_group.py.html>`__ to see an example of how to use delete_dashboard_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dashboardGroupId']
    ...
    def get_dashboard_group(self, dashboard_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dashboardservice/get_dashboard_group.py.html>`__ to see an example of how to use get_dashboard_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dashboardGroupId']
        resource_path = "/dashboardGroups/{dashboardGroupId}"
    ...
    def list_dashboard_groups(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dashboardservice/list_dashboard_groups.py.html>`__ to see an example of how to use list_dashboard_groups API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_dashboard_group(self, dashboard_group_id, update_dashboard_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dashboardservice/update_dashboard_group.py.html>`__ to see an example of how to use update_dashboard_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dashboardGroupId']
        resource_path = "/dashboardGroups/{dashboardGroupId}"
