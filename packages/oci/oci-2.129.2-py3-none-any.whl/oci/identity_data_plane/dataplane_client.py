...
class DataplaneClient(object):
    ...
    def generate_scoped_access_token(self, generate_scoped_access_token_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/identitydataplane/generate_scoped_access_token.py.html>`__ to see an example of how to use generate_scoped_access_token API.
        """
    ...
    def generate_user_security_token(self, generate_user_security_token_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/identitydataplane/generate_user_security_token.py.html>`__ to see an example of how to use generate_user_security_token API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
