...
class AIServiceSpeechClient(object):
    ...
    def cancel_transcription_job(self, transcription_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/aispeech/cancel_transcription_job.py.html>`__ to see an example of how to use cancel_transcription_job API.
        """
    ...
    def cancel_transcription_task(self, transcription_job_id, transcription_task_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/aispeech/cancel_transcription_task.py.html>`__ to see an example of how to use cancel_transcription_task API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_transcription_job_compartment(self, transcription_job_id, change_transcription_job_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/aispeech/change_transcription_job_compartment.py.html>`__ to see an example of how to use change_transcription_job_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['transcriptionJobId']
    ...
    def create_transcription_job(self, create_transcription_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/aispeech/create_transcription_job.py.html>`__ to see an example of how to use create_transcription_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_transcription_job(self, transcription_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/aispeech/delete_transcription_job.py.html>`__ to see an example of how to use delete_transcription_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['transcriptionJobId']
    ...
    def get_transcription_job(self, transcription_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/aispeech/get_transcription_job.py.html>`__ to see an example of how to use get_transcription_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['transcriptionJobId']
        resource_path = "/transcriptionJobs/{transcriptionJobId}"
    ...
    def get_transcription_task(self, transcription_job_id, transcription_task_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/aispeech/get_transcription_task.py.html>`__ to see an example of how to use get_transcription_task API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['transcriptionJobId', 'transcriptionTaskId']
    ...
    def list_transcription_jobs(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/aispeech/list_transcription_jobs.py.html>`__ to see an example of how to use list_transcription_jobs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/transcriptionJobs"
    ...
    def list_transcription_tasks(self, transcription_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/aispeech/list_transcription_tasks.py.html>`__ to see an example of how to use list_transcription_tasks API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['transcriptionJobId']
    ...
    def update_transcription_job(self, transcription_job_id, update_transcription_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/aispeech/update_transcription_job.py.html>`__ to see an example of how to use update_transcription_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['transcriptionJobId']
        resource_path = "/transcriptionJobs/{transcriptionJobId}"
