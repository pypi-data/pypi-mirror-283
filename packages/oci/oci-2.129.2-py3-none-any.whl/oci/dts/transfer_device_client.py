...
class TransferDeviceClient(object):
    ...
    def create_transfer_device(self, id, create_transfer_device_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dts/create_transfer_device.py.html>`__ to see an example of how to use create_transfer_device API.
        """
    ...
    def delete_transfer_device(self, id, transfer_device_label, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dts/delete_transfer_device.py.html>`__ to see an example of how to use delete_transfer_device API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_transfer_device(self, id, transfer_device_label, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dts/get_transfer_device.py.html>`__ to see an example of how to use get_transfer_device API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['id', 'transferDeviceLabel']
        resource_path = "/transferJobs/{id}/transferDevices/{transferDeviceLabel}"
    ...
    def list_transfer_devices(self, id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dts/list_transfer_devices.py.html>`__ to see an example of how to use list_transfer_devices API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['id']
        resource_path = "/transferJobs/{id}/transferDevices"
    ...
    def update_transfer_device(self, id, transfer_device_label, update_transfer_device_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dts/update_transfer_device.py.html>`__ to see an example of how to use update_transfer_device API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['id', 'transferDeviceLabel']
        resource_path = "/transferJobs/{id}/transferDevices/{transferDeviceLabel}"
