...
class KmsHsmClusterClient(object):
    ...
    def cancel_hsm_cluster_deletion(self, hsm_cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/cancel_hsm_cluster_deletion.py.html>`__ to see an example of how to use cancel_hsm_cluster_deletion API.
        """
    ...
    def change_hsm_cluster_compartment(self, hsm_cluster_id, change_hsm_cluster_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/change_hsm_cluster_compartment.py.html>`__ to see an example of how to use change_hsm_cluster_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['hsmClusterId']
    ...
    def create_hsm_cluster(self, create_hsm_cluster_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/create_hsm_cluster.py.html>`__ to see an example of how to use create_hsm_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def download_certificate_signing_request(self, hsm_cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/download_certificate_signing_request.py.html>`__ to see an example of how to use download_certificate_signing_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['hsmClusterId']
    ...
    def get_hsm_cluster(self, hsm_cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/get_hsm_cluster.py.html>`__ to see an example of how to use get_hsm_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['hsmClusterId']
    ...
    def get_hsm_partition(self, hsm_cluster_id, hsm_partition_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/get_hsm_partition.py.html>`__ to see an example of how to use get_hsm_partition API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_pre_co_user_credentials(self, hsm_cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/get_pre_co_user_credentials.py.html>`__ to see an example of how to use get_pre_co_user_credentials API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['hsmClusterId']
    ...
    def list_hsm_clusters(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/list_hsm_clusters.py.html>`__ to see an example of how to use list_hsm_clusters API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_hsm_partitions(self, hsm_cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/list_hsm_partitions.py.html>`__ to see an example of how to use list_hsm_partitions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['hsmClusterId']
    ...
    def schedule_hsm_cluster_deletion(self, hsm_cluster_id, schedule_hsm_cluster_deletion_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/schedule_hsm_cluster_deletion.py.html>`__ to see an example of how to use schedule_hsm_cluster_deletion API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['hsmClusterId']
    ...
    def update_hsm_cluster(self, hsm_cluster_id, update_hsm_cluster_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/update_hsm_cluster.py.html>`__ to see an example of how to use update_hsm_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['hsmClusterId']
        resource_path = "/20180608/hsmClusters/{hsmClusterId}"
    ...
    def upload_partition_certificates(self, hsm_cluster_id, upload_partition_certificates_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/upload_partition_certificates.py.html>`__ to see an example of how to use upload_partition_certificates API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['hsmClusterId']
