...
class AttachmentClient(object):
    ...
    def create_attachment(self, create_attachment_details, offer_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/marketplacepublisher/create_attachment.py.html>`__ to see an example of how to use create_attachment API.
        """
    ...
    def delete_attachment(self, offer_id, attachment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/marketplacepublisher/delete_attachment.py.html>`__ to see an example of how to use delete_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_attachment(self, offer_id, attachment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/marketplacepublisher/get_attachment.py.html>`__ to see an example of how to use get_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['offerId', 'attachmentId']
        resource_path = "/offers/{offerId}/attachments/{attachmentId}"
    ...
    def get_attachment_content(self, offer_id, attachment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/marketplacepublisher/get_attachment_content.py.html>`__ to see an example of how to use get_attachment_content API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['offerId', 'attachmentId']
    ...
    def list_attachments(self, offer_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/marketplacepublisher/list_attachments.py.html>`__ to see an example of how to use list_attachments API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['offerId']
        resource_path = "/offers/{offerId}/attachments"
