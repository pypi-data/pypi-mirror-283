...
class DesktopServiceClient(object):
    ...
    def cancel_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/cancel_work_request.py.html>`__ to see an example of how to use cancel_work_request API.
        """
    ...
    def change_desktop_pool_compartment(self, desktop_pool_id, change_desktop_pool_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/change_desktop_pool_compartment.py.html>`__ to see an example of how to use change_desktop_pool_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_desktop_pool(self, create_desktop_pool_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/create_desktop_pool.py.html>`__ to see an example of how to use create_desktop_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_desktop(self, desktop_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/delete_desktop.py.html>`__ to see an example of how to use delete_desktop API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_desktop_pool(self, desktop_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/delete_desktop_pool.py.html>`__ to see an example of how to use delete_desktop_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['desktopPoolId']
    ...
    def get_desktop(self, desktop_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/get_desktop.py.html>`__ to see an example of how to use get_desktop API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['desktopId']
        resource_path = "/desktops/{desktopId}"
    ...
    def get_desktop_pool(self, desktop_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/get_desktop_pool.py.html>`__ to see an example of how to use get_desktop_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['desktopPoolId']
        resource_path = "/desktopPools/{desktopPoolId}"
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
        resource_path = "/workRequests/{workRequestId}"
    ...
    def list_desktop_pool_desktops(self, compartment_id, desktop_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/list_desktop_pool_desktops.py.html>`__ to see an example of how to use list_desktop_pool_desktops API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_desktop_pool_volumes(self, desktop_pool_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/list_desktop_pool_volumes.py.html>`__ to see an example of how to use list_desktop_pool_volumes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['desktopPoolId', 'compartmentId']
    ...
    def list_desktop_pools(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/list_desktop_pools.py.html>`__ to see an example of how to use list_desktop_pools API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_desktops(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/list_desktops.py.html>`__ to see an example of how to use list_desktops API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def start_desktop(self, desktop_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/start_desktop.py.html>`__ to see an example of how to use start_desktop API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['desktopId']
    ...
    def start_desktop_pool(self, desktop_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/start_desktop_pool.py.html>`__ to see an example of how to use start_desktop_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['desktopPoolId']
    ...
    def stop_desktop(self, desktop_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/stop_desktop.py.html>`__ to see an example of how to use stop_desktop API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['desktopId']
    ...
    def stop_desktop_pool(self, desktop_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/stop_desktop_pool.py.html>`__ to see an example of how to use stop_desktop_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['desktopPoolId']
    ...
    def update_desktop(self, desktop_id, update_desktop_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/update_desktop.py.html>`__ to see an example of how to use update_desktop API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['desktopId']
        resource_path = "/desktops/{desktopId}"
    ...
    def update_desktop_pool(self, desktop_pool_id, update_desktop_pool_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/desktops/update_desktop_pool.py.html>`__ to see an example of how to use update_desktop_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['desktopPoolId']
        resource_path = "/desktopPools/{desktopPoolId}"
