...
class LifecycleEnvironmentClient(object):
    ...
    def attach_managed_instances_to_lifecycle_stage(self, lifecycle_stage_id, attach_managed_instances_to_lifecycle_stage_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/osmanagementhub/attach_managed_instances_to_lifecycle_stage.py.html>`__ to see an example of how to use attach_managed_instances_to_lifecycle_stage API.
        """
    ...
    def change_lifecycle_environment_compartment(self, lifecycle_environment_id, change_lifecycle_environment_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/osmanagementhub/change_lifecycle_environment_compartment.py.html>`__ to see an example of how to use change_lifecycle_environment_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_lifecycle_environment(self, create_lifecycle_environment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/osmanagementhub/create_lifecycle_environment.py.html>`__ to see an example of how to use create_lifecycle_environment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_lifecycle_environment(self, lifecycle_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/osmanagementhub/delete_lifecycle_environment.py.html>`__ to see an example of how to use delete_lifecycle_environment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['lifecycleEnvironmentId']
    ...
    def detach_managed_instances_from_lifecycle_stage(self, lifecycle_stage_id, detach_managed_instances_from_lifecycle_stage_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/osmanagementhub/detach_managed_instances_from_lifecycle_stage.py.html>`__ to see an example of how to use detach_managed_instances_from_lifecycle_stage API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['lifecycleStageId']
    ...
    def get_lifecycle_environment(self, lifecycle_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/osmanagementhub/get_lifecycle_environment.py.html>`__ to see an example of how to use get_lifecycle_environment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['lifecycleEnvironmentId']
        resource_path = "/lifecycleEnvironments/{lifecycleEnvironmentId}"
    ...
    def get_lifecycle_stage(self, lifecycle_stage_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/osmanagementhub/get_lifecycle_stage.py.html>`__ to see an example of how to use get_lifecycle_stage API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['lifecycleStageId']
    ...
    def list_lifecycle_environments(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/osmanagementhub/list_lifecycle_environments.py.html>`__ to see an example of how to use list_lifecycle_environments API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/lifecycleEnvironments"
    ...
    def list_lifecycle_stage_installed_packages(self, lifecycle_stage_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/osmanagementhub/list_lifecycle_stage_installed_packages.py.html>`__ to see an example of how to use list_lifecycle_stage_installed_packages API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['lifecycleStageId']
    ...
    def list_lifecycle_stages(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/osmanagementhub/list_lifecycle_stages.py.html>`__ to see an example of how to use list_lifecycle_stages API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def promote_software_source_to_lifecycle_stage(self, lifecycle_stage_id, promote_software_source_to_lifecycle_stage_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/osmanagementhub/promote_software_source_to_lifecycle_stage.py.html>`__ to see an example of how to use promote_software_source_to_lifecycle_stage API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['lifecycleStageId']
    ...
    def update_lifecycle_environment(self, lifecycle_environment_id, update_lifecycle_environment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/osmanagementhub/update_lifecycle_environment.py.html>`__ to see an example of how to use update_lifecycle_environment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['lifecycleEnvironmentId']
        resource_path = "/lifecycleEnvironments/{lifecycleEnvironmentId}"
