...
class OfferClient(object):
    ...
    def create_offer(self, create_offer_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/marketplaceprivateoffer/create_offer.py.html>`__ to see an example of how to use create_offer API.
        """
    ...
    def delete_offer(self, offer_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/marketplaceprivateoffer/delete_offer.py.html>`__ to see an example of how to use delete_offer API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_offer(self, offer_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/marketplaceprivateoffer/get_offer.py.html>`__ to see an example of how to use get_offer API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['offerId']
        resource_path = "/offers/{offerId}"
    ...
    def get_offer_internal_detail(self, offer_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/marketplaceprivateoffer/get_offer_internal_detail.py.html>`__ to see an example of how to use get_offer_internal_detail API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['offerId']
    ...
    def list_offers(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/marketplaceprivateoffer/list_offers.py.html>`__ to see an example of how to use list_offers API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/offers"
    ...
    def update_offer(self, offer_id, update_offer_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/marketplaceprivateoffer/update_offer.py.html>`__ to see an example of how to use update_offer API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['offerId']
        resource_path = "/offers/{offerId}"
