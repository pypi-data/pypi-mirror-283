...
class AccessGovernanceCPClient(object):
    ...
    def change_governance_instance_compartment(self, governance_instance_id, change_governance_instance_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/accessgovernancecp/change_governance_instance_compartment.py.html>`__ to see an example of how to use change_governance_instance_compartment API.
        """
    ...
    def create_governance_instance(self, create_governance_instance_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/accessgovernancecp/create_governance_instance.py.html>`__ to see an example of how to use create_governance_instance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_governance_instance(self, governance_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/accessgovernancecp/delete_governance_instance.py.html>`__ to see an example of how to use delete_governance_instance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['governanceInstanceId']
    ...
    def get_governance_instance(self, governance_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/accessgovernancecp/get_governance_instance.py.html>`__ to see an example of how to use get_governance_instance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['governanceInstanceId']
        resource_path = "/governanceInstances/{governanceInstanceId}"
    ...
    def get_governance_instance_configuration(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/accessgovernancecp/get_governance_instance_configuration.py.html>`__ to see an example of how to use get_governance_instance_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_governance_instances(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/accessgovernancecp/list_governance_instances.py.html>`__ to see an example of how to use list_governance_instances API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/governanceInstances"
    ...
    def update_governance_instance(self, update_governance_instance_details, governance_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/accessgovernancecp/update_governance_instance.py.html>`__ to see an example of how to use update_governance_instance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['governanceInstanceId']
        resource_path = "/governanceInstances/{governanceInstanceId}"
    ...
    def update_governance_instance_configuration(self, update_governance_instance_configuration_details, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/accessgovernancecp/update_governance_instance_configuration.py.html>`__ to see an example of how to use update_governance_instance_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/governanceInstances/configuration"
