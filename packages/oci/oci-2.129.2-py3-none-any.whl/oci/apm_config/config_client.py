...
class ConfigClient(object):
    ...
    def create_config(self, apm_domain_id, create_config_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmconfig/create_config.py.html>`__ to see an example of how to use create_config API.
        """
    ...
    def delete_config(self, apm_domain_id, config_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmconfig/delete_config.py.html>`__ to see an example of how to use delete_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_config(self, apm_domain_id, config_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmconfig/get_config.py.html>`__ to see an example of how to use get_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['configId', 'apmDomainId']
        resource_path = "/configs/{configId}"
    ...
    def list_configs(self, apm_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmconfig/list_configs.py.html>`__ to see an example of how to use list_configs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
        resource_path = "/configs"
    ...
    def retrieve_namespace_metrics(self, apm_domain_id, retrieve_namespace_metrics_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmconfig/retrieve_namespace_metrics.py.html>`__ to see an example of how to use retrieve_namespace_metrics API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
    ...
    def retrieve_namespaces(self, apm_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmconfig/retrieve_namespaces.py.html>`__ to see an example of how to use retrieve_namespaces API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
    ...
    def test(self, apm_domain_id, test_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmconfig/test.py.html>`__ to see an example of how to use test API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
    ...
    def update_config(self, apm_domain_id, config_id, update_config_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmconfig/update_config.py.html>`__ to see an example of how to use update_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['configId', 'apmDomainId']
        resource_path = "/configs/{configId}"
    ...
    def validate_span_filter_pattern(self, apm_domain_id, validate_span_filter_pattern_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmconfig/validate_span_filter_pattern.py.html>`__ to see an example of how to use validate_span_filter_pattern API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
