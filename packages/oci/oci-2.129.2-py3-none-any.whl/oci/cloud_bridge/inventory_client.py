...
class InventoryClient(object):
    ...
    def analyze_assets(self, compartment_id, aggregation_properties, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/analyze_assets.py.html>`__ to see an example of how to use analyze_assets API.
        """
    ...
    def change_asset_compartment(self, asset_id, change_asset_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/change_asset_compartment.py.html>`__ to see an example of how to use change_asset_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_asset_tags(self, asset_id, change_asset_tags_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/change_asset_tags.py.html>`__ to see an example of how to use change_asset_tags API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['assetId']
    ...
    def create_asset(self, create_asset_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/create_asset.py.html>`__ to see an example of how to use create_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_inventory(self, create_inventory_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/create_inventory.py.html>`__ to see an example of how to use create_inventory API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_asset(self, asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/delete_asset.py.html>`__ to see an example of how to use delete_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['assetId']
    ...
    def delete_inventory(self, inventory_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/delete_inventory.py.html>`__ to see an example of how to use delete_inventory API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_asset(self, asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/get_asset.py.html>`__ to see an example of how to use get_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['assetId']
        resource_path = "/assets/{assetId}"
    ...
    def get_inventory(self, inventory_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/get_inventory.py.html>`__ to see an example of how to use get_inventory API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['inventoryId']
        resource_path = "/inventories/{inventoryId}"
    ...
    def import_inventory(self, import_inventory_details, inventory_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/import_inventory.py.html>`__ to see an example of how to use import_inventory API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['inventoryId']
    ...
    def list_assets(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/list_assets.py.html>`__ to see an example of how to use list_assets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_historical_metrics(self, asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/list_historical_metrics.py.html>`__ to see an example of how to use list_historical_metrics API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['assetId']
    ...
    def list_inventories(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/list_inventories.py.html>`__ to see an example of how to use list_inventories API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/inventories"
    ...
    def submit_historical_metrics(self, submit_historical_metrics_details, asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/submit_historical_metrics.py.html>`__ to see an example of how to use submit_historical_metrics API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['assetId']
    ...
    def update_asset(self, asset_id, update_asset_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/update_asset.py.html>`__ to see an example of how to use update_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['assetId']
        resource_path = "/assets/{assetId}"
    ...
    def update_inventory(self, inventory_id, update_inventory_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/update_inventory.py.html>`__ to see an example of how to use update_inventory API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['inventoryId']
        resource_path = "/inventories/{inventoryId}"
