...
class OrganizationSubscriptionClient(object):
    ...
    def list_organization_subscriptions(self, compartment_id, subscription_ids, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/osuborganizationsubscription/list_organization_subscriptions.py.html>`__ to see an example of how to use list_organization_subscriptions API.
        """
