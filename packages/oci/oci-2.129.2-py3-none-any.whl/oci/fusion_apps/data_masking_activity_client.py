...
class DataMaskingActivityClient(object):
    ...
    def create_data_masking_activity(self, fusion_environment_id, create_data_masking_activity_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/create_data_masking_activity.py.html>`__ to see an example of how to use create_data_masking_activity API.
        """
    ...
    def get_data_masking_activity(self, fusion_environment_id, data_masking_activity_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/get_data_masking_activity.py.html>`__ to see an example of how to use get_data_masking_activity API.
        """
    ...
    def list_data_masking_activities(self, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/list_data_masking_activities.py.html>`__ to see an example of how to use list_data_masking_activities API.
        """
        resource_path = "/fusionEnvironments/{fusionEnvironmentId}/dataMaskingActivities"
        method = "GET"
