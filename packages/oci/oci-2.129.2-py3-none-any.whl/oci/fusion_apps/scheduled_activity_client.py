...
class ScheduledActivityClient(object):
    ...
    def get_scheduled_activity(self, fusion_environment_id, scheduled_activity_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/get_scheduled_activity.py.html>`__ to see an example of how to use get_scheduled_activity API.
        """
    ...
    def list_scheduled_activities(self, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/list_scheduled_activities.py.html>`__ to see an example of how to use list_scheduled_activities API.
        """
