...
class RefreshActivityClient(object):
    ...
    def create_refresh_activity(self, fusion_environment_id, create_refresh_activity_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/create_refresh_activity.py.html>`__ to see an example of how to use create_refresh_activity API.
        """
    ...
    def get_refresh_activity(self, fusion_environment_id, refresh_activity_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/get_refresh_activity.py.html>`__ to see an example of how to use get_refresh_activity API.
        """
    ...
    def list_refresh_activities(self, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/list_refresh_activities.py.html>`__ to see an example of how to use list_refresh_activities API.
        """
        resource_path = "/fusionEnvironments/{fusionEnvironmentId}/refreshActivities"
        method = "GET"
    ...
    def list_time_available_for_refreshes(self, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/list_time_available_for_refreshes.py.html>`__ to see an example of how to use list_time_available_for_refreshes API.
        """
