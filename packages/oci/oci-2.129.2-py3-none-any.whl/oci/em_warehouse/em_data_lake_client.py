...
class EmDataLakeClient(object):
    ...
    def cancel_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/emwarehouse/cancel_work_request.py.html>`__ to see an example of how to use cancel_work_request API.
        """
    ...
    def change_em_warehouse_compartment(self, em_warehouse_id, change_em_warehouse_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/emwarehouse/change_em_warehouse_compartment.py.html>`__ to see an example of how to use change_em_warehouse_compartment API.
        """
    ...
    def create_em_warehouse(self, create_em_warehouse_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/emwarehouse/create_em_warehouse.py.html>`__ to see an example of how to use create_em_warehouse API.
        """
    ...
    def delete_em_warehouse(self, em_warehouse_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/emwarehouse/delete_em_warehouse.py.html>`__ to see an example of how to use delete_em_warehouse API.
        """
    ...
    def get_em_warehouse(self, em_warehouse_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/emwarehouse/get_em_warehouse.py.html>`__ to see an example of how to use get_em_warehouse API.
        """
        resource_path = "/emWarehouses/{emWarehouseId}"
        method = "GET"
    ...
    def get_em_warehouse_resource_usage(self, em_warehouse_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/emwarehouse/get_em_warehouse_resource_usage.py.html>`__ to see an example of how to use get_em_warehouse_resource_usage API.
        """
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/emwarehouse/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        resource_path = "/workRequests/{workRequestId}"
        method = "GET"
    ...
    def list_em_warehouses(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/emwarehouse/list_em_warehouses.py.html>`__ to see an example of how to use list_em_warehouses API.
        """
        resource_path = "/emWarehouses"
        method = "GET"
    ...
    def list_etl_runs(self, em_warehouse_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/emwarehouse/list_etl_runs.py.html>`__ to see an example of how to use list_etl_runs API.
        """
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/emwarehouse/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/emwarehouse/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
    ...
    def list_work_requests(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/emwarehouse/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
    ...
    def update_em_warehouse(self, em_warehouse_id, update_em_warehouse_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/emwarehouse/update_em_warehouse.py.html>`__ to see an example of how to use update_em_warehouse API.
        """
        resource_path = "/emWarehouses/{emWarehouseId}"
        method = "PUT"
