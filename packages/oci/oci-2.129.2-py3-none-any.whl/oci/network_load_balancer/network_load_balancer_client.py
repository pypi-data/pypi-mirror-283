...
class NetworkLoadBalancerClient(object):
    ...
    def change_network_load_balancer_compartment(self, network_load_balancer_id, change_network_load_balancer_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/change_network_load_balancer_compartment.py.html>`__ to see an example of how to use change_network_load_balancer_compartment API.
        """
    ...
    def create_backend(self, network_load_balancer_id, create_backend_details, backend_set_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/create_backend.py.html>`__ to see an example of how to use create_backend API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_backend_set(self, network_load_balancer_id, create_backend_set_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/create_backend_set.py.html>`__ to see an example of how to use create_backend_set API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId']
    ...
    def create_listener(self, network_load_balancer_id, create_listener_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/create_listener.py.html>`__ to see an example of how to use create_listener API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId']
    ...
    def create_network_load_balancer(self, create_network_load_balancer_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/create_network_load_balancer.py.html>`__ to see an example of how to use create_network_load_balancer API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_backend(self, network_load_balancer_id, backend_set_name, backend_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/delete_backend.py.html>`__ to see an example of how to use delete_backend API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_backend_set(self, network_load_balancer_id, backend_set_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/delete_backend_set.py.html>`__ to see an example of how to use delete_backend_set API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId', 'backendSetName']
    ...
    def delete_listener(self, network_load_balancer_id, listener_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/delete_listener.py.html>`__ to see an example of how to use delete_listener API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_network_load_balancer(self, network_load_balancer_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/delete_network_load_balancer.py.html>`__ to see an example of how to use delete_network_load_balancer API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId']
    ...
    def get_backend(self, network_load_balancer_id, backend_set_name, backend_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/get_backend.py.html>`__ to see an example of how to use get_backend API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId', 'backendSetName', 'backendName']
        resource_path = "/networkLoadBalancers/{networkLoadBalancerId}/backendSets/{backendSetName}/backends/{backendName}"
    ...
    def get_backend_health(self, network_load_balancer_id, backend_set_name, backend_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/get_backend_health.py.html>`__ to see an example of how to use get_backend_health API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId', 'backendSetName', 'backendName']
    ...
    def get_backend_set(self, network_load_balancer_id, backend_set_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/get_backend_set.py.html>`__ to see an example of how to use get_backend_set API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId', 'backendSetName']
        resource_path = "/networkLoadBalancers/{networkLoadBalancerId}/backendSets/{backendSetName}"
    ...
    def get_backend_set_health(self, network_load_balancer_id, backend_set_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/get_backend_set_health.py.html>`__ to see an example of how to use get_backend_set_health API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId', 'backendSetName']
    ...
    def get_health_checker(self, network_load_balancer_id, backend_set_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/get_health_checker.py.html>`__ to see an example of how to use get_health_checker API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId', 'backendSetName']
    ...
    def get_listener(self, network_load_balancer_id, listener_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/get_listener.py.html>`__ to see an example of how to use get_listener API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId', 'listenerName']
        resource_path = "/networkLoadBalancers/{networkLoadBalancerId}/listeners/{listenerName}"
    ...
    def get_network_load_balancer(self, network_load_balancer_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/get_network_load_balancer.py.html>`__ to see an example of how to use get_network_load_balancer API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId']
        resource_path = "/networkLoadBalancers/{networkLoadBalancerId}"
    ...
    def get_network_load_balancer_health(self, network_load_balancer_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/get_network_load_balancer_health.py.html>`__ to see an example of how to use get_network_load_balancer_health API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId']
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_backend_sets(self, network_load_balancer_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/list_backend_sets.py.html>`__ to see an example of how to use list_backend_sets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId']
        resource_path = "/networkLoadBalancers/{networkLoadBalancerId}/backendSets"
    ...
    def list_backends(self, network_load_balancer_id, backend_set_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/list_backends.py.html>`__ to see an example of how to use list_backends API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId', 'backendSetName']
        resource_path = "/networkLoadBalancers/{networkLoadBalancerId}/backendSets/{backendSetName}/backends"
    ...
    def list_listeners(self, network_load_balancer_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/list_listeners.py.html>`__ to see an example of how to use list_listeners API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId']
        resource_path = "/networkLoadBalancers/{networkLoadBalancerId}/listeners"
    ...
    def list_network_load_balancer_healths(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/list_network_load_balancer_healths.py.html>`__ to see an example of how to use list_network_load_balancer_healths API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_network_load_balancers(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/list_network_load_balancers.py.html>`__ to see an example of how to use list_network_load_balancers API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/networkLoadBalancers"
    ...
    def list_network_load_balancers_policies(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/list_network_load_balancers_policies.py.html>`__ to see an example of how to use list_network_load_balancers_policies API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def list_network_load_balancers_protocols(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/list_network_load_balancers_protocols.py.html>`__ to see an example of how to use list_network_load_balancers_protocols API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def list_work_request_errors(self, work_request_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_work_request_logs(self, work_request_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId', 'compartmentId']
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def update_backend(self, network_load_balancer_id, update_backend_details, backend_set_name, backend_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/update_backend.py.html>`__ to see an example of how to use update_backend API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId', 'backendSetName', 'backendName']
        resource_path = "/networkLoadBalancers/{networkLoadBalancerId}/backendSets/{backendSetName}/backends/{backendName}"
    ...
    def update_backend_set(self, network_load_balancer_id, update_backend_set_details, backend_set_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/update_backend_set.py.html>`__ to see an example of how to use update_backend_set API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId', 'backendSetName']
        resource_path = "/networkLoadBalancers/{networkLoadBalancerId}/backendSets/{backendSetName}"
    ...
    def update_health_checker(self, network_load_balancer_id, update_health_checker_details, backend_set_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/update_health_checker.py.html>`__ to see an example of how to use update_health_checker API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId', 'backendSetName']
        resource_path = "/networkLoadBalancers/{networkLoadBalancerId}/backendSets/{backendSetName}/healthChecker"
    ...
    def update_listener(self, network_load_balancer_id, update_listener_details, listener_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/update_listener.py.html>`__ to see an example of how to use update_listener API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId', 'listenerName']
        resource_path = "/networkLoadBalancers/{networkLoadBalancerId}/listeners/{listenerName}"
    ...
    def update_network_load_balancer(self, network_load_balancer_id, update_network_load_balancer_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/update_network_load_balancer.py.html>`__ to see an example of how to use update_network_load_balancer API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId']
        resource_path = "/networkLoadBalancers/{networkLoadBalancerId}"
    ...
    def update_network_security_groups(self, network_load_balancer_id, update_network_security_groups_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/networkloadbalancer/update_network_security_groups.py.html>`__ to see an example of how to use update_network_security_groups API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['networkLoadBalancerId']
