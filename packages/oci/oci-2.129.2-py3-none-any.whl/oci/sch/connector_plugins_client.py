...
class ConnectorPluginsClient(object):
    ...
    def get_connector_plugin(self, connector_plugin_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/sch/get_connector_plugin.py.html>`__ to see an example of how to use get_connector_plugin API.
        """
    ...
    def list_connector_plugins(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/sch/list_connector_plugins.py.html>`__ to see an example of how to use list_connector_plugins API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
