...
class BlockchainPlatformClient(object):
    ...
    def change_blockchain_platform_compartment(self, blockchain_platform_id, change_blockchain_platform_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/change_blockchain_platform_compartment.py.html>`__ to see an example of how to use change_blockchain_platform_compartment API.
        """
    ...
    def create_blockchain_platform(self, create_blockchain_platform_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/create_blockchain_platform.py.html>`__ to see an example of how to use create_blockchain_platform API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_osn(self, blockchain_platform_id, create_osn_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/create_osn.py.html>`__ to see an example of how to use create_osn API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId']
    ...
    def create_peer(self, blockchain_platform_id, create_peer_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/create_peer.py.html>`__ to see an example of how to use create_peer API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId']
    ...
    def delete_blockchain_platform(self, blockchain_platform_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/delete_blockchain_platform.py.html>`__ to see an example of how to use delete_blockchain_platform API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId']
    ...
    def delete_osn(self, blockchain_platform_id, osn_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/delete_osn.py.html>`__ to see an example of how to use delete_osn API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_peer(self, blockchain_platform_id, peer_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/delete_peer.py.html>`__ to see an example of how to use delete_peer API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/delete_work_request.py.html>`__ to see an example of how to use delete_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_blockchain_platform(self, blockchain_platform_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/get_blockchain_platform.py.html>`__ to see an example of how to use get_blockchain_platform API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId']
        resource_path = "/blockchainPlatforms/{blockchainPlatformId}"
    ...
    def get_osn(self, blockchain_platform_id, osn_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/get_osn.py.html>`__ to see an example of how to use get_osn API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId', 'osnId']
        resource_path = "/blockchainPlatforms/{blockchainPlatformId}/osns/{osnId}"
    ...
    def get_peer(self, blockchain_platform_id, peer_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/get_peer.py.html>`__ to see an example of how to use get_peer API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId', 'peerId']
        resource_path = "/blockchainPlatforms/{blockchainPlatformId}/peers/{peerId}"
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
        resource_path = "/workRequests/{workRequestId}"
    ...
    def list_blockchain_platform_patches(self, blockchain_platform_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/list_blockchain_platform_patches.py.html>`__ to see an example of how to use list_blockchain_platform_patches API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId']
    ...
    def list_blockchain_platforms(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/list_blockchain_platforms.py.html>`__ to see an example of how to use list_blockchain_platforms API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_osns(self, blockchain_platform_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/list_osns.py.html>`__ to see an example of how to use list_osns API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId']
        resource_path = "/blockchainPlatforms/{blockchainPlatformId}/osns"
    ...
    def list_peers(self, blockchain_platform_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/list_peers.py.html>`__ to see an example of how to use list_peers API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId']
        resource_path = "/blockchainPlatforms/{blockchainPlatformId}/peers"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_requests(self, compartment_id, blockchain_platform_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def preview_scale_blockchain_platform(self, blockchain_platform_id, scale_blockchain_platform_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/preview_scale_blockchain_platform.py.html>`__ to see an example of how to use preview_scale_blockchain_platform API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId']
    ...
    def scale_blockchain_platform(self, blockchain_platform_id, scale_blockchain_platform_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/scale_blockchain_platform.py.html>`__ to see an example of how to use scale_blockchain_platform API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId']
    ...
    def start_blockchain_platform(self, blockchain_platform_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/start_blockchain_platform.py.html>`__ to see an example of how to use start_blockchain_platform API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId']
    ...
    def stop_blockchain_platform(self, blockchain_platform_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/stop_blockchain_platform.py.html>`__ to see an example of how to use stop_blockchain_platform API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId']
    ...
    def update_blockchain_platform(self, update_blockchain_platform_details, blockchain_platform_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/update_blockchain_platform.py.html>`__ to see an example of how to use update_blockchain_platform API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId']
        resource_path = "/blockchainPlatforms/{blockchainPlatformId}"
    ...
    def update_osn(self, blockchain_platform_id, osn_id, update_osn_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/update_osn.py.html>`__ to see an example of how to use update_osn API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId', 'osnId']
        resource_path = "/blockchainPlatforms/{blockchainPlatformId}/osns/{osnId}"
    ...
    def update_peer(self, blockchain_platform_id, peer_id, update_peer_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/update_peer.py.html>`__ to see an example of how to use update_peer API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId', 'peerId']
        resource_path = "/blockchainPlatforms/{blockchainPlatformId}/peers/{peerId}"
    ...
    def upgrade_blockchain_platform(self, upgrade_blockchain_platform_details, blockchain_platform_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/blockchain/upgrade_blockchain_platform.py.html>`__ to see an example of how to use upgrade_blockchain_platform API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['blockchainPlatformId']
