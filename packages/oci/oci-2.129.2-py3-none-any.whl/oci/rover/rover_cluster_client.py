...
class RoverClusterClient(object):
    ...
    def change_rover_cluster_compartment(self, rover_cluster_id, change_rover_cluster_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/change_rover_cluster_compartment.py.html>`__ to see an example of how to use change_rover_cluster_compartment API.
        """
    ...
    def create_rover_cluster(self, create_rover_cluster_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/create_rover_cluster.py.html>`__ to see an example of how to use create_rover_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_rover_cluster(self, rover_cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/delete_rover_cluster.py.html>`__ to see an example of how to use delete_rover_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverClusterId']
    ...
    def get_rover_cluster(self, rover_cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/get_rover_cluster.py.html>`__ to see an example of how to use get_rover_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverClusterId']
        resource_path = "/roverClusters/{roverClusterId}"
    ...
    def get_rover_cluster_certificate(self, rover_cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/get_rover_cluster_certificate.py.html>`__ to see an example of how to use get_rover_cluster_certificate API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverClusterId']
    ...
    def list_rover_clusters(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/list_rover_clusters.py.html>`__ to see an example of how to use list_rover_clusters API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def request_additional_nodes(self, rover_cluster_id, request_additional_nodes_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/request_additional_nodes.py.html>`__ to see an example of how to use request_additional_nodes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverClusterId']
    ...
    def update_rover_cluster(self, rover_cluster_id, update_rover_cluster_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/update_rover_cluster.py.html>`__ to see an example of how to use update_rover_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverClusterId']
        resource_path = "/roverClusters/{roverClusterId}"
