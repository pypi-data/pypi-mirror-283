...
class ShapeClient(object):
    ...
    def list_shapes(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/list_shapes.py.html>`__ to see an example of how to use list_shapes API.
        """
