...
class ArtifactsClient(object):
    ...
    def change_container_repository_compartment(self, repository_id, change_container_repository_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/change_container_repository_compartment.py.html>`__ to see an example of how to use change_container_repository_compartment API.
        """
    ...
    def change_repository_compartment(self, repository_id, change_repository_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/change_repository_compartment.py.html>`__ to see an example of how to use change_repository_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['repositoryId']
    ...
    def create_container_image_signature(self, create_container_image_signature_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/create_container_image_signature.py.html>`__ to see an example of how to use create_container_image_signature API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_container_repository(self, create_container_repository_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/create_container_repository.py.html>`__ to see an example of how to use create_container_repository API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_repository(self, create_repository_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/create_repository.py.html>`__ to see an example of how to use create_repository API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_container_image(self, image_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/delete_container_image.py.html>`__ to see an example of how to use delete_container_image API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_container_image_signature(self, image_signature_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/delete_container_image_signature.py.html>`__ to see an example of how to use delete_container_image_signature API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_container_repository(self, repository_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/delete_container_repository.py.html>`__ to see an example of how to use delete_container_repository API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['repositoryId']
    ...
    def delete_generic_artifact(self, artifact_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/delete_generic_artifact.py.html>`__ to see an example of how to use delete_generic_artifact API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_generic_artifact_by_path(self, repository_id, artifact_path, version, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/delete_generic_artifact_by_path.py.html>`__ to see an example of how to use delete_generic_artifact_by_path API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_repository(self, repository_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/delete_repository.py.html>`__ to see an example of how to use delete_repository API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['repositoryId']
    ...
    def get_container_configuration(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/get_container_configuration.py.html>`__ to see an example of how to use get_container_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_container_image(self, image_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/get_container_image.py.html>`__ to see an example of how to use get_container_image API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['imageId']
        resource_path = "/container/images/{imageId}"
    ...
    def get_container_image_signature(self, image_signature_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/get_container_image_signature.py.html>`__ to see an example of how to use get_container_image_signature API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['imageSignatureId']
        resource_path = "/container/imageSignatures/{imageSignatureId}"
    ...
    def get_container_repository(self, repository_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/get_container_repository.py.html>`__ to see an example of how to use get_container_repository API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['repositoryId']
        resource_path = "/container/repositories/{repositoryId}"
    ...
    def get_generic_artifact(self, artifact_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/get_generic_artifact.py.html>`__ to see an example of how to use get_generic_artifact API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['artifactId']
        resource_path = "/generic/artifacts/{artifactId}"
    ...
    def get_generic_artifact_by_path(self, repository_id, artifact_path, version, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/get_generic_artifact_by_path.py.html>`__ to see an example of how to use get_generic_artifact_by_path API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['repositoryId', 'artifactPath', 'version']
        resource_path = "/generic/repositories/{repositoryId}/artifactPaths/{artifactPath}/versions/{version}"
    ...
    def get_repository(self, repository_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/get_repository.py.html>`__ to see an example of how to use get_repository API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['repositoryId']
        resource_path = "/repositories/{repositoryId}"
    ...
    def list_container_image_signatures(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/list_container_image_signatures.py.html>`__ to see an example of how to use list_container_image_signatures API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/container/imageSignatures"
    ...
    def list_container_images(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/list_container_images.py.html>`__ to see an example of how to use list_container_images API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def list_container_repositories(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/list_container_repositories.py.html>`__ to see an example of how to use list_container_repositories API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/container/repositories"
    ...
    def list_generic_artifacts(self, compartment_id, repository_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/list_generic_artifacts.py.html>`__ to see an example of how to use list_generic_artifacts API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_repositories(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/list_repositories.py.html>`__ to see an example of how to use list_repositories API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/repositories"
    ...
    def remove_container_version(self, image_id, remove_container_version_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/remove_container_version.py.html>`__ to see an example of how to use remove_container_version API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['imageId']
    ...
    def restore_container_image(self, image_id, restore_container_image_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/restore_container_image.py.html>`__ to see an example of how to use restore_container_image API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['imageId']
    ...
    def update_container_configuration(self, compartment_id, update_container_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/update_container_configuration.py.html>`__ to see an example of how to use update_container_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/container/configuration"
    ...
    def update_container_image(self, image_id, update_container_image_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/update_container_image.py.html>`__ to see an example of how to use update_container_image API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['imageId']
        resource_path = "/container/images/{imageId}"
    ...
    def update_container_image_signature(self, image_signature_id, update_container_image_signature_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/update_container_image_signature.py.html>`__ to see an example of how to use update_container_image_signature API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['imageSignatureId']
        resource_path = "/container/imageSignatures/{imageSignatureId}"
    ...
    def update_container_repository(self, repository_id, update_container_repository_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/update_container_repository.py.html>`__ to see an example of how to use update_container_repository API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['repositoryId']
        resource_path = "/container/repositories/{repositoryId}"
    ...
    def update_generic_artifact(self, artifact_id, update_generic_artifact_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/update_generic_artifact.py.html>`__ to see an example of how to use update_generic_artifact API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['artifactId']
        resource_path = "/generic/artifacts/{artifactId}"
    ...
    def update_generic_artifact_by_path(self, repository_id, artifact_path, version, update_generic_artifact_by_path_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/update_generic_artifact_by_path.py.html>`__ to see an example of how to use update_generic_artifact_by_path API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['repositoryId', 'artifactPath', 'version']
        resource_path = "/generic/repositories/{repositoryId}/artifactPaths/{artifactPath}/versions/{version}"
    ...
    def update_repository(self, repository_id, update_repository_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/artifacts/update_repository.py.html>`__ to see an example of how to use update_repository API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['repositoryId']
        resource_path = "/repositories/{repositoryId}"
