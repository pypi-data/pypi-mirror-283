...
class UsageapiClient(object):
    ...
    def create_custom_table(self, create_custom_table_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/create_custom_table.py.html>`__ to see an example of how to use create_custom_table API.
        """
    ...
    def create_email_recipients_group(self, create_email_recipients_group_details, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/create_email_recipients_group.py.html>`__ to see an example of how to use create_email_recipients_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_query(self, create_query_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/create_query.py.html>`__ to see an example of how to use create_query API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_schedule(self, create_schedule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/create_schedule.py.html>`__ to see an example of how to use create_schedule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_usage_carbon_emissions_query(self, create_usage_carbon_emissions_query_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/create_usage_carbon_emissions_query.py.html>`__ to see an example of how to use create_usage_carbon_emissions_query API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_custom_table(self, custom_table_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/delete_custom_table.py.html>`__ to see an example of how to use delete_custom_table API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_email_recipients_group(self, email_recipients_group_id, subscription_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/delete_email_recipients_group.py.html>`__ to see an example of how to use delete_email_recipients_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_query(self, query_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/delete_query.py.html>`__ to see an example of how to use delete_query API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_schedule(self, schedule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/delete_schedule.py.html>`__ to see an example of how to use delete_schedule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_usage_carbon_emissions_query(self, usage_carbon_emissions_query_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/delete_usage_carbon_emissions_query.py.html>`__ to see an example of how to use delete_usage_carbon_emissions_query API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_custom_table(self, custom_table_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/get_custom_table.py.html>`__ to see an example of how to use get_custom_table API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['customTableId']
        resource_path = "/customTables/{customTableId}"
    ...
    def get_email_recipients_group(self, email_recipients_group_id, subscription_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/get_email_recipients_group.py.html>`__ to see an example of how to use get_email_recipients_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailRecipientsGroupId', 'subscriptionId', 'compartmentId']
        resource_path = "/usageStatements/{subscriptionId}/emailRecipientsGroups/{emailRecipientsGroupId}"
    ...
    def get_query(self, query_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/get_query.py.html>`__ to see an example of how to use get_query API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['queryId']
        resource_path = "/queries/{queryId}"
    ...
    def get_schedule(self, schedule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/get_schedule.py.html>`__ to see an example of how to use get_schedule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['scheduleId']
        resource_path = "/schedules/{scheduleId}"
    ...
    def get_scheduled_run(self, scheduled_run_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/get_scheduled_run.py.html>`__ to see an example of how to use get_scheduled_run API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_usage_carbon_emissions_query(self, usage_carbon_emissions_query_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/get_usage_carbon_emissions_query.py.html>`__ to see an example of how to use get_usage_carbon_emissions_query API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['usageCarbonEmissionsQueryId']
        resource_path = "/usageCarbonEmissionsQueries/{usageCarbonEmissionsQueryId}"
    ...
    def list_custom_tables(self, compartment_id, saved_report_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/list_custom_tables.py.html>`__ to see an example of how to use list_custom_tables API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_email_recipients_groups(self, subscription_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/list_email_recipients_groups.py.html>`__ to see an example of how to use list_email_recipients_groups API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_queries(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/list_queries.py.html>`__ to see an example of how to use list_queries API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_scheduled_runs(self, schedule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/list_scheduled_runs.py.html>`__ to see an example of how to use list_scheduled_runs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['scheduleId']
    ...
    def list_schedules(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/list_schedules.py.html>`__ to see an example of how to use list_schedules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/schedules"
    ...
    def list_usage_carbon_emissions_queries(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/list_usage_carbon_emissions_queries.py.html>`__ to see an example of how to use list_usage_carbon_emissions_queries API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/usageCarbonEmissionsQueries"
    ...
    def request_average_carbon_emission(self, sku_part_number, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/request_average_carbon_emission.py.html>`__ to see an example of how to use request_average_carbon_emission API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def request_clean_energy_usage(self, region, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/request_clean_energy_usage.py.html>`__ to see an example of how to use request_clean_energy_usage API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def request_summarized_configurations(self, tenant_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/request_summarized_configurations.py.html>`__ to see an example of how to use request_summarized_configurations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def request_summarized_usages(self, request_summarized_usages_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/request_summarized_usages.py.html>`__ to see an example of how to use request_summarized_usages API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/usage"
    ...
    def request_usage_carbon_emission_config(self, tenant_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/request_usage_carbon_emission_config.py.html>`__ to see an example of how to use request_usage_carbon_emission_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['tenantId']
    ...
    def request_usage_carbon_emissions(self, request_usage_carbon_emissions_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/request_usage_carbon_emissions.py.html>`__ to see an example of how to use request_usage_carbon_emissions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def update_custom_table(self, update_custom_table_details, custom_table_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/update_custom_table.py.html>`__ to see an example of how to use update_custom_table API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['customTableId']
        resource_path = "/customTables/{customTableId}"
    ...
    def update_email_recipients_group(self, update_email_recipients_group_details, email_recipients_group_id, subscription_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/update_email_recipients_group.py.html>`__ to see an example of how to use update_email_recipients_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailRecipientsGroupId', 'subscriptionId', 'compartmentId']
        resource_path = "/usageStatements/{subscriptionId}/emailRecipientsGroups/{emailRecipientsGroupId}"
    ...
    def update_query(self, update_query_details, query_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/update_query.py.html>`__ to see an example of how to use update_query API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['queryId']
        resource_path = "/queries/{queryId}"
    ...
    def update_schedule(self, update_schedule_details, schedule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/update_schedule.py.html>`__ to see an example of how to use update_schedule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['scheduleId']
        resource_path = "/schedules/{scheduleId}"
    ...
    def update_usage_carbon_emissions_query(self, update_usage_carbon_emissions_query_details, usage_carbon_emissions_query_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usageapi/update_usage_carbon_emissions_query.py.html>`__ to see an example of how to use update_usage_carbon_emissions_query API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['usageCarbonEmissionsQueryId']
        resource_path = "/usageCarbonEmissionsQueries/{usageCarbonEmissionsQueryId}"
