...
class LinkClient(object):
    ...
    def delete_link(self, link_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/tenantmanagercontrolplane/delete_link.py.html>`__ to see an example of how to use delete_link API.
        """
    ...
    def get_link(self, link_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/tenantmanagercontrolplane/get_link.py.html>`__ to see an example of how to use get_link API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['linkId']
        resource_path = "/links/{linkId}"
    ...
    def list_links(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/tenantmanagercontrolplane/list_links.py.html>`__ to see an example of how to use list_links API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/links"
