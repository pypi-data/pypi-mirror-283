...
class ComputeManagementClient(object):
    ...
    def attach_instance_pool_instance(self, instance_pool_id, attach_instance_pool_instance_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/attach_instance_pool_instance.py.html>`__ to see an example of how to use attach_instance_pool_instance API.
        """
    ...
    def attach_load_balancer(self, instance_pool_id, attach_load_balancer_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/attach_load_balancer.py.html>`__ to see an example of how to use attach_load_balancer API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['instancePoolId']
    ...
    def change_cluster_network_compartment(self, cluster_network_id, change_cluster_network_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/change_cluster_network_compartment.py.html>`__ to see an example of how to use change_cluster_network_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_instance_configuration_compartment(self, instance_configuration_id, change_instance_configuration_compartment_details, **kwargs):
        ...
        **Important:** Most of the properties for an existing instance configuration, including the compartment,
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/change_instance_configuration_compartment.py.html>`__ to see an example of how to use change_instance_configuration_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_instance_pool_compartment(self, instance_pool_id, change_instance_pool_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/change_instance_pool_compartment.py.html>`__ to see an example of how to use change_instance_pool_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['instancePoolId']
    ...
    def create_cluster_network(self, create_cluster_network_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/create_cluster_network.py.html>`__ to see an example of how to use create_cluster_network API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_instance_configuration(self, create_instance_configuration, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/create_instance_configuration.py.html>`__ to see an example of how to use create_instance_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_instance_pool(self, create_instance_pool_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/create_instance_pool.py.html>`__ to see an example of how to use create_instance_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_instance_configuration(self, instance_configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/delete_instance_configuration.py.html>`__ to see an example of how to use delete_instance_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['instanceConfigurationId']
    ...
    def detach_instance_pool_instance(self, instance_pool_id, detach_instance_pool_instance_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/detach_instance_pool_instance.py.html>`__ to see an example of how to use detach_instance_pool_instance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['instancePoolId']
    ...
    def detach_load_balancer(self, instance_pool_id, detach_load_balancer_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/detach_load_balancer.py.html>`__ to see an example of how to use detach_load_balancer API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['instancePoolId']
    ...
    def get_cluster_network(self, cluster_network_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/get_cluster_network.py.html>`__ to see an example of how to use get_cluster_network API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterNetworkId']
    ...
    def get_instance_configuration(self, instance_configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/get_instance_configuration.py.html>`__ to see an example of how to use get_instance_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['instanceConfigurationId']
        resource_path = "/instanceConfigurations/{instanceConfigurationId}"
    ...
    def get_instance_pool(self, instance_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/get_instance_pool.py.html>`__ to see an example of how to use get_instance_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['instancePoolId']
    ...
    def get_instance_pool_instance(self, instance_pool_id, instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/get_instance_pool_instance.py.html>`__ to see an example of how to use get_instance_pool_instance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_instance_pool_load_balancer_attachment(self, instance_pool_id, instance_pool_load_balancer_attachment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/get_instance_pool_load_balancer_attachment.py.html>`__ to see an example of how to use get_instance_pool_load_balancer_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def launch_instance_configuration(self, instance_configuration_id, instance_configuration, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/launch_instance_configuration.py.html>`__ to see an example of how to use launch_instance_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['instanceConfigurationId']
    ...
    def list_cluster_network_instances(self, compartment_id, cluster_network_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/list_cluster_network_instances.py.html>`__ to see an example of how to use list_cluster_network_instances API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_cluster_networks(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/list_cluster_networks.py.html>`__ to see an example of how to use list_cluster_networks API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_instance_configurations(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/list_instance_configurations.py.html>`__ to see an example of how to use list_instance_configurations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/instanceConfigurations"
    ...
    def list_instance_pool_instances(self, compartment_id, instance_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/list_instance_pool_instances.py.html>`__ to see an example of how to use list_instance_pool_instances API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_instance_pools(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/list_instance_pools.py.html>`__ to see an example of how to use list_instance_pools API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/instancePools"
    ...
    def reset_instance_pool(self, instance_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/reset_instance_pool.py.html>`__ to see an example of how to use reset_instance_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['instancePoolId']
    ...
    def softreset_instance_pool(self, instance_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/softreset_instance_pool.py.html>`__ to see an example of how to use softreset_instance_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['instancePoolId']
    ...
    def softstop_instance_pool(self, instance_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/softstop_instance_pool.py.html>`__ to see an example of how to use softstop_instance_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['instancePoolId']
    ...
    def start_instance_pool(self, instance_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/start_instance_pool.py.html>`__ to see an example of how to use start_instance_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['instancePoolId']
    ...
    def stop_instance_pool(self, instance_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/stop_instance_pool.py.html>`__ to see an example of how to use stop_instance_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['instancePoolId']
    ...
    def terminate_cluster_network(self, cluster_network_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/terminate_cluster_network.py.html>`__ to see an example of how to use terminate_cluster_network API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterNetworkId']
        resource_path = "/clusterNetworks/{clusterNetworkId}"
    ...
    def terminate_instance_pool(self, instance_pool_id, **kwargs):
        ...
        **Warning:** When you delete an instance pool, the resources that were created by the pool are permanently
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/terminate_instance_pool.py.html>`__ to see an example of how to use terminate_instance_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['instancePoolId']
        resource_path = "/instancePools/{instancePoolId}"
    ...
    def update_cluster_network(self, cluster_network_id, update_cluster_network_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/update_cluster_network.py.html>`__ to see an example of how to use update_cluster_network API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterNetworkId']
        resource_path = "/clusterNetworks/{clusterNetworkId}"
    ...
    def update_instance_configuration(self, instance_configuration_id, update_instance_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/update_instance_configuration.py.html>`__ to see an example of how to use update_instance_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['instanceConfigurationId']
        resource_path = "/instanceConfigurations/{instanceConfigurationId}"
    ...
    def update_instance_pool(self, instance_pool_id, update_instance_pool_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/core/update_instance_pool.py.html>`__ to see an example of how to use update_instance_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['instancePoolId']
        resource_path = "/instancePools/{instancePoolId}"
