...
class DashxApisClient(object):
    ...
    def change_management_dashboards_compartment(self, management_dashboard_id, change_management_dashboards_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/managementdashboard/change_management_dashboards_compartment.py.html>`__ to see an example of how to use change_management_dashboards_compartment API.
        """
    ...
    def change_management_saved_searches_compartment(self, management_saved_search_id, change_management_saved_searches_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/managementdashboard/change_management_saved_searches_compartment.py.html>`__ to see an example of how to use change_management_saved_searches_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_management_dashboard(self, create_management_dashboard_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/managementdashboard/create_management_dashboard.py.html>`__ to see an example of how to use create_management_dashboard API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_management_saved_search(self, create_management_saved_search_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/managementdashboard/create_management_saved_search.py.html>`__ to see an example of how to use create_management_saved_search API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_management_dashboard(self, management_dashboard_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/managementdashboard/delete_management_dashboard.py.html>`__ to see an example of how to use delete_management_dashboard API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['managementDashboardId']
    ...
    def delete_management_saved_search(self, management_saved_search_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/managementdashboard/delete_management_saved_search.py.html>`__ to see an example of how to use delete_management_saved_search API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['managementSavedSearchId']
    ...
    def export_dashboard(self, export_dashboard_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/managementdashboard/export_dashboard.py.html>`__ to see an example of how to use export_dashboard API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_management_dashboard(self, management_dashboard_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/managementdashboard/get_management_dashboard.py.html>`__ to see an example of how to use get_management_dashboard API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['managementDashboardId']
        resource_path = "/managementDashboards/{managementDashboardId}"
    ...
    def get_management_saved_search(self, management_saved_search_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/managementdashboard/get_management_saved_search.py.html>`__ to see an example of how to use get_management_saved_search API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['managementSavedSearchId']
        resource_path = "/managementSavedSearches/{managementSavedSearchId}"
    ...
    def import_dashboard(self, management_dashboard_import_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/managementdashboard/import_dashboard.py.html>`__ to see an example of how to use import_dashboard API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def list_management_dashboards(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/managementdashboard/list_management_dashboards.py.html>`__ to see an example of how to use list_management_dashboards API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_management_saved_searches(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/managementdashboard/list_management_saved_searches.py.html>`__ to see an example of how to use list_management_saved_searches API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/managementSavedSearches"
    ...
    def update_management_dashboard(self, management_dashboard_id, update_management_dashboard_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/managementdashboard/update_management_dashboard.py.html>`__ to see an example of how to use update_management_dashboard API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['managementDashboardId']
        resource_path = "/managementDashboards/{managementDashboardId}"
    ...
    def update_management_saved_search(self, management_saved_search_id, update_management_saved_search_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/managementdashboard/update_management_saved_search.py.html>`__ to see an example of how to use update_management_saved_search API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['managementSavedSearchId']
        resource_path = "/managementSavedSearches/{managementSavedSearchId}"
