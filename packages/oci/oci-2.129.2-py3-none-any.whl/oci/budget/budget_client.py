...
class BudgetClient(object):
    ...
    def create_alert_rule(self, budget_id, create_alert_rule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/budget/create_alert_rule.py.html>`__ to see an example of how to use create_alert_rule API.
        """
    ...
    def create_budget(self, create_budget_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/budget/create_budget.py.html>`__ to see an example of how to use create_budget API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_alert_rule(self, budget_id, alert_rule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/budget/delete_alert_rule.py.html>`__ to see an example of how to use delete_alert_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_budget(self, budget_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/budget/delete_budget.py.html>`__ to see an example of how to use delete_budget API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['budgetId']
    ...
    def get_alert_rule(self, budget_id, alert_rule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/budget/get_alert_rule.py.html>`__ to see an example of how to use get_alert_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['budgetId', 'alertRuleId']
        resource_path = "/budgets/{budgetId}/alertRules/{alertRuleId}"
    ...
    def get_budget(self, budget_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/budget/get_budget.py.html>`__ to see an example of how to use get_budget API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['budgetId']
        resource_path = "/budgets/{budgetId}"
    ...
    def list_alert_rules(self, budget_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/budget/list_alert_rules.py.html>`__ to see an example of how to use list_alert_rules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['budgetId']
        resource_path = "/budgets/{budgetId}/alertRules"
    ...
    def list_budgets(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/budget/list_budgets.py.html>`__ to see an example of how to use list_budgets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_alert_rule(self, budget_id, alert_rule_id, update_alert_rule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/budget/update_alert_rule.py.html>`__ to see an example of how to use update_alert_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['budgetId', 'alertRuleId']
        resource_path = "/budgets/{budgetId}/alertRules/{alertRuleId}"
    ...
    def update_budget(self, budget_id, update_budget_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/budget/update_budget.py.html>`__ to see an example of how to use update_budget API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['budgetId']
        resource_path = "/budgets/{budgetId}"
