...
class MonitoringClient(object):
    ...
    def change_alarm_compartment(self, alarm_id, change_alarm_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/change_alarm_compartment.py.html>`__ to see an example of how to use change_alarm_compartment API.
        """
    ...
    def create_alarm(self, create_alarm_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/create_alarm.py.html>`__ to see an example of how to use create_alarm API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_alarm_suppression(self, create_alarm_suppression_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/create_alarm_suppression.py.html>`__ to see an example of how to use create_alarm_suppression API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_alarm(self, alarm_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/delete_alarm.py.html>`__ to see an example of how to use delete_alarm API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['alarmId']
    ...
    def delete_alarm_suppression(self, alarm_suppression_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/delete_alarm_suppression.py.html>`__ to see an example of how to use delete_alarm_suppression API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_alarm(self, alarm_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/get_alarm.py.html>`__ to see an example of how to use get_alarm API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['alarmId']
        resource_path = "/alarms/{alarmId}"
    ...
    def get_alarm_history(self, alarm_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/get_alarm_history.py.html>`__ to see an example of how to use get_alarm_history API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['alarmId']
    ...
    def get_alarm_suppression(self, alarm_suppression_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/get_alarm_suppression.py.html>`__ to see an example of how to use get_alarm_suppression API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['alarmSuppressionId']
        resource_path = "/alarmSuppressions/{alarmSuppressionId}"
    ...
    def list_alarm_suppressions(self, alarm_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/list_alarm_suppressions.py.html>`__ to see an example of how to use list_alarm_suppressions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['alarmId']
        resource_path = "/alarmSuppressions"
    ...
    def list_alarms(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/list_alarms.py.html>`__ to see an example of how to use list_alarms API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_alarms_status(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/list_alarms_status.py.html>`__ to see an example of how to use list_alarms_status API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def list_metrics(self, compartment_id, list_metrics_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/list_metrics.py.html>`__ to see an example of how to use list_metrics API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def post_metric_data(self, post_metric_data_details, **kwargs):
        ...
        **Note:** The endpoints for this operation differ from other Monitoring operations. Replace the string `telemetry` with `telemetry-ingestion` in the endpoint, as in the following example:
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/post_metric_data.py.html>`__ to see an example of how to use post_metric_data API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def remove_alarm_suppression(self, alarm_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/remove_alarm_suppression.py.html>`__ to see an example of how to use remove_alarm_suppression API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['alarmId']
    ...
    def retrieve_dimension_states(self, alarm_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/retrieve_dimension_states.py.html>`__ to see an example of how to use retrieve_dimension_states API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['alarmId']
    ...
    def summarize_alarm_suppression_history(self, alarm_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/summarize_alarm_suppression_history.py.html>`__ to see an example of how to use summarize_alarm_suppression_history API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['alarmId']
    ...
    def summarize_metrics_data(self, compartment_id, summarize_metrics_data_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/summarize_metrics_data.py.html>`__ to see an example of how to use summarize_metrics_data API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def update_alarm(self, alarm_id, update_alarm_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/monitoring/update_alarm.py.html>`__ to see an example of how to use update_alarm API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['alarmId']
        resource_path = "/alarms/{alarmId}"
