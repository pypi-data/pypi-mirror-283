...
class NotificationControlPlaneClient(object):
    ...
    def change_topic_compartment(self, topic_id, change_topic_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ons/change_topic_compartment.py.html>`__ to see an example of how to use change_topic_compartment API.
        """
    ...
    def create_topic(self, create_topic_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ons/create_topic.py.html>`__ to see an example of how to use create_topic API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_topic(self, topic_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ons/delete_topic.py.html>`__ to see an example of how to use delete_topic API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['topicId']
    ...
    def get_topic(self, topic_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ons/get_topic.py.html>`__ to see an example of how to use get_topic API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['topicId']
        resource_path = "/topics/{topicId}"
    ...
    def list_topics(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ons/list_topics.py.html>`__ to see an example of how to use list_topics API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_topic(self, topic_id, topic_attributes_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ons/update_topic.py.html>`__ to see an example of how to use update_topic API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['topicId']
        resource_path = "/topics/{topicId}"
