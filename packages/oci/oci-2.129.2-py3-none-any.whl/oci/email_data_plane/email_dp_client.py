...
class EmailDPClient(object):
    ...
    def submit_email(self, submit_email_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/emaildataplane/submit_email.py.html>`__ to see an example of how to use submit_email API.
        """
