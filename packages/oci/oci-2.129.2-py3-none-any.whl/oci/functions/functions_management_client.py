...
class FunctionsManagementClient(object):
    ...
    def change_application_compartment(self, application_id, change_application_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/functions/change_application_compartment.py.html>`__ to see an example of how to use change_application_compartment API.
        """
    ...
    def create_application(self, create_application_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/functions/create_application.py.html>`__ to see an example of how to use create_application API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_function(self, create_function_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/functions/create_function.py.html>`__ to see an example of how to use create_function API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_application(self, application_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/functions/delete_application.py.html>`__ to see an example of how to use delete_application API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['applicationId']
    ...
    def delete_function(self, function_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/functions/delete_function.py.html>`__ to see an example of how to use delete_function API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_application(self, application_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/functions/get_application.py.html>`__ to see an example of how to use get_application API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['applicationId']
        resource_path = "/applications/{applicationId}"
    ...
    def get_function(self, function_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/functions/get_function.py.html>`__ to see an example of how to use get_function API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['functionId']
        resource_path = "/functions/{functionId}"
    ...
    def get_pbf_listing(self, pbf_listing_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/functions/get_pbf_listing.py.html>`__ to see an example of how to use get_pbf_listing API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_pbf_listing_version(self, pbf_listing_version_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/functions/get_pbf_listing_version.py.html>`__ to see an example of how to use get_pbf_listing_version API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_applications(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/functions/list_applications.py.html>`__ to see an example of how to use list_applications API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_functions(self, application_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/functions/list_functions.py.html>`__ to see an example of how to use list_functions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['applicationId']
        resource_path = "/functions"
    ...
    def list_pbf_listing_versions(self, pbf_listing_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/functions/list_pbf_listing_versions.py.html>`__ to see an example of how to use list_pbf_listing_versions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['pbfListingId']
    ...
    def list_pbf_listings(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/functions/list_pbf_listings.py.html>`__ to see an example of how to use list_pbf_listings API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def list_triggers(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/functions/list_triggers.py.html>`__ to see an example of how to use list_triggers API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def update_application(self, application_id, update_application_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/functions/update_application.py.html>`__ to see an example of how to use update_application API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['applicationId']
        resource_path = "/applications/{applicationId}"
    ...
    def update_function(self, function_id, update_function_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/functions/update_function.py.html>`__ to see an example of how to use update_function API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['functionId']
        resource_path = "/functions/{functionId}"
