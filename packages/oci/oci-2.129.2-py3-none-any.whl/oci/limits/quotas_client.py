...
class QuotasClient(object):
    ...
    def add_quota_lock(self, quota_id, add_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/limits/add_quota_lock.py.html>`__ to see an example of how to use add_quota_lock API.
        """
    ...
    def create_quota(self, create_quota_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/limits/create_quota.py.html>`__ to see an example of how to use create_quota API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_quota(self, quota_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/limits/delete_quota.py.html>`__ to see an example of how to use delete_quota API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['quotaId']
    ...
    def get_quota(self, quota_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/limits/get_quota.py.html>`__ to see an example of how to use get_quota API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['quotaId']
        resource_path = "/20181025/quotas/{quotaId}"
    ...
    def list_quotas(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/limits/list_quotas.py.html>`__ to see an example of how to use list_quotas API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def remove_quota_lock(self, quota_id, remove_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/limits/remove_quota_lock.py.html>`__ to see an example of how to use remove_quota_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['quotaId']
    ...
    def update_quota(self, quota_id, update_quota_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/limits/update_quota.py.html>`__ to see an example of how to use update_quota API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['quotaId']
        resource_path = "/20181025/quotas/{quotaId}"
