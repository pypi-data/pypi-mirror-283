...
class AccessRequestsClient(object):
    ...
    def approve_access_request(self, access_request_id, approve_access_request_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/operatoraccesscontrol/approve_access_request.py.html>`__ to see an example of how to use approve_access_request API.
        """
    ...
    def get_access_request(self, access_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/operatoraccesscontrol/get_access_request.py.html>`__ to see an example of how to use get_access_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['accessRequestId']
    ...
    def get_audit_log_report(self, access_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/operatoraccesscontrol/get_audit_log_report.py.html>`__ to see an example of how to use get_audit_log_report API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['accessRequestId']
    ...
    def interaction_request(self, access_request_id, interaction_request_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/operatoraccesscontrol/interaction_request.py.html>`__ to see an example of how to use interaction_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['accessRequestId']
    ...
    def list_access_request_histories(self, access_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/operatoraccesscontrol/list_access_request_histories.py.html>`__ to see an example of how to use list_access_request_histories API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['accessRequestId']
    ...
    def list_access_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/operatoraccesscontrol/list_access_requests.py.html>`__ to see an example of how to use list_access_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_interactions(self, access_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/operatoraccesscontrol/list_interactions.py.html>`__ to see an example of how to use list_interactions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['accessRequestId']
    ...
    def reject_access_request(self, access_request_id, reject_access_request_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/operatoraccesscontrol/reject_access_request.py.html>`__ to see an example of how to use reject_access_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['accessRequestId']
    ...
    def review_access_request(self, access_request_id, review_access_request_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/operatoraccesscontrol/review_access_request.py.html>`__ to see an example of how to use review_access_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['accessRequestId']
    ...
    def revoke_access_request(self, access_request_id, revoke_access_request_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/operatoraccesscontrol/revoke_access_request.py.html>`__ to see an example of how to use revoke_access_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['accessRequestId']
