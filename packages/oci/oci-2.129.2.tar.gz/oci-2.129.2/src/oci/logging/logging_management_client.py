...
class LoggingManagementClient(object):
    ...
    def change_log_group_compartment(self, log_group_id, change_log_group_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/change_log_group_compartment.py.html>`__ to see an example of how to use change_log_group_compartment API.
        """
    ...
    def change_log_log_group(self, log_group_id, log_id, change_log_log_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/change_log_log_group.py.html>`__ to see an example of how to use change_log_log_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_log_saved_search_compartment(self, log_saved_search_id, change_log_saved_search_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/change_log_saved_search_compartment.py.html>`__ to see an example of how to use change_log_saved_search_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_unified_agent_configuration_compartment(self, unified_agent_configuration_id, change_unified_agent_configuration_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/change_unified_agent_configuration_compartment.py.html>`__ to see an example of how to use change_unified_agent_configuration_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_log(self, log_group_id, create_log_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/create_log.py.html>`__ to see an example of how to use create_log API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['logGroupId']
    ...
    def create_log_group(self, create_log_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/create_log_group.py.html>`__ to see an example of how to use create_log_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_log_saved_search(self, create_log_saved_search_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/create_log_saved_search.py.html>`__ to see an example of how to use create_log_saved_search API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_unified_agent_configuration(self, create_unified_agent_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/create_unified_agent_configuration.py.html>`__ to see an example of how to use create_unified_agent_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_log(self, log_group_id, log_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/delete_log.py.html>`__ to see an example of how to use delete_log API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['logGroupId', 'logId']
    ...
    def delete_log_group(self, log_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/delete_log_group.py.html>`__ to see an example of how to use delete_log_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['logGroupId']
    ...
    def delete_log_saved_search(self, log_saved_search_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/delete_log_saved_search.py.html>`__ to see an example of how to use delete_log_saved_search API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['logSavedSearchId']
    ...
    def delete_unified_agent_configuration(self, unified_agent_configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/delete_unified_agent_configuration.py.html>`__ to see an example of how to use delete_unified_agent_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['unifiedAgentConfigurationId']
    ...
    def delete_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/delete_work_request.py.html>`__ to see an example of how to use delete_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_log(self, log_group_id, log_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/get_log.py.html>`__ to see an example of how to use get_log API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['logGroupId', 'logId']
        resource_path = "/logGroups/{logGroupId}/logs/{logId}"
    ...
    def get_log_group(self, log_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/get_log_group.py.html>`__ to see an example of how to use get_log_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['logGroupId']
        resource_path = "/logGroups/{logGroupId}"
    ...
    def get_log_saved_search(self, log_saved_search_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/get_log_saved_search.py.html>`__ to see an example of how to use get_log_saved_search API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['logSavedSearchId']
        resource_path = "/logSavedSearches/{logSavedSearchId}"
    ...
    def get_unified_agent_configuration(self, unified_agent_configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/get_unified_agent_configuration.py.html>`__ to see an example of how to use get_unified_agent_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['unifiedAgentConfigurationId']
        resource_path = "/unifiedAgentConfigurations/{unifiedAgentConfigurationId}"
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
        resource_path = "/workRequests/{workRequestId}"
    ...
    def list_log_groups(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/list_log_groups.py.html>`__ to see an example of how to use list_log_groups API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_log_saved_searches(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/list_log_saved_searches.py.html>`__ to see an example of how to use list_log_saved_searches API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/logSavedSearches"
    ...
    def list_logs(self, log_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/list_logs.py.html>`__ to see an example of how to use list_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['logGroupId']
        resource_path = "/logGroups/{logGroupId}/logs"
    ...
    def list_services(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/list_services.py.html>`__ to see an example of how to use list_services API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def list_unified_agent_configurations(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/list_unified_agent_configurations.py.html>`__ to see an example of how to use list_unified_agent_configurations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/unifiedAgentConfigurations"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def update_log(self, log_group_id, log_id, update_log_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/update_log.py.html>`__ to see an example of how to use update_log API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['logGroupId', 'logId']
        resource_path = "/logGroups/{logGroupId}/logs/{logId}"
    ...
    def update_log_group(self, log_group_id, update_log_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/update_log_group.py.html>`__ to see an example of how to use update_log_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['logGroupId']
        resource_path = "/logGroups/{logGroupId}"
    ...
    def update_log_saved_search(self, log_saved_search_id, update_log_saved_search_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/update_log_saved_search.py.html>`__ to see an example of how to use update_log_saved_search API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['logSavedSearchId']
        resource_path = "/logSavedSearches/{logSavedSearchId}"
    ...
    def update_unified_agent_configuration(self, unified_agent_configuration_id, update_unified_agent_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/logging/update_unified_agent_configuration.py.html>`__ to see an example of how to use update_unified_agent_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['unifiedAgentConfigurationId']
        resource_path = "/unifiedAgentConfigurations/{unifiedAgentConfigurationId}"
