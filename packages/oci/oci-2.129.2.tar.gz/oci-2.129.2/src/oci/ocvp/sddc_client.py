...
class SddcClient(object):
    ...
    def cancel_downgrade_hcx(self, sddc_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ocvp/cancel_downgrade_hcx.py.html>`__ to see an example of how to use cancel_downgrade_hcx API.
        """
    ...
    def change_sddc_compartment(self, sddc_id, change_sddc_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ocvp/change_sddc_compartment.py.html>`__ to see an example of how to use change_sddc_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['sddcId']
    ...
    def create_sddc(self, create_sddc_details, **kwargs):
        ...
        **Important:** You must configure the SDDC's networking resources with the security rules detailed in `Security Rules for Oracle Cloud VMware Solution SDDCs`__. Otherwise, provisioning the SDDC will fail. The rules are based on the requirements set by VMware.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ocvp/create_sddc.py.html>`__ to see an example of how to use create_sddc API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/sddcs"
    ...
    def delete_sddc(self, sddc_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ocvp/delete_sddc.py.html>`__ to see an example of how to use delete_sddc API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['sddcId']
    ...
    def downgrade_hcx(self, downgrade_hcx_details, sddc_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ocvp/downgrade_hcx.py.html>`__ to see an example of how to use downgrade_hcx API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['sddcId']
    ...
    def get_sddc(self, sddc_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ocvp/get_sddc.py.html>`__ to see an example of how to use get_sddc API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['sddcId']
        resource_path = "/sddcs/{sddcId}"
    ...
    def list_sddcs(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ocvp/list_sddcs.py.html>`__ to see an example of how to use list_sddcs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_supported_commitments(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ocvp/list_supported_commitments.py.html>`__ to see an example of how to use list_supported_commitments API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def list_supported_host_shapes(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ocvp/list_supported_host_shapes.py.html>`__ to see an example of how to use list_supported_host_shapes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def list_supported_vmware_software_versions(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ocvp/list_supported_vmware_software_versions.py.html>`__ to see an example of how to use list_supported_vmware_software_versions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def refresh_hcx_license_status(self, sddc_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ocvp/refresh_hcx_license_status.py.html>`__ to see an example of how to use refresh_hcx_license_status API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['sddcId']
    ...
    def retrieve_password(self, sddc_id, type, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ocvp/retrieve_password.py.html>`__ to see an example of how to use retrieve_password API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_sddc(self, sddc_id, update_sddc_details, **kwargs):
        ...
        **Important:** Updating an SDDC affects only certain attributes in the `Sddc`
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ocvp/update_sddc.py.html>`__ to see an example of how to use update_sddc API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['sddcId']
        resource_path = "/sddcs/{sddcId}"
    ...
    def upgrade_hcx(self, sddc_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ocvp/upgrade_hcx.py.html>`__ to see an example of how to use upgrade_hcx API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['sddcId']
