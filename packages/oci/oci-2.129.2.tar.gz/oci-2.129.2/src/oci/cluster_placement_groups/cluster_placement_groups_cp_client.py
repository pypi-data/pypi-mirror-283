...
class ClusterPlacementGroupsCPClient(object):
    ...
    def activate_cluster_placement_group(self, cluster_placement_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/clusterplacementgroups/activate_cluster_placement_group.py.html>`__ to see an example of how to use activate_cluster_placement_group API.
        """
    ...
    def cancel_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/clusterplacementgroups/cancel_work_request.py.html>`__ to see an example of how to use cancel_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_cluster_placement_group_compartment(self, cluster_placement_group_id, change_cluster_placement_group_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/clusterplacementgroups/change_cluster_placement_group_compartment.py.html>`__ to see an example of how to use change_cluster_placement_group_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterPlacementGroupId']
    ...
    def create_cluster_placement_group(self, create_cluster_placement_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/clusterplacementgroups/create_cluster_placement_group.py.html>`__ to see an example of how to use create_cluster_placement_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def deactivate_cluster_placement_group(self, cluster_placement_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/clusterplacementgroups/deactivate_cluster_placement_group.py.html>`__ to see an example of how to use deactivate_cluster_placement_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterPlacementGroupId']
    ...
    def delete_cluster_placement_group(self, cluster_placement_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/clusterplacementgroups/delete_cluster_placement_group.py.html>`__ to see an example of how to use delete_cluster_placement_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterPlacementGroupId']
    ...
    def get_cluster_placement_group(self, cluster_placement_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/clusterplacementgroups/get_cluster_placement_group.py.html>`__ to see an example of how to use get_cluster_placement_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterPlacementGroupId']
        resource_path = "/clusterPlacementGroups/{clusterPlacementGroupId}"
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/clusterplacementgroups/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
        resource_path = "/workRequests/{workRequestId}"
    ...
    def list_cluster_placement_groups(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/clusterplacementgroups/list_cluster_placement_groups.py.html>`__ to see an example of how to use list_cluster_placement_groups API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/clusterPlacementGroups"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/clusterplacementgroups/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/clusterplacementgroups/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_requests(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/clusterplacementgroups/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def update_cluster_placement_group(self, cluster_placement_group_id, update_cluster_placement_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/clusterplacementgroups/update_cluster_placement_group.py.html>`__ to see an example of how to use update_cluster_placement_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterPlacementGroupId']
        resource_path = "/clusterPlacementGroups/{clusterPlacementGroupId}"
