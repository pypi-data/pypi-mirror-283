...
class ServiceAttachmentClient(object):
    ...
    def get_service_attachment(self, fusion_environment_id, service_attachment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/get_service_attachment.py.html>`__ to see an example of how to use get_service_attachment API.
        """
    ...
    def list_service_attachments(self, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/list_service_attachments.py.html>`__ to see an example of how to use list_service_attachments API.
        """
