...
class FusionApplicationsClient(object):
    ...
    def create_service_attachment(self, create_service_attachment_details, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/create_service_attachment.py.html>`__ to see an example of how to use create_service_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fusionEnvironmentId']
    ...
    def delete_refresh_activity(self, fusion_environment_id, refresh_activity_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/delete_refresh_activity.py.html>`__ to see an example of how to use delete_refresh_activity API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_service_attachment(self, fusion_environment_id, service_attachment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/delete_service_attachment.py.html>`__ to see an example of how to use delete_service_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def generate_extract_details(self, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/generate_extract_details.py.html>`__ to see an example of how to use generate_extract_details API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fusionEnvironmentId']
    ...
    def initiate_extract(self, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/initiate_extract.py.html>`__ to see an example of how to use initiate_extract API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fusionEnvironmentId']
    ...
    def update_refresh_activity(self, fusion_environment_id, refresh_activity_id, update_refresh_activity_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/update_refresh_activity.py.html>`__ to see an example of how to use update_refresh_activity API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fusionEnvironmentId', 'refreshActivityId']
        resource_path = "/fusionEnvironments/{fusionEnvironmentId}/refreshActivities/{refreshActivityId}"
    ...
    def verify_service_attachment(self, verify_service_attachment_details, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/fusionapps/verify_service_attachment.py.html>`__ to see an example of how to use verify_service_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fusionEnvironmentId']
