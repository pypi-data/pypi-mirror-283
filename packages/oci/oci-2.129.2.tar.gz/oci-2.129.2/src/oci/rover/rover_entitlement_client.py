...
class RoverEntitlementClient(object):
    ...
    def change_rover_entitlement_compartment(self, rover_entitlement_id, change_rover_entitlement_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/change_rover_entitlement_compartment.py.html>`__ to see an example of how to use change_rover_entitlement_compartment API.
        """
    ...
    def create_rover_entitlement(self, create_rover_entitlement_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/create_rover_entitlement.py.html>`__ to see an example of how to use create_rover_entitlement API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_rover_entitlement(self, rover_entitlement_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/delete_rover_entitlement.py.html>`__ to see an example of how to use delete_rover_entitlement API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverEntitlementId']
    ...
    def get_rover_entitlement(self, rover_entitlement_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/get_rover_entitlement.py.html>`__ to see an example of how to use get_rover_entitlement API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_rover_entitlements(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/list_rover_entitlements.py.html>`__ to see an example of how to use list_rover_entitlements API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_rover_entitlement(self, rover_entitlement_id, update_rover_entitlement_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/update_rover_entitlement.py.html>`__ to see an example of how to use update_rover_entitlement API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverEntitlementId']
        resource_path = "/roverEntitlements/{roverEntitlementId}"
