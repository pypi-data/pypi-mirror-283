...
class RoverNodeClient(object):
    ...
    def change_rover_node_compartment(self, rover_node_id, change_rover_node_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/change_rover_node_compartment.py.html>`__ to see an example of how to use change_rover_node_compartment API.
        """
    ...
    def create_rover_node(self, create_rover_node_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/create_rover_node.py.html>`__ to see an example of how to use create_rover_node API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_rover_node(self, rover_node_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/delete_rover_node.py.html>`__ to see an example of how to use delete_rover_node API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverNodeId']
    ...
    def get_rover_node(self, rover_node_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/get_rover_node.py.html>`__ to see an example of how to use get_rover_node API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverNodeId']
        resource_path = "/roverNodes/{roverNodeId}"
    ...
    def get_rover_node_certificate(self, rover_node_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/get_rover_node_certificate.py.html>`__ to see an example of how to use get_rover_node_certificate API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverNodeId']
    ...
    def get_rover_node_encryption_key(self, rover_node_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/get_rover_node_encryption_key.py.html>`__ to see an example of how to use get_rover_node_encryption_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverNodeId']
    ...
    def get_rover_node_get_rpt(self, rover_node_id, jwt, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/get_rover_node_get_rpt.py.html>`__ to see an example of how to use get_rover_node_get_rpt API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverNodeId']
    ...
    def list_rover_nodes(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/list_rover_nodes.py.html>`__ to see an example of how to use list_rover_nodes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def rover_node_action_retrieve_ca_bundle(self, rover_node_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/rover_node_action_retrieve_ca_bundle.py.html>`__ to see an example of how to use rover_node_action_retrieve_ca_bundle API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverNodeId']
    ...
    def rover_node_action_set_key(self, rover_node_id, jwt, rover_node_action_set_key_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/rover_node_action_set_key.py.html>`__ to see an example of how to use rover_node_action_set_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverNodeId']
    ...
    def rover_node_generate_certificate(self, rover_node_generate_certificate_details, rover_node_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/rover_node_generate_certificate.py.html>`__ to see an example of how to use rover_node_generate_certificate API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverNodeId']
    ...
    def rover_node_renew_certificate(self, rover_node_renew_certificate_details, rover_node_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/rover_node_renew_certificate.py.html>`__ to see an example of how to use rover_node_renew_certificate API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverNodeId']
    ...
    def rover_node_replace_certificate_authority(self, rover_node_replace_certificate_authority_details, rover_node_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/rover_node_replace_certificate_authority.py.html>`__ to see an example of how to use rover_node_replace_certificate_authority API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverNodeId']
    ...
    def rover_node_retrieve_leaf_certificate(self, rover_node_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/rover_node_retrieve_leaf_certificate.py.html>`__ to see an example of how to use rover_node_retrieve_leaf_certificate API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverNodeId']
    ...
    def update_rover_node(self, rover_node_id, update_rover_node_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/rover/update_rover_node.py.html>`__ to see an example of how to use update_rover_node API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['roverNodeId']
        resource_path = "/roverNodes/{roverNodeId}"
