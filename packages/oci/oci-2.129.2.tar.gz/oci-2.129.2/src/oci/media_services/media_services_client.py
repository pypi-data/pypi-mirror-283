...
class MediaServicesClient(object):
    ...
    def add_media_asset_lock(self, add_lock_details, media_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/add_media_asset_lock.py.html>`__ to see an example of how to use add_media_asset_lock API.
        """
    ...
    def add_media_workflow_configuration_lock(self, add_resource_lock_details, media_workflow_configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/add_media_workflow_configuration_lock.py.html>`__ to see an example of how to use add_media_workflow_configuration_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def add_media_workflow_job_lock(self, add_lock_details, media_workflow_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/add_media_workflow_job_lock.py.html>`__ to see an example of how to use add_media_workflow_job_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def add_media_workflow_lock(self, add_resource_lock_details, media_workflow_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/add_media_workflow_lock.py.html>`__ to see an example of how to use add_media_workflow_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def add_stream_cdn_config_lock(self, add_resource_lock_details, stream_cdn_config_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/add_stream_cdn_config_lock.py.html>`__ to see an example of how to use add_stream_cdn_config_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def add_stream_distribution_channel_lock(self, add_resource_lock_details, stream_distribution_channel_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/add_stream_distribution_channel_lock.py.html>`__ to see an example of how to use add_stream_distribution_channel_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def add_stream_packaging_config_lock(self, add_resource_lock_details, stream_packaging_config_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/add_stream_packaging_config_lock.py.html>`__ to see an example of how to use add_stream_packaging_config_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_media_asset_compartment(self, media_asset_id, change_media_asset_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/change_media_asset_compartment.py.html>`__ to see an example of how to use change_media_asset_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaAssetId']
    ...
    def change_media_workflow_compartment(self, media_workflow_id, change_media_workflow_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/change_media_workflow_compartment.py.html>`__ to see an example of how to use change_media_workflow_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaWorkflowId']
    ...
    def change_media_workflow_configuration_compartment(self, media_workflow_configuration_id, change_media_workflow_configuration_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/change_media_workflow_configuration_compartment.py.html>`__ to see an example of how to use change_media_workflow_configuration_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaWorkflowConfigurationId']
    ...
    def change_media_workflow_job_compartment(self, media_workflow_job_id, change_media_workflow_job_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/change_media_workflow_job_compartment.py.html>`__ to see an example of how to use change_media_workflow_job_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaWorkflowJobId']
    ...
    def change_stream_distribution_channel_compartment(self, stream_distribution_channel_id, change_stream_distribution_channel_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/change_stream_distribution_channel_compartment.py.html>`__ to see an example of how to use change_stream_distribution_channel_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamDistributionChannelId']
    ...
    def create_media_asset(self, create_media_asset_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/create_media_asset.py.html>`__ to see an example of how to use create_media_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_media_workflow(self, create_media_workflow_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/create_media_workflow.py.html>`__ to see an example of how to use create_media_workflow API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_media_workflow_configuration(self, create_media_workflow_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/create_media_workflow_configuration.py.html>`__ to see an example of how to use create_media_workflow_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_media_workflow_job(self, create_media_workflow_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/create_media_workflow_job.py.html>`__ to see an example of how to use create_media_workflow_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_stream_cdn_config(self, create_stream_cdn_config_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/create_stream_cdn_config.py.html>`__ to see an example of how to use create_stream_cdn_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_stream_distribution_channel(self, create_stream_distribution_channel_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/create_stream_distribution_channel.py.html>`__ to see an example of how to use create_stream_distribution_channel API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_stream_packaging_config(self, create_stream_packaging_config_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/create_stream_packaging_config.py.html>`__ to see an example of how to use create_stream_packaging_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_media_asset(self, media_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/delete_media_asset.py.html>`__ to see an example of how to use delete_media_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaAssetId']
    ...
    def delete_media_asset_distribution_channel_attachment(self, media_asset_id, distribution_channel_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/delete_media_asset_distribution_channel_attachment.py.html>`__ to see an example of how to use delete_media_asset_distribution_channel_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_media_workflow(self, media_workflow_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/delete_media_workflow.py.html>`__ to see an example of how to use delete_media_workflow API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaWorkflowId']
    ...
    def delete_media_workflow_configuration(self, media_workflow_configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/delete_media_workflow_configuration.py.html>`__ to see an example of how to use delete_media_workflow_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaWorkflowConfigurationId']
    ...
    def delete_media_workflow_job(self, media_workflow_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/delete_media_workflow_job.py.html>`__ to see an example of how to use delete_media_workflow_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaWorkflowJobId']
    ...
    def delete_stream_cdn_config(self, stream_cdn_config_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/delete_stream_cdn_config.py.html>`__ to see an example of how to use delete_stream_cdn_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamCdnConfigId']
    ...
    def delete_stream_distribution_channel(self, stream_distribution_channel_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/delete_stream_distribution_channel.py.html>`__ to see an example of how to use delete_stream_distribution_channel API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamDistributionChannelId']
    ...
    def delete_stream_packaging_config(self, stream_packaging_config_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/delete_stream_packaging_config.py.html>`__ to see an example of how to use delete_stream_packaging_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamPackagingConfigId']
    ...
    def get_media_asset(self, media_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/get_media_asset.py.html>`__ to see an example of how to use get_media_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaAssetId']
        resource_path = "/mediaAssets/{mediaAssetId}"
    ...
    def get_media_asset_distribution_channel_attachment(self, media_asset_id, distribution_channel_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/get_media_asset_distribution_channel_attachment.py.html>`__ to see an example of how to use get_media_asset_distribution_channel_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaAssetId', 'distributionChannelId']
        resource_path = "/mediaAssets/{mediaAssetId}/distributionChannelAttachments/{distributionChannelId}"
    ...
    def get_media_workflow(self, media_workflow_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/get_media_workflow.py.html>`__ to see an example of how to use get_media_workflow API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaWorkflowId']
        resource_path = "/mediaWorkflows/{mediaWorkflowId}"
    ...
    def get_media_workflow_configuration(self, media_workflow_configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/get_media_workflow_configuration.py.html>`__ to see an example of how to use get_media_workflow_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaWorkflowConfigurationId']
        resource_path = "/mediaWorkflowConfigurations/{mediaWorkflowConfigurationId}"
    ...
    def get_media_workflow_job(self, media_workflow_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/get_media_workflow_job.py.html>`__ to see an example of how to use get_media_workflow_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaWorkflowJobId']
        resource_path = "/mediaWorkflowJobs/{mediaWorkflowJobId}"
    ...
    def get_stream_cdn_config(self, stream_cdn_config_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/get_stream_cdn_config.py.html>`__ to see an example of how to use get_stream_cdn_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamCdnConfigId']
        resource_path = "/streamCdnConfigs/{streamCdnConfigId}"
    ...
    def get_stream_distribution_channel(self, stream_distribution_channel_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/get_stream_distribution_channel.py.html>`__ to see an example of how to use get_stream_distribution_channel API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamDistributionChannelId']
        resource_path = "/streamDistributionChannels/{streamDistributionChannelId}"
    ...
    def get_stream_packaging_config(self, stream_packaging_config_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/get_stream_packaging_config.py.html>`__ to see an example of how to use get_stream_packaging_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamPackagingConfigId']
        resource_path = "/streamPackagingConfigs/{streamPackagingConfigId}"
    ...
    def ingest_stream_distribution_channel(self, stream_distribution_channel_id, ingest_stream_distribution_channel_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/ingest_stream_distribution_channel.py.html>`__ to see an example of how to use ingest_stream_distribution_channel API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamDistributionChannelId']
    ...
    def list_media_asset_distribution_channel_attachments(self, media_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/list_media_asset_distribution_channel_attachments.py.html>`__ to see an example of how to use list_media_asset_distribution_channel_attachments API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaAssetId']
    ...
    def list_media_assets(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/list_media_assets.py.html>`__ to see an example of how to use list_media_assets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/mediaAssets"
    ...
    def list_media_workflow_configurations(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/list_media_workflow_configurations.py.html>`__ to see an example of how to use list_media_workflow_configurations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/mediaWorkflowConfigurations"
    ...
    def list_media_workflow_jobs(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/list_media_workflow_jobs.py.html>`__ to see an example of how to use list_media_workflow_jobs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/mediaWorkflowJobs"
    ...
    def list_media_workflow_task_declarations(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/list_media_workflow_task_declarations.py.html>`__ to see an example of how to use list_media_workflow_task_declarations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def list_media_workflows(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/list_media_workflows.py.html>`__ to see an example of how to use list_media_workflows API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/mediaWorkflows"
    ...
    def list_stream_cdn_configs(self, distribution_channel_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/list_stream_cdn_configs.py.html>`__ to see an example of how to use list_stream_cdn_configs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_stream_distribution_channels(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/list_stream_distribution_channels.py.html>`__ to see an example of how to use list_stream_distribution_channels API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/streamDistributionChannels"
    ...
    def list_stream_packaging_configs(self, distribution_channel_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/list_stream_packaging_configs.py.html>`__ to see an example of how to use list_stream_packaging_configs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributionChannelId']
        resource_path = "/streamPackagingConfigs"
    ...
    def list_system_media_workflows(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/list_system_media_workflows.py.html>`__ to see an example of how to use list_system_media_workflows API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def remove_media_asset_lock(self, remove_lock_details, media_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/remove_media_asset_lock.py.html>`__ to see an example of how to use remove_media_asset_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaAssetId']
    ...
    def remove_media_workflow_configuration_lock(self, remove_resource_lock_details, media_workflow_configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/remove_media_workflow_configuration_lock.py.html>`__ to see an example of how to use remove_media_workflow_configuration_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaWorkflowConfigurationId']
    ...
    def remove_media_workflow_job_lock(self, remove_lock_details, media_workflow_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/remove_media_workflow_job_lock.py.html>`__ to see an example of how to use remove_media_workflow_job_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaWorkflowJobId']
    ...
    def remove_media_workflow_lock(self, remove_resource_lock_details, media_workflow_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/remove_media_workflow_lock.py.html>`__ to see an example of how to use remove_media_workflow_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaWorkflowId']
    ...
    def remove_stream_cdn_config_lock(self, remove_resource_lock_details, stream_cdn_config_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/remove_stream_cdn_config_lock.py.html>`__ to see an example of how to use remove_stream_cdn_config_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamCdnConfigId']
    ...
    def remove_stream_distribution_channel_lock(self, remove_resource_lock_details, stream_distribution_channel_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/remove_stream_distribution_channel_lock.py.html>`__ to see an example of how to use remove_stream_distribution_channel_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamDistributionChannelId']
    ...
    def remove_stream_packaging_config_lock(self, remove_resource_lock_details, stream_packaging_config_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/remove_stream_packaging_config_lock.py.html>`__ to see an example of how to use remove_stream_packaging_config_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamPackagingConfigId']
    ...
    def update_media_asset(self, media_asset_id, update_media_asset_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/update_media_asset.py.html>`__ to see an example of how to use update_media_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaAssetId']
        resource_path = "/mediaAssets/{mediaAssetId}"
    ...
    def update_media_workflow(self, media_workflow_id, update_media_workflow_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/update_media_workflow.py.html>`__ to see an example of how to use update_media_workflow API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaWorkflowId']
        resource_path = "/mediaWorkflows/{mediaWorkflowId}"
    ...
    def update_media_workflow_configuration(self, media_workflow_configuration_id, update_media_workflow_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/update_media_workflow_configuration.py.html>`__ to see an example of how to use update_media_workflow_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaWorkflowConfigurationId']
        resource_path = "/mediaWorkflowConfigurations/{mediaWorkflowConfigurationId}"
    ...
    def update_media_workflow_job(self, media_workflow_job_id, update_media_workflow_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/update_media_workflow_job.py.html>`__ to see an example of how to use update_media_workflow_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mediaWorkflowJobId']
        resource_path = "/mediaWorkflowJobs/{mediaWorkflowJobId}"
    ...
    def update_stream_cdn_config(self, stream_cdn_config_id, update_stream_cdn_config_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/update_stream_cdn_config.py.html>`__ to see an example of how to use update_stream_cdn_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamCdnConfigId']
        resource_path = "/streamCdnConfigs/{streamCdnConfigId}"
    ...
    def update_stream_distribution_channel(self, stream_distribution_channel_id, update_stream_distribution_channel_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/update_stream_distribution_channel.py.html>`__ to see an example of how to use update_stream_distribution_channel API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamDistributionChannelId']
        resource_path = "/streamDistributionChannels/{streamDistributionChannelId}"
    ...
    def update_stream_packaging_config(self, stream_packaging_config_id, update_stream_packaging_config_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/mediaservices/update_stream_packaging_config.py.html>`__ to see an example of how to use update_stream_packaging_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamPackagingConfigId']
        resource_path = "/streamPackagingConfigs/{streamPackagingConfigId}"
