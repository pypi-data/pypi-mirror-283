...
class PerfhubClient(object):
    ...
    def modify_snapshot_settings(self, managed_database_id, modify_snapshot_settings_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/databasemanagement/modify_snapshot_settings.py.html>`__ to see an example of how to use modify_snapshot_settings API.
        """
