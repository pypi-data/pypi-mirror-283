...
class GenerativeAiInferenceClient(object):
    ...
    def chat(self, chat_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/generativeaiinference/chat.py.html>`__ to see an example of how to use chat API.
        """
    ...
    def embed_text(self, embed_text_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/generativeaiinference/embed_text.py.html>`__ to see an example of how to use embed_text API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def generate_text(self, generate_text_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/generativeaiinference/generate_text.py.html>`__ to see an example of how to use generate_text API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def summarize_text(self, summarize_text_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/generativeaiinference/summarize_text.py.html>`__ to see an example of how to use summarize_text API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
