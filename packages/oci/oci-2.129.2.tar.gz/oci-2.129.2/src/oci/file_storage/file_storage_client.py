...
class FileStorageClient(object):
    ...
    def change_file_system_compartment(self, file_system_id, change_file_system_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/change_file_system_compartment.py.html>`__ to see an example of how to use change_file_system_compartment API.
        """
    ...
    def change_filesystem_snapshot_policy_compartment(self, filesystem_snapshot_policy_id, change_filesystem_snapshot_policy_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/change_filesystem_snapshot_policy_compartment.py.html>`__ to see an example of how to use change_filesystem_snapshot_policy_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_mount_target_compartment(self, mount_target_id, change_mount_target_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/change_mount_target_compartment.py.html>`__ to see an example of how to use change_mount_target_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_outbound_connector_compartment(self, outbound_connector_id, change_outbound_connector_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/change_outbound_connector_compartment.py.html>`__ to see an example of how to use change_outbound_connector_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_replication_compartment(self, replication_id, change_replication_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/change_replication_compartment.py.html>`__ to see an example of how to use change_replication_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_export(self, create_export_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/create_export.py.html>`__ to see an example of how to use create_export API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_file_system(self, create_file_system_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/create_file_system.py.html>`__ to see an example of how to use create_file_system API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_filesystem_snapshot_policy(self, create_filesystem_snapshot_policy_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/create_filesystem_snapshot_policy.py.html>`__ to see an example of how to use create_filesystem_snapshot_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_mount_target(self, create_mount_target_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/create_mount_target.py.html>`__ to see an example of how to use create_mount_target API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_outbound_connector(self, create_outbound_connector_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/create_outbound_connector.py.html>`__ to see an example of how to use create_outbound_connector API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_replication(self, create_replication_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/create_replication.py.html>`__ to see an example of how to use create_replication API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_snapshot(self, create_snapshot_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/create_snapshot.py.html>`__ to see an example of how to use create_snapshot API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_export(self, export_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/delete_export.py.html>`__ to see an example of how to use delete_export API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_file_system(self, file_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/delete_file_system.py.html>`__ to see an example of how to use delete_file_system API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fileSystemId']
    ...
    def delete_filesystem_snapshot_policy(self, filesystem_snapshot_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/delete_filesystem_snapshot_policy.py.html>`__ to see an example of how to use delete_filesystem_snapshot_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['filesystemSnapshotPolicyId']
    ...
    def delete_mount_target(self, mount_target_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/delete_mount_target.py.html>`__ to see an example of how to use delete_mount_target API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mountTargetId']
    ...
    def delete_outbound_connector(self, outbound_connector_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/delete_outbound_connector.py.html>`__ to see an example of how to use delete_outbound_connector API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['outboundConnectorId']
    ...
    def delete_replication(self, replication_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/delete_replication.py.html>`__ to see an example of how to use delete_replication API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['replicationId']
    ...
    def delete_replication_target(self, replication_target_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/delete_replication_target.py.html>`__ to see an example of how to use delete_replication_target API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_snapshot(self, snapshot_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/delete_snapshot.py.html>`__ to see an example of how to use delete_snapshot API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def detach_clone(self, file_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/detach_clone.py.html>`__ to see an example of how to use detach_clone API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fileSystemId']
    ...
    def estimate_replication(self, file_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/estimate_replication.py.html>`__ to see an example of how to use estimate_replication API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fileSystemId']
    ...
    def get_export(self, export_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/get_export.py.html>`__ to see an example of how to use get_export API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['exportId']
        resource_path = "/exports/{exportId}"
    ...
    def get_export_set(self, export_set_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/get_export_set.py.html>`__ to see an example of how to use get_export_set API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_file_system(self, file_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/get_file_system.py.html>`__ to see an example of how to use get_file_system API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fileSystemId']
        resource_path = "/fileSystems/{fileSystemId}"
    ...
    def get_filesystem_snapshot_policy(self, filesystem_snapshot_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/get_filesystem_snapshot_policy.py.html>`__ to see an example of how to use get_filesystem_snapshot_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['filesystemSnapshotPolicyId']
        resource_path = "/filesystemSnapshotPolicies/{filesystemSnapshotPolicyId}"
    ...
    def get_mount_target(self, mount_target_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/get_mount_target.py.html>`__ to see an example of how to use get_mount_target API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mountTargetId']
        resource_path = "/mountTargets/{mountTargetId}"
    ...
    def get_outbound_connector(self, outbound_connector_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/get_outbound_connector.py.html>`__ to see an example of how to use get_outbound_connector API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['outboundConnectorId']
        resource_path = "/outboundConnectors/{outboundConnectorId}"
    ...
    def get_replication(self, replication_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/get_replication.py.html>`__ to see an example of how to use get_replication API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['replicationId']
        resource_path = "/replications/{replicationId}"
    ...
    def get_replication_target(self, replication_target_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/get_replication_target.py.html>`__ to see an example of how to use get_replication_target API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['replicationTargetId']
        resource_path = "/replicationTargets/{replicationTargetId}"
    ...
    def get_snapshot(self, snapshot_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/get_snapshot.py.html>`__ to see an example of how to use get_snapshot API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['snapshotId']
        resource_path = "/snapshots/{snapshotId}"
    ...
    def list_export_sets(self, compartment_id, availability_domain, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/list_export_sets.py.html>`__ to see an example of how to use list_export_sets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_exports(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/list_exports.py.html>`__ to see an example of how to use list_exports API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/exports"
    ...
    def list_file_systems(self, compartment_id, availability_domain, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/list_file_systems.py.html>`__ to see an example of how to use list_file_systems API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId', 'availabilityDomain']
        resource_path = "/fileSystems"
    ...
    def list_filesystem_snapshot_policies(self, compartment_id, availability_domain, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/list_filesystem_snapshot_policies.py.html>`__ to see an example of how to use list_filesystem_snapshot_policies API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId', 'availabilityDomain']
        resource_path = "/filesystemSnapshotPolicies"
    ...
    def list_mount_targets(self, compartment_id, availability_domain, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/list_mount_targets.py.html>`__ to see an example of how to use list_mount_targets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId', 'availabilityDomain']
        resource_path = "/mountTargets"
    ...
    def list_outbound_connectors(self, compartment_id, availability_domain, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/list_outbound_connectors.py.html>`__ to see an example of how to use list_outbound_connectors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId', 'availabilityDomain']
        resource_path = "/outboundConnectors"
    ...
    def list_replication_targets(self, compartment_id, availability_domain, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/list_replication_targets.py.html>`__ to see an example of how to use list_replication_targets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId', 'availabilityDomain']
    ...
    def list_replications(self, compartment_id, availability_domain, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/list_replications.py.html>`__ to see an example of how to use list_replications API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId', 'availabilityDomain']
        resource_path = "/replications"
    ...
    def list_snapshots(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/list_snapshots.py.html>`__ to see an example of how to use list_snapshots API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/snapshots"
    ...
    def pause_filesystem_snapshot_policy(self, filesystem_snapshot_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/pause_filesystem_snapshot_policy.py.html>`__ to see an example of how to use pause_filesystem_snapshot_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['filesystemSnapshotPolicyId']
    ...
    def unpause_filesystem_snapshot_policy(self, filesystem_snapshot_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/unpause_filesystem_snapshot_policy.py.html>`__ to see an example of how to use unpause_filesystem_snapshot_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['filesystemSnapshotPolicyId']
    ...
    def update_export(self, export_id, update_export_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/update_export.py.html>`__ to see an example of how to use update_export API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['exportId']
        resource_path = "/exports/{exportId}"
    ...
    def update_export_set(self, export_set_id, update_export_set_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/update_export_set.py.html>`__ to see an example of how to use update_export_set API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['exportSetId']
        resource_path = "/exportSets/{exportSetId}"
    ...
    def update_file_system(self, file_system_id, update_file_system_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/update_file_system.py.html>`__ to see an example of how to use update_file_system API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fileSystemId']
        resource_path = "/fileSystems/{fileSystemId}"
    ...
    def update_filesystem_snapshot_policy(self, filesystem_snapshot_policy_id, update_filesystem_snapshot_policy_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/update_filesystem_snapshot_policy.py.html>`__ to see an example of how to use update_filesystem_snapshot_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['filesystemSnapshotPolicyId']
        resource_path = "/filesystemSnapshotPolicies/{filesystemSnapshotPolicyId}"
    ...
    def update_mount_target(self, mount_target_id, update_mount_target_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/update_mount_target.py.html>`__ to see an example of how to use update_mount_target API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['mountTargetId']
        resource_path = "/mountTargets/{mountTargetId}"
    ...
    def update_outbound_connector(self, outbound_connector_id, update_outbound_connector_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/update_outbound_connector.py.html>`__ to see an example of how to use update_outbound_connector API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['outboundConnectorId']
        resource_path = "/outboundConnectors/{outboundConnectorId}"
    ...
    def update_replication(self, replication_id, update_replication_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/update_replication.py.html>`__ to see an example of how to use update_replication API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['replicationId']
        resource_path = "/replications/{replicationId}"
    ...
    def update_snapshot(self, snapshot_id, update_snapshot_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/update_snapshot.py.html>`__ to see an example of how to use update_snapshot API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['snapshotId']
        resource_path = "/snapshots/{snapshotId}"
    ...
    def validate_key_tabs(self, validate_key_tabs_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/filestorage/validate_key_tabs.py.html>`__ to see an example of how to use validate_key_tabs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
