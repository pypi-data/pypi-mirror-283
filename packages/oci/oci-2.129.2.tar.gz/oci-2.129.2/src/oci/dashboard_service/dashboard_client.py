...
class DashboardClient(object):
    ...
    **Important:** Resources for the Dashboards service are created in the tenacy's home region.
    ...
    def change_dashboard_group(self, dashboard_id, change_dashboard_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dashboardservice/change_dashboard_group.py.html>`__ to see an example of how to use change_dashboard_group API.
        """
    ...
    def create_dashboard(self, create_dashboard_details, **kwargs):
        ...
        **Caution:** Resources for the Dashboard service are created in the tenacy's home region.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dashboardservice/create_dashboard.py.html>`__ to see an example of how to use create_dashboard API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_dashboard(self, dashboard_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dashboardservice/delete_dashboard.py.html>`__ to see an example of how to use delete_dashboard API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dashboardId']
    ...
    def get_dashboard(self, dashboard_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dashboardservice/get_dashboard.py.html>`__ to see an example of how to use get_dashboard API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dashboardId']
        resource_path = "/dashboards/{dashboardId}"
    ...
    def list_dashboards(self, dashboard_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dashboardservice/list_dashboards.py.html>`__ to see an example of how to use list_dashboards API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_dashboard(self, dashboard_id, update_dashboard_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/dashboardservice/update_dashboard.py.html>`__ to see an example of how to use update_dashboard API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dashboardId']
        resource_path = "/dashboards/{dashboardId}"
