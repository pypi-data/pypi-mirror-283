...
class AttributesClient(object):
    ...
    def bulk_activate_attribute(self, apm_domain_id, bulk_activate_attribute_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmtraces/bulk_activate_attribute.py.html>`__ to see an example of how to use bulk_activate_attribute API.
        """
    ...
    def bulk_de_activate_attribute(self, apm_domain_id, bulk_de_activate_attribute_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmtraces/bulk_de_activate_attribute.py.html>`__ to see an example of how to use bulk_de_activate_attribute API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
    ...
    def bulk_pin_attribute(self, apm_domain_id, bulk_pin_attribute_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmtraces/bulk_pin_attribute.py.html>`__ to see an example of how to use bulk_pin_attribute API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
    ...
    def bulk_unpin_attribute(self, apm_domain_id, bulk_unpin_attribute_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmtraces/bulk_unpin_attribute.py.html>`__ to see an example of how to use bulk_unpin_attribute API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
    ...
    def bulk_update_attribute(self, apm_domain_id, bulk_update_attribute_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmtraces/bulk_update_attribute.py.html>`__ to see an example of how to use bulk_update_attribute API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
    ...
    def bulk_update_attribute_notes(self, apm_domain_id, bulk_update_attribute_notes_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmtraces/bulk_update_attribute_notes.py.html>`__ to see an example of how to use bulk_update_attribute_notes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apmDomainId']
    ...
    def get_status_auto_activate(self, apm_domain_id, data_key_type, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmtraces/get_status_auto_activate.py.html>`__ to see an example of how to use get_status_auto_activate API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def put_toggle_auto_activate(self, apm_domain_id, is_auto_activate_on, data_key_type, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/apmtraces/put_toggle_auto_activate.py.html>`__ to see an example of how to use put_toggle_auto_activate API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
