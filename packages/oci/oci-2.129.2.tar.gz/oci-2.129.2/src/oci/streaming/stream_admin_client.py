...
class StreamAdminClient(object):
    ...
    def change_connect_harness_compartment(self, connect_harness_id, change_connect_harness_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/change_connect_harness_compartment.py.html>`__ to see an example of how to use change_connect_harness_compartment API.
        """
    ...
    def change_stream_compartment(self, stream_id, change_stream_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/change_stream_compartment.py.html>`__ to see an example of how to use change_stream_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_stream_pool_compartment(self, stream_pool_id, change_stream_pool_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/change_stream_pool_compartment.py.html>`__ to see an example of how to use change_stream_pool_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_connect_harness(self, create_connect_harness_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/create_connect_harness.py.html>`__ to see an example of how to use create_connect_harness API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_stream(self, create_stream_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/create_stream.py.html>`__ to see an example of how to use create_stream API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_stream_pool(self, create_stream_pool_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/create_stream_pool.py.html>`__ to see an example of how to use create_stream_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_connect_harness(self, connect_harness_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/delete_connect_harness.py.html>`__ to see an example of how to use delete_connect_harness API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['connectHarnessId']
    ...
    def delete_stream(self, stream_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/delete_stream.py.html>`__ to see an example of how to use delete_stream API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamId']
    ...
    def delete_stream_pool(self, stream_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/delete_stream_pool.py.html>`__ to see an example of how to use delete_stream_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamPoolId']
    ...
    def get_connect_harness(self, connect_harness_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/get_connect_harness.py.html>`__ to see an example of how to use get_connect_harness API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['connectHarnessId']
        resource_path = "/connectharnesses/{connectHarnessId}"
    ...
    def get_stream(self, stream_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/get_stream.py.html>`__ to see an example of how to use get_stream API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamId']
        resource_path = "/streams/{streamId}"
    ...
    def get_stream_pool(self, stream_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/get_stream_pool.py.html>`__ to see an example of how to use get_stream_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamPoolId']
        resource_path = "/streampools/{streamPoolId}"
    ...
    def list_connect_harnesses(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/list_connect_harnesses.py.html>`__ to see an example of how to use list_connect_harnesses API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_stream_pools(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/list_stream_pools.py.html>`__ to see an example of how to use list_stream_pools API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/streampools"
    ...
    def list_streams(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/list_streams.py.html>`__ to see an example of how to use list_streams API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/streams"
    ...
    def update_connect_harness(self, connect_harness_id, update_connect_harness_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/update_connect_harness.py.html>`__ to see an example of how to use update_connect_harness API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['connectHarnessId']
        resource_path = "/connectharnesses/{connectHarnessId}"
    ...
    def update_stream(self, stream_id, update_stream_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/update_stream.py.html>`__ to see an example of how to use update_stream API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamId']
        resource_path = "/streams/{streamId}"
    ...
    def update_stream_pool(self, stream_pool_id, update_stream_pool_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/streaming/update_stream_pool.py.html>`__ to see an example of how to use update_stream_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['streamPoolId']
        resource_path = "/streampools/{streamPoolId}"
