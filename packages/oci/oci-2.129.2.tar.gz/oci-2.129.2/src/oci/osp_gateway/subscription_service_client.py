...
class SubscriptionServiceClient(object):
    ...
    def authorize_subscription_payment(self, osp_home_region, subscription_id, compartment_id, authorize_subscription_payment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ospgateway/authorize_subscription_payment.py.html>`__ to see an example of how to use authorize_subscription_payment API.
        """
    ...
    def get_subscription(self, subscription_id, osp_home_region, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ospgateway/get_subscription.py.html>`__ to see an example of how to use get_subscription API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['subscriptionId', 'ospHomeRegion', 'compartmentId']
    ...
    def list_subscriptions(self, osp_home_region, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ospgateway/list_subscriptions.py.html>`__ to see an example of how to use list_subscriptions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def pay_subscription(self, osp_home_region, subscription_id, compartment_id, pay_subscription_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ospgateway/pay_subscription.py.html>`__ to see an example of how to use pay_subscription API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['subscriptionId', 'ospHomeRegion', 'compartmentId']
    ...
    def update_subscription(self, subscription_id, osp_home_region, compartment_id, update_subscription_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/ospgateway/update_subscription.py.html>`__ to see an example of how to use update_subscription API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['subscriptionId', 'ospHomeRegion', 'compartmentId']
        resource_path = "/subscriptions/{subscriptionId}"
