...
class SecretsClient(object):
    ...
    def get_secret_bundle(self, secret_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/secrets/get_secret_bundle.py.html>`__ to see an example of how to use get_secret_bundle API.
        """
    ...
    def get_secret_bundle_by_name(self, secret_name, vault_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/secrets/get_secret_bundle_by_name.py.html>`__ to see an example of how to use get_secret_bundle_by_name API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_secret_bundle_versions(self, secret_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/secrets/list_secret_bundle_versions.py.html>`__ to see an example of how to use list_secret_bundle_versions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['secretId']
