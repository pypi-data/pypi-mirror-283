...
class EventsClient(object):
    ...
    def change_rule_compartment(self, rule_id, change_rule_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/events/change_rule_compartment.py.html>`__ to see an example of how to use change_rule_compartment API.
        """
    ...
    def create_rule(self, create_rule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/events/create_rule.py.html>`__ to see an example of how to use create_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/rules"
    ...
    def delete_rule(self, rule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/events/delete_rule.py.html>`__ to see an example of how to use delete_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['ruleId']
    ...
    def get_rule(self, rule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/events/get_rule.py.html>`__ to see an example of how to use get_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['ruleId']
        resource_path = "/rules/{ruleId}"
    ...
    def list_rules(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/events/list_rules.py.html>`__ to see an example of how to use list_rules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_rule(self, rule_id, update_rule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/events/update_rule.py.html>`__ to see an example of how to use update_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['ruleId']
        resource_path = "/rules/{ruleId}"
