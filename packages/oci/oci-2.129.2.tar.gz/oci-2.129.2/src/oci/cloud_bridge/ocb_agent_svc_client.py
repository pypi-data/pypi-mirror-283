...
class OcbAgentSvcClient(object):
    ...
    def add_agent_dependency(self, environment_id, add_agent_dependency_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/add_agent_dependency.py.html>`__ to see an example of how to use add_agent_dependency API.
        """
    ...
    def change_agent_compartment(self, agent_id, change_agent_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/change_agent_compartment.py.html>`__ to see an example of how to use change_agent_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_agent_dependency_compartment(self, agent_dependency_id, change_agent_dependency_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/change_agent_dependency_compartment.py.html>`__ to see an example of how to use change_agent_dependency_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_environment_compartment(self, environment_id, change_environment_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/change_environment_compartment.py.html>`__ to see an example of how to use change_environment_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['environmentId']
    ...
    def create_agent(self, create_agent_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/create_agent.py.html>`__ to see an example of how to use create_agent API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_agent_dependency(self, create_agent_dependency_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/create_agent_dependency.py.html>`__ to see an example of how to use create_agent_dependency API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_environment(self, create_environment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/create_environment.py.html>`__ to see an example of how to use create_environment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_agent(self, agent_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/delete_agent.py.html>`__ to see an example of how to use delete_agent API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['agentId']
    ...
    def delete_agent_dependency(self, agent_dependency_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/delete_agent_dependency.py.html>`__ to see an example of how to use delete_agent_dependency API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['agentDependencyId']
    ...
    def delete_environment(self, environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/delete_environment.py.html>`__ to see an example of how to use delete_environment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['environmentId']
    ...
    def get_agent(self, agent_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/get_agent.py.html>`__ to see an example of how to use get_agent API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['agentId']
        resource_path = "/agents/{agentId}"
    ...
    def get_agent_dependency(self, agent_dependency_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/get_agent_dependency.py.html>`__ to see an example of how to use get_agent_dependency API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['agentDependencyId']
        resource_path = "/agentDependencies/{agentDependencyId}"
    ...
    def get_environment(self, environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/get_environment.py.html>`__ to see an example of how to use get_environment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['environmentId']
        resource_path = "/environments/{environmentId}"
    ...
    def get_plugin(self, agent_id, plugin_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/get_plugin.py.html>`__ to see an example of how to use get_plugin API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_agent_dependencies(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/list_agent_dependencies.py.html>`__ to see an example of how to use list_agent_dependencies API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_agents(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/list_agents.py.html>`__ to see an example of how to use list_agents API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/agents"
    ...
    def list_appliance_images(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/list_appliance_images.py.html>`__ to see an example of how to use list_appliance_images API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def list_environments(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/list_environments.py.html>`__ to see an example of how to use list_environments API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/environments"
    ...
    def remove_agent_dependency(self, environment_id, remove_agent_dependency_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/remove_agent_dependency.py.html>`__ to see an example of how to use remove_agent_dependency API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['environmentId']
    ...
    def update_agent(self, agent_id, update_agent_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/update_agent.py.html>`__ to see an example of how to use update_agent API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['agentId']
        resource_path = "/agents/{agentId}"
    ...
    def update_agent_dependency(self, agent_dependency_id, update_agent_dependency_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/update_agent_dependency.py.html>`__ to see an example of how to use update_agent_dependency API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['agentDependencyId']
        resource_path = "/agentDependencies/{agentDependencyId}"
    ...
    def update_environment(self, environment_id, update_environment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/update_environment.py.html>`__ to see an example of how to use update_environment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['environmentId']
        resource_path = "/environments/{environmentId}"
    ...
    def update_plugin(self, agent_id, plugin_name, update_plugin_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/cloudbridge/update_plugin.py.html>`__ to see an example of how to use update_plugin API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['agentId', 'pluginName']
        resource_path = "/agents/{agentId}/plugins/{pluginName}"
