...
class KmsManagementClient(object):
    ...
    def backup_key(self, key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/backup_key.py.html>`__ to see an example of how to use backup_key API.
        """
    ...
    def cancel_key_deletion(self, key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/cancel_key_deletion.py.html>`__ to see an example of how to use cancel_key_deletion API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['keyId']
    ...
    def cancel_key_version_deletion(self, key_id, key_version_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/cancel_key_version_deletion.py.html>`__ to see an example of how to use cancel_key_version_deletion API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_key_compartment(self, key_id, change_key_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/change_key_compartment.py.html>`__ to see an example of how to use change_key_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['keyId']
    ...
    def create_key(self, create_key_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/create_key.py.html>`__ to see an example of how to use create_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_key_version(self, key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/create_key_version.py.html>`__ to see an example of how to use create_key_version API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['keyId']
    ...
    def disable_key(self, key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/disable_key.py.html>`__ to see an example of how to use disable_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['keyId']
    ...
    def enable_key(self, key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/enable_key.py.html>`__ to see an example of how to use enable_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['keyId']
    ...
    def get_key(self, key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/get_key.py.html>`__ to see an example of how to use get_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['keyId']
    ...
    def get_key_version(self, key_id, key_version_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/get_key_version.py.html>`__ to see an example of how to use get_key_version API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['keyId', 'keyVersionId']
    ...
    def get_replication_status(self, replication_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/get_replication_status.py.html>`__ to see an example of how to use get_replication_status API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_wrapping_key(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/get_wrapping_key.py.html>`__ to see an example of how to use get_wrapping_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def import_key(self, import_key_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/import_key.py.html>`__ to see an example of how to use import_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def import_key_version(self, key_id, import_key_version_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/import_key_version.py.html>`__ to see an example of how to use import_key_version API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['keyId']
    ...
    def list_key_versions(self, key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/list_key_versions.py.html>`__ to see an example of how to use list_key_versions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['keyId']
        resource_path = "/20180608/keys/{keyId}/keyVersions"
    ...
    def list_keys(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/list_keys.py.html>`__ to see an example of how to use list_keys API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def restore_key_from_file(self, restore_key_from_file_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/restore_key_from_file.py.html>`__ to see an example of how to use restore_key_from_file API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def restore_key_from_object_store(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/restore_key_from_object_store.py.html>`__ to see an example of how to use restore_key_from_object_store API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def schedule_key_deletion(self, key_id, schedule_key_deletion_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/schedule_key_deletion.py.html>`__ to see an example of how to use schedule_key_deletion API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['keyId']
    ...
    def schedule_key_version_deletion(self, key_id, key_version_id, schedule_key_version_deletion_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/schedule_key_version_deletion.py.html>`__ to see an example of how to use schedule_key_version_deletion API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['keyId', 'keyVersionId']
    ...
    def update_key(self, key_id, update_key_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/keymanagement/update_key.py.html>`__ to see an example of how to use update_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['keyId']
        resource_path = "/20180608/keys/{keyId}"
