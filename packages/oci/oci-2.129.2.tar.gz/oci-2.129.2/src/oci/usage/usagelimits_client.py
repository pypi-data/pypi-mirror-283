...
class UsagelimitsClient(object):
    ...
    def list_usage_limits(self, compartment_id, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/usage/list_usage_limits.py.html>`__ to see an example of how to use list_usage_limits API.
        """
