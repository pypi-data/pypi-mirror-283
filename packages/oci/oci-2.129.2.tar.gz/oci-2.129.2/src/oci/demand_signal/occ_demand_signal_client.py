...
class OccDemandSignalClient(object):
    ...
    def change_occ_demand_signal_compartment(self, occ_demand_signal_id, change_occ_demand_signal_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/demandsignal/change_occ_demand_signal_compartment.py.html>`__ to see an example of how to use change_occ_demand_signal_compartment API.
        """
    ...
    def create_occ_demand_signal(self, create_occ_demand_signal_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/demandsignal/create_occ_demand_signal.py.html>`__ to see an example of how to use create_occ_demand_signal API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_occ_demand_signal(self, occ_demand_signal_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/demandsignal/delete_occ_demand_signal.py.html>`__ to see an example of how to use delete_occ_demand_signal API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['occDemandSignalId']
    ...
    def get_occ_demand_signal(self, occ_demand_signal_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/demandsignal/get_occ_demand_signal.py.html>`__ to see an example of how to use get_occ_demand_signal API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['occDemandSignalId']
        resource_path = "/occDemandSignals/{occDemandSignalId}"
    ...
    def list_occ_demand_signals(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/demandsignal/list_occ_demand_signals.py.html>`__ to see an example of how to use list_occ_demand_signals API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/occDemandSignals"
    ...
    def patch_occ_demand_signal(self, occ_demand_signal_id, patch_occ_demand_signal_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/demandsignal/patch_occ_demand_signal.py.html>`__ to see an example of how to use patch_occ_demand_signal API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['occDemandSignalId']
        resource_path = "/occDemandSignals/{occDemandSignalId}"
    ...
    def update_occ_demand_signal(self, occ_demand_signal_id, update_occ_demand_signal_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/demandsignal/update_occ_demand_signal.py.html>`__ to see an example of how to use update_occ_demand_signal API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['occDemandSignalId']
        resource_path = "/occDemandSignals/{occDemandSignalId}"
