...
class AnnouncementsPreferencesClient(object):
    ...
    def create_announcements_preference(self, announcements_preference_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/announcementsservice/create_announcements_preference.py.html>`__ to see an example of how to use create_announcements_preference API.
        """
    ...
    def get_announcements_preference(self, preference_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/announcementsservice/get_announcements_preference.py.html>`__ to see an example of how to use get_announcements_preference API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_announcements_preferences(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/announcementsservice/list_announcements_preferences.py.html>`__ to see an example of how to use list_announcements_preferences API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_announcements_preference(self, preference_id, announcements_preference_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.129.2/announcementsservice/update_announcements_preference.py.html>`__ to see an example of how to use update_announcements_preference API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['preferenceId']
        resource_path = "/announcementsPreferences/{preferenceId}"
