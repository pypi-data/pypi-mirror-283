...
class SourceKafkaEnvelopeUpsertOptionsArgs:
    def __init__(__self__, *,
                 value_decoding_errors: Optional[pulumi.Input[str]] = None):
    ...
    def value_decoding_errors(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "value_decoding_errors")

    @value_decoding_errors.setter
    def value_decoding_errors(self, value: Optional[pulumi.Input[str]]):
