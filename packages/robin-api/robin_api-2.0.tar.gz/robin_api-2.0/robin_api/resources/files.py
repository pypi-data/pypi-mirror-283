...
from ..types import  ChatCompletionChunk, ChatCompletion, FilesModel, Models, DeepLevel, IndexFile, MetricsChunk,ResponseFile
import validators
...
class Files(SyncAPIResource):
    ...
    def get_folder_files(self, *, api_folder_id:str):
        body_request= { 
            "apiFolderId" : api_folder_id,
        }
        ...
        if value.status_code == 200:
            ...
            return construct_type_v2(type_=Docs, value=value.message )
        else:
            return value
