...
class XClient:
    ...
    async def message_loop(self, blocksize=100000):
        ...
        while True:
            ...
            if time.time() - self.lastCheckTime > 3 and self.data_channel_open or self.pc.signalingState == "closed":
                print("No check received for 3 seconds, reset peer connection")
                self.setup_peer_connection()
