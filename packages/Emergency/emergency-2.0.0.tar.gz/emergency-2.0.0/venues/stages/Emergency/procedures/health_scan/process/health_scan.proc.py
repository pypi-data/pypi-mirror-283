...
def main ():
	...
	status_path = os.environ.get ("Emergency___status_path")
	status_relative_path = os.environ.get ("Emergency___status_relative_path")
	host = os.environ.get ("Emergency___harbor_host")
	port = int (os.environ.get ("Emergency___harbor_port"))
