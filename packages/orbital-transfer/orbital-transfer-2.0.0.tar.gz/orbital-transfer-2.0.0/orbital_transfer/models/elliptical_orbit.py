...
class EllipticalOrbit(Orbit):
    ...
    parameters: Optional[EllipticalOrbitParameters] = None
    advanced_parameters: Optional[AdvancedOrbitParameters] = Field(default=None, alias="advancedParameters")
    __properties: ClassVar[List[str]] = ["type", "inclination", "parameters", "advancedParameters"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EllipticalOrbit from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EllipticalOrbit from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "parameters": EllipticalOrbitParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
