...
class AnalyticalOrbitalTransferRequest(BaseModel):
    ...
    drag_perturbation: Optional[AnalyticalOrbitalTransferRequestDragPerturbation] = Field(default=None, alias="dragPerturbation")
    __properties: ClassVar[List[str]] = ["missionDateTime", "maximumDuration", "initialOrbit", "targetOrbit", "spacecraftGeometry", "platform", "propulsionSystem", "dragPerturbation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dragPerturbation": AnalyticalOrbitalTransferRequestDragPerturbation.from_dict(obj["dragPerturbation"]) if obj.get("dragPerturbation") is not None else None
        })
        return _obj
