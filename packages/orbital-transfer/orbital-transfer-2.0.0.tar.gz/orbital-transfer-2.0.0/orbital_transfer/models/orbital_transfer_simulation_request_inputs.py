...
class OrbitalTransferSimulationRequestInputs(BaseModel):
    ...
    thrust_efficiency_cutoff: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="TBD", alias="thrustEfficiencyCutoff")
    terrestrial_longitude_targeted: Optional[StrictBool] = Field(default=False, description="TBD", alias="terrestrialLongitudeTargeted")
