...
class CircularOrbit(Orbit):
    ...
    parameters: Optional[CircularOrbitParameters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parameters": CircularOrbitParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
