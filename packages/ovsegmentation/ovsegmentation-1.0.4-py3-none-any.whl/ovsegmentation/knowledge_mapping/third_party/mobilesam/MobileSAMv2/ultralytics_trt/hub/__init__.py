...
from ultralytics_trt.hub.auth import Auth
from ultralytics_trt.hub.utils import PREFIX
from ultralytics_trt.yolo.data.utils import HUBDatasetStats
from ultralytics_trt.yolo.utils import LOGGER, SETTINGS, USER_CONFIG_DIR, yaml_save
...
def export_fmts_hub():
    ...
    from ultralytics_trt.yolo.engine.exporter import export_formats
