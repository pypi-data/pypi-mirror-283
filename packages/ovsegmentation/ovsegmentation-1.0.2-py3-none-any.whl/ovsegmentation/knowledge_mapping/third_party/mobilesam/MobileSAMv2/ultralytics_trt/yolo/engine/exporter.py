...
from ultralytics_trt.nn.autobackend import check_class_names
from ultralytics_trt.nn.modules import C2f, Detect, Segment
from ultralytics_trt.yolo.cfg import get_cfg
from ultralytics_trt.yolo.utils import (
    DEFAULT_CFG,
    LINUX,
    LOGGER,
    MACOS,
...
from ultralytics_trt.yolo.utils.checks import (
    check_imgsz,
    check_requirements,
    check_version,
)
from ultralytics_trt.yolo.utils.files import file_size
from ultralytics_trt.yolo.utils.ops import Profile
from ultralytics_trt.yolo.utils.torch_utils import (
    get_latest_opset,
    select_device,
