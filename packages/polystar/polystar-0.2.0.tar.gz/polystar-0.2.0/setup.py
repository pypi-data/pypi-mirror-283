...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        build_args = ['--config', cfg, '--target', '_polystar']
        ...
        if not USE_HDF5:
            cmake_args += ["-DPOLYSTAR_HDF5=FALSE"]
        ...
        check_call([get_cmake(), '--build', '.', '--target', "_polystar"] + build_args, cwd=self.build_temp)
