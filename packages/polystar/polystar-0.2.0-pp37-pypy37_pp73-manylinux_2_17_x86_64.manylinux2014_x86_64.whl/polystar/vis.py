...
@dataclass
class VisPolyhedron:
    """Wrapper to contain visualisation options for a polystar.Polyhedron

    Attributes
    ----------
    polyhedron : Union[Polyhedron,]
        The polyhedron to be visualised.
...
def vis_polyhedron(polyhedron: VisPolyhedron, **kwargs):
    ...
    Parameters
    ----------
    polyhedron : Union[VisPolyhedron, polystar.Polyhedron,]
        The polyhedron to be visualised. Any object with similar `vertices` and `faces` properties may work as well.
    kwargs
        Optional keyword arguments for the VisPolyhedron constructor. Only used if a Polyhedron or
        is provided as input.
        face_color : Union[str, vispy.color.Color]
            The face color used for Polyhedron or object input.
        edge_color : Union[str, vispy.color.Color]
            The edge color used for Polyhedron or object input.
        fill : bool
            Control drawing the faces of the Polyhedron or object.
        outline : bool
            Control drawing the edges of the Polyhedron or object.
    """
...
def vis_polyhedra(polyhedra: List[VisPolyhedron], **kwargs):
    ...
    Parameters
    ----------
    polyhedra : List[Union[VisPolyhedron, polystar.Polyhedron,]]
        The polyhedron to be visualised. Any object with similar `vertices` and `faces` properties may work as well.
    kwargs
        Optional keyword arguments for the VisPolyhedron constructor. Only used if a Polyhedron or
        is provided in the polyhedron list.
        face_color : Union[List[Union[str, vispy.color.Color]],Union[str, vispy.color.Color]]
            A single face color used for all Polyhedron and objects or a list of colors which will be tiled
            to the size of the full polyhedra list.
        edge_color : Union[List[Union[str, vispy.color.Color]],Union[str, vispy.color.Color]]
            A single edge color used for all Polyhedron and objects or a list of colors which will be tiled
            to the size of the full polyhedra list.
        fill : Union[List[bool], bool]
            A single value to control drawing the faces of all Polyhedron and objects or a list of boolean
            values which will be tiled to the size of the full polyhedra list.
        outline : Union[List[bool], bool]
            A single value to control drawing the edges of all Polyhedron and objects or a list of boolean
            values which will be tiled to the size of the full polyhedra list.
        opacity : Union[List[float], float]
            A single value to control face opacity of all Polyhedron and objects or a list of floating point
            values which will be tiled to the size of the full polyhedra list.
    """
