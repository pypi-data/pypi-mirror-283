...
"""
tqsdk2 .tafunc 模块包含了一批用于技术指标计算的函数
...
from tqsdk2.tqdatetime  import _get_period_timestamp
...
def ref(series, n):
    ...
    Example::
        ...
        from tqsdk2 import TqApi, TqAuth, TqSim, tafunc
...
def time_to_ns_timestamp(input_time):
    ...
    Example::
        ...
        from tqsdk2.tafunc import time_to_ns_timestamp
...
def time_to_s_timestamp(input_time):
    ...
    Example::
        ...
        from tqsdk2.tafunc import time_to_s_timestamp
...
def time_to_str(input_time):
    ...
    Example::
        ...
        from tqsdk2.tafunc import time_to_str
...
def barlast(cond):
    ...
    Example::
        ...
        from tqsdk2.tafunc import barlast
...
def get_t(df, expire_datetime):
    ...
    Example::
        ...
        from tqsdk2 import TqApi, TqAuth, tafunc
