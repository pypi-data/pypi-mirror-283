...
class SearchEngineGUI(QWidget):
    ...
    def display_results(self, results, web_info):
        ...
        <div class="result">
            ...
            {description}<br>
            <button onclick="window.location.href='{url}'">Read Full Content</button>
        </div>
            """.format(url=result["url"], title=result["title"], description=result["description"])
        ...
        index = self.tabs.addTab(new_tab, "Results: " + self.search_input.text())
