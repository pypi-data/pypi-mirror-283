...
def create_action(args):
    ...
    artefact_creator.run(args.parameter, args.classifier, template_path, contributes_to)
...
def create_parser(subparsers):
    ...
    create_parser.add_argument("-c", "--contributes-to", help="Specifies the parent artefact the created artefact should contribute to or illustrate")
