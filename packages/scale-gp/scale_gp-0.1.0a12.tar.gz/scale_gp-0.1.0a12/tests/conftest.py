...
def client(request: FixtureRequest) -> Iterator[SGP]:
    ...
    with SGP(base_url=base_url, api_key=api_key, _strict_response_validation=strict) as client:
        yield client
...
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncSGP]:
    ...
    async with AsyncSGP(base_url=base_url, api_key=api_key, _strict_response_validation=strict) as client:
        yield client
