...
from scale_gp.types.applications.variant import ChatThreadHistory, ChatThreadFeedback, ApplicationInteraction
...
class TestMessages:
    ...
    @parametrize
    def test_method_feedback(self, client: SGPClient) -> None:
    ...
    @parametrize
    def test_raw_response_feedback(self, client: SGPClient) -> None:
    ...
    @parametrize
    def test_streaming_response_feedback(self, client: SGPClient) -> None:
    ...
    @parametrize
    def test_path_params_feedback(self, client: SGPClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `thread_id` but received ''"):
...
class TestAsyncMessages:
    ...
    @parametrize
    async def test_method_feedback(self, async_client: AsyncSGPClient) -> None:
    ...
    @parametrize
    async def test_raw_response_feedback(self, async_client: AsyncSGPClient) -> None:
    ...
    @parametrize
    async def test_streaming_response_feedback(self, async_client: AsyncSGPClient) -> None:
    ...
    @parametrize
    async def test_path_params_feedback(self, async_client: AsyncSGPClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `thread_id` but received ''"):
