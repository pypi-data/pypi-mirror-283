...
class Configuration(HttpClientConfiguration):
    ...
    def clone_with(self, http_client_instance=None,
                   ...
                   default_host=None, authorization=None,
                   custom_header_authentication_credentials=None):
        ...
        return Configuration(
            ...
            retry_methods=retry_methods, environment=environment, default_host=default_host,
    ...
    environments = {
        Environment.PRODUCTION: {
            ...
            Server.DEFAULT1: 'http://api-server/api/v2'
        },
    ...
    def create_auth_credentials_object(authorization,
        ...
        from mergedapi.http.auth.custom_header_authentication import CustomHeaderAuthenticationCredentials
