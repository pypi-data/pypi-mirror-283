...
class ScoreValueReportRequest(object):

    """Implementation of the 'scoreValueReportRequest' model.

    ValueReportRequest represents a request to register a set of factor values
    against an entity.
    ...
    def __init__(self,
        ...
        """Constructor for the ScoreValueReportRequest class"""
