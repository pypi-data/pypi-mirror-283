...
class DynamicThreshold(object):
    ...
    """Implementation of the 'DynamicThreshold' model.

    Apply dynamic threshold. Learn dynamic threshold value over period
    of time and apply it on value

    Attributes:
        algorithm (Algorithm1Enum): Algorithm used to learn the dynamic
            threshold value
        field_name (str): Field name on which dynamic threshold needs to be
            applied
    ...
    def __init__(self,
        ...
        """Constructor for the DynamicThreshold class"""
