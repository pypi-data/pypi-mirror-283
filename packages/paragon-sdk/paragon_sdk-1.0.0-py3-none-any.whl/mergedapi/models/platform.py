...
from mergedapi.models.release import Release


class Platform(object):

    """Implementation of the 'Platform' model.

    TODO: type model description here.

    Attributes:
        platform_name (str): Platform name, Ex: MX960. Should be of pattern
            [a-zA-Z][a-zA-Z0-9_-]*
        releases (List[Release]): Release information for the products
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('releases') is not None:
            releases = [Release.from_dictionary(x) for x in dictionary.get('releases')]
        else:
            releases = APIHelper.SKIP
