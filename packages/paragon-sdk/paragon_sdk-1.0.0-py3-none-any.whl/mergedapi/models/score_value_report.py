...
class ScoreValueReport(object):

    """Implementation of the 'scoreValueReport' model.

    ValueReport represents a registered set of factor values against an
    entity.
    ...
    def __init__(self,
        ...
        """Constructor for the ScoreValueReport class"""
