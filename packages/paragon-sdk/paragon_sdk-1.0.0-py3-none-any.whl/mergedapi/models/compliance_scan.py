...
class ComplianceScan(object):

    """Implementation of the 'complianceScan' model.

    Scan defines the state of a compliance scan.
    ...
    def __init__(self,
        ...
        """Constructor for the ComplianceScan class"""
