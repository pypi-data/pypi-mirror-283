...
class TrustApiV11alphaIntegritySkusRequest(object):

    """Implementation of the 'Trust Api V11alpha Integrity Skus Request' model.
    ...
    def __init__(self,
                 sku=APIHelper.SKIP):
        """Constructor for the TrustApiV11alphaIntegritySkusRequest class"""
