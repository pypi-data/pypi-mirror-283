...
class RateOfChange(object):
    ...
    """Implementation of the 'RateOfChange' model.

    Rate of change between present and previous value

    Attributes:
        field_name (str): Field name on which rate-of-change operation needs
            to be performed
        ...
        multiplication_factor (str): Value to be multiplied with calculated
            rate. Default is 1.0. Should be IEEE-754 64-bit floating-point
            numbers
    ...
    def __init__(self,
        ...
        """Constructor for the RateOfChange class"""
