...
class Body4(object):
    ...
    """Implementation of the 'body4' model.

    ImportScanResultsRequest defines a request to import scan results into a
    checklist.
    The RuleResults in the response will reflect the results defined by the
    scan, but these will not be
    persisted, unless there is a subsequent call to the UpdateChecklist RPC.
