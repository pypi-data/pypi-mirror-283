...
class AttestationEvidence(object):

    """Implementation of the 'attestationEvidence' model.

    Contains data collected from the device.
    ...
    def __init__(self,
        ...
        """Constructor for the AttestationEvidence class"""
