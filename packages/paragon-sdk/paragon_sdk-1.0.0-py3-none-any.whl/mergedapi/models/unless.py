...
class Unless(object):
    ...
    """Implementation of the 'Unless' model.

    UNLESS(difference) operation between vectors. Resultant vector is a set
    with elements in left-vector but not in right-vector
    ...
    def __init__(self,
                 left_vector=None,
                 right_vector=None):
        """Constructor for the Unless class"""
