...
class DeviceGroupHealthTree(object):
    ...
    """Implementation of the 'deviceGroupHealthTree' model.

    TODO: type model description here.

    Attributes:
        children (List[DeviceGroupHealthTree]): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the DeviceGroupHealthTree class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('children') is not None:
            children = [DeviceGroupHealthTree.from_dictionary(x) for x in dictionary.get('children')]
