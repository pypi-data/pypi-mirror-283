...
class CommonPaginationRequest(object):

    """Implementation of the 'commonPaginationRequest' model.

    PaginationRequest defines the number of entities to be returned by a bulk
    read request.
    ...
    def __init__(self,
        ...
        """Constructor for the CommonPaginationRequest class"""
