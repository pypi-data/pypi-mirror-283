...
class TrustApiV11alphaChecklistTemplatesRequest(object):

    """Implementation of the 'Trust Api V11alpha Checklist Templates Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the TrustApiV11alphaChecklistTemplatesRequest class"""
