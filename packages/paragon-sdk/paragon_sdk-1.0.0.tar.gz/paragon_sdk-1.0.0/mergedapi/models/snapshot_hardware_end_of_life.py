...
class SnapshotHardwareEndOfLife(object):

    """Implementation of the 'snapshotHardwareEndOfLife' model.

    HardwareEndofLife defines the hardware end of life status of the device.
    ...
    def __init__(self,
        ...
        """Constructor for the SnapshotHardwareEndOfLife class"""
