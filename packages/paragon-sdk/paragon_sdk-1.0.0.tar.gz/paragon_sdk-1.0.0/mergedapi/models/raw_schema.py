...
from mergedapi.models.path import Path


class RawSchema(object):

    """Implementation of the 'raw_schema' model.
    ...
    Attributes:
        ...
        path (List[Path]): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 path=APIHelper.SKIP):
        """Constructor for the RawSchema class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('path') is not None:
            path = [Path.from_dictionary(x) for x in dictionary.get('path')]
        else:
            path = APIHelper.SKIP
