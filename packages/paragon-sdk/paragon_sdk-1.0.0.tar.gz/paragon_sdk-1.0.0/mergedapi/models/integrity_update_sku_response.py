...
class IntegrityUpdateSKUResponse(object):

    """Implementation of the 'integrityUpdateSKUResponse' model.

    Defines the result of an UpdateSKURequest.
    ...
    def __init__(self,
                 sku=APIHelper.SKIP):
        """Constructor for the IntegrityUpdateSKUResponse class"""
