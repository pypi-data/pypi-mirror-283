...
class Linecards(object):

    """Implementation of the 'Linecards' model.

    TODO: type model description here.

    Attributes:
        available (int): available devices
        healthy (int): healthy devices
        healthy_units (List[str]): names of healthy devices
        unhealthy (int): unhealthy devices
        unhealthy_units (List[str]): names of unhealthy devices
    ...
    def __init__(self,
        ...
        """Constructor for the Linecards class"""
