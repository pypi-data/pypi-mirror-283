...
class TrustApiV11alphaChecklistChecklistsRequest(object):

    """Implementation of the 'Trust Api V11alpha Checklist Checklists Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the TrustApiV11alphaChecklistChecklistsRequest class"""
