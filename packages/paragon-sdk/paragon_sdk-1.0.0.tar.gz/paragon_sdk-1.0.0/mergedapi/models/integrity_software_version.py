...
class IntegritySoftwareVersion(object):

    """Implementation of the 'integritySoftwareVersion' model.

    SoftwareVersion defines a version of a software product.
    ...
    def __init__(self,
        ...
        """Constructor for the IntegritySoftwareVersion class"""
