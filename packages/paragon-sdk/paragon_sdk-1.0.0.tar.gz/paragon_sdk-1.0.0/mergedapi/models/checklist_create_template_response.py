...
class ChecklistCreateTemplateResponse(object):

    """Implementation of the 'checklistCreateTemplateResponse' model.

    Defines the result of creating a new template.
    ...
    def __init__(self,
        ...
        """Constructor for the ChecklistCreateTemplateResponse class"""
