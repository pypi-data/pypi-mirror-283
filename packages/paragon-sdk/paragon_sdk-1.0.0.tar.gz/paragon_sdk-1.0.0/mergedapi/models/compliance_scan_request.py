...
class ComplianceScanRequest(object):

    """Implementation of the 'complianceScanRequest' model.

    ScanRequest contains the parameters that define how a compliance scan
    should be created.
    ...
    def __init__(self,
        ...
        """Constructor for the ComplianceScanRequest class"""
