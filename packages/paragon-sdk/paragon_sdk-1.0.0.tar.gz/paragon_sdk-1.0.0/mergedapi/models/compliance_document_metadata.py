...
class ComplianceDocumentMetadata(object):

    """Implementation of the 'complianceDocumentMetadata' model.

    DocumentMetadata contains the metadata that identifies and describes a
    compliance document.
    ...
    def __init__(self,
        ...
        """Constructor for the ComplianceDocumentMetadata class"""
