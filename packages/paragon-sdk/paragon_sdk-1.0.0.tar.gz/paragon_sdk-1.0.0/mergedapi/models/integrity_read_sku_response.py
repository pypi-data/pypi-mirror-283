...
class IntegrityReadSKUResponse(object):

    """Implementation of the 'integrityReadSKUResponse' model.

    Defines the result of a ReadSKURequest.
    ...
    def __init__(self,
                 sku=APIHelper.SKIP):
        """Constructor for the IntegrityReadSKUResponse class"""
