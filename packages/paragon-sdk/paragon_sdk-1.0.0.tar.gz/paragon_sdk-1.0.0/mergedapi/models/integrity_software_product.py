...
class IntegritySoftwareProduct(object):

    """Implementation of the 'integritySoftwareProduct' model.

    SoftwareProduct defines a software product.
    ...
    def __init__(self,
        ...
        """Constructor for the IntegritySoftwareProduct class"""
