...
from mergedapi.models.definition_1 import Definition1


class Pbn(object):

    """Implementation of the 'Pbn' model.

    TODO: type model description here.

    Attributes:
        definition (Definition1): TODO: type description here.
        affected_devices (List[str]): The ids of managed devices that are
            affected by the PBN. This will be empty if no devices are affected
            by the PBN.
    ...
    def from_dictionary(cls,
        ...
        definition = Definition1.from_dictionary(dictionary.get('definition')) if 'definition' in dictionary.keys() else APIHelper.SKIP
