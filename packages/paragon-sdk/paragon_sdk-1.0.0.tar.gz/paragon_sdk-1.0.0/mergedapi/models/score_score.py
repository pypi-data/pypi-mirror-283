...
class ScoreScore(object):

    """Implementation of the 'scoreScore' model.

    Score defines the result of a trust score calculation.
    ...
    def __init__(self,
        ...
        """Constructor for the ScoreScore class"""
