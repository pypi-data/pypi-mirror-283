...
from mergedapi.models.compliance_target_status_response import ComplianceTargetStatusResponse
from mergedapi.models.compliance_list_scans_response import ComplianceListScansResponse
from mergedapi.models.compliance_create_scan_response import ComplianceCreateScanResponse
from mergedapi.models.compliance_read_scan_response import ComplianceReadScanResponse
from mergedapi.exceptions.googlerpc_status_exception import GooglerpcStatusException


class ComplianceScanController(BaseController):

    """A Controller to access Endpoints in the mergedapi API."""
    def __init__(self, config):
        super(ComplianceScanController, self).__init__(config)

    def compliance_service_target_status(self,
                                         org_id):
        """Does a GET request to /trust/api/v1.1alpha/{orgId}/compliance/scan/targets.

        List current compliance scan status and score for each unique target
        where the scan has completed normally.

        Args:
            org_id (str): TODO: type description here.

        Returns:
            ComplianceTargetStatusResponse: Response from the API. A
                successful response.
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/trust/api/v1.1alpha/{orgId}/compliance/scan/targets')
            ...
            .deserialize_into(ComplianceTargetStatusResponse.from_dictionary)
            .local_error('default', 'An unexpected error response.', GooglerpcStatusException)
        ).execute()

    def compliance_service_list_scans(self,
                                      org_id,
        ...
        """Does a GET request to /trust/api/v1.1alpha/{orgId}/compliance/scans.

        List all compliance scan registered on the server.
        ...
        Returns:
            ComplianceListScansResponse: Response from the API. A successful
                response.
        ...
        return super().new_api_call_builder.request(
            RequestBuilder().server(Server.DEFAULT)
            .path('/trust/api/v1.1alpha/{orgId}/compliance/scans')
            .http_method(HttpMethodEnum.GET)
            .template_param(Parameter()
                            .key('orgId')
                            .value(org_id)
            ...
            ResponseHandler()
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(ComplianceListScansResponse.from_dictionary)
            .local_error('default', 'An unexpected error response.', GooglerpcStatusException)
        ).execute()

    def compliance_service_create_scan(self,
                                       org_id,
                                       body):
        """Does a POST request to /trust/api/v1.1alpha/{orgId}/compliance/scans.

        Create compliance scan on the server

        Args:
            org_id (str): TODO: type description here.
            body (TrustApiV11alphaComplianceScansRequest): TODO: type
                description here.

        Returns:
            ComplianceCreateScanResponse: Response from the API. A successful
                response.
        ...
        return super().new_api_call_builder.request(
            ...
            ResponseHandler()
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(ComplianceCreateScanResponse.from_dictionary)
            .local_error('default', 'An unexpected error response.', GooglerpcStatusException)
        ).execute()

    def compliance_service_read_scan(self,
                                     org_id,
                                     id):
        """Does a GET request to /trust/api/v1.1alpha/{orgId}/compliance/scans/{id}.

        Read compliance scan from the server.
        ...
        Returns:
            ComplianceReadScanResponse: Response from the API. A successful
                response.
        ...
        return super().new_api_call_builder.request(
            RequestBuilder().server(Server.DEFAULT)
            .path('/trust/api/v1.1alpha/{orgId}/compliance/scans/{id}')
            .http_method(HttpMethodEnum.GET)
            .template_param(Parameter()
                            .key('orgId')
                            .value(org_id)
            ...
            ResponseHandler()
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(ComplianceReadScanResponse.from_dictionary)
            .local_error('default', 'An unexpected error response.', GooglerpcStatusException)
        ).execute()

    def compliance_service_delete_scan(self,
                                       org_id,
                                       id):
        """Does a DELETE request to /trust/api/v1.1alpha/{orgId}/compliance/scans/{id}.

        Delete compliance scan on the server.
