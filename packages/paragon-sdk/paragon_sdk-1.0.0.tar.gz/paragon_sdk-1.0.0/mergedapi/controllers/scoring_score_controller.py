...
from mergedapi.models.score_list_scores_response import ScoreListScoresResponse
from mergedapi.models.score_create_score_response import ScoreCreateScoreResponse
from mergedapi.models.score_read_score_response import ScoreReadScoreResponse
from mergedapi.exceptions.googlerpc_status_exception import GooglerpcStatusException


class ScoringScoreController(BaseController):

    """A Controller to access Endpoints in the mergedapi API."""
    def __init__(self, config):
        super(ScoringScoreController, self).__init__(config)

    def score_service_list_scores(self,
                                  org_id,
        ...
        """Does a GET request to /trust/api/v1.1alpha/{orgId}/scoring/scores.

        List all trust scores registered on the server.
        ...
        Returns:
            ScoreListScoresResponse: Response from the API. A successful
                response.
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/trust/api/v1.1alpha/{orgId}/scoring/scores')
            ...
            .deserialize_into(ScoreListScoresResponse.from_dictionary)
            .local_error('default', 'An unexpected error response.', GooglerpcStatusException)
        ).execute()

    def score_service_create_score(self,
                                   org_id,
                                   body):
        """Does a POST request to /trust/api/v1.1alpha/{orgId}/scoring/scores.

        Create trust score on the server

        Args:
            org_id (str): TODO: type description here.
            body (TrustApiV11alphaScoringScoresRequest): TODO: type
                description here.

        Returns:
            ScoreCreateScoreResponse: Response from the API. A successful
                response.
        ...
        return super().new_api_call_builder.request(
            ...
            ResponseHandler()
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(ScoreCreateScoreResponse.from_dictionary)
            .local_error('default', 'An unexpected error response.', GooglerpcStatusException)
        ).execute()

    def score_service_read_score(self,
                                 org_id,
                                 id):
        """Does a GET request to /trust/api/v1.1alpha/{orgId}/scoring/scores/{id}.

        Read trust score from the server.
        ...
        Returns:
            ScoreReadScoreResponse: Response from the API. A successful
                response.
        ...
        return super().new_api_call_builder.request(
            RequestBuilder().server(Server.DEFAULT)
            .path('/trust/api/v1.1alpha/{orgId}/scoring/scores/{id}')
            .http_method(HttpMethodEnum.GET)
            .template_param(Parameter()
                            .key('orgId')
                            .value(org_id)
            ...
            ResponseHandler()
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(ScoreReadScoreResponse.from_dictionary)
            .local_error('default', 'An unexpected error response.', GooglerpcStatusException)
        ).execute()

    def score_service_delete_score(self,
                                   org_id,
                                   id):
        """Does a DELETE request to /trust/api/v1.1alpha/{orgId}/scoring/scores/{id}.

        Delete trust score on the server.
