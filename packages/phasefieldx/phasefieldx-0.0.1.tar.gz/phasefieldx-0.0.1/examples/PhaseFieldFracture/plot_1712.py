...
file_vtu = pv.read(os.path.join(Data.results_folder_name, "paraview-solutions_vtu", "phasefieldx_p0_000001.vtu"))
...
###############################################################################
# Plot: Force vs Horizontal Displacement
# --------------------------------------
...
ax_reaction.set_title('Reaction Force vs Horizontal Displacement')    
ax_reaction.legend() 
