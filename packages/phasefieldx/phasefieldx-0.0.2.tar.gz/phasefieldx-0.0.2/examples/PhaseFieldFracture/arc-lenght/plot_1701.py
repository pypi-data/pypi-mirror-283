...
One Element tension/compresion Isotropic
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
from Element.Phase_Field_Fracture.solver.solver import solve
...
Data = SimulationPhaseFieldFracture(
                 ...
                 result_folder_name = "1701_One_element_isotropic_tension_compresion")
