...
def write_env_config(env):
    try:
        ...
        if not os.path.exists(assets_path):
            logger.error(f"Está faltando o conteúdo da pasta assets, faça o download para: {assets_path}")
            console.print(f"\nEstá faltando o conteúdo da pasta assets, faça o download para: {assets_path}\n", style="bold yellow")
