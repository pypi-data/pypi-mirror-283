...
cdef extern from "gs_raster.h" namespace "Geostack":
    cdef cppclass Raster[R, C](RasterBase[C]):
        ...
        Vector[C] vectorise(vector[R] contourValue, R noDataValue) except + nogil
...
cdef class _cyRasterBase_d(_PropertyMap):
    ...
    cpdef _ProjectionParameters_d getProjectionParameters(self) except *
    ...
    cpdef dict getVariablesIndexes(self) except *
    ...
    cpdef _Vector_d getRasterFootprint(self) except *
    cpdef _cyRaster_d_i indexComponents(self, string) except *
    cpdef _Vector_d indexComponentsVector(self, string, string, ReductionType, bool) except *
    ...
    cpdef _TileDimensions_d getTileDimensions(self, uint32_t ti=?, uint32_t tj=?) except *
    cpdef _BoundingBox_d getTileBounds(self, uint32_t ti=?, uint32_t tj=?) except *
...
cdef class _cyRasterBase_f(_PropertyMap):
    ...
    cpdef void write(self, string fileName, string jsonConfig) except *
    cpdef bool hasData(self) except *
    cpdef _cyRaster_f_i indexComponents(self, string) except *
    cpdef _Vector_f indexComponentsVector(self, string, string, ReductionType, bool) except *
    cpdef _Vector_f getRasterFootprint(self) except *
    cpdef cpp_set[string] getVariableNames(self) except *
    @staticmethod
    cdef _cyRasterBase_f from_ptr(object capsule)
    cpdef void saveRandomState(self) except *
    cpdef void restoreRandomState(self) except *
    cpdef _TileDimensions_f getTileDimensions(self, uint32_t ti=?, uint32_t tj=?) except *
    cpdef _BoundingBox_f getTileBounds(self, uint32_t ti=?, uint32_t tj=?) except *
    cpdef void closeFile(self) except *
...
cdef class _cyRaster_f(_cyRasterBase_f):
    ...
    cpdef _Vector_f cellCentres(self, bool mapValues=?) except *
    cpdef _Vector_f cellPolygons(self, bool mapValues=?) except *
    ...
    cpdef _Coordinate_f ijk2xyz(self, uint32_t i, uint32_t j=?, uint32_t k=?) except *
    cpdef list xyz2ijk(self, float x, float y=?, float z=?) except *
    cpdef _cyRasterBase_f get_raster_base(self) except *
...
cdef class _cyRaster_f_byt(_cyRasterBase_f):
    ...
    cpdef _Vector_f cellCentres(self, bool mapValues=?) except *
    cpdef _Vector_f cellPolygons(self, bool mapValues=?) except *
    cpdef _Vector_f vectorise(self, uint8_t[:] contourValue, object noDataValue=?) except *
...
cdef class _cyRaster_d(_cyRasterBase_d):
    ...
    cpdef void rasterise(self, _Vector_d v, string script, size_t parameters,
        string levelPropertyName) except *
    cpdef _Vector_d cellCentres(self, bool mapValues=?) except *
    cpdef _Vector_d cellPolygons(self, bool mapValues=?) except *
    ...
    cpdef _Coordinate_d ijk2xyz(self, uint32_t i, uint32_t j=?, uint32_t k=?) except *
    cpdef list xyz2ijk(self, double x, double y=?, double z=?) except *
    cpdef _cyRasterBase_d get_raster_base(self) except *
...
cdef class _cyRaster_d_byt(_cyRasterBase_d):
    ...
    cpdef _Vector_d cellCentres(self, bool mapValues=?) except *
    cpdef _Vector_d cellPolygons(self, bool mapValues=?) except *
    cpdef _Vector_d vectorise(self, uint8_t[:] contourValue, object noDataValue=?) except *
    cpdef uint8_t getCellValue(self, uint32_t i, uint32_t j=?, uint32_t k=?) except *
