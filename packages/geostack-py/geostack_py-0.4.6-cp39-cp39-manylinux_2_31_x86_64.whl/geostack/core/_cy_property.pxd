...
cdef class _PropertyMap:
    ...
    cpdef dict getProperties_int(self) except *
    cpdef dict getProperties_flt(self) except *
    cpdef dict getProperties_dbl(self) except *
    cpdef dict getProperties_str(self) except *
    cpdef dict getProperties_idx(self) except *
    cpdef dict getProperties_byt(self) except *
