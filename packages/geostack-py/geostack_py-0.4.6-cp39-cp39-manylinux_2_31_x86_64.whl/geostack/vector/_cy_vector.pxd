...
cdef class _BoundingBox_d:
    ...
    cpdef _Coordinate_d centroid(self) except *
    cpdef _Coordinate_d extent(self) except *
    ...
    cpdef _BoundingBox_d convert(self, _ProjectionParameters_d this,
        _ProjectionParameters_d other) except *
    ...
    cpdef _Vector_d toVector(self) except *
...
cdef class _BoundingBox_f:
    ...
    cpdef _Coordinate_f centroid(self) except *
    cpdef _Coordinate_f extent(self) except *
    ...
    cpdef void reset(self) except *
    cpdef _BoundingBox_f convert(self, _ProjectionParameters_d this,
        _ProjectionParameters_d other) except *
    ...
    cpdef _Vector_f toVector(self) except *
...
cdef class _Vector_d:
    ...
    cpdef _Vector_d region(self, _BoundingBox_d other, size_t parameters) except *
    cpdef _Vector_d nearest(self, _BoundingBox_d other, size_t parameters) except *
    ...
    cpdef _cyRaster_d mapDistanceOnBounds(self, double resolution, string script,
                                          size_t parameters, _BoundingBox_d bounds) except *
    ...
    cpdef _Vector_d convert_projection(self, _ProjectionParameters_d other) except *
    cpdef _Vector_d convert_geometry_type(self, size_t geometryType) except *
    ...
    cpdef object get_geometry(self, cl_uint idx) except *
    cpdef size_t get_geometry_type(self, cl_uint idx) except *
    cpdef _Coordinate_d getCoordinate(self, size_t index) except *
    cpdef _Coordinate_d getPointCoordinate(self, size_t index) except *
...
cdef class _Vector_f:
    ...
    cpdef _Vector_f region(self, _BoundingBox_f other, size_t parameters) except *
    cpdef _Vector_f nearest(self, _BoundingBox_f other, size_t parameters) except *
    ...
    cpdef _Vector_f convert_projection(self, _ProjectionParameters_d other) except *
    cpdef _Vector_f convert_geometry_type(self, size_t geometryType) except *
    cpdef void setProjectionParameters(self, _ProjectionParameters_d proj_) except *
    cpdef _ProjectionParameters_d getProjectionParameters(self)
    cpdef void updatePointIndex(self, size_t index) except *
    cpdef void updateLineStringIndex(self, size_t index) except *
    ...
    cpdef object get_geometry(self, cl_uint idx) except *
    cpdef size_t get_geometry_type(self, cl_uint idx) except *
    cpdef _Coordinate_f getCoordinate(self, size_t index) except *
    cpdef _Coordinate_f getPointCoordinate(self, size_t index) except *
