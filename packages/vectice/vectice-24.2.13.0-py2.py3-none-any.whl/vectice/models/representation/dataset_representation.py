...
from vectice.utils.common_utils import flatten_resources, repr_class
...
class DatasetRepresentation:
    ...
    def versions_list(
        ...
        for version in version_list:
            version["len_resources"] = len(version["datasetSources"])
        ...
        for versions in processed_version_list:
            ...
            if versions["len_resources"] > 1:
                del versions["dataset_sources"]
            del versions["len_resources"]
