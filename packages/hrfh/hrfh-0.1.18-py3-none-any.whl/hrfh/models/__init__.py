...
from hrfh.utils.masker import (
    mask_sentence,
    mask_word,
    custom_header_masker,
    custom_server_masker,
)
...
class HTTPRequest:
    ...
    _header_masker: callable = field(default_factory=lambda: custom_header_masker)
...
class HTTPResponse:
    ...
    _sentence_maskers: List = field(default_factory=lambda: [mask_sentence])
    _word_maskers: List = field(default_factory=lambda: [mask_word])
    _server_masker: callable = field(default_factory=lambda: custom_server_masker)
    _header_masker: callable = field(default_factory=lambda: custom_header_masker)
