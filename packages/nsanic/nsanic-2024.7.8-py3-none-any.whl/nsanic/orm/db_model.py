...
class DBModel(Model):
    ...
    @classmethod
    def sheet_name(cls, suffix: Union[str, int, float, datetime, date] = None, tz: str = G_TIME_ZONE):
        """
        数据表名 
    ...
    @classmethod
    def get_split_suffix(cls, split: Union[str, int, float, datetime, date], param: dict, tz: str = G_TIME_ZONE):
        """
        获取字典参数的分表后缀
