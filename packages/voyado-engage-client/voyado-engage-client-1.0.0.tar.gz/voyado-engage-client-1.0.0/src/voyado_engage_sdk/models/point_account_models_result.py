...
class PointAccountModelsResult(BaseModel):
    ...
    :type items: List[PointAccountModel], optional
    ...
    def __init__(
        ...
        items: List[PointAccountModel] = None,
        ...
        if items is not None:
            self.items = self._define_list(items, PointAccountModel)
