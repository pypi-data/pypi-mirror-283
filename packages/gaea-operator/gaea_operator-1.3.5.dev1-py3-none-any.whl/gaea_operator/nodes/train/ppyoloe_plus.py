...
from gaea_operator.utils import write_file, is_base64, NETWORK_ARCHITECTURE, ModelTemplate
...
def ppyoloe_plus_train(args):
    ...
    train_advanced_parameters[KEY_NETWORK_ARCHITECTURE] = \
        NETWORK_ARCHITECTURE[ModelTemplate.PPYOLOE_PLUS_NAME][train_advanced_parameters[KEY_NETWORK_ARCHITECTURE]]
