...
def ocrnet_train(args):
    ...
    train_advanced_parameters[KEY_NETWORK_ARCHITECTURE] = \
        NETWORK_ARCHITECTURE[ModelTemplate.OCRNET_NAME][train_advanced_parameters[KEY_NETWORK_ARCHITECTURE]]
    ...
    input_shape = [-1, 3, int(train_advanced_parameters['eval_height']), int(train_advanced_parameters['eval_width'])]
