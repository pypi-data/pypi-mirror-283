...
from gaea_operator.nodes import Transform, TransformEval, Package, Inference

NAME_TO_IMAGES = {
    BaseTrain.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/train/paddlepaddle:v1.3.4.1")
        ],
    BaseEval.name():
        [
            Image(kind=Accelerator.NVIDIA,
    ...
    Transform.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/transform:v1.3.4"),
    ...
    TransformEval.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/inference/nvidia:v1.3.4"),
            Image(kind=Accelerator.KUNLUN,
                  name="iregistry.baidu-int.com/windmill-public/inference/kunlun:v1.3.4")
        ],
    Package.name():
        [
            Image(kind=Accelerator.NVIDIA,
