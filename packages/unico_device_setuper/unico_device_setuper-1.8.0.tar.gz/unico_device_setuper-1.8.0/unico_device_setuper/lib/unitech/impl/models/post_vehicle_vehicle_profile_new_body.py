...
T = TypeVar("T", bound="PostVehicleVehicleProfileNewBody")


@_attrs_define
class PostVehicleVehicleProfileNewBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_vehicle_vehicle_profile_new_body = cls(
            label=label,
            height_mm=height_mm,
            length_mm=length_mm,
            width_mm=width_mm,
        ...
        post_vehicle_vehicle_profile_new_body.additional_properties = d
        return post_vehicle_vehicle_profile_new_body
