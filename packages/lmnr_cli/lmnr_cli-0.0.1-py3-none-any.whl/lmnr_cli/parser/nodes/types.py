...
import uuid
from lmnr_cli.parser.nodes import Handle, HandleType, NodeFunctions
from lmnr_cli.parser.utils import map_handles
...
def node_input_from_json(json_val: Any) -> NodeInput:
    if isinstance(json_val, str):
        ...
        return [ChatMessage.from_dict(msg) for msg in json_val]
    else:
