...
def _from_hzw(hzw_file) -> "Structure":
    ...
    >>> _from_hzw('dspawpy_proj/dspawpy_tests/inputs/supplement/Si2.hzw')
    Structure Summary
    Lattice
        abc : 0.6788385 0.6788385 0.6788385
     angles : 90.0 90.0 90.0
     volume : 0.312823517760831
          A : 0.6788385 0.0 0.0
          B : 0.0 0.6788385 0.0
          C : 0.0 0.0 0.6788385
        pbc : True True True
    PeriodicSite: Si (0.6788, 0.6788, 0.6788) [1.0, 1.0, 1.0]
    PeriodicSite: Si (2.037, 2.037, 2.037) [3.0, 3.0, 3.0]
...
def _from_xyz(xyzfile: str) -> "Structure":
    ...
    >>> _from_xyz('dspawpy_proj/dspawpy_tests/inputs/supplement/Si2.xyz')
    Structure Summary
    Lattice
        abc : 4.811495 4.826272 4.826271
     angles : 90.0 90.0 90.0
     volume : 112.07365548653935
          A : 4.811495 0.0 2.946190975431747e-16
          B : 7.76123731670016e-16 4.826272 2.9552392783072476e-16
          C : 0.0 0.0 4.826271
        pbc : True True True
    PeriodicSite: Si (4.467, 4.476, 4.476) [0.9285, 0.9274, 0.9274]
    PeriodicSite: Si (0.3443, 0.3506, 0.3506) [0.07155, 0.07265, 0.07265]
...
if __name__ == "__main__":
    ...
    doctest.testmod(None, "_from_hzw")
    doctest.testmod(None, "_from_xyz")
