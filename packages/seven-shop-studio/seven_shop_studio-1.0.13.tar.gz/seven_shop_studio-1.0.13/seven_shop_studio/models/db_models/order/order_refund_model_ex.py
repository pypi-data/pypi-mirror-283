...
:LastEditTime: 2024-07-05 16:32:28
:LastEditors: KangWenBin
:Description: 
"""
from seven_shop_studio.models.db_models.order.order_refund_model import *
from models.db_models.order.order_goods_model import *
...
class OrderRefundModelEx(OrderRefundModel):
    ...
    def check_refund_complete(self,order_id):
        ...
        # 已完成退款单商品
        sql = "SELECT COUNT(*) as count FROM order_refund_tb a JOIN order_refund_goods_tb b ON a.refund_order_id = b.refund_order_id WHERE b.order_id = %s AND a.status = 5 AND refund_status = 2"
