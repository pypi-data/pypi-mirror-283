...
from ..base import Check, DNSHostname, Resource, CheckSpec, BaseExpect
from pydantic import BaseModel, ConfigDict, Field, IPvAnyAddress, model_validator, HttpUrl


Headers = dict[str, str]


class TcpExpectType(str, Enum):
    pass


class TcpExpect(BaseExpect):
    type: TcpExpectType
    type: str


TcpExpectList = list[TcpExpect]
...
class TcpCheck(Check):
    ...
    Example:
        .. code-block:: python
            ...
            from my_monitoring_library import TcpCheck, TcpCheckSpec, TcpExpect, TcpExpectType
            ...
            tcp_check_spec = TcpCheckSpec(
                ...
                port=443,
                expect=[
                    TcpExpect(type=TcpExpectType.SOME_EXPECTATION_TYPE)
                ]
            )
