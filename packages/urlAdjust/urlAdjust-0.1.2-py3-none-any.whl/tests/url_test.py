...
class MyTestCase(unittest.TestCase):
    ...
    def test_getting_url_query_param(self):
        url_example = 'https://aws.amazon.com/cn/what-is/blockchain/?aws-products-all.sort-by=item.additionalFields.productNameLowercase&aws-products-all.sort-order=asc'
        parsed_url = url.Url(url_example)
        self.assertEqual(parsed_url.get_query_param('aws-products-all.sort-order'), 'asc')

    def test_getting_all_url_query_params(self):
          url_example = 'https://aws.amazon.com/cn/what-is/blockchain/?aws-products-all.sort-by=item.additionalFields.productNameLowercase&aws-products-all.sort-order=asc'
          parsed_url = url.Url(url_example)
          expected = {'aws-products-all.sort-by': 'item.additionalFields.productNameLowercase', 'aws-products-all.sort-order': 'asc'}
          self.assertEqual(parsed_url.get_all_query_params(), expected)
