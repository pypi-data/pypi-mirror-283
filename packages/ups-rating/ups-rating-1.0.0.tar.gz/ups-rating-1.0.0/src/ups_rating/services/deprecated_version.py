...
class DeprecatedVersionService(BaseService):
    ...
    def deprecated_rate(
        ...
        :param deprecated_version: Indicates Rate API to display the new release features in Rate API response based on Rate release. See the New section for the latest Rate release.
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/rating/{{deprecatedVersion}}/{{requestoption}}",
