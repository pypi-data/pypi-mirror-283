...
class FrsShipmentDataFreightDensityRate(BaseModel):
    ...
    :param density: Density is returned if the Shipper is eligible for Density based rate. Valid values:0 to 999.9
    :type density: str
    :param total_cubic_feet: TotalCubic feet is returned if the Shipper is eligible for Density based rate. Valid values:0 to 99999.999
