...
from paij.run_and_compile import run_maven_commands
import config
from paij import *
from paij.function_file import *
...
def main():
    ...
    if run_maven_commands(config.MAVEN_HOME, config.PROJECT_DIR, "TDDOrderServiceTest", max_retries=3):
