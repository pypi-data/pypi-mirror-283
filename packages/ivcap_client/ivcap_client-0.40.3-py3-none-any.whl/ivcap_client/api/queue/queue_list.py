...
from ...models.queue_list_result import QueueListResult
...
) -> Optional[Union[Any, BadRequestT, InvalidParameterT, InvalidScopesT, QueueListResult]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = QueueListResult.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, BadRequestT, InvalidParameterT, InvalidScopesT, QueueListResult]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, BadRequestT, InvalidParameterT, InvalidScopesT, QueueListResult]
    """
