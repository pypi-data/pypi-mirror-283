...
class ChatCompletionResponse(betterproto.Message):
    ...
    correction_applied: bool = betterproto.bool_field(12)
    first_token_time: int = betterproto.int64_field(13)
    response_time: int = betterproto.int64_field(14)
...
class EvaluateResponse(betterproto.Message):
    ...
    evaluation_time: int = betterproto.int64_field(10)
