...
setup(
    ...
    version="2.1.0", # WARNING: if you modify it here, also change Blaeu.py https://packaging.python.org/guides/single-sourcing-package-version/#single-sourcing-the-version
    ...
    keywords='networking ripe atlas monitoring ip ping traceroute dig',  # Optional
