...
known_lossy_type_strs={"<class 'dateutil.tz.tz.tzutc'>"}
...
class DetailDecoder(json.JSONDecoder):
	...
	def object_hook(C,obj):
		...
		elif B=='psycopg2.extensions.Column':assert psycopg2_types[_A],'psycopg2 is required to deserialize Column; is the server dependecy group installed?';A=psycopg2_types[_A](**A)
