...
def in_sentry_thread():return'sentry-sdk'in get_thread_name()
def is_ignored_instrumentation_caller(caller_path):return in_sentry_thread()or _is_in_patterns(caller_path,IGNORED_INSTRUMENTATION_CALLER_PATTERNS)
def is_ignored_interception_caller(caller_path):return in_sentry_thread()or _is_in_patterns(caller_path,IGNORED_INTERCEPTION_CALLER_PATTERNS)
