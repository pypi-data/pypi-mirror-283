...
class Binomial(Distribution):
    ...
    def replace_stats_with_data(self):
        ...
        self.prob = self.data.count(1) / self.size
    ...
    def __add__(self, other):
        ...
        """Function to add together two Binomial gaussian_binom with equal p
        ...
        # TODO: Define addition for two binomial gaussian_binom. Assume that the
        # p values of the two gaussian_binom are the same. The formula for
        # summing two binomial gaussian_binom with different p values is more complicated,
        # so you are only expected to implement the case for two gaussian_binom with equal p.
        ...
        #   When adding two binomial gaussian_binom, the p value remains the same
        #   The new n value is the sum of the n values of the two gaussian_binom.
    ...
    def __repr__(self):
        ...
        #
        #       with the values replaced by whatever the actual gaussian_binom values are
        #       The method should return a string in the expected format

        return f"mean {self.mean},standard deviation {self.stdev}, p {self.prob}, n {self.size}"
