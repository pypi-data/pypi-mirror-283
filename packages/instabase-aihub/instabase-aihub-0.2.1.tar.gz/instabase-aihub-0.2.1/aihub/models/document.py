...
class Document(BaseModel):
    ...
    class_edit_history: Optional[List[ModificationObject]] = None
    validations: Optional[DocumentValidations] = None
    doc_id: Optional[StrictInt] = Field(default=None, description="ID of document.")
    __properties: ClassVar[List[str]] = ["fields", "review_completed", "class_name", "post_processed_paths", "class_edit_history", "validations", "doc_id"]
