...
class ResultsResponse(BaseModel):
    ...
    ResultsResponse
    """ # noqa: E501
    batch_id: Optional[StrictStr] = Field(default=None, description="batch ID used as input for this run, if ran using a batch.")
    files: Optional[List[FileWithDocuments]] = None
    has_more: Optional[StrictBool] = Field(default=None, description="Indicates if more results are available.")
    review_completed: Optional[StrictBool] = Field(default=None, description="Whether entire run has been marked as reviewed.")
