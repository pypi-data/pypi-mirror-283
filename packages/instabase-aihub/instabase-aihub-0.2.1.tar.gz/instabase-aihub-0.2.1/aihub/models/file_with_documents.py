...
class FileWithDocuments(BaseModel):
    ...
    FileWithDocuments
    """ # noqa: E501
    original_file_name: Optional[StrictStr] = Field(default=None, description="The original name of the file.")
    documents: Optional[List[Document]] = None
    __properties: ClassVar[List[str]] = ["original_file_name", "documents"]
