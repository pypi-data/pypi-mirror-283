...
""")
    ...
    def evaluateFormula(self,fieldname='TaskMode',mode='Calculator',fromPrompt=False):
        if fromPrompt == True:
            return
        while True:
            try:
...
td('1y1m1d1h30m20s') - timedelta for 1 year 1 month 1 day 1 hour 30 minutes 20 seconds; as long as the number is followed by its hand designator, i.e. h=hour,m=minute,s=second, it will return
