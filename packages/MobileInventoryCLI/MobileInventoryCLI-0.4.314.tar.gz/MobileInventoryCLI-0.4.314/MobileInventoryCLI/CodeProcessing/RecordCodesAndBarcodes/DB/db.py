...
class ClipBoordEditor:
    ...
    def list_(self,short=False,searchable=None,delete=False,update=False):
        try:
            search=None
            with Session(ENGINE) as session:
                if searchable:
                ...
                for num,i in enumerate(results):
                    if not short:
                        ...
                        msg=f'''{Fore.light_green}{num}/{Fore.light_yellow}{ct} -> {Fore.orange_3}{i.cbid}|{Fore.cyan}{i.cbValue}{Fore.light_steel_blue}|{i.doe}|{Fore.medium_violet_red}{i.doe+timedelta(seconds=i.ageLimit)}{Style.reset}'''
                    print(msg)
                if ct == 0:
