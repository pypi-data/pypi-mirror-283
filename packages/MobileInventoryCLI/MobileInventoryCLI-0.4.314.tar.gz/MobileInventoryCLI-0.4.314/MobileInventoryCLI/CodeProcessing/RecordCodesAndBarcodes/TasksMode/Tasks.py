...
td('1h30m20s') - timedelta for 1 hour 30 minutes 20 seconds; as long as the number is followed by its hand designator, i.e. h=hour,m=minute,s=second, it will return
