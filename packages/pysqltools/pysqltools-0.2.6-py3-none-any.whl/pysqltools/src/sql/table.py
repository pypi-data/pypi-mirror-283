...
class Table:
    ...
    def create_from_df(
        self, df: pd.DataFrame, execute: bool = False, insert_data: bool = False, **insert_kwargs: Any
    ) -> str:
        """
        ...
        try:
            ...
            raise TypeError(
                "Please include the insert arguments into the create_table_from_df method", e
            )
