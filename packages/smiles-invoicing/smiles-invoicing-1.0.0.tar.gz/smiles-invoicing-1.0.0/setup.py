...
setup(
  name = 'smiles-invoicing',         #* Your package will have this name
  ...
  author = 'Robert Zakaryan',               # Your name
  author_email = 'robzakaryan@gmail.com',  # Your email
  url = 'https://www.linkedin.com/in/robert-zakaryan-4978a1183/',              # Homepage of your library (e.g. github or your website)
