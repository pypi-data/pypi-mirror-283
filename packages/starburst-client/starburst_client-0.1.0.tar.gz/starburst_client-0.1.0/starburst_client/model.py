...
class Role:
    ...
    def get_column_masks(self) -> typing.Generator["ColumnMask", None, None]:
        for column_mask in self._client.list_role_column_masks(self.id):
            column_mask["roleId"] = self.id
            yield ColumnMask(column_mask, self._client)

    def add_column_mask(
        self,
        expression: "ColumnMaskExpression",
        catalog: str | None = None,
        schema: str | None = None,
        table: str | None = None,
        ...
        column_mask = self._client.add_column_mask_to_role(
            self.id, entity, expression.id
        )
        column_mask["roleId"] = self.id
        return ColumnMask(column_mask, self._client)
...
class ColumnMaskExpression:
    ...
    @name.setter
    def name(self, name: str) -> None:
        self._client.update_column_mask_expression(
    ...
    def delete(self):
        self._client.delete_column_mask_expression(self.id)
...
class ColumnMask:
    ...
    def get_column_mask_expression(self):
        return RowFilterExpression(
            self._client.get_column_mask_expression(self.expression_id), self._client
        )

    def delete(self):
        self._client.delete_role_column_mask(self.role_id, self.id)
