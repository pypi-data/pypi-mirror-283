...
class Client:
    ...
    # ColumnMasks
    def add_column_mask_to_role(self, role_id: int, entity: dict, expression_id: int):
        ...
        assert isinstance(expression_id, int), expression_id

        if "category" not in entity:
            entity["category"] = Category.TABLES

        return self.session.post(
            f"{self.__base_url}/biac/roles/{role_id}/columnMasks",
            json={"entity": entity, "expressionId": expression_id},
        ).json()

    def create_column_mask_expression(
        self, name: str, expression: str, description: str | None = None
    ):
        ...
        return self.session.post(
            f"{self.__base_url}/biac/expressions/columnMask",
    ...
    def update_column_mask_expression(
        self,
        column_mask_expression_id: int,
        name: str,
        expression: str,
    ...
    # LocationGrants
    def add_location_grant(self, role_id: int, location: str):
        """Add a LocationGrant to a role to allow accessing that location by the given role."""
        assert isinstance(role_id, int), role_id
        assert isinstance(location, int), location

        return self.session.post(
            f"{self.__base_url}/biac/roles/{role_id}/locationGrants",
    ...
    # RowFilters
    def add_row_filter_to_role(self, role_id: int, entity: dict, expression_id: int):
    ...
    def create_row_filter_expression(
        ...
        return self.session.post(
            f"{self.__base_url}/biac/expressions/rowFilter",
            json={"name": name, "expression": expression, "description": description},
        ).json()
    ...
    def list_role_row_filters(self, role_id: int):
        ...
        return self._paginate(f"{self.__base_url}/biac/roles/{role_id}/rowFilters")
    ...
    def update_row_filter_expression(
        self,
        row_filter_expression_id: int,
        name: str,
        expression: str,
        description: str | None = None,
    ):
