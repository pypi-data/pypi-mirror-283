...
class KnowledgeBaseUpdateDTO(BaseModel):
    ...
    __properties = ["knowledgeBaseId", "name", "description", "userProfile"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> KnowledgeBaseUpdateDTO:
        """Create an instance of KnowledgeBaseUpdateDTO from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> KnowledgeBaseUpdateDTO:
        """Create an instance of KnowledgeBaseUpdateDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return KnowledgeBaseUpdateDTO.parse_obj(obj)

        _obj = KnowledgeBaseUpdateDTO.parse_obj({
