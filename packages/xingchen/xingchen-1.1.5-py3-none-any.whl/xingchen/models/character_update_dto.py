...
class CharacterUpdateDTO(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CharacterUpdateDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CharacterUpdateDTO:
        """Create an instance of CharacterUpdateDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CharacterUpdateDTO.parse_obj(obj)

        _obj = CharacterUpdateDTO.parse_obj({
            "name": obj.get("name"),
