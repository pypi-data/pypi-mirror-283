...
from xingchen.models.result_dto_list_character_dto import ResultDTOListCharacterDTO  # noqa: E501

class TestResultDTOListCharacterDTO(unittest.TestCase):
    """ResultDTOListCharacterDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultDTOListCharacterDTO:
        """Test ResultDTOListCharacterDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultDTOListCharacterDTO`
        """
        model = ResultDTOListCharacterDTO()  # noqa: E501
        if include_optional:
    ...
    def testResultDTOListCharacterDTO(self):
        """Test ResultDTOListCharacterDTO"""
