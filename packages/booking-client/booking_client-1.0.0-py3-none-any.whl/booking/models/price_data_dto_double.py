...
@JsonMap({})
class PriceDataDtoDouble(BaseModel):
    ...
    :type extra_charges: ExtraChargesDtoDouble, optional
    """
    ...
    def __init__(
        ...
        book: float = None,
        total: float = None,
        extra_charges: ExtraChargesDtoDouble = None,
    ):
        if base is not None:
            self.base = base
        if book is not None:
        ...
        if extra_charges is not None:
            self.extra_charges = self._define_object(
                extra_charges, ExtraChargesDtoDouble
            )
