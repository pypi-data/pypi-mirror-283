...
class ReviewScoresInputDto(BaseModel):
    ...
    :param language: Code of the language used to render response.<br>Please check the "Possible Values" section of the documentation for the accepted language codes.<br>, defaults to None
