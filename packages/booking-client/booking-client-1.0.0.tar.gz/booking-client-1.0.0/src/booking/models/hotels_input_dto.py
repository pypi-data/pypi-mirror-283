...
class HotelsInputDto(BaseModel):
    ...
    :param language: The language code to return the results in.<br>Please check the "Possible Values" section of the documentation for the accepted language codes.<br>, defaults to None
