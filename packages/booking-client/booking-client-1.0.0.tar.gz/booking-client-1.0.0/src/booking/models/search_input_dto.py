...
class SearchInputDto(BaseModel):
    ...
    :type checkin: str
    :param checkout: The checkout date. Must be later than {checkin}. Must be between 1 and 90 days after {checkin}.<br>Must be within 500 days in the future and in the format yyyy-mm-dd.<br>
    :type checkout: str
