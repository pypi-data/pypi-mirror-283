...
def plot(search_directory, times, special_clusters=[], width=0.1, alpha=0.6):
    ...
    composition_calc(search_directory, title_str, special_clusters, width=width, alpha=alpha)