       ...
       Generate the content based on the provided input and prompt.
        ...
        try:
            if not pdf_file_path and not urls and not text:
                raise ValueError("please provide atleast any one pdf_file_path, urls or text")
            ...
            prompt_text = Utils().extract_text(pdf_file_path=pdf_file_path, urls=urls, text=text)
