...
class EmailSender:
    ...
    def __init__(self, smtp_server: str = 'smtp.gmail.com', smtp_port: int = 587) -> None:
    ...
    def send_email(self, username: str, password: str, sender_mail: str,
                   receiver_mail: str, subject: str, content_body: str,
        ...
        try:
            ...
            raise ValueError("Failed to authenticate with the SMTP server: Invalid login credentials") from auth_error
