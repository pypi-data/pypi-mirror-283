...
class Trainer:
	...
	def print(self, epoch, loss, correct, val_loss, val_acc):
		print(
			'epoch-{}/{}\tlr: {:.6f}, train_loss: {:.4f}, train_acc: {:.4f}, val_loss: {:.4f}, val_acc: {:.4f}'.format(
				epoch, self.max_iter, self.optimizer.param_groups[0]['lr'], loss, correct, val_loss, val_acc
			))
