...
class GarfieldConfig:
    ...
    def set_gf_params(self, config=None):
        ...
        assert config['profile'] in ['RNA', 'ATAC', 'ADT', 'multi-modal', 'spatial'], \
        ...
        if config['profile'] == 'multi-modal':
            ...
            assert config['sub_data_type'] in [['rna', 'atac'], ['rna', 'adt']], \
        ...
        if config['profile'] == 'spatial':
            assert config['data_type'] in ['single-modal', 'multi-modal'], \
