...
set_target_properties(HELICS::helics PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libhelics.3.5.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libhelics.3.dylib"
  )

list(APPEND _cmake_import_check_targets HELICS::helics )
list(APPEND _cmake_import_check_files_for_HELICS::helics "${_IMPORT_PREFIX}/lib/libhelics.3.5.3.dylib" )
