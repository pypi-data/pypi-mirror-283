...
def lint_with_gpt(filename):
    ...
    assistant = client.beta.assistants.create(
        name="Python bug fixing",
        instructions="You are code linter. You will be provided with a piece of Python code, and your task is linting find syntax errors.",
        model="gpt-4o",
    ...
    thread = client.beta.threads.create(
        messages=[
            {
                "role": "user",
                "content": "find syntax errors in this code. Don't print the corrected full code. Just point out the errors in the code.",
                "attachments": [
