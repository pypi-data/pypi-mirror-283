...
class Ide(IdeManager):
    ...
    def make_element(self) -> str:
        ...
        # The solution_div not inside the other because markdown rendering troubles and useful as
        # "anchor" for IDE extractions/insertions when the "full screen" mode will be implemented.
