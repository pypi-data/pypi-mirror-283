...
class TokenRefreshMiddleware(MiddlewareMixin):
    def __init__(self, get_response):
        ...
        self.ignore_paths = ['/user-mngmt/token/refresh/', '/token/refresh/', '/user-mngmt/token/', '/token/', '/user-mngmt/token/verify/', '/token/verify/', '/user-mngmt/login/', '/login/','/metrics', '/metrics/', '/user-mngmt/forgot-password/', '/admin/', '/admin/login/', '/user-mngmt/forgot-password/', '/forgot-password/']
    ...
    def process_request(self, request):
        ...
        response, continue_on = self.refresh_access_token(request_copy)
        if continue_on:
            print("\nContinue on is TRUE\n")
