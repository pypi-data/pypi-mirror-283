...
from atoti_core import JAVA_MAX_INT as _JAVA_MAX_INT
...
def total(
    measure: NonConstantMeasureConvertible, /, *hierarchies: Hierarchy
) -> MeasureDescription:
    ...
    return ParentValue(
        ...
        _degrees={hierarchy._identifier: _JAVA_MAX_INT for hierarchy in hierarchies},
