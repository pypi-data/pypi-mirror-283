...
class CustomJavaFunction(JavaFunction):
    ...
    def get_output_type_function(
        ...
        def output_type(
            _ignored: Collection[JavaOperationElement], _java_api: JavaApi
        ) -> DataType:
...
class ExistingJavaFunction(JavaFunction):
    ...
    def _get_output_type_function(
        ...
        def output_type_function(
            operation_elements: Collection[JavaOperationElement], java_api: JavaApi
        ) -> DataType:
            java_types = [
...
def _get_output_type_from_java(
    *, java_class: str, java_method: str, types: Collection[str], java_api: JavaApi
