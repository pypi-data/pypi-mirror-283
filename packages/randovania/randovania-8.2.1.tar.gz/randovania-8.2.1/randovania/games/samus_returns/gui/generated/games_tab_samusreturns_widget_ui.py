...
class Ui_SamusReturnsGameTabWidget(object):
    def setupUi(self, SamusReturnsGameTabWidget):
        ...
        self.differences_contents.setGeometry(QRect(0, 0, 651, 1071))
        ...
        self.hints_scroll_area_contents.setGeometry(QRect(0, 0, 651, 924))
    ...
    def retranslateUi(self, SamusReturnsGameTabWidget):
        ...
        self.differences_label.setText(QCoreApplication.translate("SamusReturnsGameTabWidget", u"<html><head/><body><p>Randovania makes some changes to the original game in order to improve the game experience or to simply fix bugs in the original game.<br/>Many changes are optional and can be disabled in the options Randovania provides, but the following are <span style=\" font-weight:600;\">always</span> there:</p><p><br/><span style=\" font-weight:600;\">General Changes</span></p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Chozo Seals have been repurposed to provide hints for where items are located.</li></ul><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">DNA can now be placed anywhere in the world as pickups.</li><ul style=\"margin-top: "
                        ...
                        "p:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The Diggernaut Chase sequence has been removed and the corresponding rooms have been set to their post-chase state.</li><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The wall blocking the Landing Site from Surface East after defeating the Queen has been removed.</li><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">In the vanilla game, the Surface area where Proteus Ridley resides is a separate map from the starting Surface. These are normally not connected. This has been changed to warp the player to the other Surface map by passing the Baby blocks in the Landing Site. Once enough DNA is collected to access Ridley, you can no longer warp from Surface West to Surface East.</li></ul><p><span style=\" font-weight:600;\">Door Changes</span></p><ul style=\"margin-top:"
                        " 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Most Charge Beam doors at the entrance and exit of every area have been changed to Power Beam doors, excluding Area 4 Crystal Mines and Area 6.</li><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Most beam doors are now double-sided. This simplifies traversing through areas in reverse.</li><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Some one-way doors are now two-way to prevent softlocks or make traversal less restrictive. These include: <br/><br/><span style=\" font-weight:600;\">Area 1</span><br/><ul type=\"circle\" style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 2;\"><li style=\" margin-top:0px; margin"
                        "-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Bomb Chamber to Bomb Chamber Access</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Temple Exterior to Inner Temple East Hall</li></ul><ul type=\"circle\" style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 2;\"><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Exterior Alpha Arena to Temple Exterior</li></ul><br/><span style=\" font-weight:600;\">Area 3 Metroid Caverns</span><br/><ul type=\"circle\" style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 2;\"><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The one-way doors in Transport to Area 2 and Transport to Area 4</li></ul><br/><span style=\" font-weight:600;\""
                        ">Area 4 Central Caves/Crystal Mines<br/></span></p><ul type=\"circle\" style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 2;\"><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Caves Intersection Terminal to Transport to Area 3 and Crystal Mines</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Mines Intersection Terminal to Super Missile Chamber</li></ul><br/><span style=\" font-weight:600;\">Area 5 Tower Interior<br/></span></li></ul><ul type=\"circle\" style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 2;\"><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Plasma Beam Chamber to Grapple Shuffler and Autrack Acropolis</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right"
                        ":0px; -qt-block-indent:0; text-indent:0px;\">Gravity Suit Chamber to Gravity Suit Chamber Access</li></ul></body></html>", None))
