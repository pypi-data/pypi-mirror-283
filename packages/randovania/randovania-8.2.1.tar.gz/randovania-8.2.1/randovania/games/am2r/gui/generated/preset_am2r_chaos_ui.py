...
class Ui_PresetAM2RChaos(object):
    def setupUi(self, PresetAM2RChaos):
        ...
        self.scroll_contents.setGeometry(QRect(0, 0, 518, 687))
        ...
        self.darkness_slider = QSlider(self.shuffle_item_pos_group)
        ...
        self.submerged_water_slider = QSlider(self.shuffle_item_pos_group)
        ...
        sizePolicy.setHeightForWidth(self.submerged_water_slider_label.sizePolicy().hasHeightForWidth())
        self.submerged_water_slider_label.setSizePolicy(sizePolicy)
        ...
        self.submerged_lava_slider = QSlider(self.shuffle_item_pos_group)
