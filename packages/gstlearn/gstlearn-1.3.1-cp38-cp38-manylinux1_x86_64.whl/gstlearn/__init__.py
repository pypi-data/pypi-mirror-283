...
def csv_manage(filename, csv, mode, nitem, flagInteger=False, verbose=False):
    return _gstlearn.csv_manage(filename, csv, mode, nitem, flagInteger, verbose)
...
def db_read_csv(filename, csvfmt, verbose=0, ncol_max=-1, nrow_max=-1, flagAddSampleRank=False):
    return _gstlearn.db_read_csv(filename, csvfmt, verbose, ncol_max, nrow_max, flagAddSampleRank)

def db_write_csv(db, filename, csv, flag_allcol=1, flag_coor=1, flagInteger=False):
    return _gstlearn.db_write_csv(db, filename, csv, flag_allcol, flag_coor, flagInteger)
...
def argumentTestMatrix(mat):
    return _gstlearn.argumentTestMatrix(mat)
...
class VectorHelper(object):
    ...
    @staticmethod
    def simulateGaussianInPlace(vec, mean=0., sigma=1.):
        return _gstlearn.VectorHelper_simulateGaussianInPlace(vec, mean, sigma)
    ...
    @staticmethod
    def linearCombinationVVDInPlace(val1, vvd1, val2, vvd2, outv):
        return _gstlearn.VectorHelper_linearCombinationVVDInPlace(val1, vvd1, val2, vvd2, outv)
...
def VectorHelper_divideInPlace(vec, v):
    return _gstlearn.VectorHelper_divideInPlace(vec, v)
...
def VectorHelper_addMultiplyConstantInPlace(val1, in1, outv):
    return _gstlearn.VectorHelper_addMultiplyConstantInPlace(val1, in1, outv)
...
def VectorHelper_simulateGaussianInPlace(vec, mean=0., sigma=1.):
    return _gstlearn.VectorHelper_simulateGaussianInPlace(vec, mean, sigma)
...
def VectorHelper_flatten(vvd):
    return _gstlearn.VectorHelper_flatten(vvd)

def VectorHelper_unflatten(vd, sizes):
    return _gstlearn.VectorHelper_unflatten(vd, sizes)

def VectorHelper_flattenInPlace(vvd, vd):
    return _gstlearn.VectorHelper_flattenInPlace(vvd, vd)
...
def VectorHelper_linearCombinationVVDInPlace(val1, vvd1, val2, vvd2, outv):
    return _gstlearn.VectorHelper_linearCombinationVVDInPlace(val1, vvd1, val2, vvd2, outv)
...
def bessel_j_table(x, alpha, nb, b):
    return _gstlearn.bessel_j_table(x, alpha, nb, b)

def bessel_j(x, n):
    return _gstlearn.bessel_j(x, n)
...
class AMatrix(AStringable, ICloneable):
    ...
    def isSymmetric(self, printWhyNot=False, eps=1.e-10):
        return _gstlearn.AMatrix_isSymmetric(self, printWhyNot, eps)
    ...
    def prodNormMatInPlace(self, *args, **kwargs):
        return _gstlearn.AMatrix_prodNormMatInPlace(self, *args, **kwargs)
    ...
    def linearCombination(self, val1, mat1, val2=1., mat2=None):
        return _gstlearn.AMatrix_linearCombination(self, val1, mat1, val2, mat2)
...
class AMatrixDense(AMatrix):
    ...
    def setColumn(self, icol, tab):
        return _gstlearn.AMatrixDense_setColumn(self, icol, tab)

    def setRow(self, irow, tab):
        return _gstlearn.AMatrixDense_setRow(self, irow, tab)

    def setDiagonal(self, tab):
        return _gstlearn.AMatrixDense_setDiagonal(self, tab)
    ...
    def prodNormMatInPlace(self, *args, **kwargs):
        return _gstlearn.AMatrixDense_prodNormMatInPlace(self, *args, **kwargs)
...
class MatrixSparse(AMatrix):
    ...
    def prodNormMatInPlace(self, *args, **kwargs):
        return _gstlearn.MatrixSparse_prodNormMatInPlace(self, *args, **kwargs)
    ...
    def computeCholesky(self):
        return _gstlearn.MatrixSparse_computeCholesky(self)

    def solveCholesky(self, b, x):
        return _gstlearn.MatrixSparse_solveCholesky(self, b, x)

    def simulateCholesky(self, b, x):
        return _gstlearn.MatrixSparse_simulateCholesky(self, b, x)

    def computeCholeskyLogDeterminant(self):
        return _gstlearn.MatrixSparse_computeCholeskyLogDeterminant(self)
    ...
    def addVecInPlace(self, x, y):
        return _gstlearn.MatrixSparse_addVecInPlace(self, x, y)
    ...
    def getEigenMatrix(self):
        return _gstlearn.MatrixSparse_getEigenMatrix(self)

    def setEigenMatrix(self, eigenMatrix):
        return _gstlearn.MatrixSparse_setEigenMatrix(self, eigenMatrix)
...
class MatrixSquareSymmetric(AMatrixSquare):
    ...
    def isSymmetric(self, printWhyNot=False, eps=1.e-10):
        return _gstlearn.MatrixSquareSymmetric_isSymmetric(self, printWhyNot, eps)
    ...
    def getTriangleSize(self):
        return _gstlearn.MatrixSquareSymmetric_getTriangleSize(self)

    def computeCholesky(self):
        return _gstlearn.MatrixSquareSymmetric_computeCholesky(self)

    def invertCholesky(self):
        return _gstlearn.MatrixSquareSymmetric_invertCholesky(self)

    def solveCholeskyMat(self, b, x):
        return _gstlearn.MatrixSquareSymmetric_solveCholeskyMat(self, b, x)

    def solveCholesky(self, b, x):
        return _gstlearn.MatrixSquareSymmetric_solveCholesky(self, b, x)

    def getCholeskyTL(self):
        return _gstlearn.MatrixSquareSymmetric_getCholeskyTL(self)

    def getCholeskyXL(self):
        return _gstlearn.MatrixSquareSymmetric_getCholeskyXL(self)

    def productCholeskyInPlace(self, mode, neq, nrhs, tl, a):
        return _gstlearn.MatrixSquareSymmetric_productCholeskyInPlace(self, mode, neq, nrhs, tl, a)

    def normCholeskyInPlace(self, mode, neq, tl, a):
        return _gstlearn.MatrixSquareSymmetric_normCholeskyInPlace(self, mode, neq, tl, a)

    def computeCholeskyLogDeterminant(self):
        return _gstlearn.MatrixSquareSymmetric_computeCholeskyLogDeterminant(self)
    ...
    def _recopy(self, r):
        return _gstlearn.MatrixSquareSymmetric__recopy(self, r)
    ...
    def _constraintsConcatenateMat(self, nae, nai, neq, active, tabemat, tabimat, tabout):
        return _gstlearn.MatrixSquareSymmetric__constraintsConcatenateMat(self, nae, nai, neq, active, tabemat, tabimat, tabout)

    def _constraintsConcatenateVD(self, nae, nai, active, tabemat, tabimat, tabout):
        return _gstlearn.MatrixSquareSymmetric__constraintsConcatenateVD(self, nae, nai, active, tabemat, tabimat, tabout)

    def _constraintsCount(self, nai, active):
        return _gstlearn.MatrixSquareSymmetric__constraintsCount(self, nai, active)

    def _checkCholeskyAlreadyPerformed(self, status):
        return _gstlearn.MatrixSquareSymmetric__checkCholeskyAlreadyPerformed(self, status)
...
def ShiftOpCs_create(*args, **kwargs):
    return _gstlearn.ShiftOpCs_create(*args, **kwargs)
...
class PrecisionOp(object):
    ...
    def getLogDeterminant(self, nbsimu=1, seed=0):
        return _gstlearn.PrecisionOp_getLogDeterminant(self, nbsimu, seed)
...
def PrecisionOp_create(mesh, model, icov=0, verbose=False):
    return _gstlearn.PrecisionOp_create(mesh, model, icov, verbose)
...
class PrecisionOpCs(PrecisionOp):
    ...
    def getLogDeterminant(self, nbsimu=1, seed=0):
        return _gstlearn.PrecisionOpCs_getLogDeterminant(self, nbsimu, seed)
...
class Cholesky(ALinearOp):
    ...
    def __init__(self, mat):
        _gstlearn.Cholesky_swiginit(self, _gstlearn.new_Cholesky(mat))
    ...
    def isValid(self):
        return _gstlearn.Cholesky_isValid(self)

    def solve(self, b, x):
        return _gstlearn.Cholesky_solve(self, b, x)

    def simulate(self, b, x):
        return _gstlearn.Cholesky_simulate(self, b, x)

    def stdev(self, vcur, flagStDev=False):
        return _gstlearn.Cholesky_stdev(self, vcur, flagStDev)

    def getLogDeterminant(self):
        return _gstlearn.Cholesky_getLogDeterminant(self)
...
class ANoStat(AStringable, ICloneable):
    ...
    def manageInfo(self, mode, dbin, dbout):
        return _gstlearn.ANoStat_manageInfo(self, mode, dbin, dbout)
    ...
    def getInfoFromDb(self, ipar, icas1, iech1, icas2, iech2, val1, val2):
        return _gstlearn.ANoStat_getInfoFromDb(self, ipar, icas1, iech1, icas2, iech2, val1, val2)
...
class AVario(AStringable, ICloneable):
    ...
    def evaluate(self, db, nvar, iech1, iech2, ipas, dist, do_asym=0):
        return _gstlearn.AVario_evaluate(self, db, nvar, iech1, iech2, ipas, dist, do_asym)
...
class Model(AStringable, ASerializable, ICloneable):
    ...
    def setOptimEnabled(self, flagOptim):
        return _gstlearn.Model_setOptimEnabled(self, flagOptim)
    ...
    def getNoStatModify(self):
        return _gstlearn.Model_getNoStatModify(self)
    ...
    def evalMatOptimInPlace(self, icas1, iech1, icas2, iech2, mat, mode=None):
        return _gstlearn.Model_evalMatOptimInPlace(self, icas1, iech1, icas2, iech2, mat, mode)
    ...
    def updateCovByPoints(self, icas1, iech1, icas2, iech2):
        return _gstlearn.Model_updateCovByPoints(self, icas1, iech1, icas2, iech2)

    def updateCovByMesh(self, imesh):
        return _gstlearn.Model_updateCovByMesh(self, imesh)
    ...
    def isNostatParamDefined(self, type0):
        return _gstlearn.Model_isNostatParamDefined(self, type0)
    ...
    def nostatUpdate(self, covint):
        return _gstlearn.Model_nostatUpdate(self, covint)
...
class ACov(ASpaceObject):
    ...
    def getNoStat(self):
        return _gstlearn.ACov_getNoStat(self)

    def getNoStatModify(self):
        return _gstlearn.ACov_getNoStatModify(self)
    ...
    def evalMatOptimInPlace(self, icas1, iech1, icas2, iech2, mat, mode=None):
        return _gstlearn.ACov_evalMatOptimInPlace(self, icas1, iech1, icas2, iech2, mat, mode)
    ...
    def updateCovByMesh(self, imesh):
        return _gstlearn.ACov_updateCovByMesh(self, imesh)

    def setOptimEnabled(self, isOptimEnabled):
        return _gstlearn.ACov_setOptimEnabled(self, isOptimEnabled)
...
class ACovAnisoList(ACov, ICloneable):
    ...
    def getNoStat(self):
        return _gstlearn.ACovAnisoList_getNoStat(self)

    def getNoStatModify(self):
        return _gstlearn.ACovAnisoList_getNoStatModify(self)
    ...
    def evalMatOptimInPlace(self, icas1, iech1, icas2, iech2, mat, mode=None):
        return _gstlearn.ACovAnisoList_evalMatOptimInPlace(self, icas1, iech1, icas2, iech2, mat, mode)

    def updateCovByPoints(self, icas1, iech1, icas2, iech2):
        return _gstlearn.ACovAnisoList_updateCovByPoints(self, icas1, iech1, icas2, iech2)

    def updateCovByMesh(self, imesh):
        return _gstlearn.ACovAnisoList_updateCovByMesh(self, imesh)
    ...
    def isOptimizationInitialized(self, db=None):
        return _gstlearn.ACovAnisoList_isOptimizationInitialized(self, db)

    def optimizationPreProcess(self, db):
        return _gstlearn.ACovAnisoList_optimizationPreProcess(self, db)

    def optimizationPostProcess(self):
        return _gstlearn.ACovAnisoList_optimizationPostProcess(self)

    def optimizationSetTarget(self, *args):
        return _gstlearn.ACovAnisoList_optimizationSetTarget(self, *args)
    ...
    def delNoStat(self):
        return _gstlearn.ACovAnisoList_delNoStat(self)
...
class CovAniso(ACov, ICloneable):
    ...
    def optimizationPreProcess(self, db):
        return _gstlearn.CovAniso_optimizationPreProcess(self, db)

    def optimizationPostProcess(self):
        return _gstlearn.CovAniso_optimizationPostProcess(self)

    def optimizationSetTarget(self, *args):
        return _gstlearn.CovAniso_optimizationSetTarget(self, *args)
    ...
    def evalMatOptimInPlace(self, icas1, iech1, icas2, iech2, mat, mode=None):
        return _gstlearn.CovAniso_evalMatOptimInPlace(self, icas1, iech1, icas2, iech2, mat, mode)
...
class CovBesselK(ACovFunc):
    ...
    def getCompatibleSpaceR(self):
        return _gstlearn.CovBesselK_getCompatibleSpaceR(self)

    def getCompatibleSpaceS(self):
        return _gstlearn.CovBesselK_getCompatibleSpaceS(self)
    ...
    def hasSpectrumOnSphere(self):
        return _gstlearn.CovBesselK_hasSpectrumOnSphere(self)

    def hasSpectrumOnRn(self):
        return _gstlearn.CovBesselK_hasSpectrumOnRn(self)
    ...
    def isValidForTurningBand(self):
        return _gstlearn.CovBesselK_isValidForTurningBand(self)

    def simulateTurningBand(self, t0, operTB):
        return _gstlearn.CovBesselK_simulateTurningBand(self, t0, operTB)

    def isValidForSpectral(self):
        return _gstlearn.CovBesselK_isValidForSpectral(self)

    def simulateSpectralOmega(self, nb):
        return _gstlearn.CovBesselK_simulateSpectralOmega(self, nb)
...
class Db(AStringable, ASerializable, ICloneable):
    ...
    def getSampleCoordinatesAsSPInPlace(self, iech, P):
        return _gstlearn.Db_getSampleCoordinatesAsSPInPlace(self, iech, P)
    ...
    def getMultipleRanksActive(self, ivars, nbgh, useSel=True, useVerr=False):
        return _gstlearn.Db_getMultipleRanksActive(self, ivars, nbgh, useSel, useVerr)
    ...
    def getSimRank(self, isimu, ivar, icase, nbsimu, nvar):
        return _gstlearn.Db_getSimRank(self, isimu, ivar, icase, nbsimu, nvar)
...
class DbGrid(Db):
    ...
    @staticmethod
    def migrateAllVariables(dbin, dbout, flagAddSampleRank=True):
        return _gstlearn.DbGrid_migrateAllVariables(dbin, dbout, flagAddSampleRank)
...
def DbGrid_migrateAllVariables(dbin, dbout, flagAddSampleRank=True):
    return _gstlearn.DbGrid_migrateAllVariables(dbin, dbout, flagAddSampleRank)
...
class SimuSpectral(object):
    ...
    def simulate(self, nb, seed=4273):
        return _gstlearn.SimuSpectral_simulate(self, nb, seed)

    def simulateOnSphere(self, ns, nd, seed=4273, verbose=False):
        return _gstlearn.SimuSpectral_simulateOnSphere(self, ns, nd, seed, verbose)

    def compute(self, *args, **kwargs):
        return _gstlearn.SimuSpectral_compute(self, *args, **kwargs)

    def computeOnSphere(self, *args, **kwargs):
        return _gstlearn.SimuSpectral_computeOnSphere(self, *args, **kwargs)
...
def SimuSpectral_isValidForSpectral(model):
    return _gstlearn.SimuSpectral_isValidForSpectral(model)
