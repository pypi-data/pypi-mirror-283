...
class DdeLogger:
    ...
    def _init_logger(cls):
        ...
        sls_handler = SimpleLogHandler(end_point=system_config["sls"]["zhejianglab"]["end_point"],access_key_id=system_config["sls"]["zhejianglab"]["access_key_id"],access_key=system_config["sls"]["zhejianglab"]["access_key"], project=system_config["sls"]["zhejianglab"]["project"], log_store=log_store)
