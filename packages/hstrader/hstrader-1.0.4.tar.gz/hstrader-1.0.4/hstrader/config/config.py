...
class Config(BaseModel):
    ...
    def __init__(self, timeout: int = 5, strategy: Strategy = Strategy.AUTO, **kwargs):

        super().__init__(timeout=timeout, strategy=strategy)
    ...
    def get_symbol(self, symbol_id: int) -> Symbol:
        ...
        Returns:
            Symbol: the symbol
        """
        return self.symbols[symbol_id] or None