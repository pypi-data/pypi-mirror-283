...
def main():
    ...
    film_comp = create_film_component(
        *(x.value for x in (PS['BL'], PS['BW'], PS['FT'], PS['FBL'], PS['FBW'], PS['FBA'])))
    ...
    set_named_selection([base_comp.Content.Bodies[0], fill_comp.Content.Bodies[0], fill_comp.Content.Bodies[1]],
                        'NSV_BASE&FILL')
