...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_iroh_ffi_checksum_method_doc_close_me() != 13449:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_doc_del() != 7367:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_ffi_checksum_method_doc_set_hash() != 30875:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_doc_share() != 30398:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_ffi_checksum_method_iroherror_message() != 31085:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_add_node_addr() != 52679:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_author_create() != 28895:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_author_default() != 42499:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_author_delete() != 4225:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_author_export() != 37686:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_author_import() != 5607:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_author_list() != 62761:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_add_bytes() != 17203:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_add_bytes_named() != 63529:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_add_from_path() != 37809:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_create_collection() != 52712:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_delete_blob() != 37832:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_download() != 54471:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_export() != 19194:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_get_collection() != 22036:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_list() != 31880:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_list_collections() != 189:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_list_incomplete() != 31752:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_read_at_to_bytes() != 11107:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_read_to_bytes() != 15494:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_share() != 38899:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_size() != 39132:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_write_to_path() != 43769:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_connection_info() != 64141:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_connections() != 55452:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_doc_create() != 25418:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_doc_drop() != 41240:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_doc_join() != 61748:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_doc_join_and_subscribe() != 992:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_doc_list() != 63026:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_doc_open() != 16291:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_gossip_subscribe() != 10882:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_home_relay() != 3309:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_my_rpc_addr() != 33640:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_node_addr() != 20255:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_node_id() != 46920:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_shutdown() != 624:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_stats() != 11985:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_status() != 3356:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_tags_delete() != 46770:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_irohnode_tags_list() != 567:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_ffi_checksum_constructor_authorid_from_string() != 47849:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_constructor_blobdownloadoptions_new() != 19425:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_ffi_checksum_constructor_hash_new() != 30613:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_constructor_irohnode_memory() != 52721:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_constructor_irohnode_memory_with_options() != 51113:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_constructor_irohnode_persistent() != 9772:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_constructor_irohnode_persistent_with_options() != 11511:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_iroh_ffi_fn_method_doc_del.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_doc_del.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_iroh_ffi_fn_clone_irohnode.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_ffi_fn_clone_irohnode.restype = ctypes.c_void_p
_UniffiLib.uniffi_iroh_ffi_fn_free_irohnode.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_ffi_fn_free_irohnode.restype = None
_UniffiLib.uniffi_iroh_ffi_fn_constructor_irohnode_memory.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_fn_constructor_irohnode_memory.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_constructor_irohnode_memory_with_options.argtypes = (
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_constructor_irohnode_memory_with_options.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_constructor_irohnode_persistent.argtypes = (
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_constructor_irohnode_persistent.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_constructor_irohnode_persistent_with_options.argtypes = (
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_constructor_irohnode_persistent_with_options.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_add_node_addr.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_add_node_addr.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_create.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_create.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_default.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_default.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_delete.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_delete.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_export.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_export.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_import.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_import.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_list.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_list.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_add_bytes.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_add_bytes.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_add_bytes_named.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_add_bytes_named.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_add_from_path.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.c_int8,
    ctypes.c_void_p,
...
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_add_from_path.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_create_collection.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_create_collection.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_delete_blob.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_delete_blob.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_download.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_download.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_export.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
...
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_export.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_get_collection.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_get_collection.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_list.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_list.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_list_collections.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_list_collections.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_list_incomplete.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_list_incomplete.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_read_at_to_bytes.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.c_uint64,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_read_at_to_bytes.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_read_to_bytes.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_read_to_bytes.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_share.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_share.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_size.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_size.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_write_to_path.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_write_to_path.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_connection_info.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_connection_info.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_connections.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_connections.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_create.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_create.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_drop.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_drop.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_join.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_join.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_join_and_subscribe.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_join_and_subscribe.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_list.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_list.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_open.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_open.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_gossip_subscribe.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_gossip_subscribe.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_home_relay.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_home_relay.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_my_rpc_addr.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_my_rpc_addr.restype = _UniffiRustBuffer
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_node_addr.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_node_addr.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_node_id.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_node_id.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_shutdown.argtypes = (
    ctypes.c_void_p,
    ctypes.c_int8,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_shutdown.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_stats.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_stats.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_status.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_status.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_tags_delete.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_tags_delete.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_tags_list.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_tags_list.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_iroh_ffi_checksum_method_doc_del.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_doc_del.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_add_node_addr.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_add_node_addr.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_author_create.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_author_create.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_author_default.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_author_default.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_author_delete.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_author_delete.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_author_export.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_author_export.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_author_import.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_author_import.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_author_list.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_author_list.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_add_bytes.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_add_bytes.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_add_bytes_named.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_add_bytes_named.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_add_from_path.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_add_from_path.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_create_collection.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_create_collection.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_delete_blob.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_delete_blob.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_download.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_download.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_export.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_export.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_get_collection.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_get_collection.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_list.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_list.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_list_collections.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_list_collections.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_list_incomplete.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_list_incomplete.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_read_at_to_bytes.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_read_at_to_bytes.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_read_to_bytes.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_read_to_bytes.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_share.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_share.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_size.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_size.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_write_to_path.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_blobs_write_to_path.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_connection_info.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_connection_info.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_connections.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_connections.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_doc_create.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_doc_create.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_doc_drop.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_doc_drop.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_doc_join.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_doc_join.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_doc_join_and_subscribe.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_doc_join_and_subscribe.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_doc_list.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_doc_list.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_doc_open.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_doc_open.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_gossip_subscribe.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_gossip_subscribe.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_home_relay.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_home_relay.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_my_rpc_addr.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_my_rpc_addr.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_node_addr.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_node_addr.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_node_id.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_node_id.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_shutdown.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_shutdown.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_stats.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_stats.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_status.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_status.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_tags_delete.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_tags_delete.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_tags_list.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_irohnode_tags_list.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_ffi_checksum_constructor_irohnode_memory.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_constructor_irohnode_memory.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_constructor_irohnode_memory_with_options.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_constructor_irohnode_memory_with_options.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_constructor_irohnode_persistent.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_constructor_irohnode_persistent.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_constructor_irohnode_persistent_with_options.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_constructor_irohnode_persistent_with_options.restype = ctypes.c_uint16
...
class BlobDownloadOptions:
    ...
    _pointer: ctypes.c_void_p
    def __init__(self, format: "BlobFormat",node: "NodeAddr",tag: "SetTagOption"):
        """
        ...
        _UniffiConverterTypeNodeAddr.check_lower(node)
...
class DocProtocol(typing.Protocol):
    ...
    def close_me(self, ):
        ...
        raise NotImplementedError
    def _del(self, author_id: "AuthorId",prefix: "bytes"):
        """
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def _del(self, author_id: "AuthorId",prefix: "bytes") -> "int":
        """
        Delete entries that match the given `author` and key `prefix`.
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_doc_del(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def share(self, mode: "ShareMode",addr_options: "AddrInfoOptions") -> "str":
        """
        Share this document with peers over a ticket.
        """
...
class IrohNodeProtocol(typing.Protocol):
    """
    ...
    def author_delete(self, author: "AuthorId"):
        ...
        raise NotImplementedError
    def author_export(self, author: "AuthorId"):
        """
        ...
        raise NotImplementedError
    def author_import(self, author: "Author"):
        """
    ...
    def author_list(self, ):
        ...
        raise NotImplementedError
    def blobs_add_bytes(self, bytes: "bytes"):
        """
        Write a blob by passing bytes.
        """

        raise NotImplementedError
    def blobs_add_bytes_named(self, bytes: "bytes",name: "str"):
        """
    ...
    def blobs_add_from_path(self, path: "str",in_place: "bool",tag: "SetTagOption",wrap: "WrapOption",cb: "AddCallback"):
        ...
        raise NotImplementedError
    def blobs_create_collection(self, collection: "Collection",tag: "SetTagOption",tags_to_delete: "typing.List[str]"):
        """
    ...
    def blobs_delete_blob(self, hash: "Hash"):
        ...
        raise NotImplementedError
    def blobs_download(self, hash: "Hash",opts: "BlobDownloadOptions",cb: "DownloadCallback"):
        """
    ...
    def blobs_export(self, hash: "Hash",destination: "str",format: "BlobExportFormat",mode: "BlobExportMode"):
        ...
        raise NotImplementedError
    def blobs_get_collection(self, hash: "Hash"):
        """
    ...
    def blobs_list(self, ):
        ...
        raise NotImplementedError
    def blobs_list_collections(self, ):
        """
        ...
        raise NotImplementedError
    def blobs_list_incomplete(self, ):
        """
        ...
        raise NotImplementedError
    def blobs_read_at_to_bytes(self, hash: "Hash",offset: "int",len: "typing.Optional[int]"):
        """
        ...
        raise NotImplementedError
    def blobs_read_to_bytes(self, hash: "Hash"):
        """
        ...
        raise NotImplementedError
    def blobs_share(self, hash: "Hash",blob_format: "BlobFormat",ticket_options: "AddrInfoOptions"):
        """
        Create a ticket for sharing a blob from this node.
        """

        raise NotImplementedError
    def blobs_size(self, hash: "Hash"):
        """
    ...
    def blobs_write_to_path(self, hash: "Hash",path: "str"):
        ...
        raise NotImplementedError
    def connection_info(self, node_id: "PublicKey"):
        """
    ...
    def doc_drop(self, doc_id: "str"):
        ...
        raise NotImplementedError
    def doc_join(self, ticket: "str"):
        """
        Join and sync with an already existing document.
        """

        raise NotImplementedError
    def doc_join_and_subscribe(self, ticket: "str",cb: "SubscribeCallback"):
        """
    ...
    def doc_open(self, id: "str"):
        ...
        raise NotImplementedError
    def gossip_subscribe(self, topic: "bytes",bootstrap: "typing.List[str]",cb: "GossipMessageCallback"):
        raise NotImplementedError
    def home_relay(self, ):
        """
...
class IrohNode:
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _uniffi_rust_call(_UniffiLib.uniffi_iroh_ffi_fn_free_irohnode, pointer)

    def _uniffi_clone_pointer(self):
        return _uniffi_rust_call(_UniffiLib.uniffi_iroh_ffi_fn_clone_irohnode, self._pointer)
    ...
    async def memory(cls, ):
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_constructor_irohnode_memory(),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_pointer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_pointer,
            _UniffiLib.ffi_iroh_ffi_rust_future_free_pointer,
            _UniffiConverterTypeIrohNode.lift,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def memory_with_options(cls, options: "NodeOptions"):
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_constructor_irohnode_memory_with_options(
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def persistent(cls, path: "str"):
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_constructor_irohnode_persistent(
        _UniffiConverterString.lower(path)),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_pointer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_pointer,
            _UniffiLib.ffi_iroh_ffi_rust_future_free_pointer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def persistent_with_options(cls, path: "str",options: "NodeOptions"):
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_constructor_irohnode_persistent_with_options(
        _UniffiConverterString.lower(path),
        _UniffiConverterTypeNodeOptions.lower(options)),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_pointer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_pointer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def add_node_addr(self, addr: "NodeAddr") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_add_node_addr(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def author_create(self, ) -> "AuthorId":
        """
        Create a new document author.
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_create(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_pointer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_pointer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def author_default(self, ) -> "AuthorId":
        """
        Returns the default document author of this node.
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_default(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_pointer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_pointer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def author_delete(self, author: "AuthorId") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_delete(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypeAuthorId.lower(author)
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_void,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def author_export(self, author: "AuthorId") -> "Author":
        """
        Export the given author.
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_export(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypeAuthorId.lower(author)
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_pointer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def author_import(self, author: "Author") -> "AuthorId":
        """
        Import the given author.
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_import(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def author_list(self, ) -> "typing.List[AuthorId]":
        """
        List all the AuthorIds that exist on this node.
        """

        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_author_list(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def blobs_add_bytes(self, bytes: "bytes") -> "BlobAddOutcome":
        """
        Write a blob by passing bytes.
        """
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_add_bytes(
                self._uniffi_clone_pointer(), 
        _UniffiConverterBytes.lower(bytes)
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def blobs_add_bytes_named(self, bytes: "bytes",name: "str") -> "BlobAddOutcome":
        """
        Write a blob by passing bytes, setting an explicit tag name.
        """
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_add_bytes_named(
                self._uniffi_clone_pointer(), 
        _UniffiConverterBytes.lower(bytes),
        _UniffiConverterString.lower(name)
            ),
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def blobs_add_from_path(self, path: "str",in_place: "bool",tag: "SetTagOption",wrap: "WrapOption",cb: "AddCallback") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_add_from_path(
                self._uniffi_clone_pointer(), 
        _UniffiConverterString.lower(path),
        _UniffiConverterBool.lower(in_place),
        _UniffiConverterTypeSetTagOption.lower(tag),
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def blobs_create_collection(self, collection: "Collection",tag: "SetTagOption",tags_to_delete: "typing.List[str]") -> "HashAndTag":
        """
        Create a collection from already existing blobs.
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_create_collection(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def blobs_delete_blob(self, hash: "Hash") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_delete_blob(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypeHash.lower(hash)
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_void,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def blobs_download(self, hash: "Hash",opts: "BlobDownloadOptions",cb: "DownloadCallback") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_download(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypeHash.lower(hash),
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def blobs_export(self, hash: "Hash",destination: "str",format: "BlobExportFormat",mode: "BlobExportMode") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_export(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypeHash.lower(hash),
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def blobs_get_collection(self, hash: "Hash") -> "Collection":
        """
        Read the content of a collection
        """
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_get_collection(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypeHash.lower(hash)
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_pointer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def blobs_list(self, ) -> "typing.List[Hash]":
        """
        List all complete blobs.
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_list(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def blobs_list_collections(self, ) -> "typing.List[CollectionInfo]":
        """
        List all collections.
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_list_collections(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def blobs_list_incomplete(self, ) -> "typing.List[IncompleteBlobInfo]":
        """
        List all incomplete (partial) blobs.
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_list_incomplete(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def blobs_read_at_to_bytes(self, hash: "Hash",offset: "int",len: "typing.Optional[int]") -> "bytes":
        """
        Read all bytes of single blob at `offset` for length `len`.
        ...
        _UniffiConverterOptionalUInt64.check_lower(len)
        
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_read_at_to_bytes(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypeHash.lower(hash),
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def blobs_read_to_bytes(self, hash: "Hash") -> "bytes":
        """
        Read all bytes of single blob.
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_read_to_bytes(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypeHash.lower(hash)
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def blobs_share(self, hash: "Hash",blob_format: "BlobFormat",ticket_options: "AddrInfoOptions") -> "str":
        """
        Create a ticket for sharing a blob from this node.
        """
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_share(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypeHash.lower(hash),
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def blobs_size(self, hash: "Hash") -> "int":
        """
        Get the size information on a single blob.
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_size(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypeHash.lower(hash)
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_u64,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def blobs_write_to_path(self, hash: "Hash",path: "str") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_blobs_write_to_path(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypeHash.lower(hash),
        _UniffiConverterString.lower(path)
            ),
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def connection_info(self, node_id: "PublicKey") -> "typing.Optional[ConnectionInfo]":
        """
        Return connection information on the currently running node.
        """
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_connection_info(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypePublicKey.lower(node_id)
            ...
            _UniffiLib.ffi_iroh_ffi_rust_future_free_rust_buffer,
            # lift function
            _UniffiConverterOptionalTypeConnectionInfo.lift,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def connections(self, ) -> "typing.List[ConnectionInfo]":
        """
        Return `ConnectionInfo`s for each connection we have to another iroh node.
        """

        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_connections(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_rust_buffer,
            _UniffiLib.ffi_iroh_ffi_rust_future_free_rust_buffer,
            # lift function
            _UniffiConverterSequenceTypeConnectionInfo.lift,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def doc_create(self, ) -> "Doc":
        """
        Create a new doc.
        """

        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_create(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_pointer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_pointer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def doc_drop(self, doc_id: "str") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_drop(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def doc_join(self, ticket: "str") -> "Doc":
        """
        Join and sync with an already existing document.
        """

        _UniffiConverterString.check_lower(ticket)
        
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_join(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def doc_join_and_subscribe(self, ticket: "str",cb: "SubscribeCallback") -> "Doc":
        """
        Join and sync with an already existing document and subscribe to events on that document.
        """
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_join_and_subscribe(
                self._uniffi_clone_pointer(), 
        _UniffiConverterString.lower(ticket),
        _UniffiConverterTypeSubscribeCallback.lower(cb)
            ),
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def doc_list(self, ) -> "typing.List[NamespaceAndCapability]":
        """
        List all the docs we have access to on this node.
        """

        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_list(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def doc_open(self, id: "str") -> "typing.Optional[Doc]":
        """
        Get a [`Doc`].
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_doc_open(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def gossip_subscribe(self, topic: "bytes",bootstrap: "typing.List[str]",cb: "GossipMessageCallback") -> "Sender":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_gossip_subscribe(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def home_relay(self, ) -> "typing.Optional[str]":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_home_relay(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    def my_rpc_addr(self, ) -> "typing.Optional[str]":
        ...
        return _UniffiConverterOptionalString.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_my_rpc_addr,self._uniffi_clone_pointer(),)
        )
    ...
    async def node_addr(self, ) -> "NodeAddr":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_node_addr(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_pointer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_pointer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def node_id(self, ) -> "str":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_node_id(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def shutdown(self, force: "bool") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_shutdown(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def stats(self, ) -> "dict[str, CounterStats]":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_stats(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def status(self, ) -> "NodeStatus":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_status(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_pointer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_pointer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def tags_delete(self, name: "bytes") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_tags_delete(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def tags_list(self, ) -> "typing.List[TagInfo]":
        """
        List all tags
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_irohnode_tags_list(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_rust_buffer,
...
class _UniffiConverterTypeIrohNode:
    ...
    @classmethod
    def write(cls, value: IrohNodeProtocol, buf: _UniffiRustBuffer):
        buf.write_u64(cls.lower(value))
...
class _UniffiConverterOptionalTypeConnectionInfo(_UniffiConverterRustBuffer):
    ...
    def check_lower(cls, value):
        if value is not None:
            _UniffiConverterTypeConnectionInfo.check_lower(value)
...
class _UniffiConverterSequenceTypeConnectionInfo(_UniffiConverterRustBuffer):
    ...
    def check_lower(cls, value):
        for item in value:
            _UniffiConverterTypeConnectionInfo.check_lower(item)
