...
def root(context, missing=missing):
    ...
    if t_4((undefined(name='tunnel_interfaces') if l_0_tunnel_interfaces is missing else l_0_tunnel_interfaces)):
        ...
        yield '| Interface | Description | VRF | MTU | Shutdown | NAT Profile | Mode | Source Interface | Destination | PMTU-Discovery | IPsec Profile |\n| --------- | ----------- | --- | --- | -------- | ----------- | ---- | ---------------- | ----------- | -------------- | ------------- |\n'
        for l_1_tunnel_interface in t_2((undefined(name='tunnel_interfaces') if l_0_tunnel_interfaces is missing else l_0_tunnel_interfaces), 'name'):
            l_1_description = l_1_vrf = l_1_mtu = l_1_shutdown = l_1_nat_profile = l_1_tunnel_mode = l_1_row_source_interface = l_1_row_destination = l_1_row_pmtu = l_1_ipsec_profile = missing
            _loop_vars = {}
            pass
            ...
            yield ' |\n'
        l_1_tunnel_interface = l_1_description = l_1_vrf = l_1_mtu = l_1_shutdown = l_1_nat_profile = l_1_tunnel_mode = l_1_row_source_interface = l_1_row_destination = l_1_row_pmtu = l_1_ipsec_profile = missing
...
blocks = {}
debug_info = '7=38&13=41&14=44&17=48&18=52&19=54&21=55&22=57&24=58&25=60&26=62&27=64&28=66&29=68&30=70&31=72&32=74&33=76&34=79&37=102&43=105&44=109&45=111&46=113&47=115&48=117&49=119&50=122&54=137&60=140&61=144&62=146&63=148&64=150&65=152&66=154&67=157&74=173'