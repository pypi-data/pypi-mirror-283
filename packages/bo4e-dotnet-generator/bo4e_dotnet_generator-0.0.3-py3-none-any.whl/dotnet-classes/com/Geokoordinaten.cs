...
//    using BO4EDotNet;
//
//    var geokoordinaten = Geokoordinaten.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Geokoordinaten
    {
        /// <summary>
    ...
    public partial class Geokoordinaten
    {
        public static Geokoordinaten FromJson(string json) => JsonConvert.DeserializeObject<Geokoordinaten>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Geokoordinaten self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
