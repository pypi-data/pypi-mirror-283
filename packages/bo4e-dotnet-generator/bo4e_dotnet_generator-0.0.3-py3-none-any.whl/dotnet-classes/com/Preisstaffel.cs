...
//    using BO4EDotNet;
//
//    var preisstaffel = Preisstaffel.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Preisstaffel
    {
        /// <summary>
    ...
    public partial class Preisstaffel
    {
        public static Preisstaffel FromJson(string json) => JsonConvert.DeserializeObject<Preisstaffel>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Preisstaffel self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
