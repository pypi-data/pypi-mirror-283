...
//    using BO4EDotNet;
//
//    var sigmoidparameter = Sigmoidparameter.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    public partial class Sigmoidparameter
    {
        public static Sigmoidparameter FromJson(string json) => JsonConvert.DeserializeObject<Sigmoidparameter>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Sigmoidparameter self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
