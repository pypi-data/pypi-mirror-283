...
//    using BO4EDotNet;
//
//    var standorteigenschaftenStrom = StandorteigenschaftenStrom.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class StandorteigenschaftenStrom
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("bilanzierungsgebietEic")]
        public string BilanzierungsgebietEic { get; set; }
        ...
        /// </summary>
        [JsonProperty("regelzoneEic")]
        public string RegelzoneEic { get; set; }
    ...
    public partial class StandorteigenschaftenStrom
    {
        public static StandorteigenschaftenStrom FromJson(string json) => JsonConvert.DeserializeObject<StandorteigenschaftenStrom>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this StandorteigenschaftenStrom self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
