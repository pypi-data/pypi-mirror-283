...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public enum Vertragsart { Bilanzierungsvertrag, Buendelvertrag, Energieliefervertrag, Messstellenbetriebsvertrag, Netznutzungsvertrag };
    ...
    /// </summary>
    public enum Vertragsstatus { Abgelehnt, Aktiv, Angenommen, Beendet, Gekuendigt, InArbeit, Storniert, Uebermittelt, Widerrufen };
