...
//    using BO4EDotNet;
//
//    var aufAbschlagProOrt = AufAbschlagProOrt.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class AufAbschlagProOrt
    {
        /// <summary>
        ...
        public AufAbschlagstaffelProOrt[] Staffeln { get; set; }
    ...
    public partial class AufAbschlagProOrt
    {
        public static AufAbschlagProOrt FromJson(string json) => JsonConvert.DeserializeObject<AufAbschlagProOrt>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this AufAbschlagProOrt self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
