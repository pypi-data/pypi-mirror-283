...
//    using BO4EDotNet;
//
//    var zeitspanne = Zeitspanne.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Zeitspanne
    {
        /// <summary>
    ...
    public partial class Zeitspanne
    {
        public static Zeitspanne FromJson(string json) => JsonConvert.DeserializeObject<Zeitspanne>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Zeitspanne self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
