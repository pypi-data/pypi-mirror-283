...
//    using BO4EDotNet;
//
//    var katasteradresse = Katasteradresse.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Katasteradresse
    {
        /// <summary>
        ...
        [JsonProperty("flurstueck")]
        public string Flurstueck { get; set; }

        [JsonProperty("gemarkungFlur")]
    ...
    public partial class Katasteradresse
    {
        public static Katasteradresse FromJson(string json) => JsonConvert.DeserializeObject<Katasteradresse>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Katasteradresse self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
