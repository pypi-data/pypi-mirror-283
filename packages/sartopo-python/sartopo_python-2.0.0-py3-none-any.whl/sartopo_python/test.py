...
# sts.addMarker(39,-120,'a')
# sts.addMarker(-120.1,39.1,'b')
...
#         # print('\n\ninitial points:'+json.dumps(pointsList,indent=3))
#         # print('validated points:'+json.dumps(sts._validatePoints(pointsList),indent=3))
#         sts.addLine(pointsList,'testLine')
#         sts.addPolygon(pointsList,'testPolygon')
...
print(str(sts.getBounds(sts.getFeatures('Assignment',forceRefresh=True))))
