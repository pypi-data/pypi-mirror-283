...
#CreateProject("Robtic Arm",templates=["python","json","Arduino"],technologies=["python"],summary="Robotic arm uding gesture detection",Difficulty="medium")
#print(''.join([f"{key}: {value} \n" for key,value in FetchProject("Expense Tracker").items()]))
#UpdateProject("Expense Tracker",tags=["personal"])
#print(''.join([f"{key}: {value} \n" for key,value in FetchProject("Expense Tracker").items()]))
