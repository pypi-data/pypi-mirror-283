...
def force_text( frame, overtext , posy = 400, bg_bgra = (255,0,255,0) , fg_bgra = (0,255,255,255) , fosize = 2*32):
    ...
    frame = iprint( frame, str(overtext), FONT, (midl,posy), fg_bgra)
    return frame
        ...
        if not (vidnum is None) and (vidnum==-1):
            ...
            if (cap.find("screenshot.jpg")==0) and ('pyautogui' in globals()):
                ...
                frame = iprint( blank_image, drtext,
                                "di99" , position,  color_bgra=(0,255,0,200)  )
            ...
            if cap is None and vidnum is None:
                ...
                frame = force_text(frame, overtext , posy = 35, fg_bgra = (0,0,0,255) ) # blue
                txt_img = "xxxxxxxxxxx"
            ...
            if ret: #********************************************************* operations
                ...
                if senh.add_frame(frame):  # it is a proper image....
                    ...
                    if baduser is not None:
                        frame = force_text( frame, f"error! => {baduser}", posy = 440, fg_bgra= (0,0,255, 255), fosize = 32 )
