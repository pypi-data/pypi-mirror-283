...
class GenerativeValidationApi:
    ...
    def start_generative_test(
        ...
        """Start Generative AI Validation Test

        Starts an AI validation test on the specified generative model. The status of the job can be tracked through the [JobReader service](#tag/JobReader). The results can of the test  can be retrieved using the [Results endpoint](#tag/GenerativeModelTesting/operation/Results).
