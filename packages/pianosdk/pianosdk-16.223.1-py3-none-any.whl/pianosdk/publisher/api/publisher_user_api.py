...
class PublisherUserApi(BaseApi):
    ...
    def list(self, aid: str, offset: int = 0, limit: int = 100, disabled: bool = False, q: str = None, search_after: str = None) -> ApiResponse[List[User]]:
