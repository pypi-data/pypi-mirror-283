...
def find_top_terms(issues:list[Issue], formatter: FormatterABC, min_count:int=3):
    """
    ...
    for term, issues in sorted_terms:
        ...
        report_sections.append(
            ...
            formatter.line_separator().join([(formatter.line(False, '', i, \
                    op=date_diff(now, i.created_at).days)+'\n\n') for i in issues]) + \
