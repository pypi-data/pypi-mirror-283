...
This is a wrapper class for all types of "variables", to generate computational
graphs. It can be initialized with simply giving it a value to hold. After that,
any Variable object can be simply used as they were the "value" given to them.

Every mathematical operation (except self assignments), logical operation and
...
the gradient calculation. The second argument must be a list of Variable objects.
...
LU decompositions of self. This method does not check for PA = LU
