...
def test_convert_to_zarr():
    ...
    flim_data = flim_data.reshape(number_of_photon_count_bins, 2, 3, 3, 3) # (ut, t, z, y, x)
    ...
    assert local_folder_path / "zarr_file.zarr" in [file_path for file_path in local_folder_path.iterdir()]
