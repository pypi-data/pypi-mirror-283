...
def setup_package():
    ...
    metadata = dict(
        name='dearpyguiupdated',                                      # Required
        version=version_number(),                              # Required
        author="Alexander Osipov",       # Optional
        author_email="masterradioteck@yandex.ru",            # Optional
    ...
    if os.environ.get('READTHEDOCS') == 'True':
        metadata['package_data']['dearpyguiupdated'] = ["__init__.py", "_dearpygui.py", "dearpygui.py", "demo.py", "experimental.py"]
    elif get_platform() == "Windows":
        metadata['package_data']['dearpyguiupdated'] = ["__init__.py", "_dearpygui.so", "_dearpygui.pyd", "_dearpygui.pyi", "dearpygui.py", "demo.py", "experimental.py", "vcruntime140_1.dll"]
    else:
        metadata['package_data']['dearpyguiupdated'] = ["__init__.py", "_dearpygui.so", "_dearpygui.pyd", "_dearpygui.pyi", "dearpygui.py", "demo.py", "experimental.py"]
