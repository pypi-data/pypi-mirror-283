...
class WriteScript:
    ...
    def write_eigen(self):
        ...
        for SS in range(1, frame.N + 1):
            self.write(f'    lappend mode [expr [nodeEigenvector {self.control_nodes[SS - 1]} $i 1]]')
            self.writepy(f'    mode.append(ops.nodeEigenvector({self.control_nodes[SS - 1]}, i, 1))')
    ...
    def write_dynamic_analysis(self):
        ...
        MF_nodes_tcl = ' '.join([str(i) for i in self.control_nodes])
        self.write(f'set MF_FloorNodes [list {MF_nodes_tcl}];')
    ...
    def write_cyclic_pushover(self):
        ...
        self.write(f'    set Dincr 0.5;')
        self.writepy(f'    Dincr = 0.5')
        self.write(f'    CyclicPushover $CtrlNode $RDR_path $HBuilding $Dincr $maxRunTime;')
        self.writepy(f'    result = CyclicPushover(CtrlNode, RDR_path, HBuilding, Dincr, maxRunTime, ShowAnimation)')
        self.write()
        self.writepy()
