...
__all__ = [
    ...
    "HistoricalRetrieveResponseItem",
    "HistoricalRetrieveResponseItemLoc",
    "HistoricalRetrieveResponseItemOb",
    "HistoricalRetrieveResponseItemObObsAux",
]


class HistoricalRetrieveResponseItemLoc(BaseModel):
...
class HistoricalRetrieveResponseItemObObsAux(BaseModel):
...
class HistoricalRetrieveResponseItemOb(BaseModel):
    obs_aux: Optional[List[HistoricalRetrieveResponseItemObObsAux]] = FieldInfo(alias="obsAux", default=None)
...
class HistoricalRetrieveResponseItem(BaseModel):
    ...
    loc: Optional[HistoricalRetrieveResponseItemLoc] = None
    ...
    obs: Optional[List[HistoricalRetrieveResponseItemOb]] = None
...
HistoricalRetrieveResponse = List[HistoricalRetrieveResponseItem]
