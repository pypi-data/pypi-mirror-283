...
class TestHotspot:
    ...
    def test_method_list(self, client: Phoebe) -> None:
        hotspot = client.ref.hotspot.list(
            "string",
        )
        assert_matches_type(HotspotListResponse, hotspot, path=["response"])
    ...
    def test_raw_response_list(self, client: Phoebe) -> None:
        response = client.ref.hotspot.with_raw_response.list(
            "string",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        hotspot = response.parse()
        assert_matches_type(HotspotListResponse, hotspot, path=["response"])

    @parametrize
    def test_streaming_response_list(self, client: Phoebe) -> None:
        with client.ref.hotspot.with_streaming_response.list(
            "string",
        ) as response:
    ...
    def test_path_params_list(self, client: Phoebe) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `region_code` but received ''"):
            client.ref.hotspot.with_raw_response.list(
                "",
            )


class TestAsyncHotspot:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    async def test_method_list(self, async_client: AsyncPhoebe) -> None:
        hotspot = await async_client.ref.hotspot.list(
            "string",
        )
        assert_matches_type(HotspotListResponse, hotspot, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncPhoebe) -> None:
        response = await async_client.ref.hotspot.with_raw_response.list(
            "string",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        hotspot = await response.parse()
        assert_matches_type(HotspotListResponse, hotspot, path=["response"])

    @parametrize
    async def test_streaming_response_list(self, async_client: AsyncPhoebe) -> None:
        async with async_client.ref.hotspot.with_streaming_response.list(
            "string",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncPhoebe) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `region_code` but received ''"):
            await async_client.ref.hotspot.with_raw_response.list(
                "",
            )
