...
from aliyun.instrumentation.langchain.package import _instruments

if TYPE_CHECKING:
    from langchain_core.callbacks import BaseCallbackManager
    from aliyun.instrumentation.langchain.internal._tracer import OpenInferenceTracer

class AliyunLangChainInstrumentor(BaseInstrumentor):  # type: ignore
    """
