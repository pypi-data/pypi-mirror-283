...
// %%EXPORT px
MAT24_API
int32_t xsp2co1_involution_find_type4(uint64_t *invar, uint32_t guide, uint32_t baby);
// %%EXPORT px
MAT24_API
int32_t xsp2co1_elem_find_type4(uint64_t *elem, uint32_t guide, uint32_t baby);
// %%EXPORT px
MAT24_API
