...
__all__ = ['KubeadmInstallArgs', 'KubeadmInstall']

@pulumi.input_type
class KubeadmInstallArgs:
...
class KubeadmInstall(pulumi.ComponentResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: KubeadmInstallArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Installs kubeadm on a remote system.

        :param str resource_name: The name of the resource.
        :param KubeadmInstallArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KubeadmInstallArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is not None:
            ...
            __props__ = KubeadmInstallArgs.__new__(KubeadmInstallArgs)
        ...
        super(KubeadmInstall, __self__).__init__(
