...
__all__ = ['ContainerdServiceArgs', 'ContainerdService']
...
class ContainerdService(pulumi.ComponentResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ContainerdServiceArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Containerd systemd service file. Will likely get replaced with a static function when https://github.com/pulumi/pulumi/issues/7583 gets resolved.

        :param str resource_name: The name of the resource.
        :param ContainerdServiceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ContainerdServiceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is not None:
            ...
            __props__ = ContainerdServiceArgs.__new__(ContainerdServiceArgs)
        ...
        super(ContainerdService, __self__).__init__(
