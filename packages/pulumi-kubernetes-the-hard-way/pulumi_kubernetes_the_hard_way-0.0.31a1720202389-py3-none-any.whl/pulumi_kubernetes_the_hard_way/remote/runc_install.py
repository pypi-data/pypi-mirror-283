...
__all__ = ['RuncInstallArgs', 'RuncInstall']

@pulumi.input_type
class RuncInstallArgs:
...
class RuncInstall(pulumi.ComponentResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RuncInstallArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Installs runc on a remote system.

        :param str resource_name: The name of the resource.
        :param RuncInstallArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RuncInstallArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is not None:
            ...
            __props__ = RuncInstallArgs.__new__(RuncInstallArgs)
