...
__all__ = ['CrictlInstallArgs', 'CrictlInstall']

@pulumi.input_type
class CrictlInstallArgs:
...
class CrictlInstall(pulumi.ComponentResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: CrictlInstallArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Installs crictl on a remote system

        :param str resource_name: The name of the resource.
        :param CrictlInstallArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CrictlInstallArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is not None:
            ...
            __props__ = CrictlInstallArgs.__new__(CrictlInstallArgs)
            ...
            __props__.__dict__["crictl_mv"] = None
            __props__.__dict__["crictl_path"] = None
        ...
        super(CrictlInstall, __self__).__init__(
    ...
    @property
    @pulumi.getter(name="crictlMv")
    def crictl_mv(self) -> pulumi.Output['_tools.Mv']:
        """
        The crictl mv operation.
        """
        return pulumi.get(self, "crictl_mv")

    @property
    @pulumi.getter(name="crictlPath")
    def crictl_path(self) -> pulumi.Output[str]:
        """
        The crictl path on the remote system
        """
        return pulumi.get(self, "crictl_path")
