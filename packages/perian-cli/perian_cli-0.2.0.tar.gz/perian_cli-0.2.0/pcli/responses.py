...
class DefaultApiException(DefaultException):
    detail: str = "An error occurred while connecting to the Sky Platform. Please try again or contact our support."


class InstanceTypeApiException(DefaultException):
    detail: str = "An error occurred while retrieving instance types. Please try again or contact our support."
...
class InstanceTypeNotFoundException(DefaultException):
    detail: str = "No instance types for given filters found. Please verify your filters."
...
class JobAPIException(DefaultException):
    detail: str = "An error occurred while retrieving jobs. Please try again or contact our support."
...
class InvalidJobManifestException(DefaultException):
    detail: str = "Malformed job manifest."
...
class AcceleratorTypeNotFoundException(DefaultException):
    detail: str = "No accelerator types for given filters found. Please verify your filters."


class AcceleratorTypeAPIException(DefaultException):
    detail: str = "An error occurred while retrieving accelerator types. Please try again or contact our support."
...
class InsufficientQuotaException(DefaultException):
    detail: str = "You have insufficient quota to create a new job. Please unlock your account by adding payment information."
