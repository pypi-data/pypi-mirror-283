...
import pytest
from python_sage_imap.helpers.message import MessageSet, MessageParts
...
def test_message_parts_enum():
    ...
    assert MessageParts.BODY_HEADER_FIELDS == "BODY[HEADER.FIELDS (FROM TO SUBJECT DATE)]"
    ...
    assert MessageParts.BODY_PEEK_HEADER_FIELDS == "BODY.PEEK[HEADER.FIELDS (FROM TO SUBJECT DATE)]"
