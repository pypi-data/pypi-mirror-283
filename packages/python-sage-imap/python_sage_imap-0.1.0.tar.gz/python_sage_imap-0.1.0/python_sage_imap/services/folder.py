...
from python_sage_imap.helpers.mailbox import DefaultMailboxes
from python_sage_imap.services.client import IMAPClient
...
class IMAPFolderService:
    ...
    def delete_folder(self, folder_name: str) -> None:
        ...
        """
        if (
            folder_name in DefaultMailboxes._value2member_map_ # pylint: disable=protected-access
        ):
