...
def test_from_address():
    assert IMAPSearchCriteria.from_address("example@example.com") == 'FROM "example@example.com"'

def test_to_address():
    assert IMAPSearchCriteria.to_address("example@example.com") == 'TO "example@example.com"'
