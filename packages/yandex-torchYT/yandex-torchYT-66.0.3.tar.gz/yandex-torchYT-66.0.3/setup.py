...
class InstallCommand(install):
    def run(self):
        raise RuntimeError("You are trying to install a stub package yandex-torchYT. Maybe you are using the wrong pypi? See https://nda.ya.ru/t/GljGihbC5zAGGz for details")
