...
class SimSES(threading.Thread):
    ...
    def __init__(self, path: str, name: str, do_simulation: bool = True, do_analysis: bool = True, do_validation: bool = False,
                 simulation_config: ConfigParser = None, analysis_config: ConfigParser = None, validation_config: ConfigParser = None,
                 queue: Queue = None, batch_dir: str = 'batch/'):
        """
    ...
    def run_one_simulation_step(self, time: float, power: float = None, power_dist: [float] = None, adapted_time: float = None) -> None:
        """
