...
from streaming_wds.core.downloader import ShardDownloader
from streaming_wds.core.extractor import ShardExtractor
from streaming_wds.core.sharder import (
    ComputeWorkerInfos,
)
...
class StreamingWebDataset(IterableDataset):
    ...
    def initialize_worker_components(self):
        ...
        self._samples_queue: Queue[Dict[str, bytes]] = Queue(maxsize=self.buffer_size)
