...
from streaming_wds.dataset import StreamingWebDataset
from streaming_wds.types import StateDict
from streaming_wds.utils import get_dist_world_size
...
class StreamingDataLoader(DataLoader):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._worker_infos = dataset.get_worker_infos(get_dist_world_size() * num_workers or 1)
        ...
        # TODO: override the collate_fn to handle __source_rank__ and __wds_shard_idx__
    ...
    def __iter__(self) -> Any:
        for batch in super().__iter__():
            source_ranks = cast(Tensor, batch.pop("__wds_global_rank")).tolist()
