...
class LabelResultsLabelImage(BaseModel):
    ...
    :type label_image_format: LabelImageLabelImageFormat
    ...
    :param pdf417: PDF-417 is a two-dimensional barcode, which can store up to about 1,800 printable ASCII characters or 1,100 binary characters per symbol. The symbol is rectangular.  The PDF417 image will be returned when the shipment is trans-border and the service option is one of the following: Standard Express, Saver Express Plus. The image is Base 64 encoded and only returned for GIF image format., defaults to None
    :type pdf417: str, optional
    :param international_signature_graphic_image: Base 64 encoded graphic image of the Warsaw text and signature box., defaults to None
    :type international_signature_graphic_image: str, optional
    :param url: This is only returned if the label link is requested to be returned and only at the first package result  Applicable for following types of shipments: Print/Electronic Return Label Print/Electronic Import Control Label Forward shipment except for Mail Innovations Forward, defaults to None
    :type url: str, optional
    """

    def __init__(
        self,
        label_image_format: LabelImageLabelImageFormat,
        graphic_image: str,
        html_image: str = None,
        pdf417: str = None,
