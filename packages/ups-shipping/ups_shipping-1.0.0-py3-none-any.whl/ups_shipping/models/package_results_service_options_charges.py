...
class PackageResultsServiceOptionsCharges(BaseModel):
    ...
    :param currency_code: Package accessorial charges currency code type. The currency code used in the Shipment request is returned.
    :type currency_code: str
    :param monetary_value: Package accessorial charges value amount. Valid values are from 0 to 99999999999999.99
