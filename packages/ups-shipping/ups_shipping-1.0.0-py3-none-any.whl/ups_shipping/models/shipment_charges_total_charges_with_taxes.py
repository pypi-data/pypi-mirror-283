...
class ShipmentChargesTotalChargesWithTaxes(BaseModel):
    ...
    :param monetary_value: TotalChargesWithTaxes monetary value amount.  Valid values are from 0 to 99999999999999.99
