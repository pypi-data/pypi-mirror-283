...
class GroupMembers(
    ...
    def __init__(
        ...
        *,
        ...
        :param group: The group's resource name in the format ``iam/organization/<organization_id>/group/<name>``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/group_members#group GroupMembers#group}
        :param members: A list of user principal IDs to add to the group. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/group_members#members GroupMembers#members}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing GroupMembers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/group_members#import import section} in the documentation of this resource for the id to use
