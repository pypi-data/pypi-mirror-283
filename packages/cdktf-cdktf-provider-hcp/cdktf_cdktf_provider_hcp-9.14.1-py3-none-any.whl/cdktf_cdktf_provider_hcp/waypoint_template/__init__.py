...
class WaypointTemplate(
    ...
    def __init__(
        ...
        *,
        ...
        terraform_cloud_workspace_details: typing.Union["WaypointTemplateTerraformCloudWorkspaceDetails", typing.Dict[builtins.str, typing.Any]],
        terraform_no_code_module: typing.Union["WaypointTemplateTerraformNoCodeModule", typing.Dict[builtins.str, typing.Any]],
        ...
        :param name: The name of the Template. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#name WaypointTemplate#name}
        :param summary: A brief description of the template, up to 110 characters. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#summary WaypointTemplate#summary}
        :param terraform_cloud_workspace_details: Terraform Cloud Workspace details. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#terraform_cloud_workspace_details WaypointTemplate#terraform_cloud_workspace_details}
        :param terraform_no_code_module: Terraform Cloud No-Code Module details. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#terraform_no_code_module WaypointTemplate#terraform_no_code_module}
        :param description: A description of the template, along with when and why it should be used, up to 500 characters. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#description WaypointTemplate#description}
        :param labels: List of labels attached to this Template. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#labels WaypointTemplate#labels}
        :param project_id: The ID of the HCP project where the Waypoint Template is located. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#project_id WaypointTemplate#project_id}
        :param readme_markdown_template: Instructions for using the template (markdown format supported. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#readme_markdown_template WaypointTemplate#readme_markdown_template}
        :param variable_options: List of variable options for the template. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#variable_options WaypointTemplate#variable_options}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing WaypointTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#import import section} in the documentation of this resource for the id to use
    ...
    def put_terraform_cloud_workspace_details(
        ...
        *,
        ...
        '''
        :param name: Name of the Terraform Cloud Workspace. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#name WaypointTemplate#name}
        :param terraform_project_id: Terraform Cloud Project ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#terraform_project_id WaypointTemplate#terraform_project_id}
        '''
    ...
    def put_terraform_no_code_module(
        ...
        *,
        ...
        '''
        :param source: No-Code Module Source. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#source WaypointTemplate#source}
        :param version: No-Code Module Version. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#version WaypointTemplate#version}
        '''
        value = WaypointTemplateTerraformNoCodeModule(source=source, version=version)
    ...
    def terraform_no_code_module(
        ...
        return typing.cast("WaypointTemplateTerraformNoCodeModuleOutputReference", jsii.get(self, "terraformNoCodeModule"))
    ...
    def terraform_no_code_module_input(
        self,
    ) -> typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, "WaypointTemplateTerraformNoCodeModule"]]:
        return typing.cast(typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, "WaypointTemplateTerraformNoCodeModule"]], jsii.get(self, "terraformNoCodeModuleInput"))
...
class WaypointTemplateConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if isinstance(terraform_no_code_module, dict):
            terraform_no_code_module = WaypointTemplateTerraformNoCodeModule(**terraform_no_code_module)
        if __debug__:
    ...
    def terraform_cloud_workspace_details(
        ...
        return typing.cast("WaypointTemplateTerraformCloudWorkspaceDetails", result)

    @builtins.property
    def terraform_no_code_module(self) -> "WaypointTemplateTerraformNoCodeModule":
        ...
        return typing.cast("WaypointTemplateTerraformNoCodeModule", result)
...
@jsii.data_type(
    jsii_type="@cdktf/provider-hcp.waypointTemplate.WaypointTemplateTerraformNoCodeModule",
    jsii_struct_bases=[],
    name_mapping={"source": "source", "version": "version"},
)
class WaypointTemplateTerraformNoCodeModule:
    def __init__(self, *, source: builtins.str, version: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b3ce494116601986ba0eab34007b576f52386049b0c7b22aa38357d42c9c1f64)
    ...
    def __repr__(self) -> str:
        return "WaypointTemplateTerraformNoCodeModule(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class WaypointTemplateTerraformNoCodeModuleOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-hcp.waypointTemplate.WaypointTemplateTerraformNoCodeModuleOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7f9c3ff2bb161469a1db2a5aaf34444536239e4c0ed892041f9f4d745696f546)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    def source(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5adbf856d23d35527ead1181ea38b97a5d8529c54ac16130fdfa9865a425e601)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def version(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f9e54a20e91929acda8f9c575c2f6f47ff76af747a6fac9b46a24add0748c15a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, WaypointTemplateTerraformNoCodeModule]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, WaypointTemplateTerraformNoCodeModule]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__58f36ce951131a1aa96fa7fc2e5b21600cd8c603d488939874abae03fcf2c3e4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class WaypointTemplateVariableOptions:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: Variable name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#name WaypointTemplate#name}
        :param variable_type: Variable type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#variable_type WaypointTemplate#variable_type}
        :param options: List of options. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#options WaypointTemplate#options}
        :param user_editable: Whether the variable is editable by the user creating an application. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/waypoint_template#user_editable WaypointTemplate#user_editable}
        '''
        if __debug__:
...
def _typecheckingstub__b3ce494116601986ba0eab34007b576f52386049b0c7b22aa38357d42c9c1f64(
    *,
    source: builtins.str,
    version: builtins.str,
) -> None:
...
def _typecheckingstub__7f9c3ff2bb161469a1db2a5aaf34444536239e4c0ed892041f9f4d745696f546(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__5adbf856d23d35527ead1181ea38b97a5d8529c54ac16130fdfa9865a425e601(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f9e54a20e91929acda8f9c575c2f6f47ff76af747a6fac9b46a24add0748c15a(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__58f36ce951131a1aa96fa7fc2e5b21600cd8c603d488939874abae03fcf2c3e4(
    value: typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, WaypointTemplateTerraformNoCodeModule]],
) -> None:
    """Type checking stubs"""
    pass
