...
class NotificationsWebhook(
    ...
    def __init__(
        ...
        *,
        ...
        :param config: The webhook configuration used to deliver event payloads. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/notifications_webhook#config NotificationsWebhook#config}
        :param name: The webhook's name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/notifications_webhook#name NotificationsWebhook#name}
        :param description: The webhook's description. Descriptions are useful for helping others understand the purpose of the webhook. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/notifications_webhook#description NotificationsWebhook#description}
        :param enabled: Indicates if the webhook should receive payloads for the subscribed events. Defaults to ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/notifications_webhook#enabled NotificationsWebhook#enabled}
        :param project_id: The ID of the project to create the webhook under. If unspecified, the webhook will be created in the project the provider is configured with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/notifications_webhook#project_id NotificationsWebhook#project_id}
        :param subscriptions: Set of events to subscribe the webhook to all resources or a specific resource in the project. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/notifications_webhook#subscriptions NotificationsWebhook#subscriptions}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing NotificationsWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/notifications_webhook#import import section} in the documentation of this resource for the id to use
    ...
    def put_config(
        ...
        *,
        ...
        '''
        :param url: The HTTP or HTTPS destination URL that HCP delivers the event payloads to. The destination must be able to use the HCP webhook `payload <https://developer.hashicorp.com/hcp/docs/hcp/admin/projects/webhooks#webhook-payload>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/notifications_webhook#url NotificationsWebhook#url}
        :param hmac_key: The arbitrary secret that HCP uses to sign all its webhook requests. This is a write-only field, it is written once and not visible thereafter. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/notifications_webhook#hmac_key NotificationsWebhook#hmac_key}
        '''
...
class NotificationsWebhookSubscriptions:
    def __init__(
        ...
        *,
        ...
        '''
        :param events: The information about the events of a webhook subscription. The service that owns the resource is responsible for maintaining events. Refer to the service's webhook documentation for more information. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/notifications_webhook#events NotificationsWebhook#events}
        :param resource_id: Refers to the resource the webhook is subscribed to. If not set, the webhook subscribes to the emitted events listed in events for any resource in the webhook's project. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/notifications_webhook#resource_id NotificationsWebhook#resource_id}
        '''
        if __debug__:
...
class NotificationsWebhookSubscriptionsEvents:
    def __init__(
        ...
        *,
        ...
        '''
        :param actions: The list of event actions subscribed for the resource type set as the `source <#source>`_. For example, ``["create", "update"]``. When the action is '*', it means that the webhook is subscribed to all event actions for the event source. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/notifications_webhook#actions NotificationsWebhook#actions}
        :param source: The resource type of the source of the event. For example, ``hashicorp.packer.version``. Event source might not be the same type as the resource that the webhook is subscribed to (`resource_id <#resource_id>`_) if the event is from a descendant resource. For example, webhooks are subscribed to a ``hashicorp.packer.registry`` and receive events for descendent resources such as a ``hashicorp.packer.version``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.1/docs/resources/notifications_webhook#source NotificationsWebhook#source}
        '''
        if __debug__:
