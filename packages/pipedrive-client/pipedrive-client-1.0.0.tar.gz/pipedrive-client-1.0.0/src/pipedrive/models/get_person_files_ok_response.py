...
@JsonMap({"id_": "id"})
class GetPersonFilesOkResponseData(BaseModel):
    """The file data
...
@JsonMap({})
class GetPersonFilesOkResponseAdditionalData(BaseModel):
...
@JsonMap({})
class GetPersonFilesOkResponse(BaseModel):
    """GetPersonFilesOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The array of files, defaults to None
    :type data: List[GetPersonFilesOkResponseData], optional
    :param additional_data: The additional data of the list, defaults to None
    :type additional_data: GetPersonFilesOkResponseAdditionalData, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetPersonFilesOkResponseData] = None,
        additional_data: GetPersonFilesOkResponseAdditionalData = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetPersonFilesOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetPersonFilesOkResponseAdditionalData
            )
