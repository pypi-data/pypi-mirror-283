...
class DataVisibleTo2(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataVisibleTo2._member_map_.values()))


@JsonMap({"id_": "id"})
class AddLeadCreatedResponseData(BaseModel):
    ...
    :type value: DataValue2, optional
    ...
    :type visible_to: DataVisibleTo2, optional
    ...
    def __init__(
        ...
        was_seen: bool = None,
        value: DataValue2 = None,
        expected_close_date: str = None,
        next_activity_id: int = None,
        add_time: str = None,
        update_time: str = None,
        visible_to: DataVisibleTo2 = None,
        cc_email: str = None,
    ):
        if id_ is not None:
            self.id_ = id_
        ...
        if value is not None:
            self.value = self._define_object(value, DataValue2)
        ...
        if visible_to is not None:
            self.visible_to = self._enum_matching(
                visible_to, DataVisibleTo2.list(), "visible_to"
            )
...
@JsonMap({})
class AddLeadCreatedResponse(BaseModel):
    """AddLeadCreatedResponse

    :param success: success, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: AddLeadCreatedResponseData, optional
    """

    def __init__(self, success: bool = None, data: AddLeadCreatedResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, AddLeadCreatedResponseData)
