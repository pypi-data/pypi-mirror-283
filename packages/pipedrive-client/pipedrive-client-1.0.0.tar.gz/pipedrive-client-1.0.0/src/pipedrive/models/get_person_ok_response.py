...
class PictureIdPictures16(BaseModel):
    """PictureIdPictures16
...
@JsonMap({"id_": "id"})
class DataPictureId11(BaseModel):
    """DataPictureId11
    ...
    :type pictures: PictureIdPictures16, optional
    """
    ...
    def __init__(
        ...
        pictures: PictureIdPictures16 = None,
    ):
        if id_ is not None:
            self.id_ = id_
        ...
        if pictures is not None:
            self.pictures = self._define_object(pictures, PictureIdPictures16)


@JsonMap({"id_": "id"})
class DataOwnerId11(BaseModel):
    """DataOwnerId11
...
@JsonMap({"id_": "id"})
class GetPersonOkResponseData(BaseModel):
    ...
    :type phone: List[DataPhone8], optional
    ...
    :type email: List[DataEmail8], optional
    ...
    :type picture_id: DataPictureId11, optional
    ...
    :type owner_id: DataOwnerId11, optional
    :param org_id: org_id, defaults to None
    :type org_id: DataOrgId12, optional
    ...
    def __init__(
        ...
        company_id: int = None,
        active_flag: bool = None,
        phone: List[DataPhone8] = None,
        email: List[DataEmail8] = None,
        first_char: str = None,
        add_time: str = None,
        update_time: str = None,
        visible_to: str = None,
        picture_id: DataPictureId11 = None,
        label: int = None,
        org_name: str = None,
        owner_name: str = None,
        cc_email: str = None,
        owner_id: DataOwnerId11 = None,
        org_id: DataOrgId12 = None,
        name: str = None,
        first_name: str = None,
        last_name: str = None,
        ...
        if phone is not None:
            self.phone = self._define_list(phone, DataPhone8)
        if email is not None:
            self.email = self._define_list(email, DataEmail8)
        ...
        if picture_id is not None:
            self.picture_id = self._define_object(picture_id, DataPictureId11)
        if label is not None:
            self.label = label
        ...
        if cc_email is not None:
            self.cc_email = cc_email
        if owner_id is not None:
            self.owner_id = self._define_object(owner_id, DataOwnerId11)
        if org_id is not None:
            self.org_id = self._define_object(org_id, DataOrgId12)
        if name is not None:
            self.name = name
...
@JsonMap({})
class GetPersonOkResponseAdditionalData(BaseModel):
    """GetPersonOkResponseAdditionalData

    :param dropbox_email: Dropbox email for the person, defaults to None
...
@JsonMap({"id_": "id"})
class OrganizationOrganizationId25(BaseModel):
    """OrganizationOrganizationId25
...
class RelatedObjectsOrganization25(BaseModel):
    """RelatedObjectsOrganization25

    :param organization_id: organization_id, defaults to None
    :type organization_id: OrganizationOrganizationId25, optional
    """

    def __init__(self, organization_id: OrganizationOrganizationId25 = None):
        if organization_id is not None:
            self.organization_id = self._define_object(
                organization_id, OrganizationOrganizationId25
            )


@JsonMap({"id_": "id"})
class UserUserId24(BaseModel):
    """UserUserId24
...
class RelatedObjectsUser24(BaseModel):
    """RelatedObjectsUser24

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId24, optional
    """

    def __init__(self, user_id: UserUserId24 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId24)


@JsonMap({"_128": "128", "_512": "512"})
class PictureIdPictures17(BaseModel):
    """PictureIdPictures17
...
@JsonMap({"id_": "id"})
class PicturePictureId6(BaseModel):
    """PicturePictureId6
    ...
    :type added_by_user_id: int, optional
    :param pictures: pictures, defaults to None
    :type pictures: PictureIdPictures17, optional
    """
    ...
    def __init__(
        ...
        update_time: str = None,
        added_by_user_id: int = None,
        pictures: PictureIdPictures17 = None,
    ):
        if id_ is not None:
            self.id_ = id_
        if item_type is not None:
        ...
        if added_by_user_id is not None:
            self.added_by_user_id = added_by_user_id
        if pictures is not None:
            self.pictures = self._define_object(pictures, PictureIdPictures17)


@JsonMap({"picture_id": "PICTURE_ID"})
class RelatedObjectsPicture6(BaseModel):
    """The picture that is associated with the item

    :param picture_id: picture_id, defaults to None
    :type picture_id: PicturePictureId6, optional
    """

    def __init__(self, picture_id: PicturePictureId6 = None):
        if picture_id is not None:
            self.picture_id = self._define_object(picture_id, PicturePictureId6)


@JsonMap({})
class GetPersonOkResponseRelatedObjects(BaseModel):
    """GetPersonOkResponseRelatedObjects

    :param organization: organization, defaults to None
    :type organization: RelatedObjectsOrganization25, optional
    :param user: user, defaults to None
    :type user: RelatedObjectsUser24, optional
    :param picture: The picture that is associated with the item, defaults to None
    :type picture: RelatedObjectsPicture6, optional
    """

    def __init__(
        self,
        organization: RelatedObjectsOrganization25 = None,
        user: RelatedObjectsUser24 = None,
        picture: RelatedObjectsPicture6 = None,
    ):
        if organization is not None:
            self.organization = self._define_object(
                organization, RelatedObjectsOrganization25
            )
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser24)
        if picture is not None:
            self.picture = self._define_object(picture, RelatedObjectsPicture6)


@JsonMap({})
class GetPersonOkResponse(BaseModel):
    """GetPersonOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: GetPersonOkResponseData, optional
    :param additional_data: additional_data, defaults to None
    :type additional_data: GetPersonOkResponseAdditionalData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: GetPersonOkResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: GetPersonOkResponseData = None,
        additional_data: GetPersonOkResponseAdditionalData = None,
        related_objects: GetPersonOkResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, GetPersonOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetPersonOkResponseAdditionalData
            )
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, GetPersonOkResponseRelatedObjects
            )
