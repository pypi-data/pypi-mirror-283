...
class DataActiveFlag2(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataActiveFlag2._member_map_.values()))


class DataDeletedFlag3(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataDeletedFlag3._member_map_.values()))


@JsonMap({"id_": "id"})
class AddTeamOkResponseData(BaseModel):
    ...
    :type active_flag: DataActiveFlag2, optional
    :param deleted_flag: deleted_flag, defaults to None
    :type deleted_flag: DataDeletedFlag3, optional
    ...
    def __init__(
        ...
        manager_id: int = None,
        users: List[int] = None,
        active_flag: DataActiveFlag2 = None,
        deleted_flag: DataDeletedFlag3 = None,
        add_time: str = None,
        ...
        if active_flag is not None:
            self.active_flag = self._enum_matching(
                active_flag, DataActiveFlag2.list(), "active_flag"
            )
        if deleted_flag is not None:
            self.deleted_flag = self._enum_matching(
                deleted_flag, DataDeletedFlag3.list(), "deleted_flag"
            )
...
@JsonMap({})
class AddTeamOkResponse(BaseModel):
    """AddTeamOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: AddTeamOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: AddTeamOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, AddTeamOkResponseData)
