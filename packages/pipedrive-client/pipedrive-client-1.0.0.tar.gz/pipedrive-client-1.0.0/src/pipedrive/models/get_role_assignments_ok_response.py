...
@JsonMap({"type_": "type"})
class GetRoleAssignmentsOkResponseData(BaseModel):
...
@JsonMap({})
class AdditionalDataPagination20(BaseModel):
...
@JsonMap({})
class GetRoleAssignmentsOkResponseAdditionalData(BaseModel):
    """The additional data in the role list

    :param pagination: The pagination details in the role list, defaults to None
    :type pagination: AdditionalDataPagination20, optional
    """

    def __init__(self, pagination: AdditionalDataPagination20 = None):
        if pagination is not None:
            self.pagination = self._define_object(
                pagination, AdditionalDataPagination20
            )


@JsonMap({})
class GetRoleAssignmentsOkResponse(BaseModel):
    """GetRoleAssignmentsOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The role assignments, defaults to None
    :type data: List[GetRoleAssignmentsOkResponseData], optional
    :param additional_data: The additional data in the role list, defaults to None
    :type additional_data: GetRoleAssignmentsOkResponseAdditionalData, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetRoleAssignmentsOkResponseData] = None,
        additional_data: GetRoleAssignmentsOkResponseAdditionalData = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetRoleAssignmentsOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetRoleAssignmentsOkResponseAdditionalData
            )
