...
@JsonMap({})
class DataOrganization4(BaseModel):
...
@JsonMap({"id_": "id"})
class UpdateNoteOkResponseData(BaseModel):
    ...
    :type organization: DataOrganization4, optional
    :param person: The person the note is attached to, defaults to None
    :type person: DataPerson4, optional
    ...
    def __init__(
        ...
        org_id: int = None,
        organization: DataOrganization4 = None,
        person: DataPerson4 = None,
        person_id: int = None,
        ...
        if deal is not None:
            self.deal = self._define_object(deal, DataDeal4)
        ...
        if organization is not None:
            self.organization = self._define_object(organization, DataOrganization4)
        if person is not None:
            self.person = self._define_object(person, DataPerson4)
        ...
        if user is not None:
            self.user = self._define_object(user, DataUser4)
        if user_id is not None:
            self.user_id = user_id


@JsonMap({})
class UpdateNoteOkResponse(BaseModel):
    """UpdateNoteOkResponse

    :param success: If the request was successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: UpdateNoteOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: UpdateNoteOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, UpdateNoteOkResponseData)
