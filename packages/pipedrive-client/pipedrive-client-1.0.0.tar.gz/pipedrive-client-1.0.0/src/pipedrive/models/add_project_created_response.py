...
@JsonMap({"id_": "id"})
class AddProjectCreatedResponseData(BaseModel):
...
@JsonMap({})
class AddProjectCreatedResponse(BaseModel):
    """AddProjectCreatedResponse

    :param success: success, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: AddProjectCreatedResponseData, optional
    ...
    def __init__(
        self,
        success: bool = None,
        data: AddProjectCreatedResponseData = None,
        additional_data: dict = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, AddProjectCreatedResponseData)
