...
class GetFiltersOkResponseData(BaseModel):
    """The filter object
...
@JsonMap({})
class GetFiltersOkResponse(BaseModel):
    """GetFiltersOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The array of filters, defaults to None
    :type data: List[GetFiltersOkResponseData], optional
    """

    def __init__(
        self, success: bool = None, data: List[GetFiltersOkResponseData] = None
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetFiltersOkResponseData)
