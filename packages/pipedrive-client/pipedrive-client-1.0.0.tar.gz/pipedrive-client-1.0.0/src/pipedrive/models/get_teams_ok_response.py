...
class DataActiveFlag1(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataActiveFlag1._member_map_.values()))


class DataDeletedFlag2(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataDeletedFlag2._member_map_.values()))


@JsonMap({"id_": "id"})
class GetTeamsOkResponseData(BaseModel):
    ...
    :type active_flag: DataActiveFlag1, optional
    :param deleted_flag: deleted_flag, defaults to None
    :type deleted_flag: DataDeletedFlag2, optional
    ...
    def __init__(
        ...
        manager_id: int = None,
        users: List[int] = None,
        active_flag: DataActiveFlag1 = None,
        deleted_flag: DataDeletedFlag2 = None,
        add_time: str = None,
        ...
        if active_flag is not None:
            self.active_flag = self._enum_matching(
                active_flag, DataActiveFlag1.list(), "active_flag"
            )
        if deleted_flag is not None:
            self.deleted_flag = self._enum_matching(
                deleted_flag, DataDeletedFlag2.list(), "deleted_flag"
            )
...
@JsonMap({})
class GetTeamsOkResponse(BaseModel):
    """GetTeamsOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: List[GetTeamsOkResponseData], optional
    """

    def __init__(self, success: bool = None, data: List[GetTeamsOkResponseData] = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetTeamsOkResponseData)
