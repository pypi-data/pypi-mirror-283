...
class PictureIdPictures10(BaseModel):
    """PictureIdPictures10
...
@JsonMap({})
class DataPictureId7(BaseModel):
    """DataPictureId7
    ...
    :type pictures: PictureIdPictures10, optional
    """
    ...
    def __init__(
        ...
        pictures: PictureIdPictures10 = None,
    ):
        if value is not None:
            self.value = value
        ...
        if pictures is not None:
            self.pictures = self._define_object(pictures, PictureIdPictures10)


@JsonMap({"id_": "id"})
class UpdateOrganizationOkResponseData(BaseModel):
    ...
    :type owner_id: DataOwnerId7, optional
    ...
    :type picture_id: DataPictureId7, optional
    ...
    def __init__(
        ...
        id_: int = None,
        company_id: int = None,
        owner_id: DataOwnerId7 = None,
        name: str = None,
        active_flag: bool = None,
        picture_id: DataPictureId7 = None,
        ...
        if owner_id is not None:
            self.owner_id = self._define_object(owner_id, DataOwnerId7)
        if name is not None:
            self.name = name
        if active_flag is not None:
            self.active_flag = active_flag
        if picture_id is not None:
            self.picture_id = self._define_object(picture_id, DataPictureId7)
...
@JsonMap({"id_": "id"})
class OrganizationOrganizationId16(BaseModel):
    """OrganizationOrganizationId16
...
class RelatedObjectsOrganization16(BaseModel):
    """RelatedObjectsOrganization16

    :param organization_id: organization_id, defaults to None
    :type organization_id: OrganizationOrganizationId16, optional
    """

    def __init__(self, organization_id: OrganizationOrganizationId16 = None):
        if organization_id is not None:
            self.organization_id = self._define_object(
                organization_id, OrganizationOrganizationId16
            )


@JsonMap({"id_": "id"})
class UserUserId18(BaseModel):
    """UserUserId18
...
class RelatedObjectsUser18(BaseModel):
    """RelatedObjectsUser18

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId18, optional
    """

    def __init__(self, user_id: UserUserId18 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId18)


@JsonMap({"_128": "128", "_512": "512"})
class PictureIdPictures11(BaseModel):
    """PictureIdPictures11
...
@JsonMap({"id_": "id"})
class PicturePictureId4(BaseModel):
    """PicturePictureId4
    ...
    :type added_by_user_id: int, optional
    :param pictures: pictures, defaults to None
    :type pictures: PictureIdPictures11, optional
    """
    ...
    def __init__(
        ...
        update_time: str = None,
        added_by_user_id: int = None,
        pictures: PictureIdPictures11 = None,
    ):
        if id_ is not None:
            self.id_ = id_
        if item_type is not None:
        ...
        if added_by_user_id is not None:
            self.added_by_user_id = added_by_user_id
        if pictures is not None:
            self.pictures = self._define_object(pictures, PictureIdPictures11)


@JsonMap({"picture_id": "PICTURE_ID"})
class RelatedObjectsPicture4(BaseModel):
    """The picture that is associated with the item

    :param picture_id: picture_id, defaults to None
    :type picture_id: PicturePictureId4, optional
    """

    def __init__(self, picture_id: PicturePictureId4 = None):
        if picture_id is not None:
            self.picture_id = self._define_object(picture_id, PicturePictureId4)


@JsonMap({})
class UpdateOrganizationOkResponseRelatedObjects(BaseModel):
    """UpdateOrganizationOkResponseRelatedObjects

    :param organization: organization, defaults to None
    :type organization: RelatedObjectsOrganization16, optional
    :param user: user, defaults to None
    :type user: RelatedObjectsUser18, optional
    :param picture: The picture that is associated with the item, defaults to None
    :type picture: RelatedObjectsPicture4, optional
    """

    def __init__(
        self,
        organization: RelatedObjectsOrganization16 = None,
        user: RelatedObjectsUser18 = None,
        picture: RelatedObjectsPicture4 = None,
    ):
        if organization is not None:
            self.organization = self._define_object(
                organization, RelatedObjectsOrganization16
            )
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser18)
        if picture is not None:
            self.picture = self._define_object(picture, RelatedObjectsPicture4)


@JsonMap({})
class UpdateOrganizationOkResponse(BaseModel):
    """UpdateOrganizationOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: UpdateOrganizationOkResponseData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: UpdateOrganizationOkResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: UpdateOrganizationOkResponseData = None,
        related_objects: UpdateOrganizationOkResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, UpdateOrganizationOkResponseData)
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, UpdateOrganizationOkResponseRelatedObjects
            )
