...
@JsonMap({"id_": "id"})
class AddFileAndLinkItOkResponseData(BaseModel):
    """The file data
...
@JsonMap({})
class AddFileAndLinkItOkResponse(BaseModel):
    ...
    :type data: AddFileAndLinkItOkResponseData, optional
    """

    def __init__(
        self, success: bool = None, data: AddFileAndLinkItOkResponseData = None
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, AddFileAndLinkItOkResponseData)
