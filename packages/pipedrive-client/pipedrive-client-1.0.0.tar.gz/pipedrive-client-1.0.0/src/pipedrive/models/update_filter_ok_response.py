...
class DataType2(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataType2._member_map_.values()))


@JsonMap({"id_": "id", "type_": "type"})
class UpdateFilterOkResponseData(BaseModel):
    ...
    def __init__(
        ...
        if type_ is not None:
            self.type_ = self._enum_matching(type_, DataType2.list(), "type_")
...
@JsonMap({})
class UpdateFilterOkResponse(BaseModel):
    """UpdateFilterOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: UpdateFilterOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: UpdateFilterOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, UpdateFilterOkResponseData)
