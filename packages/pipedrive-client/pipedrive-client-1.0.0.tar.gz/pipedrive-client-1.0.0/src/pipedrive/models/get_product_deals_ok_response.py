...
@JsonMap({"id_": "id"})
class DataCreatorUserId7(BaseModel):
...
@JsonMap({})
class PersonIdEmail27(BaseModel):
    """PersonIdEmail27
...
@JsonMap({})
class PersonIdPhone27(BaseModel):
    """PersonIdPhone27
...
class DataPersonId7(BaseModel):
    ...
    def __init__(
        ...
        active_flag: bool = None,
        name: str = None,
        email: List[PersonIdEmail27] = None,
        phone: List[PersonIdPhone27] = None,
        owner_id: int = None,
        value: int = None,
    ):
        if active_flag is not None:
        ...
        if name is not None:
            self.name = name
        if email is not None:
            self.email = self._define_list(email, PersonIdEmail27)
        if phone is not None:
            self.phone = self._define_list(phone, PersonIdPhone27)
...
@JsonMap({"id_": "id"})
class GetProductDealsOkResponseData(BaseModel):
    ...
    :type creator_user_id: DataCreatorUserId7, optional
    :param user_id: user_id, defaults to None
    :type user_id: DataUserId7, optional
    :param person_id: person_id, defaults to None
    :type person_id: DataPersonId7, optional
    :param org_id: org_id, defaults to None
    :type org_id: DataOrgId15, optional
    ...
    def __init__(
        self,
        id_: int = None,
        creator_user_id: DataCreatorUserId7 = None,
        user_id: DataUserId7 = None,
        person_id: DataPersonId7 = None,
        org_id: DataOrgId15 = None,
        stage_id: int = None,
        title: str = None,
        value: float = None,
        currency: str = None,
        ...
        if creator_user_id is not None:
            self.creator_user_id = self._define_object(
                creator_user_id, DataCreatorUserId7
            )
        if user_id is not None:
            self.user_id = self._define_object(user_id, DataUserId7)
        if person_id is not None:
            self.person_id = self._define_object(person_id, DataPersonId7)
        if org_id is not None:
            self.org_id = self._define_object(org_id, DataOrgId15)
...
@JsonMap({})
class GetProductDealsOkResponseAdditionalData(BaseModel):
...
@JsonMap({"id_": "id"})
class OrganizationOrganizationId33(BaseModel):
    """OrganizationOrganizationId33
...
class RelatedObjectsOrganization33(BaseModel):
    """RelatedObjectsOrganization33

    :param organization_id: organization_id, defaults to None
    :type organization_id: OrganizationOrganizationId33, optional
    """

    def __init__(self, organization_id: OrganizationOrganizationId33 = None):
        if organization_id is not None:
            self.organization_id = self._define_object(
                organization_id, OrganizationOrganizationId33
            )


@JsonMap({})
class PersonIdEmail28(BaseModel):
    """PersonIdEmail28
...
@JsonMap({})
class PersonIdPhone28(BaseModel):
    """PersonIdPhone28
...
@JsonMap({"id_": "id"})
class PersonPersonId21(BaseModel):
    """PersonPersonId21
    ...
    def __init__(
        ...
        id_: int = None,
        name: str = None,
        email: List[PersonIdEmail28] = None,
        phone: List[PersonIdPhone28] = None,
        owner_id: int = None,
    ):
        if active_flag is not None:
            self.active_flag = active_flag
        ...
        if name is not None:
            self.name = name
        if email is not None:
            self.email = self._define_list(email, PersonIdEmail28)
        if phone is not None:
            self.phone = self._define_list(phone, PersonIdPhone28)
        if owner_id is not None:
            self.owner_id = owner_id


@JsonMap({"person_id": "PERSON_ID"})
class RelatedObjectsPerson21(BaseModel):
    """RelatedObjectsPerson21

    :param person_id: person_id, defaults to None
    :type person_id: PersonPersonId21, optional
    """

    def __init__(self, person_id: PersonPersonId21 = None):
        if person_id is not None:
            self.person_id = self._define_object(person_id, PersonPersonId21)


@JsonMap({"id_": "id"})
class UserUserId33(BaseModel):
    """UserUserId33
...
class RelatedObjectsUser33(BaseModel):
    """RelatedObjectsUser33

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId33, optional
    """

    def __init__(self, user_id: UserUserId33 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId33)


@JsonMap({"id_": "id"})
class RelatedObjectsStage3(BaseModel):
    """RelatedObjectsStage3
...
@JsonMap({"id_": "id"})
class RelatedObjectsPipeline3(BaseModel):
    """RelatedObjectsPipeline3
...
@JsonMap({})
class GetProductDealsOkResponseRelatedObjects(BaseModel):
    """GetProductDealsOkResponseRelatedObjects

    :param organization: organization, defaults to None
    :type organization: RelatedObjectsOrganization33, optional
    :param person: person, defaults to None
    :type person: RelatedObjectsPerson21, optional
    :param user: user, defaults to None
    :type user: RelatedObjectsUser33, optional
    :param stage: stage, defaults to None
    :type stage: RelatedObjectsStage3, optional
    :param pipeline: pipeline, defaults to None
    :type pipeline: RelatedObjectsPipeline3, optional
    """

    def __init__(
        self,
        organization: RelatedObjectsOrganization33 = None,
        person: RelatedObjectsPerson21 = None,
        user: RelatedObjectsUser33 = None,
        stage: RelatedObjectsStage3 = None,
        pipeline: RelatedObjectsPipeline3 = None,
    ):
        if organization is not None:
            self.organization = self._define_object(
                organization, RelatedObjectsOrganization33
            )
        if person is not None:
            self.person = self._define_object(person, RelatedObjectsPerson21)
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser33)
        if stage is not None:
            self.stage = self._define_object(stage, RelatedObjectsStage3)
        if pipeline is not None:
            self.pipeline = self._define_object(pipeline, RelatedObjectsPipeline3)


@JsonMap({})
class GetProductDealsOkResponse(BaseModel):
    """GetProductDealsOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The array of deals, defaults to None
    :type data: List[GetProductDealsOkResponseData], optional
    :param additional_data: The additional data of the list, defaults to None
    :type additional_data: GetProductDealsOkResponseAdditionalData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: GetProductDealsOkResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetProductDealsOkResponseData] = None,
        additional_data: GetProductDealsOkResponseAdditionalData = None,
        related_objects: GetProductDealsOkResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetProductDealsOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetProductDealsOkResponseAdditionalData
            )
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, GetProductDealsOkResponseRelatedObjects
            )
