...
@JsonMap({})
class GetPersonChangelogOkResponseData(BaseModel):
...
@JsonMap({})
class GetPersonChangelogOkResponseAdditionalData(BaseModel):
...
@JsonMap({})
class GetPersonChangelogOkResponse(BaseModel):
    """GetPersonChangelogOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: List[GetPersonChangelogOkResponseData], optional
    :param additional_data: The additional data of the list, defaults to None
    :type additional_data: GetPersonChangelogOkResponseAdditionalData, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetPersonChangelogOkResponseData] = None,
        additional_data: GetPersonChangelogOkResponseAdditionalData = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetPersonChangelogOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetPersonChangelogOkResponseAdditionalData
            )
