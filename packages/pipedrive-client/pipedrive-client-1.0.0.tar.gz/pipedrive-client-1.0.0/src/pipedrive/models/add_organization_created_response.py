...
class PictureIdPictures6(BaseModel):
    """PictureIdPictures6
...
@JsonMap({})
class DataPictureId5(BaseModel):
    """DataPictureId5
    ...
    :type pictures: PictureIdPictures6, optional
    """
    ...
    def __init__(
        ...
        pictures: PictureIdPictures6 = None,
    ):
        if value is not None:
            self.value = value
        ...
        if pictures is not None:
            self.pictures = self._define_object(pictures, PictureIdPictures6)


@JsonMap({"id_": "id"})
class AddOrganizationCreatedResponseData(BaseModel):
    ...
    :type owner_id: DataOwnerId5, optional
    ...
    :type picture_id: DataPictureId5, optional
    ...
    def __init__(
        ...
        id_: int = None,
        company_id: int = None,
        owner_id: DataOwnerId5 = None,
        name: str = None,
        active_flag: bool = None,
        picture_id: DataPictureId5 = None,
        ...
        if owner_id is not None:
            self.owner_id = self._define_object(owner_id, DataOwnerId5)
        if name is not None:
            self.name = name
        if active_flag is not None:
            self.active_flag = active_flag
        if picture_id is not None:
            self.picture_id = self._define_object(picture_id, DataPictureId5)
...
@JsonMap({"id_": "id"})
class OrganizationOrganizationId14(BaseModel):
    """OrganizationOrganizationId14
...
class RelatedObjectsOrganization14(BaseModel):
    """RelatedObjectsOrganization14

    :param organization_id: organization_id, defaults to None
    :type organization_id: OrganizationOrganizationId14, optional
    """

    def __init__(self, organization_id: OrganizationOrganizationId14 = None):
        if organization_id is not None:
            self.organization_id = self._define_object(
                organization_id, OrganizationOrganizationId14
            )


@JsonMap({"id_": "id"})
class UserUserId16(BaseModel):
    """UserUserId16
...
class RelatedObjectsUser16(BaseModel):
    """RelatedObjectsUser16

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId16, optional
    """

    def __init__(self, user_id: UserUserId16 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId16)


@JsonMap({"_128": "128", "_512": "512"})
class PictureIdPictures7(BaseModel):
    """PictureIdPictures7
...
@JsonMap({"id_": "id"})
class PicturePictureId2(BaseModel):
    """PicturePictureId2
    ...
    :type added_by_user_id: int, optional
    :param pictures: pictures, defaults to None
    :type pictures: PictureIdPictures7, optional
    """
    ...
    def __init__(
        ...
        update_time: str = None,
        added_by_user_id: int = None,
        pictures: PictureIdPictures7 = None,
    ):
        if id_ is not None:
            self.id_ = id_
        if item_type is not None:
        ...
        if added_by_user_id is not None:
            self.added_by_user_id = added_by_user_id
        if pictures is not None:
            self.pictures = self._define_object(pictures, PictureIdPictures7)


@JsonMap({"picture_id": "PICTURE_ID"})
class RelatedObjectsPicture2(BaseModel):
    """The picture that is associated with the item

    :param picture_id: picture_id, defaults to None
    :type picture_id: PicturePictureId2, optional
    """

    def __init__(self, picture_id: PicturePictureId2 = None):
        if picture_id is not None:
            self.picture_id = self._define_object(picture_id, PicturePictureId2)


@JsonMap({})
class AddOrganizationCreatedResponseRelatedObjects(BaseModel):
    """AddOrganizationCreatedResponseRelatedObjects

    :param organization: organization, defaults to None
    :type organization: RelatedObjectsOrganization14, optional
    :param user: user, defaults to None
    :type user: RelatedObjectsUser16, optional
    :param picture: The picture that is associated with the item, defaults to None
    :type picture: RelatedObjectsPicture2, optional
    """

    def __init__(
        self,
        organization: RelatedObjectsOrganization14 = None,
        user: RelatedObjectsUser16 = None,
        picture: RelatedObjectsPicture2 = None,
    ):
        if organization is not None:
            self.organization = self._define_object(
                organization, RelatedObjectsOrganization14
            )
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser16)
        if picture is not None:
            self.picture = self._define_object(picture, RelatedObjectsPicture2)


@JsonMap({})
class AddOrganizationCreatedResponse(BaseModel):
    """AddOrganizationCreatedResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: AddOrganizationCreatedResponseData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: AddOrganizationCreatedResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: AddOrganizationCreatedResponseData = None,
        related_objects: AddOrganizationCreatedResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, AddOrganizationCreatedResponseData)
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, AddOrganizationCreatedResponseRelatedObjects
            )
