...
class DataFieldType10(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataFieldType10._member_map_.values()))


@JsonMap({"id_": "id"})
class UpdateOrganizationFieldOkResponseData(BaseModel):
    ...
    :type field_type: DataFieldType10, optional
    ...
    def __init__(
        ...
        name: str = None,
        order_nr: int = None,
        field_type: DataFieldType10 = None,
        add_time: str = None,
        ...
        if field_type is not None:
            self.field_type = self._enum_matching(
                field_type, DataFieldType10.list(), "field_type"
            )
...
@JsonMap({})
class UpdateOrganizationFieldOkResponse(BaseModel):
    """UpdateOrganizationFieldOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: UpdateOrganizationFieldOkResponseData, optional
    """

    def __init__(
        self, success: bool = None, data: UpdateOrganizationFieldOkResponseData = None
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, UpdateOrganizationFieldOkResponseData)
