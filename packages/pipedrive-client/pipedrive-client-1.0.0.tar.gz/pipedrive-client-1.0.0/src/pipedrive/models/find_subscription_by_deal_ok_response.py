...
@JsonMap({"id_": "id"})
class FindSubscriptionByDealOkResponseData(BaseModel):
...
@JsonMap({})
class FindSubscriptionByDealOkResponse(BaseModel):
    """FindSubscriptionByDealOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: FindSubscriptionByDealOkResponseData, optional
    """

    def __init__(
        self, success: bool = None, data: FindSubscriptionByDealOkResponseData = None
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, FindSubscriptionByDealOkResponseData)
