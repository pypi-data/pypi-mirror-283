...
@JsonMap({"id_": "id"})
class DataCreatorUserId2(BaseModel):
...
@JsonMap({})
class PersonIdEmail7(BaseModel):
    """PersonIdEmail7
...
@JsonMap({})
class PersonIdPhone7(BaseModel):
    """PersonIdPhone7
...
class DataPersonId2(BaseModel):
    ...
    def __init__(
        ...
        active_flag: bool = None,
        name: str = None,
        email: List[PersonIdEmail7] = None,
        phone: List[PersonIdPhone7] = None,
        owner_id: int = None,
        value: int = None,
    ):
        if active_flag is not None:
        ...
        if name is not None:
            self.name = name
        if email is not None:
            self.email = self._define_list(email, PersonIdEmail7)
        if phone is not None:
            self.phone = self._define_list(phone, PersonIdPhone7)
...
@JsonMap({"id_": "id"})
class AddDealCreatedResponseData(BaseModel):
    ...
    :type creator_user_id: DataCreatorUserId2, optional
    :param user_id: user_id, defaults to None
    :type user_id: DataUserId2, optional
    :param person_id: person_id, defaults to None
    :type person_id: DataPersonId2, optional
    :param org_id: org_id, defaults to None
    :type org_id: DataOrgId2, optional
    ...
    def __init__(
        self,
        id_: int = None,
        creator_user_id: DataCreatorUserId2 = None,
        user_id: DataUserId2 = None,
        person_id: DataPersonId2 = None,
        org_id: DataOrgId2 = None,
        stage_id: int = None,
        title: str = None,
        value: float = None,
        currency: str = None,
        ...
        if creator_user_id is not None:
            self.creator_user_id = self._define_object(
                creator_user_id, DataCreatorUserId2
            )
        if user_id is not None:
            self.user_id = self._define_object(user_id, DataUserId2)
        if person_id is not None:
            self.person_id = self._define_object(person_id, DataPersonId2)
        if org_id is not None:
            self.org_id = self._define_object(org_id, DataOrgId2)
...
class RelatedObjectsUser6(BaseModel):
    """RelatedObjectsUser6

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId6, optional
    """

    def __init__(self, user_id: UserUserId6 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId6)


@JsonMap({"id_": "id"})
class OrganizationOrganizationId6(BaseModel):
    """OrganizationOrganizationId6
...
class RelatedObjectsOrganization6(BaseModel):
    """RelatedObjectsOrganization6

    :param organization_id: organization_id, defaults to None
    :type organization_id: OrganizationOrganizationId6, optional
    """

    def __init__(self, organization_id: OrganizationOrganizationId6 = None):
        if organization_id is not None:
            self.organization_id = self._define_object(
                organization_id, OrganizationOrganizationId6
            )


@JsonMap({})
class PersonIdEmail8(BaseModel):
    """PersonIdEmail8
...
@JsonMap({})
class PersonIdPhone8(BaseModel):
    """PersonIdPhone8
...
@JsonMap({"id_": "id"})
class PersonPersonId6(BaseModel):
    """PersonPersonId6
    ...
    def __init__(
        ...
        id_: int = None,
        name: str = None,
        email: List[PersonIdEmail8] = None,
        phone: List[PersonIdPhone8] = None,
        owner_id: int = None,
    ):
        if active_flag is not None:
            self.active_flag = active_flag
        ...
        if name is not None:
            self.name = name
        if email is not None:
            self.email = self._define_list(email, PersonIdEmail8)
        if phone is not None:
            self.phone = self._define_list(phone, PersonIdPhone8)
        if owner_id is not None:
            self.owner_id = owner_id


@JsonMap({"person_id": "PERSON_ID"})
class RelatedObjectsPerson6(BaseModel):
    """RelatedObjectsPerson6

    :param person_id: person_id, defaults to None
    :type person_id: PersonPersonId6, optional
    """

    def __init__(self, person_id: PersonPersonId6 = None):
        if person_id is not None:
            self.person_id = self._define_object(person_id, PersonPersonId6)


@JsonMap({})
class AddDealCreatedResponseRelatedObjects(BaseModel):
    """AddDealCreatedResponseRelatedObjects

    :param user: user, defaults to None
    :type user: RelatedObjectsUser6, optional
    :param organization: organization, defaults to None
    :type organization: RelatedObjectsOrganization6, optional
    :param person: person, defaults to None
    :type person: RelatedObjectsPerson6, optional
    """

    def __init__(
        self,
        user: RelatedObjectsUser6 = None,
        organization: RelatedObjectsOrganization6 = None,
        person: RelatedObjectsPerson6 = None,
    ):
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser6)
        if organization is not None:
            self.organization = self._define_object(
                organization, RelatedObjectsOrganization6
            )
        if person is not None:
            self.person = self._define_object(person, RelatedObjectsPerson6)


@JsonMap({})
class AddDealCreatedResponse(BaseModel):
    """AddDealCreatedResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: AddDealCreatedResponseData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: AddDealCreatedResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: AddDealCreatedResponseData = None,
        related_objects: AddDealCreatedResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, AddDealCreatedResponseData)
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, AddDealCreatedResponseRelatedObjects
            )
