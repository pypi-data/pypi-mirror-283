...
class GetActivityOkResponseData(BaseModel):
...
class RelatedObjectsUser3(BaseModel):
    """RelatedObjectsUser3

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId3, optional
    """

    def __init__(self, user_id: UserUserId3 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId3)


@JsonMap({"id_": "id"})
class DealDealId3(BaseModel):
...
class RelatedObjectsDeal3(BaseModel):
    """RelatedObjectsDeal3

    :param deal_id: The ID of the deal which is associated with the item, defaults to None
    :type deal_id: DealDealId3, optional
    """

    def __init__(self, deal_id: DealDealId3 = None):
        if deal_id is not None:
            self.deal_id = self._define_object(deal_id, DealDealId3)


@JsonMap({})
class PersonIdEmail3(BaseModel):
    """PersonIdEmail3
...
@JsonMap({})
class PersonIdPhone3(BaseModel):
    """PersonIdPhone3
...
@JsonMap({"id_": "id"})
class PersonPersonId3(BaseModel):
    """PersonPersonId3
    ...
    def __init__(
        ...
        id_: int = None,
        name: str = None,
        email: List[PersonIdEmail3] = None,
        phone: List[PersonIdPhone3] = None,
        owner_id: int = None,
    ):
        if id_ is not None:
            self.id_ = id_
        if name is not None:
            self.name = name
        if email is not None:
            self.email = self._define_list(email, PersonIdEmail3)
        if phone is not None:
            self.phone = self._define_list(phone, PersonIdPhone3)
        if owner_id is not None:
            self.owner_id = owner_id


@JsonMap({"person_id": "PERSON_ID"})
class RelatedObjectsPerson3(BaseModel):
    """RelatedObjectsPerson3

    :param person_id: person_id, defaults to None
    :type person_id: PersonPersonId3, optional
    """

    def __init__(self, person_id: PersonPersonId3 = None):
        if person_id is not None:
            self.person_id = self._define_object(person_id, PersonPersonId3)


@JsonMap({"id_": "id"})
class OrganizationOrganizationId3(BaseModel):
    """OrganizationOrganizationId3
...
class RelatedObjectsOrganization3(BaseModel):
    """RelatedObjectsOrganization3

    :param organization_id: organization_id, defaults to None
    :type organization_id: OrganizationOrganizationId3, optional
    """

    def __init__(self, organization_id: OrganizationOrganizationId3 = None):
        if organization_id is not None:
            self.organization_id = self._define_object(
                organization_id, OrganizationOrganizationId3
            )


@JsonMap({})
class GetActivityOkResponseRelatedObjects(BaseModel):
    """GetActivityOkResponseRelatedObjects

    :param user: user, defaults to None
    :type user: RelatedObjectsUser3, optional
    :param deal: deal, defaults to None
    :type deal: RelatedObjectsDeal3, optional
    :param person: person, defaults to None
    :type person: RelatedObjectsPerson3, optional
    :param organization: organization, defaults to None
    :type organization: RelatedObjectsOrganization3, optional
    """

    def __init__(
        self,
        user: RelatedObjectsUser3 = None,
        deal: RelatedObjectsDeal3 = None,
        person: RelatedObjectsPerson3 = None,
        organization: RelatedObjectsOrganization3 = None,
    ):
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser3)
        if deal is not None:
            self.deal = self._define_object(deal, RelatedObjectsDeal3)
        if person is not None:
            self.person = self._define_object(person, RelatedObjectsPerson3)
        if organization is not None:
            self.organization = self._define_object(
                organization, RelatedObjectsOrganization3
            )


@JsonMap({})
class GetActivityOkResponse(BaseModel):
    """GetActivityOkResponse

    :param success: success, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: GetActivityOkResponseData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: GetActivityOkResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: GetActivityOkResponseData = None,
        related_objects: GetActivityOkResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, GetActivityOkResponseData)
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, GetActivityOkResponseRelatedObjects
            )
