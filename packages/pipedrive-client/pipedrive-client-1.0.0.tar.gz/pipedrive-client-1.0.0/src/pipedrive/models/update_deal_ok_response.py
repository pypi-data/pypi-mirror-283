...
@JsonMap({"id_": "id"})
class DataCreatorUserId4(BaseModel):
...
@JsonMap({})
class PersonIdEmail11(BaseModel):
    """PersonIdEmail11
...
@JsonMap({})
class PersonIdPhone11(BaseModel):
    """PersonIdPhone11
...
class DataPersonId4(BaseModel):
    ...
    def __init__(
        ...
        active_flag: bool = None,
        name: str = None,
        email: List[PersonIdEmail11] = None,
        phone: List[PersonIdPhone11] = None,
        owner_id: int = None,
        value: int = None,
    ):
        if active_flag is not None:
        ...
        if name is not None:
            self.name = name
        if email is not None:
            self.email = self._define_list(email, PersonIdEmail11)
        if phone is not None:
            self.phone = self._define_list(phone, PersonIdPhone11)
...
@JsonMap({"id_": "id"})
class UpdateDealOkResponseData(BaseModel):
    ...
    :type creator_user_id: DataCreatorUserId4, optional
    :param user_id: user_id, defaults to None
    :type user_id: DataUserId4, optional
    :param person_id: person_id, defaults to None
    :type person_id: DataPersonId4, optional
    :param org_id: org_id, defaults to None
    :type org_id: DataOrgId4, optional
    ...
    def __init__(
        self,
        id_: int = None,
        creator_user_id: DataCreatorUserId4 = None,
        user_id: DataUserId4 = None,
        person_id: DataPersonId4 = None,
        org_id: DataOrgId4 = None,
        stage_id: int = None,
        title: str = None,
        value: float = None,
        currency: str = None,
        ...
        if creator_user_id is not None:
            self.creator_user_id = self._define_object(
                creator_user_id, DataCreatorUserId4
            )
        if user_id is not None:
            self.user_id = self._define_object(user_id, DataUserId4)
        if person_id is not None:
            self.person_id = self._define_object(person_id, DataPersonId4)
        if org_id is not None:
            self.org_id = self._define_object(org_id, DataOrgId4)
...
class RelatedObjectsUser8(BaseModel):
    """RelatedObjectsUser8

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId8, optional
    """

    def __init__(self, user_id: UserUserId8 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId8)


@JsonMap({"id_": "id"})
class OrganizationOrganizationId8(BaseModel):
    """OrganizationOrganizationId8
...
class RelatedObjectsOrganization8(BaseModel):
    """RelatedObjectsOrganization8

    :param organization_id: organization_id, defaults to None
    :type organization_id: OrganizationOrganizationId8, optional
    """

    def __init__(self, organization_id: OrganizationOrganizationId8 = None):
        if organization_id is not None:
            self.organization_id = self._define_object(
                organization_id, OrganizationOrganizationId8
            )


@JsonMap({})
class PersonIdEmail12(BaseModel):
    """PersonIdEmail12
...
@JsonMap({})
class PersonIdPhone12(BaseModel):
    """PersonIdPhone12
...
@JsonMap({"id_": "id"})
class PersonPersonId8(BaseModel):
    """PersonPersonId8
    ...
    def __init__(
        ...
        id_: int = None,
        name: str = None,
        email: List[PersonIdEmail12] = None,
        phone: List[PersonIdPhone12] = None,
        owner_id: int = None,
    ):
        if active_flag is not None:
            self.active_flag = active_flag
        ...
        if name is not None:
            self.name = name
        if email is not None:
            self.email = self._define_list(email, PersonIdEmail12)
        if phone is not None:
            self.phone = self._define_list(phone, PersonIdPhone12)
        if owner_id is not None:
            self.owner_id = owner_id


@JsonMap({"person_id": "PERSON_ID"})
class RelatedObjectsPerson8(BaseModel):
    """RelatedObjectsPerson8

    :param person_id: person_id, defaults to None
    :type person_id: PersonPersonId8, optional
    """

    def __init__(self, person_id: PersonPersonId8 = None):
        if person_id is not None:
            self.person_id = self._define_object(person_id, PersonPersonId8)


@JsonMap({})
class UpdateDealOkResponseRelatedObjects(BaseModel):
    """UpdateDealOkResponseRelatedObjects

    :param user: user, defaults to None
    :type user: RelatedObjectsUser8, optional
    :param organization: organization, defaults to None
    :type organization: RelatedObjectsOrganization8, optional
    :param person: person, defaults to None
    :type person: RelatedObjectsPerson8, optional
    """

    def __init__(
        self,
        user: RelatedObjectsUser8 = None,
        organization: RelatedObjectsOrganization8 = None,
        person: RelatedObjectsPerson8 = None,
    ):
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser8)
        if organization is not None:
            self.organization = self._define_object(
                organization, RelatedObjectsOrganization8
            )
        if person is not None:
            self.person = self._define_object(person, RelatedObjectsPerson8)


@JsonMap({})
class UpdateDealOkResponse(BaseModel):
    """UpdateDealOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: UpdateDealOkResponseData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: UpdateDealOkResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: UpdateDealOkResponseData = None,
        related_objects: UpdateDealOkResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, UpdateDealOkResponseData)
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, UpdateDealOkResponseRelatedObjects
            )
