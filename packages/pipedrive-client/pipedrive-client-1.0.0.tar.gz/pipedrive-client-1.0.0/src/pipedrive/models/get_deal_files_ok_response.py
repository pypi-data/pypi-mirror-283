...
@JsonMap({"id_": "id"})
class GetDealFilesOkResponseData(BaseModel):
    """The file data
...
@JsonMap({})
class GetDealFilesOkResponseAdditionalData(BaseModel):
...
@JsonMap({})
class GetDealFilesOkResponse(BaseModel):
    """GetDealFilesOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The array of files, defaults to None
    :type data: List[GetDealFilesOkResponseData], optional
    :param additional_data: The additional data of the list, defaults to None
    :type additional_data: GetDealFilesOkResponseAdditionalData, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetDealFilesOkResponseData] = None,
        additional_data: GetDealFilesOkResponseAdditionalData = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetDealFilesOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetDealFilesOkResponseAdditionalData
            )
