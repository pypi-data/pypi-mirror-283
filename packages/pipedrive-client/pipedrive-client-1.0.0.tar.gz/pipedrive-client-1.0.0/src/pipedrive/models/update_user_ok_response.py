...
class AccessApp8(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, AccessApp8._member_map_.values()))


@JsonMap({})
class DataAccess7(BaseModel):
    """DataAccess7

    :param app: app, defaults to None
    :type app: AccessApp8, optional
    ...
    def __init__(
        self, app: AccessApp8 = None, admin: bool = None, permission_set_id: str = None
    ):
        if app is not None:
            self.app = self._enum_matching(app, AccessApp8.list(), "app")
...
@JsonMap({"id_": "id"})
class UpdateUserOkResponseData(BaseModel):
    ...
    :type access: List[DataAccess7], optional
    ...
    def __init__(
        ...
        if access is not None:
            self.access = self._define_list(access, DataAccess7)
...
@JsonMap({})
class UpdateUserOkResponse(BaseModel):
    """UpdateUserOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: UpdateUserOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: UpdateUserOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, UpdateUserOkResponseData)
