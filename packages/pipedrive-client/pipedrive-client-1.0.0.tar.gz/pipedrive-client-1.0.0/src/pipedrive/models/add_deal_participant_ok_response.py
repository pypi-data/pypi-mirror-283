...
class PictureIdPictures2(BaseModel):
    """PictureIdPictures2
...
@JsonMap({"id_": "id"})
class DataPictureId2(BaseModel):
    """DataPictureId2
    ...
    :type pictures: PictureIdPictures2, optional
    """
    ...
    def __init__(
        ...
        pictures: PictureIdPictures2 = None,
    ):
        if id_ is not None:
            self.id_ = id_
        ...
        if pictures is not None:
            self.pictures = self._define_object(pictures, PictureIdPictures2)


@JsonMap({"id_": "id"})
class DataOwnerId2(BaseModel):
    """DataOwnerId2
...
@JsonMap({"id_": "id"})
class AddDealParticipantOkResponseData(BaseModel):
    ...
    :type phone: List[DataPhone2], optional
    ...
    :type email: List[DataEmail2], optional
    ...
    :type picture_id: DataPictureId2, optional
    ...
    :type owner_id: DataOwnerId2, optional
    :param org_id: org_id, defaults to None
    :type org_id: DataOrgId6, optional
    ...
    def __init__(
        ...
        company_id: int = None,
        active_flag: bool = None,
        phone: List[DataPhone2] = None,
        email: List[DataEmail2] = None,
        first_char: str = None,
        add_time: str = None,
        update_time: str = None,
        visible_to: str = None,
        picture_id: DataPictureId2 = None,
        label: int = None,
        org_name: str = None,
        owner_name: str = None,
        cc_email: str = None,
        owner_id: DataOwnerId2 = None,
        org_id: DataOrgId6 = None,
        name: str = None,
        first_name: str = None,
        last_name: str = None,
        ...
        if phone is not None:
            self.phone = self._define_list(phone, DataPhone2)
        if email is not None:
            self.email = self._define_list(email, DataEmail2)
        ...
        if picture_id is not None:
            self.picture_id = self._define_object(picture_id, DataPictureId2)
        if label is not None:
            self.label = label
        ...
        if cc_email is not None:
            self.cc_email = cc_email
        if owner_id is not None:
            self.owner_id = self._define_object(owner_id, DataOwnerId2)
        if org_id is not None:
            self.org_id = self._define_object(org_id, DataOrgId6)
        if name is not None:
            self.name = name
...
class RelatedObjectsUser12(BaseModel):
    """RelatedObjectsUser12

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId12, optional
    """

    def __init__(self, user_id: UserUserId12 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId12)


@JsonMap({})
class PersonIdEmail16(BaseModel):
    """PersonIdEmail16
...
@JsonMap({})
class PersonIdPhone16(BaseModel):
    """PersonIdPhone16
...
@JsonMap({"id_": "id"})
class PersonPersonId12(BaseModel):
    """PersonPersonId12
    ...
    def __init__(
        ...
        id_: int = None,
        name: str = None,
        email: List[PersonIdEmail16] = None,
        phone: List[PersonIdPhone16] = None,
        owner_id: int = None,
    ):
        if active_flag is not None:
            self.active_flag = active_flag
        ...
        if name is not None:
            self.name = name
        if email is not None:
            self.email = self._define_list(email, PersonIdEmail16)
        if phone is not None:
            self.phone = self._define_list(phone, PersonIdPhone16)
        if owner_id is not None:
            self.owner_id = owner_id


@JsonMap({"person_id": "PERSON_ID"})
class RelatedObjectsPerson12(BaseModel):
    """RelatedObjectsPerson12

    :param person_id: person_id, defaults to None
    :type person_id: PersonPersonId12, optional
    """

    def __init__(self, person_id: PersonPersonId12 = None):
        if person_id is not None:
            self.person_id = self._define_object(person_id, PersonPersonId12)


@JsonMap({})
class AddDealParticipantOkResponseRelatedObjects(BaseModel):
    """AddDealParticipantOkResponseRelatedObjects

    :param user: user, defaults to None
    :type user: RelatedObjectsUser12, optional
    :param person: person, defaults to None
    :type person: RelatedObjectsPerson12, optional
    """

    def __init__(
        self, user: RelatedObjectsUser12 = None, person: RelatedObjectsPerson12 = None
    ):
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser12)
        if person is not None:
            self.person = self._define_object(person, RelatedObjectsPerson12)


@JsonMap({})
class AddDealParticipantOkResponse(BaseModel):
    """AddDealParticipantOkResponse

    :param success: If the request was successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: AddDealParticipantOkResponseData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: AddDealParticipantOkResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: AddDealParticipantOkResponseData = None,
        related_objects: AddDealParticipantOkResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, AddDealParticipantOkResponseData)
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, AddDealParticipantOkResponseRelatedObjects
            )
