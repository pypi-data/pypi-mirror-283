...
@JsonMap({})
class DataOrganization3(BaseModel):
...
@JsonMap({"id_": "id"})
class GetNoteOkResponseData(BaseModel):
    ...
    :type organization: DataOrganization3, optional
    :param person: The person the note is attached to, defaults to None
    :type person: DataPerson3, optional
    ...
    def __init__(
        ...
        org_id: int = None,
        organization: DataOrganization3 = None,
        person: DataPerson3 = None,
        person_id: int = None,
        ...
        if deal is not None:
            self.deal = self._define_object(deal, DataDeal3)
        ...
        if organization is not None:
            self.organization = self._define_object(organization, DataOrganization3)
        if person is not None:
            self.person = self._define_object(person, DataPerson3)
        ...
        if user is not None:
            self.user = self._define_object(user, DataUser3)
        if user_id is not None:
            self.user_id = user_id


@JsonMap({})
class GetNoteOkResponse(BaseModel):
    """GetNoteOkResponse

    :param success: If the request was successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: GetNoteOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: GetNoteOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, GetNoteOkResponseData)
