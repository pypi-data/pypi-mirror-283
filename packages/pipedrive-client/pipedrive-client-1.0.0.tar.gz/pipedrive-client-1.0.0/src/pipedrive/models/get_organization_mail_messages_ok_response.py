...
class DataMailTrackingStatus3(Enum):
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, DataMailTrackingStatus3._member_map_.values())
        )


class DataMailLinkTrackingEnabledFlag7(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                DataMailLinkTrackingEnabledFlag7._member_map_.values(),
            )
        )


class DataReadFlag7(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataReadFlag7._member_map_.values()))


class DataDraftFlag3(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataDraftFlag3._member_map_.values()))


class DataSyncedFlag7(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataSyncedFlag7._member_map_.values()))


class DataDeletedFlag12(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataDeletedFlag12._member_map_.values()))


class DataHasBodyFlag4(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataHasBodyFlag4._member_map_.values()))


class DataSentFlag4(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataSentFlag4._member_map_.values()))


class DataSentFromPipedriveFlag4(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, DataSentFromPipedriveFlag4._member_map_.values())
        )


class DataSmartBccFlag7(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataSmartBccFlag7._member_map_.values()))


class DataHasAttachmentsFlag7(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, DataHasAttachmentsFlag7._member_map_.values())
        )


class DataHasInlineAttachmentsFlag7(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, DataHasInlineAttachmentsFlag7._member_map_.values())
        )


class DataHasRealAttachmentsFlag7(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, DataHasRealAttachmentsFlag7._member_map_.values())
        )
...
class DataData2(BaseModel):
    ...
    :type mail_tracking_status: DataMailTrackingStatus3, optional
    :param mail_link_tracking_enabled_flag: mail_link_tracking_enabled_flag, defaults to None
    :type mail_link_tracking_enabled_flag: DataMailLinkTrackingEnabledFlag7, optional
    :param read_flag: read_flag, defaults to None
    :type read_flag: DataReadFlag7, optional
    ...
    :type draft_flag: DataDraftFlag3, optional
    :param synced_flag: synced_flag, defaults to None
    :type synced_flag: DataSyncedFlag7, optional
    :param deleted_flag: deleted_flag, defaults to None
    :type deleted_flag: DataDeletedFlag12, optional
    :param has_body_flag: has_body_flag, defaults to None
    :type has_body_flag: DataHasBodyFlag4, optional
    :param sent_flag: sent_flag, defaults to None
    :type sent_flag: DataSentFlag4, optional
    :param sent_from_pipedrive_flag: sent_from_pipedrive_flag, defaults to None
    :type sent_from_pipedrive_flag: DataSentFromPipedriveFlag4, optional
    :param smart_bcc_flag: smart_bcc_flag, defaults to None
    :type smart_bcc_flag: DataSmartBccFlag7, optional
    ...
    :type has_attachments_flag: DataHasAttachmentsFlag7, optional
    :param has_inline_attachments_flag: has_inline_attachments_flag, defaults to None
    :type has_inline_attachments_flag: DataHasInlineAttachmentsFlag7, optional
    :param has_real_attachments_flag: has_real_attachments_flag, defaults to None
    :type has_real_attachments_flag: DataHasRealAttachmentsFlag7, optional
    ...
    def __init__(
        self,
        id_: int = None,
        from_: List[DataFrom4] = None,
        to: List[DataTo4] = None,
        cc: List[DataCc4] = None,
        bcc: List[DataBcc4] = None,
        body_url: str = None,
        account_id: str = None,
        user_id: int = None,
        ...
        subject: str = None,
        snippet: str = None,
        mail_tracking_status: DataMailTrackingStatus3 = None,
        mail_link_tracking_enabled_flag: DataMailLinkTrackingEnabledFlag7 = None,
        read_flag: DataReadFlag7 = None,
        draft: str = None,
        draft_flag: DataDraftFlag3 = None,
        synced_flag: DataSyncedFlag7 = None,
        deleted_flag: DataDeletedFlag12 = None,
        has_body_flag: DataHasBodyFlag4 = None,
        sent_flag: DataSentFlag4 = None,
        sent_from_pipedrive_flag: DataSentFromPipedriveFlag4 = None,
        smart_bcc_flag: DataSmartBccFlag7 = None,
        message_time: str = None,
        add_time: str = None,
        update_time: str = None,
        has_attachments_flag: DataHasAttachmentsFlag7 = None,
        has_inline_attachments_flag: DataHasInlineAttachmentsFlag7 = None,
        has_real_attachments_flag: DataHasRealAttachmentsFlag7 = None,
        nylas_id: str = None,
        s3_bucket: str = None,
        ...
        if from_ is not None:
            self.from_ = self._define_list(from_, DataFrom4)
        if to is not None:
            self.to = self._define_list(to, DataTo4)
        if cc is not None:
            self.cc = self._define_list(cc, DataCc4)
        if bcc is not None:
            self.bcc = self._define_list(bcc, DataBcc4)
...
@JsonMap({})
class GetOrganizationMailMessagesOkResponseData(BaseModel):
    ...
    :type data: DataData2, optional
    """

    def __init__(
        self, object: str = None, timestamp: str = None, data: DataData2 = None
    ):
        ...
        if timestamp is not None:
            self.timestamp = timestamp
        if data is not None:
            self.data = self._define_object(data, DataData2)


@JsonMap({})
class GetOrganizationMailMessagesOkResponseAdditionalData(BaseModel):
...
@JsonMap({})
class GetOrganizationMailMessagesOkResponse(BaseModel):
    """GetOrganizationMailMessagesOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The array of mail messages, defaults to None
    :type data: List[GetOrganizationMailMessagesOkResponseData], optional
    :param additional_data: The additional data of the list, defaults to None
    :type additional_data: GetOrganizationMailMessagesOkResponseAdditionalData, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetOrganizationMailMessagesOkResponseData] = None,
        additional_data: GetOrganizationMailMessagesOkResponseAdditionalData = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(
                data, GetOrganizationMailMessagesOkResponseData
            )
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetOrganizationMailMessagesOkResponseAdditionalData
            )
