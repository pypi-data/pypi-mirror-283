...
class DataFieldType13(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataFieldType13._member_map_.values()))


@JsonMap({"id_": "id"})
class GetPersonFieldOkResponseData(BaseModel):
    ...
    :type field_type: DataFieldType13, optional
    ...
    def __init__(
        ...
        name: str = None,
        order_nr: int = None,
        field_type: DataFieldType13 = None,
        add_time: str = None,
        ...
        if field_type is not None:
            self.field_type = self._enum_matching(
                field_type, DataFieldType13.list(), "field_type"
            )
...
@JsonMap({})
class GetPersonFieldOkResponse(BaseModel):
    """GetPersonFieldOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: GetPersonFieldOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: GetPersonFieldOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, GetPersonFieldOkResponseData)
