...
@JsonMap({"id_": "id"})
class UpdateStageOkResponseData(BaseModel):
...
@JsonMap({})
class UpdateStageOkResponse(BaseModel):
    ...
    :type data: UpdateStageOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: UpdateStageOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, UpdateStageOkResponseData)
