...
@JsonMap({"id_": "id"})
class GetOrganizationFilesOkResponseData(BaseModel):
    """The file data
...
@JsonMap({})
class GetOrganizationFilesOkResponseAdditionalData(BaseModel):
...
@JsonMap({})
class GetOrganizationFilesOkResponse(BaseModel):
    """GetOrganizationFilesOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The array of files, defaults to None
    :type data: List[GetOrganizationFilesOkResponseData], optional
    :param additional_data: The additional data of the list, defaults to None
    :type additional_data: GetOrganizationFilesOkResponseAdditionalData, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetOrganizationFilesOkResponseData] = None,
        additional_data: GetOrganizationFilesOkResponseAdditionalData = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetOrganizationFilesOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetOrganizationFilesOkResponseAdditionalData
            )
