...
@JsonMap({"id_": "id"})
class UpdateProjectOkResponseData(BaseModel):
...
@JsonMap({})
class UpdateProjectOkResponse(BaseModel):
    """UpdateProjectOkResponse

    :param success: success, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: UpdateProjectOkResponseData, optional
    ...
    def __init__(
        self,
        success: bool = None,
        data: UpdateProjectOkResponseData = None,
        additional_data: dict = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, UpdateProjectOkResponseData)
