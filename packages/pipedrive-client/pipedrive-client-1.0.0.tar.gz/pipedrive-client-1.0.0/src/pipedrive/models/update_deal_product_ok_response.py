...
class DataDiscountType3(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataDiscountType3._member_map_.values()))


class DataTaxMethod3(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataTaxMethod3._member_map_.values()))


class DataBillingFrequency2(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataBillingFrequency2._member_map_.values()))


@JsonMap({"id_": "id"})
class UpdateDealProductOkResponseData(BaseModel):
    ...
    :type discount_type: DataDiscountType3, optional
    ...
    :type tax_method: DataTaxMethod3, optional
    ...
    :type billing_frequency: DataBillingFrequency2, optional
    ...
    def __init__(
        ...
        quantity: int = None,
        discount: float = None,
        discount_type: DataDiscountType3 = None,
        product_variation_id: int = None,
        comments: str = None,
        tax: float = None,
        tax_method: DataTaxMethod3 = None,
        enabled_flag: bool = None,
        billing_frequency: DataBillingFrequency2 = None,
        ...
        if discount_type is not None:
            self.discount_type = self._enum_matching(
                discount_type, DataDiscountType3.list(), "discount_type"
            )
...
@JsonMap({})
class UpdateDealProductOkResponse(BaseModel):
    """UpdateDealProductOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: UpdateDealProductOkResponseData, optional
    """

    def __init__(
        self, success: bool = None, data: UpdateDealProductOkResponseData = None
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, UpdateDealProductOkResponseData)
