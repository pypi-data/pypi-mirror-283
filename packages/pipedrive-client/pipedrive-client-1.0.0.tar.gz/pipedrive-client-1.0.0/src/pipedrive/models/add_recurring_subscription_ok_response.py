...
@JsonMap({"id_": "id"})
class AddRecurringSubscriptionOkResponseData(BaseModel):
...
@JsonMap({})
class AddRecurringSubscriptionOkResponse(BaseModel):
    """AddRecurringSubscriptionOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: AddRecurringSubscriptionOkResponseData, optional
    """

    def __init__(
        self, success: bool = None, data: AddRecurringSubscriptionOkResponseData = None
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(
                data, AddRecurringSubscriptionOkResponseData
            )
