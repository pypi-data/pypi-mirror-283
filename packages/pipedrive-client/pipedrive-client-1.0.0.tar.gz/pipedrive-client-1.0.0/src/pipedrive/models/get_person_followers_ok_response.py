...
@JsonMap({"id_": "id"})
class GetPersonFollowersOkResponseData(BaseModel):
...
@JsonMap({})
class GetPersonFollowersOkResponseAdditionalData(BaseModel):
...
@JsonMap({})
class GetPersonFollowersOkResponse(BaseModel):
    """GetPersonFollowersOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The list of followers, defaults to None
    :type data: List[GetPersonFollowersOkResponseData], optional
    :param additional_data: The additional data of the list, defaults to None
    :type additional_data: GetPersonFollowersOkResponseAdditionalData, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetPersonFollowersOkResponseData] = None,
        additional_data: GetPersonFollowersOkResponseAdditionalData = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetPersonFollowersOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetPersonFollowersOkResponseAdditionalData
            )
