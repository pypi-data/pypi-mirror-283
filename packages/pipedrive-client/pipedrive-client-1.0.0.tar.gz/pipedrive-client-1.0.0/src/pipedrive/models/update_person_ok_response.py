...
class PictureIdPictures18(BaseModel):
    """PictureIdPictures18
...
@JsonMap({"id_": "id"})
class DataPictureId12(BaseModel):
    """DataPictureId12
    ...
    :type pictures: PictureIdPictures18, optional
    """
    ...
    def __init__(
        ...
        pictures: PictureIdPictures18 = None,
    ):
        if id_ is not None:
            self.id_ = id_
        ...
        if pictures is not None:
            self.pictures = self._define_object(pictures, PictureIdPictures18)


@JsonMap({"id_": "id"})
class DataOwnerId12(BaseModel):
    """DataOwnerId12
...
@JsonMap({"id_": "id"})
class UpdatePersonOkResponseData(BaseModel):
    ...
    :type phone: List[DataPhone9], optional
    ...
    :type email: List[DataEmail9], optional
    ...
    :type picture_id: DataPictureId12, optional
    ...
    :type owner_id: DataOwnerId12, optional
    :param org_id: org_id, defaults to None
    :type org_id: DataOrgId13, optional
    ...
    def __init__(
        ...
        company_id: int = None,
        active_flag: bool = None,
        phone: List[DataPhone9] = None,
        email: List[DataEmail9] = None,
        first_char: str = None,
        add_time: str = None,
        update_time: str = None,
        visible_to: str = None,
        picture_id: DataPictureId12 = None,
        label: int = None,
        org_name: str = None,
        owner_name: str = None,
        cc_email: str = None,
        owner_id: DataOwnerId12 = None,
        org_id: DataOrgId13 = None,
        name: str = None,
        first_name: str = None,
        last_name: str = None,
        ...
        if phone is not None:
            self.phone = self._define_list(phone, DataPhone9)
        if email is not None:
            self.email = self._define_list(email, DataEmail9)
        ...
        if picture_id is not None:
            self.picture_id = self._define_object(picture_id, DataPictureId12)
        if label is not None:
            self.label = label
        ...
        if cc_email is not None:
            self.cc_email = cc_email
        if owner_id is not None:
            self.owner_id = self._define_object(owner_id, DataOwnerId12)
        if org_id is not None:
            self.org_id = self._define_object(org_id, DataOrgId13)
        if name is not None:
            self.name = name
...
class RelatedObjectsUser25(BaseModel):
    """RelatedObjectsUser25

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId25, optional
    """

    def __init__(self, user_id: UserUserId25 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId25)


@JsonMap({})
class UpdatePersonOkResponseRelatedObjects(BaseModel):
    """UpdatePersonOkResponseRelatedObjects

    :param user: user, defaults to None
    :type user: RelatedObjectsUser25, optional
    """

    def __init__(self, user: RelatedObjectsUser25 = None):
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser25)


@JsonMap({})
class UpdatePersonOkResponse(BaseModel):
    """UpdatePersonOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: UpdatePersonOkResponseData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: UpdatePersonOkResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: UpdatePersonOkResponseData = None,
        related_objects: UpdatePersonOkResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, UpdatePersonOkResponseData)
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, UpdatePersonOkResponseRelatedObjects
            )
