...
class GetDealActivitiesOkResponseData(BaseModel):
...
class AssignedToUserIdActivities1(BaseModel):
...
@JsonMap({})
class ActivityDistributionAssignedToUserId1(BaseModel):
    """The ID of the user

    :param activities: The count of activities related to the user grouped by activity type, defaults to None
    :type activities: AssignedToUserIdActivities1, optional
    ...
    def __init__(
        self,
        activities: AssignedToUserIdActivities1 = None,
        name: str = None,
        ...
        if activities is not None:
            self.activities = self._define_object(
                activities, AssignedToUserIdActivities1
            )
        if name is not None:
            self.name = name
...
class AdditionalDataActivityDistribution1(BaseModel):
    ...
    :type assigned_to_user_id: ActivityDistributionAssignedToUserId1, optional
    """

    def __init__(
        self, assigned_to_user_id: ActivityDistributionAssignedToUserId1 = None
    ):
        if assigned_to_user_id is not None:
            self.assigned_to_user_id = self._define_object(
                assigned_to_user_id, ActivityDistributionAssignedToUserId1
            )


@JsonMap({})
class GetDealActivitiesOkResponseAdditionalData(BaseModel):
    ...
    :type activity_distribution: AdditionalDataActivityDistribution1, optional
    ...
    def __init__(
        self,
        activity_distribution: AdditionalDataActivityDistribution1 = None,
        start: int = None,
        limit: int = None,
        ...
        if activity_distribution is not None:
            self.activity_distribution = self._define_object(
                activity_distribution, AdditionalDataActivityDistribution1
            )
...
@JsonMap({"id_": "id"})
class OrganizationOrganizationId9(BaseModel):
    """OrganizationOrganizationId9
...
class RelatedObjectsOrganization9(BaseModel):
    """RelatedObjectsOrganization9

    :param organization_id: organization_id, defaults to None
    :type organization_id: OrganizationOrganizationId9, optional
    """

    def __init__(self, organization_id: OrganizationOrganizationId9 = None):
        if organization_id is not None:
            self.organization_id = self._define_object(
                organization_id, OrganizationOrganizationId9
            )


@JsonMap({})
class PersonIdEmail13(BaseModel):
    """PersonIdEmail13
...
@JsonMap({})
class PersonIdPhone13(BaseModel):
    """PersonIdPhone13
...
@JsonMap({"id_": "id"})
class PersonPersonId9(BaseModel):
    """PersonPersonId9
    ...
    def __init__(
        ...
        id_: int = None,
        name: str = None,
        email: List[PersonIdEmail13] = None,
        phone: List[PersonIdPhone13] = None,
        owner_id: int = None,
    ):
        if active_flag is not None:
            self.active_flag = active_flag
        ...
        if email is not None:
            self.email = self._define_list(email, PersonIdEmail13)
        if phone is not None:
            self.phone = self._define_list(phone, PersonIdPhone13)
        if owner_id is not None:
            self.owner_id = owner_id


@JsonMap({"person_id": "PERSON_ID"})
class RelatedObjectsPerson9(BaseModel):
    """RelatedObjectsPerson9

    :param person_id: person_id, defaults to None
    :type person_id: PersonPersonId9, optional
    """

    def __init__(self, person_id: PersonPersonId9 = None):
        if person_id is not None:
            self.person_id = self._define_object(person_id, PersonPersonId9)


@JsonMap({"id_": "id"})
class DealDealId5(BaseModel):
...
class RelatedObjectsDeal5(BaseModel):
    """RelatedObjectsDeal5

    :param deal_id: The ID of the deal which is associated with the item, defaults to None
    :type deal_id: DealDealId5, optional
    """

    def __init__(self, deal_id: DealDealId5 = None):
        if deal_id is not None:
            self.deal_id = self._define_object(deal_id, DealDealId5)


@JsonMap({"id_": "id"})
class UserUserId9(BaseModel):
    """UserUserId9
...
class RelatedObjectsUser9(BaseModel):
    """RelatedObjectsUser9

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId9, optional
    """

    def __init__(self, user_id: UserUserId9 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId9)


@JsonMap({})
class GetDealActivitiesOkResponseRelatedObjects(BaseModel):
    """GetDealActivitiesOkResponseRelatedObjects

    :param organization: organization, defaults to None
    :type organization: RelatedObjectsOrganization9, optional
    :param person: person, defaults to None
    :type person: RelatedObjectsPerson9, optional
    :param deal: deal, defaults to None
    :type deal: RelatedObjectsDeal5, optional
    :param user: user, defaults to None
    :type user: RelatedObjectsUser9, optional
    """

    def __init__(
        self,
        organization: RelatedObjectsOrganization9 = None,
        person: RelatedObjectsPerson9 = None,
        deal: RelatedObjectsDeal5 = None,
        user: RelatedObjectsUser9 = None,
    ):
        if organization is not None:
            self.organization = self._define_object(
                organization, RelatedObjectsOrganization9
            )
        if person is not None:
            self.person = self._define_object(person, RelatedObjectsPerson9)
        if deal is not None:
            self.deal = self._define_object(deal, RelatedObjectsDeal5)
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser9)


@JsonMap({})
class GetDealActivitiesOkResponse(BaseModel):
    """GetDealActivitiesOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The array of activities, defaults to None
    :type data: List[GetDealActivitiesOkResponseData], optional
    :param additional_data: additional_data, defaults to None
    :type additional_data: GetDealActivitiesOkResponseAdditionalData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: GetDealActivitiesOkResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetDealActivitiesOkResponseData] = None,
        additional_data: GetDealActivitiesOkResponseAdditionalData = None,
        related_objects: GetDealActivitiesOkResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetDealActivitiesOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetDealActivitiesOkResponseAdditionalData
            )
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, GetDealActivitiesOkResponseRelatedObjects
            )
