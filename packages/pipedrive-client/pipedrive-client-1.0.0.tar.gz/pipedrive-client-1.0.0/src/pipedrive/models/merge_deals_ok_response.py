...
@JsonMap({"id_": "id"})
class MergeDealsOkResponseData(BaseModel):
    ...
    :param merge_what_id: The deal ID of the deal which the original deal was merged with, defaults to None
...
@JsonMap({})
class MergeDealsOkResponse(BaseModel):
    """MergeDealsOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: MergeDealsOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: MergeDealsOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, MergeDealsOkResponseData)
