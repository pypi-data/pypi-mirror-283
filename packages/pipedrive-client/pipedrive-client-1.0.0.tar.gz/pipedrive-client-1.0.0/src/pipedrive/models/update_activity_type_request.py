...
class UpdateActivityTypeRequestIconKey(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                UpdateActivityTypeRequestIconKey._member_map_.values(),
            )
        )
...
class UpdateActivityTypeRequest(BaseModel):
    ...
    :type icon_key: UpdateActivityTypeRequestIconKey, optional
    ...
    :param order_nr: An order number for this activity type. Order numbers should be used to order the types in the activity type selections., defaults to None
    ...
    def __init__(
        self,
        name: str = None,
        icon_key: UpdateActivityTypeRequestIconKey = None,
        color: str = None,
        order_nr: int = None,
    ):
        if name is not None:
        ...
        if icon_key is not None:
            self.icon_key = self._enum_matching(
                icon_key, UpdateActivityTypeRequestIconKey.list(), "icon_key"
            )
