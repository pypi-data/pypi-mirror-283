...
class GetPersonActivitiesOkResponseData(BaseModel):
...
class AssignedToUserIdActivities3(BaseModel):
...
@JsonMap({})
class ActivityDistributionAssignedToUserId3(BaseModel):
    """The ID of the user

    :param activities: The count of activities related to the user grouped by activity type, defaults to None
    :type activities: AssignedToUserIdActivities3, optional
    ...
    def __init__(
        self,
        activities: AssignedToUserIdActivities3 = None,
        name: str = None,
        ...
        if activities is not None:
            self.activities = self._define_object(
                activities, AssignedToUserIdActivities3
            )
        if name is not None:
            self.name = name
...
class AdditionalDataActivityDistribution3(BaseModel):
    ...
    :type assigned_to_user_id: ActivityDistributionAssignedToUserId3, optional
    """

    def __init__(
        self, assigned_to_user_id: ActivityDistributionAssignedToUserId3 = None
    ):
        if assigned_to_user_id is not None:
            self.assigned_to_user_id = self._define_object(
                assigned_to_user_id, ActivityDistributionAssignedToUserId3
            )


@JsonMap({})
class GetPersonActivitiesOkResponseAdditionalData(BaseModel):
    ...
    :type activity_distribution: AdditionalDataActivityDistribution3, optional
    ...
    def __init__(
        self,
        activity_distribution: AdditionalDataActivityDistribution3 = None,
        start: int = None,
        limit: int = None,
        ...
        if activity_distribution is not None:
            self.activity_distribution = self._define_object(
                activity_distribution, AdditionalDataActivityDistribution3
            )
...
@JsonMap({})
class GetPersonActivitiesOkResponse(BaseModel):
    """GetPersonActivitiesOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The array of activities, defaults to None
    :type data: List[GetPersonActivitiesOkResponseData], optional
    :param additional_data: additional_data, defaults to None
    :type additional_data: GetPersonActivitiesOkResponseAdditionalData, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetPersonActivitiesOkResponseData] = None,
        additional_data: GetPersonActivitiesOkResponseAdditionalData = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetPersonActivitiesOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetPersonActivitiesOkResponseAdditionalData
            )
