...
@JsonMap({"id_": "id"})
class LinkFileToItemOkResponseData(BaseModel):
    """The file data
...
@JsonMap({})
class LinkFileToItemOkResponse(BaseModel):
    ...
    :type data: LinkFileToItemOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: LinkFileToItemOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, LinkFileToItemOkResponseData)
