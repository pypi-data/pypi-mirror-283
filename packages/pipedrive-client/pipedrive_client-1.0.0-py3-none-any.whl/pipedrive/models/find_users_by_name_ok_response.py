...
class AccessApp5(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, AccessApp5._member_map_.values()))


@JsonMap({})
class DataAccess4(BaseModel):
    """DataAccess4

    :param app: app, defaults to None
    :type app: AccessApp5, optional
    ...
    def __init__(
        self, app: AccessApp5 = None, admin: bool = None, permission_set_id: str = None
    ):
        if app is not None:
            self.app = self._enum_matching(app, AccessApp5.list(), "app")
...
@JsonMap({"id_": "id"})
class FindUsersByNameOkResponseData(BaseModel):
    ...
    :type access: List[DataAccess4], optional
    ...
    def __init__(
        ...
        if access is not None:
            self.access = self._define_list(access, DataAccess4)
...
@JsonMap({})
class FindUsersByNameOkResponse(BaseModel):
    """FindUsersByNameOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: List[FindUsersByNameOkResponseData], optional
    """

    def __init__(
        self, success: bool = None, data: List[FindUsersByNameOkResponseData] = None
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, FindUsersByNameOkResponseData)
