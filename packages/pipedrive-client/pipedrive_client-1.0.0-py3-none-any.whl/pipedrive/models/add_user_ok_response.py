...
class AccessApp4(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, AccessApp4._member_map_.values()))


@JsonMap({})
class DataAccess3(BaseModel):
    """DataAccess3

    :param app: app, defaults to None
    :type app: AccessApp4, optional
    ...
    def __init__(
        self, app: AccessApp4 = None, admin: bool = None, permission_set_id: str = None
    ):
        if app is not None:
            self.app = self._enum_matching(app, AccessApp4.list(), "app")
...
@JsonMap({"id_": "id"})
class AddUserOkResponseData(BaseModel):
    ...
    :type access: List[DataAccess3], optional
    ...
    def __init__(
        ...
        if access is not None:
            self.access = self._define_list(access, DataAccess3)
...
@JsonMap({})
class AddUserOkResponse(BaseModel):
    """AddUserOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: AddUserOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: AddUserOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, AddUserOkResponseData)
