...
class DataReadFlag4(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataReadFlag4._member_map_.values()))


class DataHasAttachmentsFlag4(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, DataHasAttachmentsFlag4._member_map_.values())
        )


class DataHasInlineAttachmentsFlag4(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, DataHasInlineAttachmentsFlag4._member_map_.values())
        )


class DataHasRealAttachmentsFlag4(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, DataHasRealAttachmentsFlag4._member_map_.values())
        )


class DataDeletedFlag9(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataDeletedFlag9._member_map_.values()))


class DataSyncedFlag4(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataSyncedFlag4._member_map_.values()))


class DataSmartBccFlag4(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataSmartBccFlag4._member_map_.values()))


class DataMailLinkTrackingEnabledFlag4(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                DataMailLinkTrackingEnabledFlag4._member_map_.values(),
            )
        )


@JsonMap({"id_": "id"})
class PartiesTo2(BaseModel):
    """Member of a thread
...
@JsonMap({"from_": "from"})
class DataParties2(BaseModel):
    """Parties of the mail thread

    :param to: Recipients of the mail thread, defaults to None
    :type to: List[PartiesTo2], optional
    :param from_: Senders of the mail thread, defaults to None
    :type from_: List[PartiesFrom2], optional
    """

    def __init__(self, to: List[PartiesTo2] = None, from_: List[PartiesFrom2] = None):
        if to is not None:
            self.to = self._define_list(to, PartiesTo2)
        if from_ is not None:
            self.from_ = self._define_list(from_, PartiesFrom2)


class DataHasDraftFlag2(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataHasDraftFlag2._member_map_.values()))


class DataHasSentFlag2(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataHasSentFlag2._member_map_.values()))


class DataArchivedFlag2(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataArchivedFlag2._member_map_.values()))


class DataSharedFlag2(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataSharedFlag2._member_map_.values()))


class DataExternalDeletedFlag2(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, DataExternalDeletedFlag2._member_map_.values())
        )


class DataFirstMessageToMeFlag2(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, DataFirstMessageToMeFlag2._member_map_.values())
        )


class DataAllMessagesSentFlag2(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, DataAllMessagesSentFlag2._member_map_.values())
        )


@JsonMap({"id_": "id"})
class GetMailThreadOkResponseData(BaseModel):
    ...
    :type read_flag: DataReadFlag4, optional
    ...
    :type has_draft_flag: DataHasDraftFlag2, optional
    :param has_sent_flag: has_sent_flag, defaults to None
    :type has_sent_flag: DataHasSentFlag2, optional
    :param archived_flag: archived_flag, defaults to None
    :type archived_flag: DataArchivedFlag2, optional
    :param shared_flag: shared_flag, defaults to None
    :type shared_flag: DataSharedFlag2, optional
    :param external_deleted_flag: external_deleted_flag, defaults to None
    :type external_deleted_flag: DataExternalDeletedFlag2, optional
    :param first_message_to_me_flag: first_message_to_me_flag, defaults to None
    :type first_message_to_me_flag: DataFirstMessageToMeFlag2, optional
    ...
    :type all_messages_sent_flag: DataAllMessagesSentFlag2, optional
    """
    ...
    def __init__(
        ...
        subject: str = None,
        snippet: str = None,
        read_flag: DataReadFlag4 = None,
        mail_tracking_status: str = None,
        has_attachments_flag: DataHasAttachmentsFlag4 = None,
        has_inline_attachments_flag: DataHasInlineAttachmentsFlag4 = None,
        has_real_attachments_flag: DataHasRealAttachmentsFlag4 = None,
        deleted_flag: DataDeletedFlag9 = None,
        synced_flag: DataSyncedFlag4 = None,
        smart_bcc_flag: DataSmartBccFlag4 = None,
        mail_link_tracking_enabled_flag: DataMailLinkTrackingEnabledFlag4 = None,
        parties: DataParties2 = None,
        ...
        has_draft_flag: DataHasDraftFlag2 = None,
        has_sent_flag: DataHasSentFlag2 = None,
        archived_flag: DataArchivedFlag2 = None,
        shared_flag: DataSharedFlag2 = None,
        external_deleted_flag: DataExternalDeletedFlag2 = None,
        first_message_to_me_flag: DataFirstMessageToMeFlag2 = None,
        ...
        lead_id: str = None,
        all_messages_sent_flag: DataAllMessagesSentFlag2 = None,
    ):
        if id_ is not None:
            self.id_ = id_
        ...
        if read_flag is not None:
            self.read_flag = self._enum_matching(
                read_flag, DataReadFlag4.list(), "read_flag"
            )
        ...
        if mail_link_tracking_enabled_flag is not None:
            self.mail_link_tracking_enabled_flag = self._enum_matching(
                ...
                DataMailLinkTrackingEnabledFlag4.list(),
                "mail_link_tracking_enabled_flag",
            )
        if parties is not None:
            self.parties = self._define_object(parties, DataParties2)
        ...
        if all_messages_sent_flag is not None:
            self.all_messages_sent_flag = self._enum_matching(
                ...
                DataAllMessagesSentFlag2.list(),
                "all_messages_sent_flag",
            )


@JsonMap({})
class GetMailThreadOkResponse(BaseModel):
    """GetMailThreadOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: GetMailThreadOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: GetMailThreadOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, GetMailThreadOkResponseData)
