...
class PictureIdPictures13(BaseModel):
    """PictureIdPictures13
...
@JsonMap({"id_": "id"})
class DataPictureId9(BaseModel):
    """DataPictureId9
    ...
    :type pictures: PictureIdPictures13, optional
    """
    ...
    def __init__(
        ...
        pictures: PictureIdPictures13 = None,
    ):
        if id_ is not None:
            self.id_ = id_
        ...
        if pictures is not None:
            self.pictures = self._define_object(pictures, PictureIdPictures13)


@JsonMap({"id_": "id"})
class DataOwnerId9(BaseModel):
    """DataOwnerId9
...
@JsonMap({"id_": "id"})
class GetPersonsOkResponseData(BaseModel):
    ...
    :type phone: List[DataPhone5], optional
    ...
    :type email: List[DataEmail5], optional
    ...
    :type picture_id: DataPictureId9, optional
    ...
    :type owner_id: DataOwnerId9, optional
    :param org_id: org_id, defaults to None
    :type org_id: DataOrgId10, optional
    ...
    def __init__(
        ...
        company_id: int = None,
        active_flag: bool = None,
        phone: List[DataPhone5] = None,
        email: List[DataEmail5] = None,
        first_char: str = None,
        add_time: str = None,
        update_time: str = None,
        visible_to: str = None,
        picture_id: DataPictureId9 = None,
        label: int = None,
        org_name: str = None,
        owner_name: str = None,
        cc_email: str = None,
        owner_id: DataOwnerId9 = None,
        org_id: DataOrgId10 = None,
        name: str = None,
        first_name: str = None,
        last_name: str = None,
        ...
        if phone is not None:
            self.phone = self._define_list(phone, DataPhone5)
        if email is not None:
            self.email = self._define_list(email, DataEmail5)
        ...
        if picture_id is not None:
            self.picture_id = self._define_object(picture_id, DataPictureId9)
        if label is not None:
            self.label = label
        ...
        if cc_email is not None:
            self.cc_email = cc_email
        if owner_id is not None:
            self.owner_id = self._define_object(owner_id, DataOwnerId9)
        if org_id is not None:
            self.org_id = self._define_object(org_id, DataOrgId10)
        if name is not None:
            self.name = name
...
@JsonMap({})
class AdditionalDataPagination14(BaseModel):
...
@JsonMap({})
class GetPersonsOkResponseAdditionalData(BaseModel):
    """GetPersonsOkResponseAdditionalData

    :param pagination: Pagination details of the list, defaults to None
    :type pagination: AdditionalDataPagination14, optional
    """

    def __init__(self, pagination: AdditionalDataPagination14 = None):
        if pagination is not None:
            self.pagination = self._define_object(
                pagination, AdditionalDataPagination14
            )


@JsonMap({"id_": "id"})
class OrganizationOrganizationId24(BaseModel):
    """OrganizationOrganizationId24
...
class RelatedObjectsOrganization24(BaseModel):
    """RelatedObjectsOrganization24

    :param organization_id: organization_id, defaults to None
    :type organization_id: OrganizationOrganizationId24, optional
    """

    def __init__(self, organization_id: OrganizationOrganizationId24 = None):
        if organization_id is not None:
            self.organization_id = self._define_object(
                organization_id, OrganizationOrganizationId24
            )


@JsonMap({"id_": "id"})
class UserUserId22(BaseModel):
    """UserUserId22
...
class RelatedObjectsUser22(BaseModel):
    """RelatedObjectsUser22

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId22, optional
    """

    def __init__(self, user_id: UserUserId22 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId22)


@JsonMap({"_128": "128", "_512": "512"})
class PictureIdPictures14(BaseModel):
    """PictureIdPictures14
...
@JsonMap({"id_": "id"})
class PicturePictureId5(BaseModel):
    """PicturePictureId5
    ...
    :type added_by_user_id: int, optional
    :param pictures: pictures, defaults to None
    :type pictures: PictureIdPictures14, optional
    """
    ...
    def __init__(
        ...
        update_time: str = None,
        added_by_user_id: int = None,
        pictures: PictureIdPictures14 = None,
    ):
        if id_ is not None:
            self.id_ = id_
        if item_type is not None:
        ...
        if added_by_user_id is not None:
            self.added_by_user_id = added_by_user_id
        if pictures is not None:
            self.pictures = self._define_object(pictures, PictureIdPictures14)


@JsonMap({"picture_id": "PICTURE_ID"})
class RelatedObjectsPicture5(BaseModel):
    """The picture that is associated with the item

    :param picture_id: picture_id, defaults to None
    :type picture_id: PicturePictureId5, optional
    """

    def __init__(self, picture_id: PicturePictureId5 = None):
        if picture_id is not None:
            self.picture_id = self._define_object(picture_id, PicturePictureId5)


@JsonMap({})
class GetPersonsOkResponseRelatedObjects(BaseModel):
    """GetPersonsOkResponseRelatedObjects

    :param organization: organization, defaults to None
    :type organization: RelatedObjectsOrganization24, optional
    :param user: user, defaults to None
    :type user: RelatedObjectsUser22, optional
    :param picture: The picture that is associated with the item, defaults to None
    :type picture: RelatedObjectsPicture5, optional
    """

    def __init__(
        self,
        organization: RelatedObjectsOrganization24 = None,
        user: RelatedObjectsUser22 = None,
        picture: RelatedObjectsPicture5 = None,
    ):
        if organization is not None:
            self.organization = self._define_object(
                organization, RelatedObjectsOrganization24
            )
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser22)
        if picture is not None:
            self.picture = self._define_object(picture, RelatedObjectsPicture5)


@JsonMap({})
class GetPersonsOkResponse(BaseModel):
    """GetPersonsOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The array of persons, defaults to None
    :type data: List[GetPersonsOkResponseData], optional
    :param additional_data: additional_data, defaults to None
    :type additional_data: GetPersonsOkResponseAdditionalData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: GetPersonsOkResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetPersonsOkResponseData] = None,
        additional_data: GetPersonsOkResponseAdditionalData = None,
        related_objects: GetPersonsOkResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetPersonsOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetPersonsOkResponseAdditionalData
            )
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, GetPersonsOkResponseRelatedObjects
            )
