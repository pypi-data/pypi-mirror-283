...
class PictureIdPictures15(BaseModel):
    """PictureIdPictures15
...
@JsonMap({"id_": "id"})
class DataPictureId10(BaseModel):
    """DataPictureId10
    ...
    :type pictures: PictureIdPictures15, optional
    """
    ...
    def __init__(
        ...
        pictures: PictureIdPictures15 = None,
    ):
        if id_ is not None:
            self.id_ = id_
        ...
        if pictures is not None:
            self.pictures = self._define_object(pictures, PictureIdPictures15)


@JsonMap({"id_": "id"})
class DataOwnerId10(BaseModel):
    """DataOwnerId10
...
@JsonMap({"id_": "id"})
class AddPersonCreatedResponseData(BaseModel):
    ...
    :type phone: List[DataPhone6], optional
    ...
    :type email: List[DataEmail6], optional
    ...
    :type picture_id: DataPictureId10, optional
    ...
    :type owner_id: DataOwnerId10, optional
    :param org_id: org_id, defaults to None
    :type org_id: DataOrgId11, optional
    ...
    def __init__(
        ...
        company_id: int = None,
        active_flag: bool = None,
        phone: List[DataPhone6] = None,
        email: List[DataEmail6] = None,
        first_char: str = None,
        add_time: str = None,
        update_time: str = None,
        visible_to: str = None,
        picture_id: DataPictureId10 = None,
        label: int = None,
        org_name: str = None,
        owner_name: str = None,
        cc_email: str = None,
        owner_id: DataOwnerId10 = None,
        org_id: DataOrgId11 = None,
        name: str = None,
        first_name: str = None,
        last_name: str = None,
        ...
        if phone is not None:
            self.phone = self._define_list(phone, DataPhone6)
        if email is not None:
            self.email = self._define_list(email, DataEmail6)
        ...
        if picture_id is not None:
            self.picture_id = self._define_object(picture_id, DataPictureId10)
        if label is not None:
            self.label = label
        ...
        if cc_email is not None:
            self.cc_email = cc_email
        if owner_id is not None:
            self.owner_id = self._define_object(owner_id, DataOwnerId10)
        if org_id is not None:
            self.org_id = self._define_object(org_id, DataOrgId11)
        if name is not None:
            self.name = name
...
class RelatedObjectsUser23(BaseModel):
    """RelatedObjectsUser23

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId23, optional
    """

    def __init__(self, user_id: UserUserId23 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId23)


@JsonMap({})
class AddPersonCreatedResponseRelatedObjects(BaseModel):
    """AddPersonCreatedResponseRelatedObjects

    :param user: user, defaults to None
    :type user: RelatedObjectsUser23, optional
    """

    def __init__(self, user: RelatedObjectsUser23 = None):
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser23)


@JsonMap({})
class AddPersonCreatedResponse(BaseModel):
    """AddPersonCreatedResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: AddPersonCreatedResponseData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: AddPersonCreatedResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: AddPersonCreatedResponseData = None,
        related_objects: AddPersonCreatedResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, AddPersonCreatedResponseData)
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, AddPersonCreatedResponseRelatedObjects
            )
