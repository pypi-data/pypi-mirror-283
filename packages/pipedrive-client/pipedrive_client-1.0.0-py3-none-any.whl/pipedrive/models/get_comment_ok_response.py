...
@JsonMap({})
class GetCommentOkResponseData(BaseModel):
...
@JsonMap({})
class GetCommentOkResponse(BaseModel):
    """GetCommentOkResponse

    :param success: If the request was successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: GetCommentOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: GetCommentOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, GetCommentOkResponseData)
