...
class AddActivityCreatedResponseData(BaseModel):
...
@JsonMap({})
class AddActivityCreatedResponseAdditionalData(BaseModel):
    """AddActivityCreatedResponseAdditionalData

    :param updates_story_id: This field will be deprecated, defaults to None
    :type updates_story_id: int, optional
    """

    def __init__(self, updates_story_id: int = None):
        if updates_story_id is not None:
            self.updates_story_id = updates_story_id


@JsonMap({"id_": "id"})
class UserUserId2(BaseModel):
    """UserUserId2
...
class RelatedObjectsUser2(BaseModel):
    """RelatedObjectsUser2

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId2, optional
    """

    def __init__(self, user_id: UserUserId2 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId2)


@JsonMap({"id_": "id"})
class DealDealId2(BaseModel):
...
class RelatedObjectsDeal2(BaseModel):
    """RelatedObjectsDeal2

    :param deal_id: The ID of the deal which is associated with the item, defaults to None
    :type deal_id: DealDealId2, optional
    """

    def __init__(self, deal_id: DealDealId2 = None):
        if deal_id is not None:
            self.deal_id = self._define_object(deal_id, DealDealId2)


@JsonMap({})
class PersonIdEmail2(BaseModel):
    """PersonIdEmail2
...
@JsonMap({})
class PersonIdPhone2(BaseModel):
    """PersonIdPhone2
...
@JsonMap({"id_": "id"})
class PersonPersonId2(BaseModel):
    """PersonPersonId2
    ...
    def __init__(
        ...
        id_: int = None,
        name: str = None,
        email: List[PersonIdEmail2] = None,
        phone: List[PersonIdPhone2] = None,
        owner_id: int = None,
    ):
        if active_flag is not None:
            self.active_flag = active_flag
        ...
        if name is not None:
            self.name = name
        if email is not None:
            self.email = self._define_list(email, PersonIdEmail2)
        if phone is not None:
            self.phone = self._define_list(phone, PersonIdPhone2)
        if owner_id is not None:
            self.owner_id = owner_id


@JsonMap({"person_id": "PERSON_ID"})
class RelatedObjectsPerson2(BaseModel):
    """RelatedObjectsPerson2

    :param person_id: person_id, defaults to None
    :type person_id: PersonPersonId2, optional
    """

    def __init__(self, person_id: PersonPersonId2 = None):
        if person_id is not None:
            self.person_id = self._define_object(person_id, PersonPersonId2)


@JsonMap({"id_": "id"})
class OrganizationOrganizationId2(BaseModel):
    """OrganizationOrganizationId2
...
class RelatedObjectsOrganization2(BaseModel):
    """RelatedObjectsOrganization2

    :param organization_id: organization_id, defaults to None
    :type organization_id: OrganizationOrganizationId2, optional
    """

    def __init__(self, organization_id: OrganizationOrganizationId2 = None):
        if organization_id is not None:
            self.organization_id = self._define_object(
                organization_id, OrganizationOrganizationId2
            )


@JsonMap({})
class AddActivityCreatedResponseRelatedObjects(BaseModel):
    """AddActivityCreatedResponseRelatedObjects

    :param user: user, defaults to None
    :type user: RelatedObjectsUser2, optional
    :param deal: deal, defaults to None
    :type deal: RelatedObjectsDeal2, optional
    :param person: person, defaults to None
    :type person: RelatedObjectsPerson2, optional
    :param organization: organization, defaults to None
    :type organization: RelatedObjectsOrganization2, optional
    """

    def __init__(
        self,
        user: RelatedObjectsUser2 = None,
        deal: RelatedObjectsDeal2 = None,
        person: RelatedObjectsPerson2 = None,
        organization: RelatedObjectsOrganization2 = None,
    ):
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser2)
        if deal is not None:
            self.deal = self._define_object(deal, RelatedObjectsDeal2)
        if person is not None:
            self.person = self._define_object(person, RelatedObjectsPerson2)
        if organization is not None:
            self.organization = self._define_object(
                organization, RelatedObjectsOrganization2
            )


@JsonMap({})
class AddActivityCreatedResponse(BaseModel):
    """AddActivityCreatedResponse

    :param success: success, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: AddActivityCreatedResponseData, optional
    :param additional_data: additional_data, defaults to None
    :type additional_data: AddActivityCreatedResponseAdditionalData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: AddActivityCreatedResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: AddActivityCreatedResponseData = None,
        additional_data: AddActivityCreatedResponseAdditionalData = None,
        related_objects: AddActivityCreatedResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, AddActivityCreatedResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, AddActivityCreatedResponseAdditionalData
            )
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, AddActivityCreatedResponseRelatedObjects
            )
