...
@JsonMap({"id_": "id"})
class GetProjectsOkResponseData(BaseModel):
...
@JsonMap({})
class GetProjectsOkResponseAdditionalData(BaseModel):
...
@JsonMap({})
class GetProjectsOkResponse(BaseModel):
    """GetProjectsOkResponse

    :param success: success, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: List[GetProjectsOkResponseData], optional
    :param additional_data: The additional data of the list, defaults to None
    :type additional_data: GetProjectsOkResponseAdditionalData, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetProjectsOkResponseData] = None,
        additional_data: GetProjectsOkResponseAdditionalData = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetProjectsOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetProjectsOkResponseAdditionalData
            )
