...
@JsonMap({})
class GetProjectPlanOkResponseData(BaseModel):
...
@JsonMap({})
class GetProjectPlanOkResponse(BaseModel):
    """GetProjectPlanOkResponse

    :param success: success, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: List[GetProjectPlanOkResponseData], optional
    ...
    def __init__(
        self,
        success: bool = None,
        data: List[GetProjectPlanOkResponseData] = None,
        additional_data: dict = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetProjectPlanOkResponseData)
