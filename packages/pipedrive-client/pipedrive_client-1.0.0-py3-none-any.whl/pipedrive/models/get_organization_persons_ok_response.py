...
class PictureIdPictures12(BaseModel):
    """PictureIdPictures12
...
@JsonMap({"id_": "id"})
class DataPictureId8(BaseModel):
    """DataPictureId8
    ...
    :type pictures: PictureIdPictures12, optional
    """
    ...
    def __init__(
        ...
        pictures: PictureIdPictures12 = None,
    ):
        if id_ is not None:
            self.id_ = id_
        ...
        if pictures is not None:
            self.pictures = self._define_object(pictures, PictureIdPictures12)


@JsonMap({"id_": "id"})
class DataOwnerId8(BaseModel):
    """DataOwnerId8
...
@JsonMap({"id_": "id"})
class GetOrganizationPersonsOkResponseData(BaseModel):
    ...
    :type phone: List[DataPhone4], optional
    ...
    :type email: List[DataEmail4], optional
    ...
    :type picture_id: DataPictureId8, optional
    ...
    :type owner_id: DataOwnerId8, optional
    :param org_id: org_id, defaults to None
    :type org_id: DataOrgId9, optional
    ...
    def __init__(
        ...
        company_id: int = None,
        active_flag: bool = None,
        phone: List[DataPhone4] = None,
        email: List[DataEmail4] = None,
        first_char: str = None,
        add_time: str = None,
        update_time: str = None,
        visible_to: str = None,
        picture_id: DataPictureId8 = None,
        label: int = None,
        org_name: str = None,
        owner_name: str = None,
        cc_email: str = None,
        owner_id: DataOwnerId8 = None,
        org_id: DataOrgId9 = None,
        name: str = None,
        first_name: str = None,
        last_name: str = None,
        ...
        if phone is not None:
            self.phone = self._define_list(phone, DataPhone4)
        if email is not None:
            self.email = self._define_list(email, DataEmail4)
        ...
        if picture_id is not None:
            self.picture_id = self._define_object(picture_id, DataPictureId8)
        if label is not None:
            self.label = label
        ...
        if cc_email is not None:
            self.cc_email = cc_email
        if owner_id is not None:
            self.owner_id = self._define_object(owner_id, DataOwnerId8)
        if org_id is not None:
            self.org_id = self._define_object(org_id, DataOrgId9)
        if name is not None:
            self.name = name
...
@JsonMap({})
class GetOrganizationPersonsOkResponseAdditionalData(BaseModel):
...
@JsonMap({"id_": "id"})
class OrganizationOrganizationId19(BaseModel):
    """OrganizationOrganizationId19
...
class RelatedObjectsOrganization19(BaseModel):
    """RelatedObjectsOrganization19

    :param organization_id: organization_id, defaults to None
    :type organization_id: OrganizationOrganizationId19, optional
    """

    def __init__(self, organization_id: OrganizationOrganizationId19 = None):
        if organization_id is not None:
            self.organization_id = self._define_object(
                organization_id, OrganizationOrganizationId19
            )


@JsonMap({"id_": "id"})
class UserUserId21(BaseModel):
    """UserUserId21
...
class RelatedObjectsUser21(BaseModel):
    """RelatedObjectsUser21

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId21, optional
    """

    def __init__(self, user_id: UserUserId21 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId21)


@JsonMap({})
class GetOrganizationPersonsOkResponseRelatedObjects(BaseModel):
    """GetOrganizationPersonsOkResponseRelatedObjects

    :param organization: organization, defaults to None
    :type organization: RelatedObjectsOrganization19, optional
    :param user: user, defaults to None
    :type user: RelatedObjectsUser21, optional
    """

    def __init__(
        self,
        organization: RelatedObjectsOrganization19 = None,
        user: RelatedObjectsUser21 = None,
    ):
        if organization is not None:
            self.organization = self._define_object(
                organization, RelatedObjectsOrganization19
            )
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser21)


@JsonMap({})
class GetOrganizationPersonsOkResponse(BaseModel):
    """GetOrganizationPersonsOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The array of persons, defaults to None
    :type data: List[GetOrganizationPersonsOkResponseData], optional
    :param additional_data: The additional data of the list, defaults to None
    :type additional_data: GetOrganizationPersonsOkResponseAdditionalData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: GetOrganizationPersonsOkResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetOrganizationPersonsOkResponseData] = None,
        additional_data: GetOrganizationPersonsOkResponseAdditionalData = None,
        related_objects: GetOrganizationPersonsOkResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetOrganizationPersonsOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetOrganizationPersonsOkResponseAdditionalData
            )
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, GetOrganizationPersonsOkResponseRelatedObjects
            )
