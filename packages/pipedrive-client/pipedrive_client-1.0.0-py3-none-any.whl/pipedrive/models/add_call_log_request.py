...
class AddCallLogRequestOutcome(Enum):
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, AddCallLogRequestOutcome._member_map_.values())
        )


@JsonMap({})
class AddCallLogRequest(BaseModel):
    """AddCallLogRequest
    ...
    :type outcome: AddCallLogRequestOutcome
    ...
    def __init__(
        self,
        outcome: AddCallLogRequestOutcome,
        to_phone_number: str,
        start_time: str,
        end_time: str,
        user_id: int = None,
        ...
        self.outcome = self._enum_matching(
            outcome, AddCallLogRequestOutcome.list(), "outcome"
        )
