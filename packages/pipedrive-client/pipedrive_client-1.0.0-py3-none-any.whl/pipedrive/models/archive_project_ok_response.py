...
@JsonMap({"id_": "id"})
class ArchiveProjectOkResponseData(BaseModel):
...
@JsonMap({})
class ArchiveProjectOkResponse(BaseModel):
    """ArchiveProjectOkResponse

    :param success: success, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: ArchiveProjectOkResponseData, optional
    ...
    def __init__(
        self,
        success: bool = None,
        data: ArchiveProjectOkResponseData = None,
        additional_data: dict = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, ArchiveProjectOkResponseData)
