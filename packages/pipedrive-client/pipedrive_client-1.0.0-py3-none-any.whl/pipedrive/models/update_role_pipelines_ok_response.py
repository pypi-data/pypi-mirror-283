...
@JsonMap({})
class UpdateRolePipelinesOkResponseData(BaseModel):
    """The response data
...
@JsonMap({})
class UpdateRolePipelinesOkResponse(BaseModel):
    """UpdateRolePipelinesOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The response data, defaults to None
    :type data: UpdateRolePipelinesOkResponseData, optional
    """

    def __init__(
        self, success: bool = None, data: UpdateRolePipelinesOkResponseData = None
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, UpdateRolePipelinesOkResponseData)
