...
@JsonMap({})
class GetOrganizationChangelogOkResponseData(BaseModel):
...
@JsonMap({})
class GetOrganizationChangelogOkResponseAdditionalData(BaseModel):
...
@JsonMap({})
class GetOrganizationChangelogOkResponse(BaseModel):
    """GetOrganizationChangelogOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: List[GetOrganizationChangelogOkResponseData], optional
    :param additional_data: The additional data of the list, defaults to None
    :type additional_data: GetOrganizationChangelogOkResponseAdditionalData, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetOrganizationChangelogOkResponseData] = None,
        additional_data: GetOrganizationChangelogOkResponseAdditionalData = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetOrganizationChangelogOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetOrganizationChangelogOkResponseAdditionalData
            )
