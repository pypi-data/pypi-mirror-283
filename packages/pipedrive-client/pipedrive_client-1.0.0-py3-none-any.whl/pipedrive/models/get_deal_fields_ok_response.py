...
class DataFieldType2(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataFieldType2._member_map_.values()))


@JsonMap({"id_": "id"})
class GetDealFieldsOkResponseData(BaseModel):
    ...
    :type field_type: DataFieldType2, optional
    ...
    def __init__(
        ...
        name: str = None,
        order_nr: int = None,
        field_type: DataFieldType2 = None,
        add_time: str = None,
        ...
        if field_type is not None:
            self.field_type = self._enum_matching(
                field_type, DataFieldType2.list(), "field_type"
            )
...
@JsonMap({})
class GetDealFieldsOkResponseAdditionalData(BaseModel):
...
@JsonMap({})
class GetDealFieldsOkResponse(BaseModel):
    """GetDealFieldsOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: List[GetDealFieldsOkResponseData], optional
    :param additional_data: The additional data of the list, defaults to None
    :type additional_data: GetDealFieldsOkResponseAdditionalData, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetDealFieldsOkResponseData] = None,
        additional_data: GetDealFieldsOkResponseAdditionalData = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetDealFieldsOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetDealFieldsOkResponseAdditionalData
            )
