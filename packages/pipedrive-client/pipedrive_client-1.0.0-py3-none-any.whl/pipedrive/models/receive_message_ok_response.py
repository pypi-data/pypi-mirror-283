...
@JsonMap({"id_": "id"})
class ReceiveMessageOkResponseData(BaseModel):
    ...
    :type attachments: List[DataAttachments], optional
    """
    ...
    def __init__(
        ...
        attachments: List[DataAttachments] = None,
    ):
        self.id_ = id_
        ...
        if attachments is not None:
            self.attachments = self._define_list(attachments, DataAttachments)


@JsonMap({})
class ReceiveMessageOkResponse(BaseModel):
    """ReceiveMessageOkResponse

    :param success: If the request was successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: ReceiveMessageOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: ReceiveMessageOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, ReceiveMessageOkResponseData)
