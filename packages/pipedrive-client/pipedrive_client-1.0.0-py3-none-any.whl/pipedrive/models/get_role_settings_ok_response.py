...
@JsonMap({})
class GetRoleSettingsOkResponseData(BaseModel):
...
@JsonMap({})
class GetRoleSettingsOkResponse(BaseModel):
    """GetRoleSettingsOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The settings for the role, defaults to None
    :type data: GetRoleSettingsOkResponseData, optional
    """

    def __init__(
        self, success: bool = None, data: GetRoleSettingsOkResponseData = None
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, GetRoleSettingsOkResponseData)
