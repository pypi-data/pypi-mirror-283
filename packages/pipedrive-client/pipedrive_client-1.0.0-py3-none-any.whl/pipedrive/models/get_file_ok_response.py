...
@JsonMap({"id_": "id"})
class GetFileOkResponseData(BaseModel):
    """The file data
...
@JsonMap({})
class GetFileOkResponse(BaseModel):
    """GetFileOkResponse

    :param success: If the request was successful or not, defaults to None
    :type success: bool, optional
    :param data: The file data, defaults to None
    :type data: GetFileOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: GetFileOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, GetFileOkResponseData)
