...
class DataColor2(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataColor2._member_map_.values()))


@JsonMap({"id_": "id"})
class AddLeadLabelOkResponseData(BaseModel):
    ...
    :type color: DataColor2, optional
    ...
    def __init__(
        ...
        if color is not None:
            self.color = self._enum_matching(color, DataColor2.list(), "color")
...
@JsonMap({})
class AddLeadLabelOkResponse(BaseModel):
    """AddLeadLabelOkResponse

    :param success: success, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: AddLeadLabelOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: AddLeadLabelOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, AddLeadLabelOkResponseData)
