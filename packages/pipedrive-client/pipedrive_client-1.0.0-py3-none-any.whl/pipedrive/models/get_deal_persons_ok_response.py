...
class PictureIdPictures3(BaseModel):
    """PictureIdPictures3
...
@JsonMap({"id_": "id"})
class DataPictureId3(BaseModel):
    """DataPictureId3
    ...
    :type pictures: PictureIdPictures3, optional
    """
    ...
    def __init__(
        ...
        pictures: PictureIdPictures3 = None,
    ):
        if id_ is not None:
            self.id_ = id_
        ...
        if pictures is not None:
            self.pictures = self._define_object(pictures, PictureIdPictures3)


@JsonMap({"id_": "id"})
class DataOwnerId3(BaseModel):
    """DataOwnerId3
...
@JsonMap({"id_": "id"})
class GetDealPersonsOkResponseData(BaseModel):
    ...
    :type phone: List[DataPhone3], optional
    ...
    :type email: List[DataEmail3], optional
    ...
    :type picture_id: DataPictureId3, optional
    ...
    :type owner_id: DataOwnerId3, optional
    :param org_id: org_id, defaults to None
    :type org_id: DataOrgId7, optional
    ...
    def __init__(
        ...
        company_id: int = None,
        active_flag: bool = None,
        phone: List[DataPhone3] = None,
        email: List[DataEmail3] = None,
        first_char: str = None,
        add_time: str = None,
        update_time: str = None,
        visible_to: str = None,
        picture_id: DataPictureId3 = None,
        label: int = None,
        org_name: str = None,
        owner_name: str = None,
        cc_email: str = None,
        owner_id: DataOwnerId3 = None,
        org_id: DataOrgId7 = None,
        name: str = None,
        first_name: str = None,
        last_name: str = None,
        ...
        if phone is not None:
            self.phone = self._define_list(phone, DataPhone3)
        if email is not None:
            self.email = self._define_list(email, DataEmail3)
        ...
        if picture_id is not None:
            self.picture_id = self._define_object(picture_id, DataPictureId3)
        if label is not None:
            self.label = label
        ...
        if cc_email is not None:
            self.cc_email = cc_email
        if owner_id is not None:
            self.owner_id = self._define_object(owner_id, DataOwnerId3)
        if org_id is not None:
            self.org_id = self._define_object(org_id, DataOrgId7)
        if name is not None:
            self.name = name
...
@JsonMap({})
class GetDealPersonsOkResponseAdditionalData(BaseModel):
...
@JsonMap({"id_": "id"})
class OrganizationOrganizationId12(BaseModel):
    """OrganizationOrganizationId12
...
class RelatedObjectsOrganization12(BaseModel):
    """RelatedObjectsOrganization12

    :param organization_id: organization_id, defaults to None
    :type organization_id: OrganizationOrganizationId12, optional
    """

    def __init__(self, organization_id: OrganizationOrganizationId12 = None):
        if organization_id is not None:
            self.organization_id = self._define_object(
                organization_id, OrganizationOrganizationId12
            )


@JsonMap({"id_": "id"})
class UserUserId13(BaseModel):
    """UserUserId13
...
class RelatedObjectsUser13(BaseModel):
    """RelatedObjectsUser13

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId13, optional
    """

    def __init__(self, user_id: UserUserId13 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId13)


@JsonMap({})
class GetDealPersonsOkResponseRelatedObjects(BaseModel):
    """GetDealPersonsOkResponseRelatedObjects

    :param organization: organization, defaults to None
    :type organization: RelatedObjectsOrganization12, optional
    :param user: user, defaults to None
    :type user: RelatedObjectsUser13, optional
    """

    def __init__(
        self,
        organization: RelatedObjectsOrganization12 = None,
        user: RelatedObjectsUser13 = None,
    ):
        if organization is not None:
            self.organization = self._define_object(
                organization, RelatedObjectsOrganization12
            )
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser13)


@JsonMap({})
class GetDealPersonsOkResponse(BaseModel):
    """GetDealPersonsOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The array of persons, defaults to None
    :type data: List[GetDealPersonsOkResponseData], optional
    :param additional_data: The additional data of the list, defaults to None
    :type additional_data: GetDealPersonsOkResponseAdditionalData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: GetDealPersonsOkResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetDealPersonsOkResponseData] = None,
        additional_data: GetDealPersonsOkResponseAdditionalData = None,
        related_objects: GetDealPersonsOkResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetDealPersonsOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetDealPersonsOkResponseAdditionalData
            )
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, GetDealPersonsOkResponseRelatedObjects
            )
