...
class DataFieldType8(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataFieldType8._member_map_.values()))


@JsonMap({"id_": "id"})
class AddOrganizationFieldOkResponseData(BaseModel):
    ...
    :type field_type: DataFieldType8, optional
    ...
    def __init__(
        ...
        name: str = None,
        order_nr: int = None,
        field_type: DataFieldType8 = None,
        add_time: str = None,
        ...
        if field_type is not None:
            self.field_type = self._enum_matching(
                field_type, DataFieldType8.list(), "field_type"
            )
...
@JsonMap({})
class AddOrganizationFieldOkResponse(BaseModel):
    """AddOrganizationFieldOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: AddOrganizationFieldOkResponseData, optional
    """

    def __init__(
        self, success: bool = None, data: AddOrganizationFieldOkResponseData = None
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, AddOrganizationFieldOkResponseData)
