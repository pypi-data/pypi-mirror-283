...
class UpdateProductRequestVisibleTo(Enum):
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, UpdateProductRequestVisibleTo._member_map_.values())
        )


class UpdateProductRequestBillingFrequency(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                UpdateProductRequestBillingFrequency._member_map_.values(),
            )
        )
...
class UpdateProductRequest(BaseModel):
    ...
    :type visible_to: UpdateProductRequestVisibleTo, optional
    ...
    :type billing_frequency: UpdateProductRequestBillingFrequency, optional
    ...
    def __init__(
        ...
        visible_to: UpdateProductRequestVisibleTo = None,
        owner_id: int = None,
        prices: List[dict] = None,
        billing_frequency: UpdateProductRequestBillingFrequency = None,
        ...
        if visible_to is not None:
            self.visible_to = self._enum_matching(
                visible_to, UpdateProductRequestVisibleTo.list(), "visible_to"
            )
        ...
        if billing_frequency is not None:
            self.billing_frequency = self._enum_matching(
                billing_frequency,
                UpdateProductRequestBillingFrequency.list(),
                "billing_frequency",
            )
