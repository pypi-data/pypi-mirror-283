...
class DataFieldType7(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataFieldType7._member_map_.values()))


@JsonMap({"id_": "id"})
class GetOrganizationFieldsOkResponseData(BaseModel):
    ...
    :type field_type: DataFieldType7, optional
    ...
    def __init__(
        ...
        name: str = None,
        order_nr: int = None,
        field_type: DataFieldType7 = None,
        add_time: str = None,
        ...
        if field_type is not None:
            self.field_type = self._enum_matching(
                field_type, DataFieldType7.list(), "field_type"
            )
...
@JsonMap({})
class GetOrganizationFieldsOkResponseAdditionalData(BaseModel):
...
@JsonMap({})
class GetOrganizationFieldsOkResponse(BaseModel):
    """GetOrganizationFieldsOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: List[GetOrganizationFieldsOkResponseData], optional
    :param additional_data: The additional data of the list, defaults to None
    :type additional_data: GetOrganizationFieldsOkResponseAdditionalData, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetOrganizationFieldsOkResponseData] = None,
        additional_data: GetOrganizationFieldsOkResponseAdditionalData = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetOrganizationFieldsOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetOrganizationFieldsOkResponseAdditionalData
            )
