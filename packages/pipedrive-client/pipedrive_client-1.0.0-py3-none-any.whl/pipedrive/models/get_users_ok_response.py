...
class AccessApp2(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, AccessApp2._member_map_.values()))


@JsonMap({})
class DataAccess2(BaseModel):
    """DataAccess2

    :param app: app, defaults to None
    :type app: AccessApp2, optional
    ...
    def __init__(
        self, app: AccessApp2 = None, admin: bool = None, permission_set_id: str = None
    ):
        if app is not None:
            self.app = self._enum_matching(app, AccessApp2.list(), "app")
...
@JsonMap({"id_": "id"})
class GetUsersOkResponseData(BaseModel):
    ...
    :type access: List[DataAccess2], optional
    ...
    def __init__(
        ...
        if access is not None:
            self.access = self._define_list(access, DataAccess2)
...
@JsonMap({})
class GetUsersOkResponse(BaseModel):
    """GetUsersOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: List[GetUsersOkResponseData], optional
    """

    def __init__(self, success: bool = None, data: List[GetUsersOkResponseData] = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetUsersOkResponseData)
