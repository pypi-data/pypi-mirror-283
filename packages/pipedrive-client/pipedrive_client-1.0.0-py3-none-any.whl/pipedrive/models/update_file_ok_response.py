...
@JsonMap({"id_": "id"})
class UpdateFileOkResponseData(BaseModel):
    """The file data
...
@JsonMap({})
class UpdateFileOkResponse(BaseModel):
    ...
    :type data: UpdateFileOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: UpdateFileOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, UpdateFileOkResponseData)
