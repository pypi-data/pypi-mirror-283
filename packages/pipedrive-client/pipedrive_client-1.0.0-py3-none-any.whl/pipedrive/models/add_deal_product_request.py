...
class AddDealProductRequestDiscountType(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                AddDealProductRequestDiscountType._member_map_.values(),
            )
        )


class AddDealProductRequestTaxMethod(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, AddDealProductRequestTaxMethod._member_map_.values())
        )


class AddDealProductRequestBillingFrequency(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                AddDealProductRequestBillingFrequency._member_map_.values(),
            )
        )


@JsonMap({})
class AddDealProductRequest(BaseModel):
    """AddDealProductRequest

    :param product_id: The ID of the product to use
    :type product_id: int
    :param item_price: The price at which this product will be added to the deal
    :type item_price: float
    :param quantity: How many items of this product will be added to the deal
    :type quantity: int
    ...
    :type discount_type: AddDealProductRequestDiscountType, optional
    ...
    :type tax_method: AddDealProductRequestTaxMethod, optional
    ...
    :type billing_frequency: AddDealProductRequestBillingFrequency, optional
    ...
    def __init__(
        ...
        quantity: int,
        discount: float = None,
        discount_type: AddDealProductRequestDiscountType = None,
        product_variation_id: int = None,
        comments: str = None,
        tax: float = None,
        tax_method: AddDealProductRequestTaxMethod = None,
        enabled_flag: bool = None,
        billing_frequency: AddDealProductRequestBillingFrequency = None,
        ...
        if discount_type is not None:
            self.discount_type = self._enum_matching(
                discount_type, AddDealProductRequestDiscountType.list(), "discount_type"
            )
        ...
        if tax_method is not None:
            self.tax_method = self._enum_matching(
                tax_method, AddDealProductRequestTaxMethod.list(), "tax_method"
            )
        ...
        if billing_frequency is not None:
            self.billing_frequency = self._enum_matching(
                billing_frequency,
                AddDealProductRequestBillingFrequency.list(),
                "billing_frequency",
            )
