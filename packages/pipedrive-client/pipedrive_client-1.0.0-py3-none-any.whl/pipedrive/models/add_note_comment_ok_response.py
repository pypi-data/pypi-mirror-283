...
@JsonMap({})
class AddNoteCommentOkResponseData(BaseModel):
...
@JsonMap({})
class AddNoteCommentOkResponse(BaseModel):
    """AddNoteCommentOkResponse

    :param success: If the request was successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: AddNoteCommentOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: AddNoteCommentOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, AddNoteCommentOkResponseData)
