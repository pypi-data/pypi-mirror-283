...
class DataOutcome2(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataOutcome2._member_map_.values()))


@JsonMap({"id_": "id"})
class AddCallLogOkResponseData(BaseModel):
    ...
    def __init__(
        ...
        self.outcome = self._enum_matching(outcome, DataOutcome2.list(), "outcome")
...
@JsonMap({})
class AddCallLogOkResponse(BaseModel):
    """AddCallLogOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: AddCallLogOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: AddCallLogOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, AddCallLogOkResponseData)
