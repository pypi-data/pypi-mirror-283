...
@JsonMap({"id_": "id"})
class GetPipelineDealsOkResponseData(BaseModel):
...
@JsonMap({})
class GetPipelineDealsOkResponseAdditionalData(BaseModel):
...
@JsonMap({})
class GetPipelineDealsOkResponse(BaseModel):
    ...
    :type data: List[GetPipelineDealsOkResponseData], optional
    :param additional_data: The additional data of the list, defaults to None
    :type additional_data: GetPipelineDealsOkResponseAdditionalData, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetPipelineDealsOkResponseData] = None,
        additional_data: GetPipelineDealsOkResponseAdditionalData = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetPipelineDealsOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetPipelineDealsOkResponseAdditionalData
            )
