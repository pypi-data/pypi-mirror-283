...
class DataIconKey1(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataIconKey1._member_map_.values()))


@JsonMap({"id_": "id"})
class GetActivityTypesOkResponseData(BaseModel):
    ...
    :type icon_key: DataIconKey1, optional
    ...
    def __init__(
        ...
        if icon_key is not None:
            self.icon_key = self._enum_matching(
                icon_key, DataIconKey1.list(), "icon_key"
            )
...
@JsonMap({})
class GetActivityTypesOkResponse(BaseModel):
    """GetActivityTypesOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The array of activity types, defaults to None
    :type data: List[GetActivityTypesOkResponseData], optional
    """

    def __init__(
        self, success: bool = None, data: List[GetActivityTypesOkResponseData] = None
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetActivityTypesOkResponseData)
