...
@JsonMap({})
class PutProjectPlanTaskOkResponseData(BaseModel):
...
@JsonMap({})
class PutProjectPlanTaskOkResponse(BaseModel):
    """PutProjectPlanTaskOkResponse

    :param success: success, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: PutProjectPlanTaskOkResponseData, optional
    ...
    def __init__(
        self,
        success: bool = None,
        data: PutProjectPlanTaskOkResponseData = None,
        additional_data: dict = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, PutProjectPlanTaskOkResponseData)
