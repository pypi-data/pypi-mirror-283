...
class UpdateActivityOkResponseData(BaseModel):
...
class RelatedObjectsUser4(BaseModel):
    """RelatedObjectsUser4

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId4, optional
    """

    def __init__(self, user_id: UserUserId4 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId4)


@JsonMap({"id_": "id"})
class DealDealId4(BaseModel):
...
class RelatedObjectsDeal4(BaseModel):
    """RelatedObjectsDeal4

    :param deal_id: The ID of the deal which is associated with the item, defaults to None
    :type deal_id: DealDealId4, optional
    """

    def __init__(self, deal_id: DealDealId4 = None):
        if deal_id is not None:
            self.deal_id = self._define_object(deal_id, DealDealId4)


@JsonMap({})
class PersonIdEmail4(BaseModel):
    """PersonIdEmail4
...
@JsonMap({})
class PersonIdPhone4(BaseModel):
    """PersonIdPhone4
...
@JsonMap({"id_": "id"})
class PersonPersonId4(BaseModel):
    """PersonPersonId4
    ...
    def __init__(
        ...
        id_: int = None,
        name: str = None,
        email: List[PersonIdEmail4] = None,
        phone: List[PersonIdPhone4] = None,
        owner_id: int = None,
    ):
        if active_flag is not None:
            self.active_flag = active_flag
        ...
        if name is not None:
            self.name = name
        if email is not None:
            self.email = self._define_list(email, PersonIdEmail4)
        if phone is not None:
            self.phone = self._define_list(phone, PersonIdPhone4)
        if owner_id is not None:
            self.owner_id = owner_id


@JsonMap({"person_id": "PERSON_ID"})
class RelatedObjectsPerson4(BaseModel):
    """RelatedObjectsPerson4

    :param person_id: person_id, defaults to None
    :type person_id: PersonPersonId4, optional
    """

    def __init__(self, person_id: PersonPersonId4 = None):
        if person_id is not None:
            self.person_id = self._define_object(person_id, PersonPersonId4)


@JsonMap({"id_": "id"})
class OrganizationOrganizationId4(BaseModel):
    """OrganizationOrganizationId4
...
class RelatedObjectsOrganization4(BaseModel):
    """RelatedObjectsOrganization4

    :param organization_id: organization_id, defaults to None
    :type organization_id: OrganizationOrganizationId4, optional
    """

    def __init__(self, organization_id: OrganizationOrganizationId4 = None):
        if organization_id is not None:
            self.organization_id = self._define_object(
                organization_id, OrganizationOrganizationId4
            )


@JsonMap({})
class UpdateActivityOkResponseRelatedObjects(BaseModel):
    """UpdateActivityOkResponseRelatedObjects

    :param user: user, defaults to None
    :type user: RelatedObjectsUser4, optional
    :param deal: deal, defaults to None
    :type deal: RelatedObjectsDeal4, optional
    :param person: person, defaults to None
    :type person: RelatedObjectsPerson4, optional
    :param organization: organization, defaults to None
    :type organization: RelatedObjectsOrganization4, optional
    """

    def __init__(
        self,
        user: RelatedObjectsUser4 = None,
        deal: RelatedObjectsDeal4 = None,
        person: RelatedObjectsPerson4 = None,
        organization: RelatedObjectsOrganization4 = None,
    ):
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser4)
        if deal is not None:
            self.deal = self._define_object(deal, RelatedObjectsDeal4)
        if person is not None:
            self.person = self._define_object(person, RelatedObjectsPerson4)
        if organization is not None:
            self.organization = self._define_object(
                organization, RelatedObjectsOrganization4
            )


@JsonMap({})
class UpdateActivityOkResponse(BaseModel):
    """UpdateActivityOkResponse

    :param success: success, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: UpdateActivityOkResponseData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: UpdateActivityOkResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: UpdateActivityOkResponseData = None,
        related_objects: UpdateActivityOkResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, UpdateActivityOkResponseData)
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, UpdateActivityOkResponseRelatedObjects
            )
