...
@JsonMap({"id_": "id"})
class GetProjectsBoardOkResponseData(BaseModel):
...
@JsonMap({})
class GetProjectsBoardOkResponse(BaseModel):
    """GetProjectsBoardOkResponse

    :param success: success, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: GetProjectsBoardOkResponseData, optional
    ...
    def __init__(
        self,
        success: bool = None,
        data: GetProjectsBoardOkResponseData = None,
        additional_data: dict = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, GetProjectsBoardOkResponseData)
