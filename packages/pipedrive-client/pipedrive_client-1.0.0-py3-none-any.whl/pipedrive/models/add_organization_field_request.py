...
class AddOrganizationFieldRequestFieldType(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                AddOrganizationFieldRequestFieldType._member_map_.values(),
            )
        )


@JsonMap({})
class AddOrganizationFieldRequest(BaseModel):
    ...
    :type field_type: AddOrganizationFieldRequestFieldType
    """

    def __init__(
        self,
        name: str,
        field_type: AddOrganizationFieldRequestFieldType,
        ...
        self.field_type = self._enum_matching(
            field_type, AddOrganizationFieldRequestFieldType.list(), "field_type"
        )
