...
@JsonMap({"id_": "id"})
class DuplicateDealOkResponseData(BaseModel):
...
@JsonMap({})
class DuplicateDealOkResponse(BaseModel):
    """DuplicateDealOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: DuplicateDealOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: DuplicateDealOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, DuplicateDealOkResponseData)
