...
@JsonMap({"id_": "id"})
class AddFileOkResponseData(BaseModel):
    """The file data
...
@JsonMap({})
class AddFileOkResponse(BaseModel):
    """AddFileOkResponse

    :param success: If the request was successful or not, defaults to None
    :type success: bool, optional
    :param data: The file data, defaults to None
    :type data: AddFileOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: AddFileOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, AddFileOkResponseData)
