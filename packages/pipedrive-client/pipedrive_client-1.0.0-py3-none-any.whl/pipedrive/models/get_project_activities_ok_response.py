...
class GetProjectActivitiesOkResponseData(BaseModel):
...
@JsonMap({})
class GetProjectActivitiesOkResponseAdditionalData(BaseModel):
...
@JsonMap({})
class GetProjectActivitiesOkResponse(BaseModel):
    """GetProjectActivitiesOkResponse

    :param success: success, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: List[GetProjectActivitiesOkResponseData], optional
    :param additional_data: The additional data of the list, defaults to None
    :type additional_data: GetProjectActivitiesOkResponseAdditionalData, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetProjectActivitiesOkResponseData] = None,
        additional_data: GetProjectActivitiesOkResponseAdditionalData = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetProjectActivitiesOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetProjectActivitiesOkResponseAdditionalData
            )
