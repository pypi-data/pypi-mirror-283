...
@JsonMap({"id_": "id"})
class GetProjectsPhasesOkResponseData(BaseModel):
...
@JsonMap({})
class GetProjectsPhasesOkResponse(BaseModel):
    """GetProjectsPhasesOkResponse

    :param success: success, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: List[GetProjectsPhasesOkResponseData], optional
    ...
    def __init__(
        self,
        success: bool = None,
        data: List[GetProjectsPhasesOkResponseData] = None,
        additional_data: dict = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetProjectsPhasesOkResponseData)
