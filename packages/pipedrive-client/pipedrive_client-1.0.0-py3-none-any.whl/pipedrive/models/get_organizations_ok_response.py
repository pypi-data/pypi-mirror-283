...
class PictureIdPictures4(BaseModel):
    """PictureIdPictures4
...
@JsonMap({})
class DataPictureId4(BaseModel):
    """DataPictureId4
    ...
    :type pictures: PictureIdPictures4, optional
    """
    ...
    def __init__(
        ...
        pictures: PictureIdPictures4 = None,
    ):
        if value is not None:
            self.value = value
        ...
        if pictures is not None:
            self.pictures = self._define_object(pictures, PictureIdPictures4)


@JsonMap({"id_": "id"})
class GetOrganizationsOkResponseData(BaseModel):
    ...
    :type owner_id: DataOwnerId4, optional
    ...
    :type picture_id: DataPictureId4, optional
    ...
    def __init__(
        ...
        id_: int = None,
        company_id: int = None,
        owner_id: DataOwnerId4 = None,
        name: str = None,
        active_flag: bool = None,
        picture_id: DataPictureId4 = None,
        ...
        if owner_id is not None:
            self.owner_id = self._define_object(owner_id, DataOwnerId4)
        if name is not None:
            self.name = name
        if active_flag is not None:
            self.active_flag = active_flag
        if picture_id is not None:
            self.picture_id = self._define_object(picture_id, DataPictureId4)
...
@JsonMap({})
class AdditionalDataPagination11(BaseModel):
...
@JsonMap({})
class GetOrganizationsOkResponseAdditionalData(BaseModel):
    """GetOrganizationsOkResponseAdditionalData

    :param pagination: Pagination details of the list, defaults to None
    :type pagination: AdditionalDataPagination11, optional
    """

    def __init__(self, pagination: AdditionalDataPagination11 = None):
        if pagination is not None:
            self.pagination = self._define_object(
                pagination, AdditionalDataPagination11
            )


@JsonMap({"id_": "id"})
class OrganizationOrganizationId13(BaseModel):
    """OrganizationOrganizationId13
...
class RelatedObjectsOrganization13(BaseModel):
    """RelatedObjectsOrganization13

    :param organization_id: organization_id, defaults to None
    :type organization_id: OrganizationOrganizationId13, optional
    """

    def __init__(self, organization_id: OrganizationOrganizationId13 = None):
        if organization_id is not None:
            self.organization_id = self._define_object(
                organization_id, OrganizationOrganizationId13
            )


@JsonMap({"id_": "id"})
class UserUserId15(BaseModel):
    """UserUserId15
...
class RelatedObjectsUser15(BaseModel):
    """RelatedObjectsUser15

    :param user_id: user_id, defaults to None
    :type user_id: UserUserId15, optional
    """

    def __init__(self, user_id: UserUserId15 = None):
        if user_id is not None:
            self.user_id = self._define_object(user_id, UserUserId15)


@JsonMap({"_128": "128", "_512": "512"})
class PictureIdPictures5(BaseModel):
    """PictureIdPictures5
...
@JsonMap({"id_": "id"})
class PicturePictureId1(BaseModel):
    """PicturePictureId1
    ...
    :type added_by_user_id: int, optional
    :param pictures: pictures, defaults to None
    :type pictures: PictureIdPictures5, optional
    """
    ...
    def __init__(
        ...
        update_time: str = None,
        added_by_user_id: int = None,
        pictures: PictureIdPictures5 = None,
    ):
        if id_ is not None:
            self.id_ = id_
        if item_type is not None:
        ...
        if added_by_user_id is not None:
            self.added_by_user_id = added_by_user_id
        if pictures is not None:
            self.pictures = self._define_object(pictures, PictureIdPictures5)


@JsonMap({"picture_id": "PICTURE_ID"})
class RelatedObjectsPicture1(BaseModel):
    """The picture that is associated with the item

    :param picture_id: picture_id, defaults to None
    :type picture_id: PicturePictureId1, optional
    """

    def __init__(self, picture_id: PicturePictureId1 = None):
        if picture_id is not None:
            self.picture_id = self._define_object(picture_id, PicturePictureId1)


@JsonMap({})
class GetOrganizationsOkResponseRelatedObjects(BaseModel):
    """GetOrganizationsOkResponseRelatedObjects

    :param organization: organization, defaults to None
    :type organization: RelatedObjectsOrganization13, optional
    :param user: user, defaults to None
    :type user: RelatedObjectsUser15, optional
    :param picture: The picture that is associated with the item, defaults to None
    :type picture: RelatedObjectsPicture1, optional
    """

    def __init__(
        self,
        organization: RelatedObjectsOrganization13 = None,
        user: RelatedObjectsUser15 = None,
        picture: RelatedObjectsPicture1 = None,
    ):
        if organization is not None:
            self.organization = self._define_object(
                organization, RelatedObjectsOrganization13
            )
        if user is not None:
            self.user = self._define_object(user, RelatedObjectsUser15)
        if picture is not None:
            self.picture = self._define_object(picture, RelatedObjectsPicture1)


@JsonMap({})
class GetOrganizationsOkResponse(BaseModel):
    """GetOrganizationsOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: The array of organizations, defaults to None
    :type data: List[GetOrganizationsOkResponseData], optional
    :param additional_data: additional_data, defaults to None
    :type additional_data: GetOrganizationsOkResponseAdditionalData, optional
    :param related_objects: related_objects, defaults to None
    :type related_objects: GetOrganizationsOkResponseRelatedObjects, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetOrganizationsOkResponseData] = None,
        additional_data: GetOrganizationsOkResponseAdditionalData = None,
        related_objects: GetOrganizationsOkResponseRelatedObjects = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetOrganizationsOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetOrganizationsOkResponseAdditionalData
            )
        if related_objects is not None:
            self.related_objects = self._define_object(
                related_objects, GetOrganizationsOkResponseRelatedObjects
            )
