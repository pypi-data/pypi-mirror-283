...
class DataIsActive2(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataIsActive2._member_map_.values()))
...
class DataType5(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataType5._member_map_.values()))


@JsonMap({"id_": "id", "type_": "type"})
class AddWebhookCreatedResponseData(BaseModel):
    ...
    :type is_active: DataIsActive2, optional
    ...
    def __init__(
        ...
        is_active: DataIsActive2 = None,
        add_time: str = None,
        remove_time: str = None,
        type_: DataType5 = None,
        ...
        if is_active is not None:
            self.is_active = self._enum_matching(
                is_active, DataIsActive2.list(), "is_active"
            )
        ...
        if type_ is not None:
            self.type_ = self._enum_matching(type_, DataType5.list(), "type_")
...
@JsonMap({})
class AddWebhookCreatedResponse(BaseModel):
    ...
    :type data: AddWebhookCreatedResponseData, optional
    """
    ...
    def __init__(
        ...
        success: bool = None,
        status: str = None,
        data: AddWebhookCreatedResponseData = None,
    ):
        ...
        if status is not None:
            self.status = status
        if data is not None:
            self.data = self._define_object(data, AddWebhookCreatedResponseData)
