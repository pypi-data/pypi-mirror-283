...
class DataVisibleTo1(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataVisibleTo1._member_map_.values()))


@JsonMap({"id_": "id"})
class GetLeadsOkResponseData(BaseModel):
    ...
    :type value: DataValue1, optional
    ...
    :type visible_to: DataVisibleTo1, optional
    ...
    def __init__(
        ...
        was_seen: bool = None,
        value: DataValue1 = None,
        expected_close_date: str = None,
        next_activity_id: int = None,
        add_time: str = None,
        update_time: str = None,
        visible_to: DataVisibleTo1 = None,
        cc_email: str = None,
    ):
        if id_ is not None:
            self.id_ = id_
        ...
        if value is not None:
            self.value = self._define_object(value, DataValue1)
        ...
        if visible_to is not None:
            self.visible_to = self._enum_matching(
                visible_to, DataVisibleTo1.list(), "visible_to"
            )
...
@JsonMap({})
class GetLeadsOkResponseAdditionalData(BaseModel):
...
@JsonMap({})
class GetLeadsOkResponse(BaseModel):
    """GetLeadsOkResponse

    :param success: success, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: List[GetLeadsOkResponseData], optional
    :param additional_data: The additional data of the list, defaults to None
    :type additional_data: GetLeadsOkResponseAdditionalData, optional
    """

    def __init__(
        self,
        success: bool = None,
        data: List[GetLeadsOkResponseData] = None,
        additional_data: GetLeadsOkResponseAdditionalData = None,
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_list(data, GetLeadsOkResponseData)
        if additional_data is not None:
            self.additional_data = self._define_object(
                additional_data, GetLeadsOkResponseAdditionalData
            )
