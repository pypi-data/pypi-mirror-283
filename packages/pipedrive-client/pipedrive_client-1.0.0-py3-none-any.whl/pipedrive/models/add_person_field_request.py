...
class AddPersonFieldRequestFieldType(Enum):
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, AddPersonFieldRequestFieldType._member_map_.values())
        )


@JsonMap({})
class AddPersonFieldRequest(BaseModel):
    ...
    :type field_type: AddPersonFieldRequestFieldType
    """

    def __init__(
        self,
        name: str,
        field_type: AddPersonFieldRequestFieldType,
        ...
        self.field_type = self._enum_matching(
            field_type, AddPersonFieldRequestFieldType.list(), "field_type"
        )
