...
class AccessApp7(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, AccessApp7._member_map_.values()))


@JsonMap({})
class DataAccess6(BaseModel):
    """DataAccess6

    :param app: app, defaults to None
    :type app: AccessApp7, optional
    ...
    def __init__(
        self, app: AccessApp7 = None, admin: bool = None, permission_set_id: str = None
    ):
        if app is not None:
            self.app = self._enum_matching(app, AccessApp7.list(), "app")
...
@JsonMap({"id_": "id"})
class GetUserOkResponseData(BaseModel):
    ...
    :type access: List[DataAccess6], optional
    ...
    def __init__(
        ...
        if access is not None:
            self.access = self._define_list(access, DataAccess6)
...
@JsonMap({})
class GetUserOkResponse(BaseModel):
    """GetUserOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: GetUserOkResponseData, optional
    """

    def __init__(self, success: bool = None, data: GetUserOkResponseData = None):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, GetUserOkResponseData)
