...
class DataIconKey3(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, DataIconKey3._member_map_.values()))


@JsonMap({"id_": "id"})
class UpdateActivityTypeOkResponseData(BaseModel):
    ...
    :type icon_key: DataIconKey3, optional
    ...
    def __init__(
        ...
        if icon_key is not None:
            self.icon_key = self._enum_matching(
                icon_key, DataIconKey3.list(), "icon_key"
            )
...
@JsonMap({})
class UpdateActivityTypeOkResponse(BaseModel):
    """UpdateActivityTypeOkResponse

    :param success: If the response is successful or not, defaults to None
    :type success: bool, optional
    :param data: data, defaults to None
    :type data: UpdateActivityTypeOkResponseData, optional
    """

    def __init__(
        self, success: bool = None, data: UpdateActivityTypeOkResponseData = None
    ):
        if success is not None:
            self.success = success
        if data is not None:
            self.data = self._define_object(data, UpdateActivityTypeOkResponseData)
