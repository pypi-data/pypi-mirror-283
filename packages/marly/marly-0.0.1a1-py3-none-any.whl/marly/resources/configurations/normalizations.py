...
from ...types.configurations import normalization_create_params, normalization_update_params
from ...types.configuration.normalization_config import NormalizationConfig
from ...types.configurations.normalization_list_response import NormalizationListResponse
...
class NormalizationsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/configuration/normalizations/{normalization_id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NormalizationConfig,
