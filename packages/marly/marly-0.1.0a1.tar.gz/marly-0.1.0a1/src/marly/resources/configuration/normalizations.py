...
from ...types.configuration.normalization_config_response import NormalizationConfigResponse
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=NormalizationConfigResponse,
        )
