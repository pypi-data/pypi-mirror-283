...
from marly.types import (
    OutputMappingListResponse,
    OutputMappingConfigResponse,
)
...
class TestOutputMappings:
    ...
    def test_method_create(self, client: Marly) -> None:
        output_mapping = client.output_mappings.create(
            created_by="string",
        )
        assert_matches_type(OutputMappingConfigResponse, output_mapping, path=["response"])
    ...
    def test_raw_response_create(self, client: Marly) -> None:
        response = client.output_mappings.with_raw_response.create(
            created_by="string",
        )
    ...
    def test_streaming_response_create(self, client: Marly) -> None:
        with client.output_mappings.with_streaming_response.create(
            created_by="string",
        ) as response:
    ...
    def test_method_retrieve(self, client: Marly) -> None:
        output_mapping = client.output_mappings.retrieve(
    ...
    def test_raw_response_retrieve(self, client: Marly) -> None:
        response = client.output_mappings.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve(self, client: Marly) -> None:
        with client.output_mappings.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: Marly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `output_mapping_id` but received ''"):
            client.output_mappings.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_update(self, client: Marly) -> None:
        output_mapping = client.output_mappings.update(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
        )
        assert_matches_type(OutputMappingConfigResponse, output_mapping, path=["response"])
    ...
    def test_raw_response_update(self, client: Marly) -> None:
        response = client.output_mappings.with_raw_response.update(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
        )
    ...
    def test_streaming_response_update(self, client: Marly) -> None:
        with client.output_mappings.with_streaming_response.update(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update(self, client: Marly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `output_mapping_id` but received ''"):
            client.output_mappings.with_raw_response.update(
                "",
                created_by="string",
            )
    ...
    def test_method_list(self, client: Marly) -> None:
        output_mapping = client.output_mappings.list()
    ...
    def test_raw_response_list(self, client: Marly) -> None:
        response = client.output_mappings.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Marly) -> None:
        with client.output_mappings.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: Marly) -> None:
        output_mapping = client.output_mappings.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_raw_response_delete(self, client: Marly) -> None:
        response = client.output_mappings.with_raw_response.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_delete(self, client: Marly) -> None:
        with client.output_mappings.with_streaming_response.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: Marly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `output_mapping_id` but received ''"):
            client.output_mappings.with_raw_response.delete(
                "",
            )
...
class TestAsyncOutputMappings:
    ...
    async def test_method_create(self, async_client: AsyncMarly) -> None:
        output_mapping = await async_client.output_mappings.create(
            created_by="string",
        )
        assert_matches_type(OutputMappingConfigResponse, output_mapping, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncMarly) -> None:
        response = await async_client.output_mappings.with_raw_response.create(
            created_by="string",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncMarly) -> None:
        async with async_client.output_mappings.with_streaming_response.create(
            created_by="string",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_retrieve(self, async_client: AsyncMarly) -> None:
        output_mapping = await async_client.output_mappings.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(OutputMappingConfigResponse, output_mapping, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncMarly) -> None:
        response = await async_client.output_mappings.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncMarly) -> None:
        async with async_client.output_mappings.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncMarly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `output_mapping_id` but received ''"):
            await async_client.output_mappings.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_update(self, async_client: AsyncMarly) -> None:
        output_mapping = await async_client.output_mappings.update(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
        )
        assert_matches_type(OutputMappingConfigResponse, output_mapping, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncMarly) -> None:
        response = await async_client.output_mappings.with_raw_response.update(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncMarly) -> None:
        async with async_client.output_mappings.with_streaming_response.update(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update(self, async_client: AsyncMarly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `output_mapping_id` but received ''"):
            await async_client.output_mappings.with_raw_response.update(
                "",
                created_by="string",
            )
    ...
    async def test_method_list(self, async_client: AsyncMarly) -> None:
        output_mapping = await async_client.output_mappings.list()
        assert_matches_type(OutputMappingListResponse, output_mapping, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncMarly) -> None:
        response = await async_client.output_mappings.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncMarly) -> None:
        async with async_client.output_mappings.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncMarly) -> None:
        output_mapping = await async_client.output_mappings.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert output_mapping is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncMarly) -> None:
        response = await async_client.output_mappings.with_raw_response.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncMarly) -> None:
        async with async_client.output_mappings.with_streaming_response.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncMarly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `output_mapping_id` but received ''"):
            await async_client.output_mappings.with_raw_response.delete(
                "",
            )
