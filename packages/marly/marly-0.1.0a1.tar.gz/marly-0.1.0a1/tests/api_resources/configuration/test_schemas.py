...
class TestSchemas:
    ...
    def test_method_create(self, client: Marly) -> None:
        schema = client.configuration.schemas.create(
            created_by="string",
        )
        assert_matches_type(SchemaConfigResponse, schema, path=["response"])
    ...
    def test_raw_response_create(self, client: Marly) -> None:
        response = client.configuration.schemas.with_raw_response.create(
            created_by="string",
        )
    ...
    def test_streaming_response_create(self, client: Marly) -> None:
        with client.configuration.schemas.with_streaming_response.create(
            created_by="string",
        ) as response:
    ...
    def test_method_retrieve(self, client: Marly) -> None:
        schema = client.configuration.schemas.retrieve(
    ...
    def test_raw_response_retrieve(self, client: Marly) -> None:
        response = client.configuration.schemas.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve(self, client: Marly) -> None:
        with client.configuration.schemas.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: Marly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `schema_id` but received ''"):
            client.configuration.schemas.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_update(self, client: Marly) -> None:
        schema = client.configuration.schemas.update(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
        )
        assert_matches_type(SchemaConfigResponse, schema, path=["response"])
    ...
    def test_raw_response_update(self, client: Marly) -> None:
        response = client.configuration.schemas.with_raw_response.update(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
        )
    ...
    def test_streaming_response_update(self, client: Marly) -> None:
        with client.configuration.schemas.with_streaming_response.update(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update(self, client: Marly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `schema_id` but received ''"):
            client.configuration.schemas.with_raw_response.update(
                "",
                created_by="string",
            )
    ...
    def test_streaming_response_list(self, client: Marly) -> None:
        with client.configuration.schemas.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: Marly) -> None:
        schema = client.configuration.schemas.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_raw_response_delete(self, client: Marly) -> None:
        response = client.configuration.schemas.with_raw_response.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_delete(self, client: Marly) -> None:
        with client.configuration.schemas.with_streaming_response.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: Marly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `schema_id` but received ''"):
            client.configuration.schemas.with_raw_response.delete(
                "",
            )
...
class TestAsyncSchemas:
    ...
    async def test_method_create(self, async_client: AsyncMarly) -> None:
        schema = await async_client.configuration.schemas.create(
            created_by="string",
        )
        assert_matches_type(SchemaConfigResponse, schema, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncMarly) -> None:
        response = await async_client.configuration.schemas.with_raw_response.create(
            created_by="string",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncMarly) -> None:
        async with async_client.configuration.schemas.with_streaming_response.create(
            created_by="string",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_retrieve(self, async_client: AsyncMarly) -> None:
        schema = await async_client.configuration.schemas.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(SchemaConfigResponse, schema, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncMarly) -> None:
        response = await async_client.configuration.schemas.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncMarly) -> None:
        async with async_client.configuration.schemas.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncMarly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `schema_id` but received ''"):
            await async_client.configuration.schemas.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_update(self, async_client: AsyncMarly) -> None:
        schema = await async_client.configuration.schemas.update(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
        )
        assert_matches_type(SchemaConfigResponse, schema, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncMarly) -> None:
        response = await async_client.configuration.schemas.with_raw_response.update(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncMarly) -> None:
        async with async_client.configuration.schemas.with_streaming_response.update(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update(self, async_client: AsyncMarly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `schema_id` but received ''"):
            await async_client.configuration.schemas.with_raw_response.update(
                "",
                created_by="string",
            )
    ...
    async def test_method_list(self, async_client: AsyncMarly) -> None:
        schema = await async_client.configuration.schemas.list()
        assert_matches_type(SchemaListResponse, schema, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncMarly) -> None:
        response = await async_client.configuration.schemas.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncMarly) -> None:
        async with async_client.configuration.schemas.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncMarly) -> None:
        schema = await async_client.configuration.schemas.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert schema is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncMarly) -> None:
        response = await async_client.configuration.schemas.with_raw_response.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncMarly) -> None:
        async with async_client.configuration.schemas.with_streaming_response.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncMarly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `schema_id` but received ''"):
            await async_client.configuration.schemas.with_raw_response.delete(
                "",
            )
