...
class TestPrompts:
    ...
    def test_method_create(self, client: Marly) -> None:
        prompt = client.configurations.prompts.create(
            created_by="string",
            messages=[
                {
                    "role": "string",
        ...
        assert_matches_type(PromptConfig, prompt, path=["response"])
    ...
    def test_raw_response_create(self, client: Marly) -> None:
        response = client.configurations.prompts.with_raw_response.create(
            created_by="string",
            messages=[
                {
                    "role": "string",
    ...
    def test_streaming_response_create(self, client: Marly) -> None:
        with client.configurations.prompts.with_streaming_response.create(
            created_by="string",
            messages=[
                {
                    "role": "string",
    ...
    def test_method_retrieve(self, client: Marly) -> None:
        prompt = client.configurations.prompts.retrieve(
    ...
    def test_raw_response_retrieve(self, client: Marly) -> None:
        response = client.configurations.prompts.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve(self, client: Marly) -> None:
        with client.configurations.prompts.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: Marly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `prompt_id` but received ''"):
            client.configurations.prompts.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_update(self, client: Marly) -> None:
        prompt = client.configurations.prompts.update(
    ...
    def test_raw_response_update(self, client: Marly) -> None:
        response = client.configurations.prompts.with_raw_response.update(
            path_prompt_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
            messages=[
                {
    ...
    def test_streaming_response_update(self, client: Marly) -> None:
        with client.configurations.prompts.with_streaming_response.update(
            path_prompt_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
            messages=[
                {
    ...
    def test_path_params_update(self, client: Marly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `path_prompt_id` but received ''"):
            client.configurations.prompts.with_raw_response.update(
                path_prompt_id="",
                created_by="string",
                messages=[
                    {
    ...
    def test_streaming_response_list(self, client: Marly) -> None:
        with client.configurations.prompts.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: Marly) -> None:
        prompt = client.configurations.prompts.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_raw_response_delete(self, client: Marly) -> None:
        response = client.configurations.prompts.with_raw_response.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_delete(self, client: Marly) -> None:
        with client.configurations.prompts.with_streaming_response.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: Marly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `prompt_id` but received ''"):
            client.configurations.prompts.with_raw_response.delete(
                "",
            )
...
class TestAsyncPrompts:
    ...
    async def test_method_create(self, async_client: AsyncMarly) -> None:
        prompt = await async_client.configurations.prompts.create(
            created_by="string",
            messages=[
                {
                    "role": "string",
    ...
    async def test_raw_response_create(self, async_client: AsyncMarly) -> None:
        response = await async_client.configurations.prompts.with_raw_response.create(
            created_by="string",
            messages=[
                {
                    "role": "string",
    ...
    async def test_streaming_response_create(self, async_client: AsyncMarly) -> None:
        async with async_client.configurations.prompts.with_streaming_response.create(
            created_by="string",
            messages=[
                {
                    "role": "string",
    ...
    async def test_method_retrieve(self, async_client: AsyncMarly) -> None:
        prompt = await async_client.configurations.prompts.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(PromptConfig, prompt, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncMarly) -> None:
        response = await async_client.configurations.prompts.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncMarly) -> None:
        async with async_client.configurations.prompts.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncMarly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `prompt_id` but received ''"):
            await async_client.configurations.prompts.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_update(self, async_client: AsyncMarly) -> None:
        prompt = await async_client.configurations.prompts.update(
            path_prompt_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
            messages=[
                {
    ...
    async def test_raw_response_update(self, async_client: AsyncMarly) -> None:
        response = await async_client.configurations.prompts.with_raw_response.update(
            path_prompt_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
            messages=[
                {
    ...
    async def test_streaming_response_update(self, async_client: AsyncMarly) -> None:
        async with async_client.configurations.prompts.with_streaming_response.update(
            path_prompt_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            created_by="string",
            messages=[
                {
    ...
    async def test_path_params_update(self, async_client: AsyncMarly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `path_prompt_id` but received ''"):
            await async_client.configurations.prompts.with_raw_response.update(
                path_prompt_id="",
                created_by="string",
                messages=[
                    {
    ...
    async def test_method_list(self, async_client: AsyncMarly) -> None:
        prompt = await async_client.configurations.prompts.list()
        assert_matches_type(PromptListResponse, prompt, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncMarly) -> None:
        response = await async_client.configurations.prompts.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncMarly) -> None:
        async with async_client.configurations.prompts.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncMarly) -> None:
        prompt = await async_client.configurations.prompts.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert prompt is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncMarly) -> None:
        response = await async_client.configurations.prompts.with_raw_response.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncMarly) -> None:
        async with async_client.configurations.prompts.with_streaming_response.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncMarly) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `prompt_id` but received ''"):
            await async_client.configurations.prompts.with_raw_response.delete(
                "",
            )
