...
from ...types.configurations import prompt_create_params, prompt_update_params
from ...types.configuration.prompt_config import PromptConfig
from ...types.configurations.prompt_list_response import PromptListResponse
...
class PromptsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/configuration/prompts/{prompt_id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=PromptConfig,
    ...
    def update(
        ...
        *,
        ...
        return self._put(
            f"/configuration/prompts/{path_prompt_id}",
            body=maybe_transform(
                {
                    "created_by": created_by,
                    "messages": messages,
