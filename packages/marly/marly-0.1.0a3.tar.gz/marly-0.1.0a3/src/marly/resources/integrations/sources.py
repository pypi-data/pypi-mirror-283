...
from ...types.integrations import source_register_s3_params, source_register_local_fs_params
from ...types.integrations.source_register_s3_response import SourceRegisterS3Response
from ...types.integrations.source_register_local_fs_response import SourceRegisterLocalFsResponse
...
class SourcesResource(SyncAPIResource):
    ...
    def register_local_fs(
        ...
        *,
        ...
        """
        return self._post(
            "/integrations/sources/register-local-fs",
            body=maybe_transform({"base_path": base_path}, source_register_local_fs_params.SourceRegisterLocalFsParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=SourceRegisterLocalFsResponse,
        )
        ...
        *,
        ...
        return await self._post(
            ...
            body=await async_maybe_transform(
                {"base_path": base_path}, source_register_local_fs_params.SourceRegisterLocalFsParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class SourcesResourceWithRawResponse:
    def __init__(self, sources: SourcesResource) -> None:
        ...
        self.register_local_fs = to_raw_response_wrapper(
            sources.register_local_fs,
        )
...
class AsyncSourcesResourceWithRawResponse:
    def __init__(self, sources: AsyncSourcesResource) -> None:
        ...
        self.register_local_fs = async_to_raw_response_wrapper(
            sources.register_local_fs,
        )
...
class SourcesResourceWithStreamingResponse:
    def __init__(self, sources: SourcesResource) -> None:
        ...
        self.register_local_fs = to_streamed_response_wrapper(
            sources.register_local_fs,
        )
...
class AsyncSourcesResourceWithStreamingResponse:
    def __init__(self, sources: AsyncSourcesResource) -> None:
        ...
        self.register_local_fs = async_to_streamed_response_wrapper(
            sources.register_local_fs,
        )
