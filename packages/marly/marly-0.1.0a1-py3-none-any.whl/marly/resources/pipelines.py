...
from ..types import pipeline_create_params, pipeline_update_params
...
from ..types.pipeline_config_response import PipelineConfigResponse
...
class PipelinesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=PipelineConfigResponse,
        )
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/configuration/pipelines/{pipeline_id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=PipelineConfigResponse,
