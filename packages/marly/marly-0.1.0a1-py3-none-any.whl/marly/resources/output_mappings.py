...
from ..types import output_mapping_create_params, output_mapping_update_params
...
from ..types.output_mapping_list_response import OutputMappingListResponse
from ..types.output_mapping_config_response import OutputMappingConfigResponse
...
class OutputMappingsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=OutputMappingConfigResponse,
        )
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/configuration/output-mappings/{output_mapping_id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=OutputMappingConfigResponse,
