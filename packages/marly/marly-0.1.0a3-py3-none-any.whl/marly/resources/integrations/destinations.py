...
from ...types.integrations import (
    destination_register_s3_params,
    destination_register_excel_params,
    destination_register_postgres_params,
)
...
from ...types.integrations.destination_register_postgres_response import DestinationRegisterPostgresResponse
...
class DestinationsResource(SyncAPIResource):
    ...
    def register_postgres(
        ...
        *,
        ...
        """
        return self._post(
            "/integrations/destinations/register_postgres",
            body=maybe_transform(
                {
                    "database": database,
                    "host": host,
                ...
                destination_register_postgres_params.DestinationRegisterPostgresParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=DestinationRegisterPostgresResponse,
        )
...
class DestinationsResourceWithRawResponse:
    def __init__(self, destinations: DestinationsResource) -> None:
        ...
        self.register_postgres = to_raw_response_wrapper(
            destinations.register_postgres,
        )
...
class AsyncDestinationsResourceWithRawResponse:
    def __init__(self, destinations: AsyncDestinationsResource) -> None:
        ...
        self.register_postgres = async_to_raw_response_wrapper(
            destinations.register_postgres,
        )
...
class DestinationsResourceWithStreamingResponse:
    def __init__(self, destinations: DestinationsResource) -> None:
        ...
        self.register_postgres = to_streamed_response_wrapper(
            destinations.register_postgres,
        )
...
class AsyncDestinationsResourceWithStreamingResponse:
    def __init__(self, destinations: AsyncDestinationsResource) -> None:
        ...
        self.register_postgres = async_to_streamed_response_wrapper(
            destinations.register_postgres,
        )
