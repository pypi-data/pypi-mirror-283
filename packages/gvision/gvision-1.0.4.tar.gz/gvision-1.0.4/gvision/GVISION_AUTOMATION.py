...
dataset = project.version(1).download("yolov8")
	...
	if st.button("Deployment Demo"):
		...
		if task == 'detect' or task == 'segment':
			st.switch_page(os.path.join(current_dir, "pages", "2_Object_Detection_Demo.py"))
		else:
			st.switch_page(os.path.join(current_dir, "pages", "3_Classification_or_Pose_Demo.py"))
