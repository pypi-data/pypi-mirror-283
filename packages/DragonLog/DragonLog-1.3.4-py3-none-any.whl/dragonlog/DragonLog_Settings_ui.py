...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.hideColPushButton.setObjectName("hideColPushButton")
        self.verticalLayout_2.addWidget(self.hideColPushButton)
        self.showColPushButton = QtWidgets.QPushButton(parent=self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.colHideListWidget.setObjectName("colHideListWidget")
        self.verticalLayout_4.addWidget(self.colHideListWidget)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox.setTitle(_translate("Dialog", "Show or hide columns"))
        self.label_14.setText(_translate("Dialog", "Columns to show"))
        self.hideColPushButton.setText(_translate("Dialog", ">"))
        self.showColPushButton.setText(_translate("Dialog", "<"))
        self.label_15.setText(_translate("Dialog", "Columns to hide"))
