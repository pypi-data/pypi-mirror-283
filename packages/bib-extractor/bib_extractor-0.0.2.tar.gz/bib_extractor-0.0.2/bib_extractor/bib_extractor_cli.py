...
from bib_extractor.bib_extractor_main import BibExtractor, setup_common_logger
...
def _parser():
    ...
    parser.add_argument('--logs_dir', default='./logs', help='Name of directory for log files')
...
def main():
    ...
    logger = setup_common_logger(args, logger_name)
    # logger = setup_logger(args, logger_name, args.log)
    args.logger = logger
