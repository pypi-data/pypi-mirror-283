...
<<<<<<< HEAD
from mt import tp, logg, traceback as tb
=======
from mt import tp, logg, traceback
>>>>>>> 5f3eca92e08838e6b14805fa667ccc77735e446e
...
class Bee:
    ...
    def _put_msg(self, child_id, msg):
        ...
        try:
            ...
            raise traceback.LogicError(
                "Unexpected exception caught while sending a message.",
                causing_error=e,
            )
    ...
    async def _execute_task(self, name: str, args: tuple = (), kwargs: dict = {}):
        ...
        try:
            ...
            raise traceback.LogicError(
                "Unexpected exception caught while executing a task.",
    ...
    def _mourn_death(self, child_id, msg):  # msg = {'death_type': str, ...}
        ...
        if msg["death_type"] == "killed":
            with logg.scoped_debug(
                f"Child bee {child_id} was killed",
                logger=self.logger,
            ):
        ...
        while not self.stop_managing and not self.to_terminate:
            ...
            if num_workers < min_num_workers:
                if not inited:
                    ...
                    raise traceback.LogicError(
                        "All children bees have been killed.",
                        debug={
...
async def beehive_run(
    ...
    if msg["status"] == "cancelled":
        raise traceback.LogicError(
            "The queen bee cancelled the task.", debug={"reason": msg["reason"]}
        )
