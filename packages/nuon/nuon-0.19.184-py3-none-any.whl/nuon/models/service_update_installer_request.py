...
"""
    ...
    The version of the OpenAPI document: 0.19.184
...
class ServiceUpdateInstallerRequest(BaseModel):
    ...
    metadata: Optional[ServiceUpdateInstallerRequestMetadata] = None
    name: StrictStr
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": ServiceUpdateInstallerRequestMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None,
            "name": obj.get("name")
        })
        return _obj
