...
#app = Flask(__name__)
app = Flask(__name__, template_folder=resource_filename(__name__, 'templates'))
...
# OpenAI API Key
client = OpenAI()
print(resource_filename(__name__, 'templates/index.html'))

# Define the system message
system_message = open(resource_filename('ignacio_bot', 'system_context.txt'), 'r').read()
