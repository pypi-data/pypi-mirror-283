# python build stubs for package messenger
...
mod = Module('_messenger')
mod.add_include('"messenger_go.h"')
...
mod.add_function('Slice_messenger_DataMsg_CTor', retval('int64_t'), [])
mod.add_function('Slice_messenger_DataMsg_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Slice_messenger_DataMsg_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Slice_messenger_DataMsg_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('Slice_messenger_DataMsg_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('Slice_messenger_DataMsg_append', None, [param('int64_t', 'handle'), param('int64_t', 'value')])
mod.add_function('Slice_agent_DataMsg_CTor', retval('int64_t'), [])
mod.add_function('Slice_agent_DataMsg_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Slice_agent_DataMsg_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Slice_agent_DataMsg_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('Slice_agent_DataMsg_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('Slice_agent_DataMsg_append', None, [param('int64_t', 'handle'), param('int64_t', 'value')])
...
mod.add_function('messenger_Messenger', retval('int64_t'), [])
mod.add_function('messenger_Set_Messenger', None, [param('int64_t', 'val')])
mod.add_function('messenger_DataMsg_CTor', retval('int64_t'), [])
mod.add_function('messenger_DataMsg_InputName_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('messenger_DataMsg_InputName_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('messenger_DataMsg_Uid_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('messenger_DataMsg_Uid_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('messenger_DataMsg_Source_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('messenger_DataMsg_Source_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('messenger_DataMsg_Data_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('messenger_DataMsg_Data_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('messenger_DataMsg_Params_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('messenger_DataMsg_Params_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('messenger_DataMsg_ContentType_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('messenger_DataMsg_ContentType_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('messenger_StringArray_CTor', retval('int64_t'), [])
mod.add_function('messenger_StringArray_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('messenger_StringArray_elem', retval('char*'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('messenger_StringArray_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('messenger_StringArray_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('char*', 'value')])
mod.add_function('messenger_StringArray_append', None, [param('int64_t', 'handle'), param('char*', 'value')])
add_checked_function(mod, 'messenger_GetTest', retval('int64_t'), [])
add_checked_string_function(mod, 'messenger_MessengerSendReply', retval('char*'), [param('char*', 'dest'), param('char*', 'uid'), param('char*', 'source'), param('int64_t', 'data'), param('int64_t', 'parameters'), param('char*', 'content_type'), param('char*', 'err_str')])
add_checked_function(mod, 'messenger_MessengerGetMsgs', retval('int64_t'), [param('int64_t', 'timeout')])
add_checked_string_function(mod, 'messenger_MessengerInit', retval('char*'), [param('int64_t', 'outputs'), param('int64_t', 'inputs'), param('char*', 'nats_url'), param('char*', 'queue'), param('int64_t', 'batch')])

mod.generate(open('messenger.c', 'w'))
