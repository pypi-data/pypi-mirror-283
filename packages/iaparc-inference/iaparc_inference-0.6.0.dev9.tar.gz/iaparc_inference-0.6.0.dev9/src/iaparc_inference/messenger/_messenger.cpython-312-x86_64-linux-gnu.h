...
// --- wrapping slice: []messenger.DataMsg ---
//
extern long long int Slice_messenger_DataMsg_CTor();
extern GoInt Slice_messenger_DataMsg_len(long long int handle);
extern long long int Slice_messenger_DataMsg_elem(long long int handle, GoInt _idx);
extern long long int Slice_messenger_DataMsg_subslice(long long int handle, GoInt _st, GoInt _ed);
extern void Slice_messenger_DataMsg_set(long long int handle, GoInt _idx, long long int _vl);
extern void Slice_messenger_DataMsg_append(long long int handle, long long int _vl);

// --- wrapping slice: []agent.DataMsg ---
//
extern long long int Slice_agent_DataMsg_CTor();
extern GoInt Slice_agent_DataMsg_len(long long int handle);
extern long long int Slice_agent_DataMsg_elem(long long int handle, GoInt _idx);
extern long long int Slice_agent_DataMsg_subslice(long long int handle, GoInt _st, GoInt _ed);
extern void Slice_agent_DataMsg_set(long long int handle, GoInt _idx, long long int _vl);
extern void Slice_agent_DataMsg_append(long long int handle, long long int _vl);
...
//
extern long long int messenger_Messenger();
extern void messenger_Set_Messenger(long long int val);

// --- wrapping struct: messenger.DataMsg ---
//
extern long long int messenger_DataMsg_CTor();
extern char* messenger_DataMsg_InputName_Get(long long int handle);
extern void messenger_DataMsg_InputName_Set(long long int handle, char* val);
extern char* messenger_DataMsg_Uid_Get(long long int handle);
extern void messenger_DataMsg_Uid_Set(long long int handle, char* val);
extern char* messenger_DataMsg_Source_Get(long long int handle);
extern void messenger_DataMsg_Source_Set(long long int handle, char* val);
extern long long int messenger_DataMsg_Data_Get(long long int handle);
extern void messenger_DataMsg_Data_Set(long long int handle, long long int val);
extern long long int messenger_DataMsg_Params_Get(long long int handle);
extern void messenger_DataMsg_Params_Set(long long int handle, long long int val);
extern char* messenger_DataMsg_ContentType_Get(long long int handle);
extern void messenger_DataMsg_ContentType_Set(long long int handle, char* val);

// --- wrapping slice: messenger.StringArray ---
//
extern long long int messenger_StringArray_CTor();
extern GoInt messenger_StringArray_len(long long int handle);
extern char* messenger_StringArray_elem(long long int handle, GoInt _idx);
extern long long int messenger_StringArray_subslice(long long int handle, GoInt _st, GoInt _ed);
extern void messenger_StringArray_set(long long int handle, GoInt _idx, char* _vl);
extern void messenger_StringArray_append(long long int handle, char* _vl);
extern long long int messenger_GetTest();
extern char* messenger_MessengerSendReply(char* dest, char* uid, char* source, long long int data, long long int parameters, char* content_type, char* err_str);
extern long long int messenger_MessengerGetMsgs(long long int timeout);
extern char* messenger_MessengerInit(long long int outputs, long long int inputs, char* nats_url, char* queue, long long int batch);
