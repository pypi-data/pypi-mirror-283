...
class FrameMixin(MovableMixin,                 # pylint: disable=abstract-method
                 SizeableMixin, ParameterMixin):
    """
...
class PanelMixin:                              # pylint: disable=abstract-method
    """
...
class ZoomMixin(CommandMixin):                 # pylint: disable=abstract-method
    """
    ...
    @rmi
    def zoom(self,                          # pylint: disable=too-many-arguments
...
class GraphFrame(ZComponent,    # pylint: disable=too-many-ancestors, too-many-public-methods
                 FrameMixin, PanelMixin, ZoomMixin, PreferencesMixin):
    """
...
class OverlayGraph(GraphPanel,  # pylint: disable=abstract-method, too-many-ancestors
...
class PolyGraph(GraphPanel, # pylint: disable=abstract-method, too-many-ancestors
                ZoomMixin, PreferencesMixin):
    """
    Polygraph
...
class PlotFrame(ZComponent, # pylint: disable=abstract-method, too-many-ancestors
                FrameMixin, ZoomMixin, PreferencesMixin):
    """
    X-Y Plot Frame
    ...
    @rmi
    def zoom(self,        # pylint: disable=too-many-arguments, arguments-differ
             xmin: Optional[float] = None, xmax: Optional[float] = None,
             ymin: Optional[float] = None, ymax: Optional[float] = None,
