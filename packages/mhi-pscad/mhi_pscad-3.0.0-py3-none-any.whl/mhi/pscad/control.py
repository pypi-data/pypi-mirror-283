...
class ControlFrame(ZComponent, FrameMixin): # pylint: disable=abstract-method, too-many-ancestors
    """
...
class Control(Component):  # pylint: disable=abstract-method, too-many-ancestors
    """
...
class Button(Control):     # pylint: disable=abstract-method, too-many-ancestors
    """
...
class Switch(Control):     # pylint: disable=abstract-method, too-many-ancestors
    """
...
class Selector(Control):   # pylint: disable=abstract-method, too-many-ancestors
    ...
    def position(self, position: int) -> None:
        ...
        """
        if not position in range(1, 10+1):
...
class Slider(Control):     # pylint: disable=abstract-method, too-many-ancestors
    """
