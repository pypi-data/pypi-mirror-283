...
def _form_parse(codecs, root):                 # pylint: disable=too-many-locals
...
class FormCodec:                       # pylint: disable=too-many-public-methods
    """
    ...
    def application(remote):        # pylint: disable=missing-function-docstring
        codec = FormCodec._load(remote, 'IDR_{}_SETTINGS_FORM',
                                'GRAPHICS', 'LICENSE')
        codec._coding['cl_use_advanced'] = _boolean_codec # pylint: disable=protected-access
        return codec

    @staticmethod
    def project(remote):            # pylint: disable=missing-function-docstring
        codec = FormCodec._load(remote, 'IDR_{}_OPTIONS', 'COMPILER')
        coding = codec._coding                # pylint: disable=protected-access
    ...
    def _load(remote, fmt, *args):
        ...
        for iid in args:
            ...
            try:
                res_id = RES_ID[name]
                xml = remote._pscad._xml(res_id) # pylint: disable=protected-access
