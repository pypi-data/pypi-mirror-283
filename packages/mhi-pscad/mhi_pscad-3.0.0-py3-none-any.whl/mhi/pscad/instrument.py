...
class Instrument(ZComponent, FrameMixin):   # pylint: disable=too-many-ancestors, abstract-method
    """
...
class PolyMeter(Instrument):    # pylint: disable=too-many-ancestors, abstract-method
    """
...
class PhasorMeter(Instrument):  # pylint: disable=too-many-ancestors, abstract-method
    """
...
class Oscilloscope(Instrument): # pylint: disable=too-many-ancestors, abstract-method
