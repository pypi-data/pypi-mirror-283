...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    2,
    '',
    'com/terraquantum/invitation/v1/invitation/created_invitation_token.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CREATEDINVITATIONTOKENPROTO'].fields_by_name['token']._loaded_options = None
