...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    2,
    '',
    'com/terraquantum/invitation/v1/invitation/get_valid_invitation_request.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GETVALIDINVITATIONREQUEST'].fields_by_name['invitation_token']._loaded_options = None
