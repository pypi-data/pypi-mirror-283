...
class Client:
    ...
    def create(
        self, name, *, cpu_count=None, ram_size=None, disk_size=None, iso_path=None, iso_connected=True, mac=None, efi=False
    ):
        ...
        vmx = VMX(vmx_file)
        vmx.generate(cpu_count=cpu_count, ram_mb=ram_size, vmdk_pathname=str(host_vmdk_path), efi=efi)
