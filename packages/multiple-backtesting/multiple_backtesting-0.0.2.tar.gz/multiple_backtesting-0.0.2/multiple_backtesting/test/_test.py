...
from multiple_backtesting import Backtest, Strategy
from multiple_backtesting._stats import compute_drawdown_duration_peaks
from multiple_backtesting._util import _Array, _as_str, _Indicator, try_
from multiple_backtesting.lib import (
    OHLCV_AGG,
    SignalStrategy,
    TrailingStrategy,
    barssince,
...
from multiple_backtesting.test import EURUSD, GOOG, SMA
...
class TestPlot(TestCase):
    ...
    def test_resample(self):
        bt = Backtest(GOOG, SmaCross)
        bt.run()
        import multiple_backtesting._plotting
        with _tempfile() as f,\
                patch.object(multiple_backtesting._plotting, '_MAX_CANDLES', 10),\
