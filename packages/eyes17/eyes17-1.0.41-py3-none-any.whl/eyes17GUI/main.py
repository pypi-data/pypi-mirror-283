...
if 'Windows' in pf:
    ...
    import sr04dist, utils, logger, XYplot, i2cLogger, tof, advanced_logger, advanced_logger_pe, blockcoding, circuitjs, multiplexedlogger, \
        single_channel_logger, thermoelectric
    import BHCurve, BHCurveHMC, android_quiz
...
QT_TRANSLATE_NOOP('MainWindow', 'Android App Quiz')
...
otherExpts = [
    ...
    [QT_TRANSLATE_NOOP('MainWindow', 'Thermoelectric effect, (ADS1115 and PT1000)'), ('7.8', 'thermoelectric')],
...
class MainWindow(QMainWindow):
    ...
    def makeMenu(self):
        ...
        mb.addAction(self.tr('Android App Quiz'), lambda item=('2.100', 'android_quiz'): self.callExpt(item))
...
You can customize the way they are used to build the path."""
    ...
    def reconnect(self, **kwargs):
        ...
        if p != None:
            ...
            if self.expName in [('3.1', 'scope'),('3.16', 'data_logger'),('7.3', 'advanced_logger'),('7.4', 'blockcoding'),('8.4', 'i2cLogger')]:
