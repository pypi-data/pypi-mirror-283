...
class MutateApp:
    ...
    def write_report_file(self, original_result: MutantJobWithResults,
        ...
        try:
            valid_rule_names.remove(ENV_FREE_CHECK)
        except ValueError:
            mutation_logger.warning(f"{ENV_FREE_CHECK} was not found in rule list")
            pass  # Currently we expect to see the env free check, but this is not an error
