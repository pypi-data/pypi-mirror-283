...
def ConfigToNumElectrons(config, ignoreFullD = 0, ignoreFullF = 0):
    ...
    """
def GetAtomicData(atomDict, descriptorsDesired, dBase = '/private/var/folders/4_/xyjwmyz1497g3qhhndg003800000gn/T/cirrus-ci-build/build/temp.macosx-11.0-arm64-cpython-310/rdkit_install/share/RDKit/Data/atomdb.gdb', table = 'atomic_data', where = '', user = 'sysdba', password = 'masterkey', includeElCounts = 0):
    """
...
def SplitComposition(compStr):
    ...
    """
_atomDbName: str = '/private/var/folders/4_/xyjwmyz1497g3qhhndg003800000gn/T/cirrus-ci-build/build/temp.macosx-11.0-arm64-cpython-310/rdkit_install/share/RDKit/Data/atomdb.gdb'
