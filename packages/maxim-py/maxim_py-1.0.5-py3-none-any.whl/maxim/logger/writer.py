...
class LogWriterConfig:
    def __init__(self, base_url, api_key, repository_id, auto_flush=True, flush_interval: Union[int, None] = 10, is_debug=False):
...
class LogWriter:
    ...
    def flush_logs(self, logs):
        try:
            ...
            print(f"[MaximSDK] Failed to push logs to server. Writing logs to file. Error: {e}")
