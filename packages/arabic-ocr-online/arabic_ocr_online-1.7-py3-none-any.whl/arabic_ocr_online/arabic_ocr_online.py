...
def ocring(image_url, out_image_path):
    ...
    # Use the model directory inside the Docker container
    model_directory = "/app/easyocr_model"
    reader = Reader(langs, gpu=True, download_enabled=False, model_storage_directory=model_directory)
