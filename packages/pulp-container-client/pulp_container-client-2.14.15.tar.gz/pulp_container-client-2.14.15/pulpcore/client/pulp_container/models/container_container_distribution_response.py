...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, repository=None, name=None, pulp_labels=None, pulp_created=None, base_path=None, content_guard=None, repository_version=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
