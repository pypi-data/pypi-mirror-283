...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_href=None, retain_repo_versions=None, latest_version_href=None, description=None, name=None, pulp_labels=None, manifest_signing_service=None, versions_href=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
