...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, content_guard=None, name=None, hidden=False, base_path=None, pulp_labels=None, repository=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
