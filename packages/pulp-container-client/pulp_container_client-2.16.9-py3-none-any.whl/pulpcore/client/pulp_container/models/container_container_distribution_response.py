...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, pulp_created=None, pulp_href=None, name=None, hidden=False, base_path=None, pulp_labels=None, repository=None, repository_version=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
