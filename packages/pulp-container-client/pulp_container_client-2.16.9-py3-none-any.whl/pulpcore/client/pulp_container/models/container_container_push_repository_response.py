...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, description=None, retain_repo_versions=None, pulp_created=None, pulp_href=None, name=None, versions_href=None, manifest_signing_service=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
