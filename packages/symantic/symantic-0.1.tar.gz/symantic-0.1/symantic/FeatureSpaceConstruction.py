...
class feature_space_construction:
  ...
  def feature_space(self):
    ...
    if self.no_of_operators !=None and self.no_of_operators+1 > 9: 
        ...
        if response == 'no': 
            sys.exit('************************************************ Exiting the run based on the user preference !!!!!!!!!!!!!!! ************************************************')
    ...
    if self.no_of_operators == None:
        ...
        rmse1, equation1,r21 =  sr.Regressor(self.df_feature_values,self.Target_column,self.columns,self.dimension,self.sis_features,self.device,metrics = self.metrics).regressor_fit()
        ...
        while True:
            ...
            rmse, equation,r2 =  sr.Regressor(self.df_feature_values,self.Target_column,self.columns,self.dimension,self.sis_features,self.device,metrics = self.metrics).regressor_fit()
