...
class feature_space_construction:
    ...
    def feature_expansion(self):
        ...
        if self.no_of_operators == None:
            ...
            rmse,equation,r2 = srd.Regressor(self.df_feature_values,self.Target_column,self.feature_names,self.dimensionality,self.dimension,self.sis_features,self.device,self.output_dim,metrics=self.metrics).regressor_fit()
