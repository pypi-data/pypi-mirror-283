...
data = {
 ...
 'OGEABES': {'abbrev': 'OGEABES',
             'extra': ['eilanden'],
             'name': 'Gerecht in eerste aanleg van Bonaire, Sint Eustatius en '
                     'Saba'},
 'OGEAC': {'abbrev': 'OGEAC',
           'extra': ['eilanden'],
