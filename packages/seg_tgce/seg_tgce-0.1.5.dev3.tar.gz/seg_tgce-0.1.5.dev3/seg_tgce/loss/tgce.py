...
class TcgeSs(Loss):  # type: ignore
    ...
    def call(self, y_true: tf.Tensor, y_pred: tf.Tensor) -> tf.Tensor:
        ...
        num_elements_y_true = tf.reduce_prod(y_true_shape)
        num_elements_new_shape = tf.reduce_prod(new_shape)
        print(f"Number of elements in y_true: {num_elements_y_true}")
        print(f"Number of elements in new shape: {num_elements_new_shape}")
