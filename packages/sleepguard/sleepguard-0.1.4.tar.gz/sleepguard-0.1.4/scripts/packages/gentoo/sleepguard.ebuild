...
DESCRIPTION="Keep the system awake if significant system activity is detected."
...
# a dependency.
RDEPEND="dev-lang/python:3.12 dev-python/virtualenv"
...
src_compile() {
  ...
  # Install PyInstaller using pip in virtual environment
  pip install pyinstaller || die

  # Run PyInstaller with your main Python script
  pyinstaller --onefile "${S}/src/sleepguard/guard.py" || die
}
