...
class GeometryMixin(object):
    ...
    def view_shapes(shapes: List[Union[LineString, Polygon, MultiPolygon, MultiLineString]],
        ...
        check_str(name='color_palette', value=color_palette, options=Options.PALETTE_OPTIONS_CATEGORICAL.value)
    ...
    def adjust_geometry_locations(geometries: List[Polygon],
        ...
        if pixels_per_mm is not None:
            ...
            shift = (max(0, int(shift[0] / pixels_per_mm)), max(int(shift[1] / pixels_per_mm)))
        results = []
