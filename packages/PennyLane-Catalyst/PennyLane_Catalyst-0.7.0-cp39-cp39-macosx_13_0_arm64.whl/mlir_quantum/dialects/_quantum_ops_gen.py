...
def adjoint(out_qreg, qreg, *, loc=None, ip=None) -> _SubClassValueT:
...
def alloc(qreg, *, nqubits=None, nqubits_attr=None, loc=None, ip=None) -> _SubClassValueT:
...
def compbasis(obs, qubits, *, loc=None, ip=None) -> _SubClassValueT:
...
def counts(eigvals, counts, obs, shots, *, in_eigvals=None, in_counts=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def custom(out_qubits, out_ctrl_qubits, params, in_qubits, gate_name, in_ctrl_qubits, in_ctrl_values, *, adjoint=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def expval(expval, obs, *, shots=None, loc=None, ip=None) -> _SubClassValueT:
...
def extract(qubit, qreg, *, idx=None, idx_attr=None, loc=None, ip=None) -> _SubClassValueT:
...
def gphase(out_ctrl_qubits, params, in_ctrl_qubits, in_ctrl_values, *, adjoint=None, loc=None, ip=None) -> _SubClassValueT:
...
def hamiltonian(obs, coeffs, terms, *, loc=None, ip=None) -> _SubClassValueT:
...
def hermitian(obs, matrix, qubits, *, loc=None, ip=None) -> _SubClassValueT:
...
def insert(out_qreg, in_qreg, qubit, *, idx=None, idx_attr=None, loc=None, ip=None) -> _SubClassValueT:
...
class MeasureOp(_ods_ir.OpView):
  ...
  def __init__(self, mres, out_qubit, in_qubit, *, postselect=None, loc=None, ip=None):
    ...
    if postselect is not None: attributes["postselect"] = (postselect if (
        issubclass(type(postselect), _ods_ir.Attribute) or
...
def measure(mres, out_qubit, in_qubit, *, postselect=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def multirz(out_qubits, out_ctrl_qubits, theta, in_qubits, in_ctrl_qubits, in_ctrl_values, *, adjoint=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def namedobs(obs, qubit, type_, *, loc=None, ip=None) -> _SubClassValueT:
...
def probs(probabilities, obs, *, state_in=None, loc=None, ip=None) -> _SubClassValueT:
...
def unitary(out_qubits, out_ctrl_qubits, matrix, in_qubits, in_ctrl_qubits, in_ctrl_values, *, adjoint=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def sample(samples, obs, shots, *, in_data=None, loc=None, ip=None) -> _SubClassValueT:
...
def state(state, obs, *, state_in=None, loc=None, ip=None) -> _SubClassValueT:
...
def tensor(obs, terms, *, loc=None, ip=None) -> _SubClassValueT:
...
def var(variance, obs, *, shots=None, loc=None, ip=None) -> _SubClassValueT:
