...
class ZneOp(_ods_ir.OpView):
  ...
  def __init__(self, result, callee, args, scaleFactors, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.extend(_get_op_results_or_values(args))
    operands.append(_get_op_result_or_value(scaleFactors))
...
def zne(result, callee, args, scale_factors, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ZneOp(result=result, callee=callee, args=args, scaleFactors=scale_factors, loc=loc, ip=ip))
