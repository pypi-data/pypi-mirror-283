...
class BackpropOp(_ods_ir.OpView):
  ...
  def __init__(self, vals, gradients, callee, args, diffArgShadows, calleeResults, cotangents, *, diffArgIndices=None, keepValueResults=None, loc=None, ip=None):
    ...
    if keepValueResults is not None: attributes["keepValueResults"] = (keepValueResults if (
        issubclass(type(keepValueResults), _ods_ir.Attribute) or
...
def backprop(vals, gradients, callee, args, diff_arg_shadows, callee_results, cotangents, *, diff_arg_indices=None, keep_value_results=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
class ReturnOp(_ods_ir.OpView):
  ...
  def __init__(self, tape, empty, *, loc=None, ip=None):
    ...
    issubclass(type(empty), _ods_ir.Attribute) or
...
def value_and_grad(vals, gradients, method, callee, operands_, *, diff_arg_indices=None, finite_diff_param=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
