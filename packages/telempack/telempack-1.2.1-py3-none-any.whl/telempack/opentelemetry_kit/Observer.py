...
class Observer:
    ...
    def mount_telemetry(self, app):
        ...
        if self.resource_data.export_endpoint == 'console':
        ...
        if self.resource_data.export_endpoint == 'console':
            ...
            metrics.set_meter_provider(MeterProvider([PeriodicExportingMetricReader(console_metric_exporter)], resource=otel_resource))
        else:
