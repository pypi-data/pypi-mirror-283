...
class DefaultApi(object):
    ...
    def add_stream_job_submission_with_http_info(self, client_id, **kwargs):  # noqa: E501
        ...
        all_params = ['client_id', 'submit_to_flink', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'client_id' in local_var_params:
            query_params.append(('client_id', local_var_params['client_id']))  # noqa: E501
        if 'submit_to_flink' in local_var_params:
            query_params.append(('submit_to_flink', local_var_params['submit_to_flink']))  # noqa: E501
