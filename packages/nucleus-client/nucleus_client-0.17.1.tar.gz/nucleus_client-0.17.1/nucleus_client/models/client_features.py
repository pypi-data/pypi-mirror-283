...
class ClientFeatures(object):
    ...
    def __init__(self, admin_api_keys=None, admin_glossary=None, admin_goals=None, admin_user_self=None, admin_users=None, data_overview=None, data_tables=None, dataset_download=None, dataset_metadata_editor=None, dataset_upload=None, filters=None, glossary=None, help_button=None, logout=None, nav=None, page_editor=None, print_button=None, save_prefs=None, sql_query=None, sso=None, user_roles=None, user_survey=None, view_admin_page=None, view_data_overview_details=None):  # noqa: E501
