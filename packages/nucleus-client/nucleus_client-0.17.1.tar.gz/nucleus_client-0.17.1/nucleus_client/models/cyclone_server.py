...
class CycloneServer(object):
    ...
    def __init__(self, id=None, description=None, disabled_wait_secs=None, dt_u=None, enable_log_requests=None, error_wait_secs=None, etl_settings=None, last_request=None, location=None, log_retention_days=None, max_clients=None, name=None, ping_delay_seconds=None, require_encryption=None, service_id=None, settings_wait_secs=None, status=None, status_dt_u=None, update_at=None, version=None):  # noqa: E501
