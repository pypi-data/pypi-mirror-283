...
class ClientSso(object):
    ...
    openapi_types = {
        ...
        'claims': 'list[str]',
        'client_id': 'str',
        'custom_auth_url_params': 'dict(str, object)',
        'custom_token_url_params': 'dict(str, object)',
        'id_issuer': 'str',
        'id_token_alg': 'str',
        'id_token_jwks_url': 'str',
    ...
    attribute_map = {
        ...
        'claims': 'claims',
        'client_id': 'client_id',
        'custom_auth_url_params': 'custom_auth_url_params',
        'custom_token_url_params': 'custom_token_url_params',
        'id_issuer': 'id_issuer',
        'id_token_alg': 'id_token_alg',
        'id_token_jwks_url': 'id_token_jwks_url',
    ...
    def __init__(self, auth_code_url=None, claims=None, client_id=None, custom_auth_url_params=None, custom_token_url_params=None, id_issuer=None, id_token_alg=None, id_token_jwks_url=None, id_token_key_type=None, id_token_rsa_key=None, prompt=None, redirect_uri=None, role_template=None, secret=None, token_authentication_method=None, token_exchange_url=None, token_fields=None, token_headers=None, token_request_values_in_url=None, type=None, user_info_url=None):  # noqa: E501
        """ClientSso - a model defined in OpenAPI"""  # noqa: E501

        self._auth_code_url = None
        self._claims = None
        self._client_id = None
        self._custom_auth_url_params = None
        self._custom_token_url_params = None
        self._id_issuer = None
        self._id_token_alg = None
        self._id_token_jwks_url = None
        ...
        if custom_auth_url_params is not None:
            self.custom_auth_url_params = custom_auth_url_params
        if custom_token_url_params is not None:
            self.custom_token_url_params = custom_token_url_params
        if id_issuer is not None:
            self.id_issuer = id_issuer
        if id_token_alg is not None:
            self.id_token_alg = id_token_alg
        if id_token_jwks_url is not None:
            self.id_token_jwks_url = id_token_jwks_url
    ...
    @property
    def custom_auth_url_params(self):
        """Gets the custom_auth_url_params of this ClientSso.  # noqa: E501


        :return: The custom_auth_url_params of this ClientSso.  # noqa: E501
        :rtype: dict(str, object)
        """
        return self._custom_auth_url_params

    @custom_auth_url_params.setter
    def custom_auth_url_params(self, custom_auth_url_params):
        """Sets the custom_auth_url_params of this ClientSso.


        :param custom_auth_url_params: The custom_auth_url_params of this ClientSso.  # noqa: E501
        :type: dict(str, object)
        """

        self._custom_auth_url_params = custom_auth_url_params

    @property
    def custom_token_url_params(self):
        """Gets the custom_token_url_params of this ClientSso.  # noqa: E501


        :return: The custom_token_url_params of this ClientSso.  # noqa: E501
        :rtype: dict(str, object)
        """
        return self._custom_token_url_params

    @custom_token_url_params.setter
    def custom_token_url_params(self, custom_token_url_params):
        """Sets the custom_token_url_params of this ClientSso.


        :param custom_token_url_params: The custom_token_url_params of this ClientSso.  # noqa: E501
        :type: dict(str, object)
        """

        self._custom_token_url_params = custom_token_url_params
    ...
    @property
    def id_token_jwks_url(self):
        """Gets the id_token_jwks_url of this ClientSso.  # noqa: E501


        :return: The id_token_jwks_url of this ClientSso.  # noqa: E501
        :rtype: str
        """
        return self._id_token_jwks_url

    @id_token_jwks_url.setter
    def id_token_jwks_url(self, id_token_jwks_url):
        """Sets the id_token_jwks_url of this ClientSso.


        :param id_token_jwks_url: The id_token_jwks_url of this ClientSso.  # noqa: E501
        :type: str
        """

        self._id_token_jwks_url = id_token_jwks_url
    ...
    def role_template(self):
        """Gets the role_template of this ClientSso.  # noqa: E501


        :return: The role_template of this ClientSso.  # noqa: E501
        :rtype: dict(str, object)
        """
    ...
    def role_template(self, role_template):
        """Sets the role_template of this ClientSso.


        :param role_template: The role_template of this ClientSso.  # noqa: E501
        :type: dict(str, object)
        """
    ...
    def token_headers(self):
        """Gets the token_headers of this ClientSso.  # noqa: E501


        :return: The token_headers of this ClientSso.  # noqa: E501
        :rtype: dict(str, object)
        """
        return self._token_headers

    @token_headers.setter
    def token_headers(self, token_headers):
        """Sets the token_headers of this ClientSso.


        :param token_headers: The token_headers of this ClientSso.  # noqa: E501
        :type: dict(str, object)
        """
