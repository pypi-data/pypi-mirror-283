...
from vision_oslo_extension.main_page_frame import PageOne, PageTwo, PageThree, PageFour, PageFive
...
class StartPage(BasePage): # define another object of first page
    ...
    def __init__(self, parent, controller):
        ...
        self.optionframe = self.create_frame(fill=tk.BOTH, row_weights=(1, 1, 1, 1, 1), column_weights=(4, 1))
        ...
        explain5 = tk.Label(master=self.optionframe, text = 'Addtional Support: e.g. BEMU',font = controller.text_font)
        explain5.grid(row = 4, column = 0, sticky = "w", padx=5, pady=5)  

        button5 = tk.Button(master=self.optionframe, text = 'Add Support', command=lambda: self.button_callback("PageFive"))
