...
class Sessions(BaseSDK):
    ...
    def list(
        ...
        status: Optional[models.GetSessionListQueryParamStatus] = None,
        ...
        **Deprecation Notice (2024-01-01):** All parameters were initially considered optional, however
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="GetSessionList", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                out = utils.unmarshal_json(http_res.text, Optional[List[models.Session]])
                return out
    ...
    def get(
        ...
        if http_res.status_code == 200:
            # pylint: disable=no-else-return
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                out = utils.unmarshal_json(http_res.text, Optional[models.Session])
                return out
    ...
    def revoke(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="RevokeSession", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["400","401","404","4XX","5XX"],
        )
    ...
    def create_token_from_template(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="CreateSessionTokenFromTemplate", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if http_res.status_code == 200:
            # pylint: disable=no-else-return
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                out = utils.unmarshal_json(http_res.text, Optional[models.CreateSessionTokenFromTemplateResponseBody])
                return out
    ...
    def verify(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="VerifySession", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if http_res.status_code == 200:
            ...
            content_type = http_res.headers.get("Content-Type")
            raise models.SDKError(f"unknown content-type received: {content_type}", http_res.status_code, http_res.text, http_res)
        elif http_res.status_code in [400, 401, 404, 410]:
            # pylint: disable=no-else-return
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                data = utils.unmarshal_json(http_res.text, models.ClerkErrorsData)
                out = models.ClerkErrors(data=data)
