...
class GetSessionListQueryParamStatus(str, Enum):
...
class GetSessionListRequestTypedDict(TypedDict):
    ...
    status: NotRequired[GetSessionListQueryParamStatus]
    r"""Filter sessions by the provided status"""
...
class GetSessionListRequest(BaseModel):
    ...
    r"""List sessions for the given user"""
    status: Annotated[Optional[GetSessionListQueryParamStatus], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = None
    r"""Filter sessions by the provided status"""
