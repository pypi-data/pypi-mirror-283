...
class PreviewTemplateRequestBody(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["body", "from_email_name", "reply_to_email_name", "subject"]
...
class PreviewTemplateRequest(BaseModel):
    template_type: Annotated[str, FieldMetadata(path=PathParamMetadata(style="simple", explode=False))]
    r"""The type of template to preview"""
    slug: Annotated[str, FieldMetadata(path=PathParamMetadata(style="simple", explode=False))]
    r"""The slug of the template to preview"""
    request_body: Annotated[Optional[PreviewTemplateRequestBody], FieldMetadata(request=RequestMetadata(media_type="application/json"))] = None
    r"""Required parameters"""
