...
from clerk_dev.utils import FieldMetadata, MultipartFormMetadata, PathParamMetadata, RequestMetadata
import io
import pydantic
...
class SetUserProfileImageFileTypedDict(TypedDict):
    file_name: str
    content: Union[bytes, IO[bytes], io.BufferedReader]
    content_type: NotRequired[str]
    

class SetUserProfileImageFile(BaseModel):
...
class SetUserProfileImageRequestBodyTypedDict(TypedDict):
    file: NotRequired[SetUserProfileImageFileTypedDict]
    

class SetUserProfileImageRequestBody(BaseModel):
    file: Annotated[Optional[SetUserProfileImageFile], pydantic.Field(alias=""), FieldMetadata(multipart=MultipartFormMetadata(file=True))] = None
