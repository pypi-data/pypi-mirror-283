...
class UpdateUserRequestBody(BaseModel):
    ...
    * Algorithm: SHA1
    ...
    def serialize_model(self, handler):
        optional_fields = ["backup_codes", "create_organization_enabled", "created_at", "delete_self_enabled", "external_id", "first_name", "last_name", "notify_primary_email_address_changed", "password", "password_digest", "password_hasher", "primary_email_address_id", "primary_phone_number_id", "primary_web3_wallet_id", "private_metadata", "profile_image_id", "public_metadata", "sign_out_of_other_sessions", "skip_password_checks", "totp_secret", "unsafe_metadata", "username"]
        nullable_fields = ["create_organization_enabled", "delete_self_enabled", "external_id", "first_name", "last_name", "password", "profile_image_id", "sign_out_of_other_sessions", "skip_password_checks", "username"]
        null_default_fields = []
