...
class Users(BaseSDK):
    ...
    def list(
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                out = utils.unmarshal_json(http_res.text, Optional[List[models.User]])
                return out
    ...
    def create(
        ...
        request = models.CreateUserRequestBody(
            ...
            phone_number=phone_number,
            private_metadata=utils.unmarshal(private_metadata, models.CreateUserPrivateMetadata) if not isinstance(private_metadata, BaseModel) and private_metadata is not None else private_metadata,
            public_metadata=utils.unmarshal(public_metadata, models.CreateUserPublicMetadata) if not isinstance(public_metadata, BaseModel) and public_metadata is not None else public_metadata,
            skip_password_checks=skip_password_checks,
            skip_password_requirement=skip_password_requirement,
            totp_secret=totp_secret,
            unsafe_metadata=utils.unmarshal(unsafe_metadata, models.CreateUserUnsafeMetadata) if not isinstance(unsafe_metadata, BaseModel) and unsafe_metadata is not None else unsafe_metadata,
            username=username,
            web3_wallet=web3_wallet,
        )
        ...
        if http_res.status_code == 200:
            # pylint: disable=no-else-return
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                out = utils.unmarshal_json(http_res.text, Optional[models.User])
                return out
    ...
    def update(
        ...
        request = models.UpdateUserRequest(
            ...
            request_body=models.UpdateUserRequestBody(
                ...
                private_metadata=utils.unmarshal(private_metadata, models.UpdateUserPrivateMetadata) if not isinstance(private_metadata, BaseModel) and private_metadata is not None else private_metadata,
                profile_image_id=profile_image_id,
                public_metadata=utils.unmarshal(public_metadata, models.UpdateUserPublicMetadata) if not isinstance(public_metadata, BaseModel) and public_metadata is not None else public_metadata,
                sign_out_of_other_sessions=sign_out_of_other_sessions,
                skip_password_checks=skip_password_checks,
                totp_secret=totp_secret,
                unsafe_metadata=utils.unmarshal(unsafe_metadata, models.UpdateUserUnsafeMetadata) if not isinstance(unsafe_metadata, BaseModel) and unsafe_metadata is not None else unsafe_metadata,
                username=username,
            ),
        )
    ...
    def update_metadata(
        self, *,
        user_id: str,
        private_metadata: Optional[Union[models.UpdateUserMetadataPrivateMetadata, models.UpdateUserMetadataPrivateMetadataTypedDict]] = None,
        public_metadata: Optional[Dict[str, Any]] = None,
        unsafe_metadata: Optional[Union[models.UpdateUserMetadataUnsafeMetadata, models.UpdateUserMetadataUnsafeMetadataTypedDict]] = None,
        server_url: Optional[str] = None,
    ) -> models.User:
        ...
        request = models.UpdateUserMetadataRequest(
            ...
            request_body=models.UpdateUserMetadataRequestBody(
                private_metadata=utils.unmarshal(private_metadata, models.UpdateUserMetadataPrivateMetadata) if not isinstance(private_metadata, BaseModel) and private_metadata is not None else private_metadata,
                public_metadata=public_metadata,
                unsafe_metadata=utils.unmarshal(unsafe_metadata, models.UpdateUserMetadataUnsafeMetadata) if not isinstance(unsafe_metadata, BaseModel) and unsafe_metadata is not None else unsafe_metadata,
            ),
        )
    ...
    def disable_mfa(
        ...
        if http_res.status_code == 200:
            # pylint: disable=no-else-return
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                out = utils.unmarshal_json(http_res.text, Optional[models.DisableMFAResponseBody])
                return out
    ...
    def get_o_auth_access_token(
        ...
        if http_res.status_code == 200:
            # pylint: disable=no-else-return
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                out = utils.unmarshal_json(http_res.text, Optional[List[models.ResponseBody]])
                return out
    ...
    def get_organization_memberships(
        ...
        res = models.UsersGetOrganizationMembershipsResponse(result=None, next=next_func)
        
        if http_res.status_code == 200:
            # pylint: disable=no-else-return
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                out = utils.unmarshal_json(http_res.text, Optional[models.OrganizationMemberships])
                res.result = out
            else:
                content_type = http_res.headers.get("Content-Type")
                raise models.SDKError(f"unknown content-type received: {content_type}", http_res.status_code, http_res.text, http_res)
    ...
    def set_profile_image(
        self, *,
        user_id: str,
        file: Optional[Union[models.SetUserProfileImageFile, models.SetUserProfileImageFileTypedDict]] = None,
        server_url: Optional[str] = None,
    ) -> models.User:
        ...
        request = models.SetUserProfileImageRequest(
            ...
            request_body=models.SetUserProfileImageRequestBody(
                file=utils.unmarshal(file, models.SetUserProfileImageFile) if not isinstance(file, BaseModel) and file is not None else file,
            ),
        )
    ...
    def verify_password(
        ...
        if http_res.status_code == 200:
            # pylint: disable=no-else-return
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                out = utils.unmarshal_json(http_res.text, Optional[models.VerifyPasswordResponseBody])
                return out
            
            content_type = http_res.headers.get("Content-Type")
            raise models.SDKError(f"unknown content-type received: {content_type}", http_res.status_code, http_res.text, http_res)
        elif http_res.status_code == 400 or http_res.status_code == 404 or http_res.status_code == 422 or http_res.status_code >= 400 and http_res.status_code < 500 or http_res.status_code >= 500 and http_res.status_code < 600:
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
    ...
    def verify_totp(
        ...
        if http_res.status_code == 200:
            # pylint: disable=no-else-return
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                out = utils.unmarshal_json(http_res.text, Optional[models.VerifyTOTPResponseBody])
                return out
    ...
    def count(
        ...
        if http_res.status_code == 200:
            # pylint: disable=no-else-return
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                out = utils.unmarshal_json(http_res.text, Optional[models.TotalCount])
                return out
