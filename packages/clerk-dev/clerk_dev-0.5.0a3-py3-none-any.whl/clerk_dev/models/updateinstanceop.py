...
class UpdateInstanceRequestBody(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["allowed_origins", "clerk_js_version", "cookieless_dev", "development_origin", "enhanced_email_deliverability", "hibp", "support_email", "test_mode", "url_based_session_syncing"]
        nullable_fields = ["clerk_js_version", "development_origin", "enhanced_email_deliverability", "hibp", "support_email", "test_mode"]
        null_default_fields = []
