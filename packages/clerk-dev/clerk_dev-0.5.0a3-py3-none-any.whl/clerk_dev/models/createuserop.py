...
class CreateUserRequestBody(BaseModel):
    ...
    * Algorithm: SHA1
    ...
    def serialize_model(self, handler):
        optional_fields = ["backup_codes", "created_at", "email_address", "external_id", "first_name", "last_name", "password", "password_digest", "password_hasher", "phone_number", "private_metadata", "public_metadata", "skip_password_checks", "skip_password_requirement", "totp_secret", "unsafe_metadata", "username", "web3_wallet"]
        nullable_fields = ["external_id", "first_name", "last_name", "password", "username"]
        null_default_fields = []
