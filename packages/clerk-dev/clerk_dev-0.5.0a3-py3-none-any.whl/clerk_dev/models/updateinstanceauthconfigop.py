...
class UpdateInstanceAuthConfigRequestBody(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["enhanced_email_deliverability", "from_email_address", "progressive_sign_up", "restricted_to_allowlist", "session_token_template", "test_mode"]
        nullable_fields = ["enhanced_email_deliverability", "from_email_address", "progressive_sign_up", "restricted_to_allowlist", "session_token_template", "test_mode"]
        null_default_fields = []
