...
class OrganizationsSDK(BaseSDK):
    ...
    def list(
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                out = utils.unmarshal_json(http_res.text, Optional[models.Organizations])
                return out
    ...
    def create(
        ...
        private_metadata: Optional[Union[models.CreateOrganizationPrivateMetadata, models.CreateOrganizationPrivateMetadataTypedDict]] = None,
        public_metadata: Optional[Union[models.CreateOrganizationPublicMetadata, models.CreateOrganizationPublicMetadataTypedDict]] = None,
        ...
        request = models.CreateOrganizationRequestBody(
            ...
            name=name,
            private_metadata=utils.unmarshal(private_metadata, models.CreateOrganizationPrivateMetadata) if not isinstance(private_metadata, BaseModel) and private_metadata is not None else private_metadata,
            public_metadata=utils.unmarshal(public_metadata, models.CreateOrganizationPublicMetadata) if not isinstance(public_metadata, BaseModel) and public_metadata is not None else public_metadata,
            slug=slug,
        )
        ...
        if http_res.status_code == 200:
            # pylint: disable=no-else-return
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                out = utils.unmarshal_json(http_res.text, Optional[models.Organization])
                return out
    ...
    def update(
        ...
        request = models.UpdateOrganizationRequest(
            ...
            request_body=models.UpdateOrganizationRequestBody(
                ...
                max_allowed_memberships=max_allowed_memberships,
                name=name,
                private_metadata=utils.unmarshal(private_metadata, models.UpdateOrganizationPrivateMetadata) if not isinstance(private_metadata, BaseModel) and private_metadata is not None else private_metadata,
                public_metadata=utils.unmarshal(public_metadata, models.UpdateOrganizationPublicMetadata) if not isinstance(public_metadata, BaseModel) and public_metadata is not None else public_metadata,
                slug=slug,
            ),
        )
    ...
    def upload_logo(
        ...
        if http_res.status_code == 200:
            # pylint: disable=no-else-return
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                out = utils.unmarshal_json(http_res.text, Optional[models.OrganizationWithLogo])
                return out
            
            content_type = http_res.headers.get("Content-Type")
            raise models.SDKError(f"unknown content-type received: {content_type}", http_res.status_code, http_res.text, http_res)
        elif http_res.status_code in [400, 403, 404, 413]:
            # pylint: disable=no-else-return
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                data = utils.unmarshal_json(http_res.text, models.ClerkErrorsData)
                out = models.ClerkErrors(data=data)
    ...
    def merge_metadata(
        ...
        request = models.MergeOrganizationMetadataRequest(
            ...
            request_body=models.MergeOrganizationMetadataRequestBody(
                private_metadata=utils.unmarshal(private_metadata, models.MergeOrganizationMetadataPrivateMetadata) if not isinstance(private_metadata, BaseModel) and private_metadata is not None else private_metadata,
                public_metadata=utils.unmarshal(public_metadata, models.MergeOrganizationMetadataPublicMetadata) if not isinstance(public_metadata, BaseModel) and public_metadata is not None else public_metadata,
            ),
        )
