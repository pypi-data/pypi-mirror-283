...
class SignUps(BaseSDK):
    ...
    def update(
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(request.request_body, False, True, "json", Optional[models.UpdateSignUpRequestBody]),
        )
        
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="UpdateSignUp", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(http_res.headers.get("Content-Type") or "", "application/json"):                
                out = utils.unmarshal_json(http_res.text, Optional[models.SignUp])
                return out
