...
setup(
  ...
  description='The module implements functions for working with the API of the Cropwise Operations digital management platform.',
  ...
  install_requires=['requests','pandas','shapely','xml','simplekml'],
  classifiers=[
