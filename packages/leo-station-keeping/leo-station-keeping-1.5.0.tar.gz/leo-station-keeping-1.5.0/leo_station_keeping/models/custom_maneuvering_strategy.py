...
class CustomManeuveringStrategy(BaseModel):
    ...
    thrust_arc_mean_longitude_argument: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="If <b>thrustArcsPosition</b> is set to <b>MEAN_LONGITUDE</b>, the mean longitude of the center of the arc ", alias="thrustArcMeanLongitudeArgument")
