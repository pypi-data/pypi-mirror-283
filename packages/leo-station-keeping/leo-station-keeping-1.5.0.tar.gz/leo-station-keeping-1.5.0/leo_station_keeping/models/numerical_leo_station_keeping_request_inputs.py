...
class NumericalLeoStationKeepingRequestInputs(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["missionDateTime", "initialDate", "maximumDuration", "initialOrbit", "spacecraftGeometry", "platform", "propulsionSystem", "perturbations", "tolerance", "customManeuveringStrategy"]
