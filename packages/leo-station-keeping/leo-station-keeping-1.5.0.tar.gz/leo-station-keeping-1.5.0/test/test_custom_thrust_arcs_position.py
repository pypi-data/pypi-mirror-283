...
class TestCustomThrustArcsPosition(unittest.TestCase):
    """CustomThrustArcsPosition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomThrustArcsPosition:
        """Test CustomThrustArcsPosition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomThrustArcsPosition`
        """
        model = CustomThrustArcsPosition()
        if include_optional:
    ...
    def testCustomThrustArcsPosition(self):
        """Test CustomThrustArcsPosition"""
