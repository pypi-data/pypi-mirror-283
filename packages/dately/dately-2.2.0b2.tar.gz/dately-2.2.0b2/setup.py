...
setup(
    ...
    url='https://github.com/cedricmoorejr/dately/tree/v2.2.0-b.2',
    project_urls={
        'Source Code': 'https://github.com/cedricmoorejr/dately/releases/tag/v2.2.0-beta.2',
    },
    ...
    classifiers=[
        ...
        'Development Status :: 4 - Beta',  # Updated development status
