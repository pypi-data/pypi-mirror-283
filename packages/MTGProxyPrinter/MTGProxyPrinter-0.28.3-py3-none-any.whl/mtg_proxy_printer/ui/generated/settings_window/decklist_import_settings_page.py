...
class Ui_DecklistImportSettingsPage(object):
    ...
    def retranslateUi(self, DecklistImportSettingsPage):
        ...
        self.basic_land_removal_group_box.setTitle(_translate("DecklistImportSettingsPage", "Control the one-click basic land removal"))
        self.basic_land_removal_label.setText(_translate("DecklistImportSettingsPage", "These options control, if the automatic removal should also include Wastes or Snow-Covered basic lands."))
        self.remove_basic_wastes_enable.setWhatsThis(_translate("DecklistImportSettingsPage", "Include Wastes when removing basic lands."))
        self.remove_basic_wastes_enable.setText(_translate("DecklistImportSettingsPage", "Enable removal of Basic Wastes"))
        self.remove_snow_basics_enable.setWhatsThis(_translate("DecklistImportSettingsPage", "Include Snow-Covered basic lands when removing basic lands."))
        self.remove_snow_basics_enable.setText(_translate("DecklistImportSettingsPage", "Enable removal of Snow-Covered Basic lands"))
...
"These options set the default behaviour when encountering ambiguous card"))
        self.print_guessing_group_box.setTitle(_translate("DecklistImportSettingsPage", "Control print guessing in ambiguous cases"))
        self.print_guessing_prefer_already_downloaded.setToolTip(_translate("DecklistImportSettingsPage", "When guessing a printing, prefer printings with already downloaded images over other possible printings."))
...
"With some deck list formats, this option is always enabled."))
        self.print_guessing_enable.setText(_translate("DecklistImportSettingsPage", "Enable print guessing by default"))
