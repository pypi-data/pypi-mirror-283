...
class WorkerSettings(BaseCrawlerSettings):
    QUEUE_CONNECTION_URL: str = DEFAULT_CONNECTION_URL
    MAX_TOTAL_PROCESSING_TASKS: int = DEFAULT_MAX_TOTAL_PROCESSING_TASKS
    ...
    def load(self, config: dict):
        ...
        self.MAX_TOTAL_PROCESSING_TASKS = queue.get("max_total_tasks", DEFAULT_MAX_TOTAL_PROCESSING_TASKS)
