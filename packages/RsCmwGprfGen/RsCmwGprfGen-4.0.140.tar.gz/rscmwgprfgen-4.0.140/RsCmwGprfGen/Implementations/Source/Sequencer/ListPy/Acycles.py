...
class AcyclesCls:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("acycles", core, parent)
	...
	def set(self, index: int, arb_cycles: int) -> None:
		...
		Defines or queries the number of ARB cycles for the sequencer list entry with the selected <Index>. \n
			:param index: integer
			:param arb_cycles: numeric Range: 1 to 10000
		"""
	...
	def get(self, index: int) -> int:
		...
		Defines or queries the number of ARB cycles for the sequencer list entry with the selected <Index>. \n
			:param index: integer
			:return: arb_cycles: numeric Range: 1 to 10000"""
	...
	def get_all(self) -> List[int]:
		...
		Defines the ARB cycles for all sequencer list entries. \n
			:return: arb_cycles: numeric Comma-separated list of values, one value per list entry Range: 1 to 10000
		"""
	...
	def set_all(self, arb_cycles: List[int]) -> None:
		...
		Defines the ARB cycles for all sequencer list entries. \n
			:param arb_cycles: numeric Comma-separated list of values, one value per list entry Range: 1 to 10000
		"""
