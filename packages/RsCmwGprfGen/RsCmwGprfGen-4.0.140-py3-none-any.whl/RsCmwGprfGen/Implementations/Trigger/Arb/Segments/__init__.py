...
class SegmentsCls:
	...
	def get_mode(self) -> enums.ArbSegmentsMode:
		...
		Selects a trigger mode for multi-segment waveform files. \n
			:return: mode: CONTinuous | CSEamless | AUTO CONTinuous: A trigger event causes an immediate switchover to the next segment. CSEamless: A trigger event causes a switchover after the end of the segment has been reached. AUTO: The generator processes one segment after another.
		"""
	...
	def set_mode(self, mode: enums.ArbSegmentsMode) -> None:
		...
		Selects a trigger mode for multi-segment waveform files. \n
			:param mode: CONTinuous | CSEamless | AUTO CONTinuous: A trigger event causes an immediate switchover to the next segment. CSEamless: A trigger event causes a switchover after the end of the segment has been reached. AUTO: The generator processes one segment after another.
		"""
