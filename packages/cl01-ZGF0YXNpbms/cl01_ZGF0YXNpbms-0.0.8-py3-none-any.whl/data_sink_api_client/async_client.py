...
class AsyncDatasinkAPIClient:
    ...
    async def _request(self, method, endpoint, object_ctors, json=None, **kwargs):
    ...
    async def create_embedding(self, embedding_request: models.EmbeddingRequest) -> Union[dict, models.HTTPValidationError, models.ModelNotFoundResponse, models.EmbeddingResponse]:
        """Create Embedding"""
        return await self._request(
            'POST',
            '/embed',
    ...
    async def create_collection(self, collection_info: Union['CollectionInfo', 'QdrantCollectionInfo']) -> Union[dict, models.HTTPValidationError, models.QdrantCollectionInfo, models.UnsupportedCollectionTypeResponse]:
        """Create Collection"""
        return await self._request(
            'POST',
            '/collections',
    ...
    async def query(self, collection_id, query_request: models.QueryRequest) -> Union[dict, models.HTTPValidationError, models.CollectionNotFoundResponse, models.UnsupportedCollectionTypeResponse]:
        """Query"""
        return await self._request(
            'POST',
    ...
    async def create_collection_entity(self, collection_id, collection_entity: models.CollectionEntity) -> Union[models.HTTPValidationError, models.CollectionEntityAlreadyExistsResponse, models.CollectionEntityResponse, models.CollectionNotFoundResponse, dict]:
    ...
    async def get_collection_entity(self, collection_id, entity_id) -> Union[models.CollectionOrCollectionEntityNotFoundResponse, models.HTTPValidationError, models.CollectionEntityResponse]:
        ...
        return await self._request(
            ...
            object_ctors={
                ...
                404: models.CollectionOrCollectionEntityNotFoundResponse,
                422: models.HTTPValidationError
            }
        )

    async def update_collection_entity(self, collection_id, entity_id, collection_entity: models.CollectionEntity) -> Union[models.CollectionOrCollectionEntityNotFoundResponse, models.HTTPValidationError, models.CollectionEntityResponse]:
    ...
    async def add_data(self, collection_id, data_point: Union['DataPoint', List['DataPoint']]) -> Union[dict, models.HTTPValidationError, models.CollectionNotFoundResponse, models.UnsupportedCollectionTypeResponse]:
        """Add Data"""
        return await self._request(
            'POST',
