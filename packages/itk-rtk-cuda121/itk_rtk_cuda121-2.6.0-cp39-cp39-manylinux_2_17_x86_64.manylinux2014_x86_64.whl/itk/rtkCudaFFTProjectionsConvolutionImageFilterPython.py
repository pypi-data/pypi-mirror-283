...
def cuda_fft_projections_convolution_image_filter(*args: itkt.ImageLike,  gpu_enabled: bool=..., coefficients: Sequence[float]=..., greatest_prime_factor: int=..., truncation_correction: float=..., zero_pad_factors: Sequence[int]=...,**kwargs)-> itkt.ImageSourceReturn:
