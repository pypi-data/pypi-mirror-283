depends = ('ITKPyBase', 'ITKSmoothing', 'ITKRegistrationCommon', 'ITKOptimizers', 'ITKImageNoise', 'ITKIOTIFF', 'ITKIORAW', 'ITKIOMeta', 'ITKIOGDCM', 'ITKFFT', 'ITKConvolution', 'ITKCommon', 'ITKBridgeNumPy', 'CudaCommon', )
templates = (  ('FixedArray', 'itk::FixedArray', 'itkFixedArrayi2', False, 'int, 2'),
  ...
  ('CudaImage', 'itk::CudaImage', 'itkCudaImageVF52', True, 'itk::Vector< float,5 >, 2'),
  ('CudaImage', 'itk::CudaImage', 'itkCudaImageCVF52', True, 'itk::CovariantVector< float,5 >, 2'),
  ('CudaImage', 'itk::CudaImage', 'itkCudaImageVF53', True, 'itk::Vector< float,5 >, 3'),
  ('CudaImage', 'itk::CudaImage', 'itkCudaImageCVF53', True, 'itk::CovariantVector< float,5 >, 3'),
  ('CudaImage', 'itk::CudaImage', 'itkCudaImageVF54', True, 'itk::Vector< float,5 >, 4'),
  ('CudaImage', 'itk::CudaImage', 'itkCudaImageCVF54', True, 'itk::CovariantVector< float,5 >, 4'),
  ...
  ('ParkerShortScanImageFilter', 'rtk::ParkerShortScanImageFilter', 'rtkParkerShortScanImageFilterCIF3', False, 'itk::CudaImage<float, 3>'),
  ...
  ('ScatterGlareCorrectionImageFilter', 'rtk::ScatterGlareCorrectionImageFilter', 'rtkScatterGlareCorrectionImageFilterCIF3CIF3F', False, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, float'),
  ...
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIF2CIF2', True, 'itk::CudaImage<float, 2>, itk::CudaImage<float, 2>'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIF3CIF3', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIF4CIF4', True, 'itk::CudaImage<float, 4>, itk::CudaImage<float, 4>'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF22CIVF22', True, 'itk::CudaImage<itk::Vector< float,2 >, 2>, itk::CudaImage<itk::Vector< float,2 >, 2>'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF23CIVF23', True, 'itk::CudaImage<itk::Vector< float,2 >, 3>, itk::CudaImage<itk::Vector< float,2 >, 3>'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF24CIVF24', True, 'itk::CudaImage<itk::Vector< float,2 >, 4>, itk::CudaImage<itk::Vector< float,2 >, 4>'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF32CIVF32', True, 'itk::CudaImage<itk::Vector< float,3 >, 2>, itk::CudaImage<itk::Vector< float,3 >, 2>'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF33CIVF33', True, 'itk::CudaImage<itk::Vector< float,3 >, 3>, itk::CudaImage<itk::Vector< float,3 >, 3>'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF34CIVF34', True, 'itk::CudaImage<itk::Vector< float,3 >, 4>, itk::CudaImage<itk::Vector< float,3 >, 4>'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF42CIVF42', True, 'itk::CudaImage<itk::Vector< float,4 >, 2>, itk::CudaImage<itk::Vector< float,4 >, 2>'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF43CIVF43', True, 'itk::CudaImage<itk::Vector< float,4 >, 3>, itk::CudaImage<itk::Vector< float,4 >, 3>'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF44CIVF44', True, 'itk::CudaImage<itk::Vector< float,4 >, 4>, itk::CudaImage<itk::Vector< float,4 >, 4>'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF52CIVF52', True, 'itk::CudaImage<itk::Vector< float,5 >, 2>, itk::CudaImage<itk::Vector< float,5 >, 2>'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF53CIVF53', True, 'itk::CudaImage<itk::Vector< float,5 >, 3>, itk::CudaImage<itk::Vector< float,5 >, 3>'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF54CIVF54', True, 'itk::CudaImage<itk::Vector< float,5 >, 4>, itk::CudaImage<itk::Vector< float,5 >, 4>'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIF3CIF3RFCIF3CIF3F', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, rtk::FFTRampImageFilter< itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, float >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIF3CIF3SGCIF3CIF3F', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, rtk::ScatterGlareCorrectionImageFilter< itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, float >'),
  ...
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIF2CIF2', True, 'itk::CudaImage<float, 2>, itk::CudaImage<float, 2>'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIF3CIF3', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIF4CIF4', True, 'itk::CudaImage<float, 4>, itk::CudaImage<float, 4>'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF22CIVF22', True, 'itk::CudaImage<itk::Vector<float,2>, 2>, itk::CudaImage<itk::Vector<float,2>, 2>'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF23CIVF23', True, 'itk::CudaImage<itk::Vector<float,2>, 3>, itk::CudaImage<itk::Vector<float,2>, 3>'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF24CIVF24', True, 'itk::CudaImage<itk::Vector<float,2>, 4>, itk::CudaImage<itk::Vector<float,2>, 4>'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF32CIVF32', True, 'itk::CudaImage<itk::Vector<float,3>, 2>, itk::CudaImage<itk::Vector<float,3>, 2>'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF33CIVF33', True, 'itk::CudaImage<itk::Vector<float,3>, 3>, itk::CudaImage<itk::Vector<float,3>, 3>'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF34CIVF34', True, 'itk::CudaImage<itk::Vector<float,3>, 4>, itk::CudaImage<itk::Vector<float,3>, 4>'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF42CIVF42', True, 'itk::CudaImage<itk::Vector<float,4>, 2>, itk::CudaImage<itk::Vector<float,4>, 2>'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF43CIVF43', True, 'itk::CudaImage<itk::Vector<float,4>, 3>, itk::CudaImage<itk::Vector<float,4>, 3>'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF44CIVF44', True, 'itk::CudaImage<itk::Vector<float,4>, 4>, itk::CudaImage<itk::Vector<float,4>, 4>'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF52CIVF52', True, 'itk::CudaImage<itk::Vector<float,5>, 2>, itk::CudaImage<itk::Vector<float,5>, 2>'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF53CIVF53', True, 'itk::CudaImage<itk::Vector<float,5>, 3>, itk::CudaImage<itk::Vector<float,5>, 3>'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF54CIVF54', True, 'itk::CudaImage<itk::Vector<float,5>, 4>, itk::CudaImage<itk::Vector<float,5>, 4>'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIF3CIF3PSCIF3', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, rtk::ParkerShortScanImageFilter< itk::CudaImage<float, 3>>'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIF2CIF2IPIFCIF2', True, 'itk::CudaImage<float, 2>, itk::CudaImage<float, 2>, itk::InPlaceImageFilter< itk::CudaImage<float, 2> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIF3CIF3IPIFCIF3', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, itk::InPlaceImageFilter< itk::CudaImage<float, 3> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIF4CIF4IPIFCIF4', True, 'itk::CudaImage<float, 4>, itk::CudaImage<float, 4>, itk::InPlaceImageFilter< itk::CudaImage<float, 4> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF22CIVF22IPIFCIVF22', True, 'itk::CudaImage<itk::Vector< float,2 >, 2>, itk::CudaImage<itk::Vector< float,2 >, 2>, itk::InPlaceImageFilter< itk::CudaImage<itk::Vector< float,2 >, 2> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF23CIVF23IPIFCIVF23', True, 'itk::CudaImage<itk::Vector< float,2 >, 3>, itk::CudaImage<itk::Vector< float,2 >, 3>, itk::InPlaceImageFilter< itk::CudaImage<itk::Vector< float,2 >, 3> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF24CIVF24IPIFCIVF24', True, 'itk::CudaImage<itk::Vector< float,2 >, 4>, itk::CudaImage<itk::Vector< float,2 >, 4>, itk::InPlaceImageFilter< itk::CudaImage<itk::Vector< float,2 >, 4> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF32CIVF32IPIFCIVF32', True, 'itk::CudaImage<itk::Vector< float,3 >, 2>, itk::CudaImage<itk::Vector< float,3 >, 2>, itk::InPlaceImageFilter< itk::CudaImage<itk::Vector< float,3 >, 2> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF33CIVF33IPIFCIVF33', True, 'itk::CudaImage<itk::Vector< float,3 >, 3>, itk::CudaImage<itk::Vector< float,3 >, 3>, itk::InPlaceImageFilter< itk::CudaImage<itk::Vector< float,3 >, 3> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF34CIVF34IPIFCIVF34', True, 'itk::CudaImage<itk::Vector< float,3 >, 4>, itk::CudaImage<itk::Vector< float,3 >, 4>, itk::InPlaceImageFilter< itk::CudaImage<itk::Vector< float,3 >, 4> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF42CIVF42IPIFCIVF42', True, 'itk::CudaImage<itk::Vector< float,4 >, 2>, itk::CudaImage<itk::Vector< float,4 >, 2>, itk::InPlaceImageFilter< itk::CudaImage<itk::Vector< float,4 >, 2> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF43CIVF43IPIFCIVF43', True, 'itk::CudaImage<itk::Vector< float,4 >, 3>, itk::CudaImage<itk::Vector< float,4 >, 3>, itk::InPlaceImageFilter< itk::CudaImage<itk::Vector< float,4 >, 3> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF44CIVF44IPIFCIVF44', True, 'itk::CudaImage<itk::Vector< float,4 >, 4>, itk::CudaImage<itk::Vector< float,4 >, 4>, itk::InPlaceImageFilter< itk::CudaImage<itk::Vector< float,4 >, 4> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF52CIVF52IPIFCIVF52', True, 'itk::CudaImage<itk::Vector< float,5 >, 2>, itk::CudaImage<itk::Vector< float,5 >, 2>, itk::InPlaceImageFilter< itk::CudaImage<itk::Vector< float,5 >, 2> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF53CIVF53IPIFCIVF53', True, 'itk::CudaImage<itk::Vector< float,5 >, 3>, itk::CudaImage<itk::Vector< float,5 >, 3>, itk::InPlaceImageFilter< itk::CudaImage<itk::Vector< float,5 >, 3> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF54CIVF54IPIFCIVF54', True, 'itk::CudaImage<itk::Vector< float,5 >, 4>, itk::CudaImage<itk::Vector< float,5 >, 4>, itk::InPlaceImageFilter< itk::CudaImage<itk::Vector< float,5 >, 4> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIF3CIF3PSCIF3', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, rtk::ParkerShortScanImageFilter< itk::CudaImage<float, 3>>'),
  ...
  ('CudaImageDataManager', 'itk::CudaImageDataManager', 'itkCudaImageDataManagerCIVF52', True, 'itk::CudaImage<itk::Vector< float,5 >, 2>'),
  ('CudaImageDataManager', 'itk::CudaImageDataManager', 'itkCudaImageDataManagerCICVF52', True, 'itk::CudaImage<itk::CovariantVector< float,5 >, 2>'),
  ('CudaImageDataManager', 'itk::CudaImageDataManager', 'itkCudaImageDataManagerCIVF53', True, 'itk::CudaImage<itk::Vector< float,5 >, 3>'),
  ('CudaImageDataManager', 'itk::CudaImageDataManager', 'itkCudaImageDataManagerCICVF53', True, 'itk::CudaImage<itk::CovariantVector< float,5 >, 3>'),
  ('CudaImageDataManager', 'itk::CudaImageDataManager', 'itkCudaImageDataManagerCIVF54', True, 'itk::CudaImage<itk::Vector< float,5 >, 4>'),
  ('CudaImageDataManager', 'itk::CudaImageDataManager', 'itkCudaImageDataManagerCICVF54', True, 'itk::CudaImage<itk::CovariantVector< float,5 >, 4>'),
  ...
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIF3CIF3BPCIF3CIF3', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, rtk::BackProjectionImageFilter< itk::CudaImage<float, 3>, itk::CudaImage<float, 3> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF23CIVF23BPCIVF23CIVF23', True, 'itk::CudaImage<itk::Vector< float,2 >, 3>, itk::CudaImage<itk::Vector< float,2 >, 3>, rtk::BackProjectionImageFilter< itk::CudaImage<itk::Vector< float,2 >, 3>, itk::CudaImage<itk::Vector< float,2 >, 3> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF33CIVF33BPCIVF33CIVF33', True, 'itk::CudaImage<itk::Vector< float,3 >, 3>, itk::CudaImage<itk::Vector< float,3 >, 3>, rtk::BackProjectionImageFilter< itk::CudaImage<itk::Vector< float,3 >, 3>, itk::CudaImage<itk::Vector< float,3 >, 3> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF43CIVF43BPCIVF43CIVF43', True, 'itk::CudaImage<itk::Vector< float,4 >, 3>, itk::CudaImage<itk::Vector< float,4 >, 3>, rtk::BackProjectionImageFilter< itk::CudaImage<itk::Vector< float,4 >, 3>, itk::CudaImage<itk::Vector< float,4 >, 3> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF53CIVF53BPCIVF53CIVF53', True, 'itk::CudaImage<itk::Vector< float,5 >, 3>, itk::CudaImage<itk::Vector< float,5 >, 3>, rtk::BackProjectionImageFilter< itk::CudaImage<itk::Vector< float,5 >, 3>, itk::CudaImage<itk::Vector< float,5 >, 3> >'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIF3CIF3BPCIF3CIF3', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, rtk::BackProjectionImageFilter< itk::CudaImage<float, 3>, itk::CudaImage<float, 3> >'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF23CIVF23BPCIVF23CIVF23', True, 'itk::CudaImage<itk::Vector< float,2 >, 3>, itk::CudaImage<itk::Vector< float,2 >, 3>, rtk::BackProjectionImageFilter< itk::CudaImage<itk::Vector< float,2 >, 3>, itk::CudaImage<itk::Vector< float,2 >, 3> >'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF33CIVF33BPCIVF33CIVF33', True, 'itk::CudaImage<itk::Vector< float,3 >, 3>, itk::CudaImage<itk::Vector< float,3 >, 3>, rtk::BackProjectionImageFilter< itk::CudaImage<itk::Vector< float,3 >, 3>, itk::CudaImage<itk::Vector< float,3 >, 3> >'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF43CIVF43BPCIVF43CIVF43', True, 'itk::CudaImage<itk::Vector< float,4 >, 3>, itk::CudaImage<itk::Vector< float,4 >, 3>, rtk::BackProjectionImageFilter< itk::CudaImage<itk::Vector< float,4 >, 3>, itk::CudaImage<itk::Vector< float,4 >, 3> >'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF53CIVF53BPCIVF53CIVF53', True, 'itk::CudaImage<itk::Vector< float,5 >, 3>, itk::CudaImage<itk::Vector< float,5 >, 3>, rtk::BackProjectionImageFilter< itk::CudaImage<itk::Vector< float,5 >, 3>, itk::CudaImage<itk::Vector< float,5 >, 3> >'),
  ...
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIF3CIF3CteISrcCIF3', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, rtk::ConstantImageSource< itk::CudaImage<float, 3> >'),
  ...
  ('CudaFFTProjectionsConvolutionImageFilter', 'rtk::CudaFFTProjectionsConvolutionImageFilter', 'rtkCudaFFTProjectionsConvolutionImageFilterSGCIF3CIF3F', False, 'rtk::ScatterGlareCorrectionImageFilter<itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, float>'),
  ('CudaFFTProjectionsConvolutionImageFilter', 'rtk::CudaFFTProjectionsConvolutionImageFilter', 'rtkCudaFFTProjectionsConvolutionImageFilterRFCIF3CIF3F', False, 'rtk::FFTRampImageFilter<itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, float>'),
  ('CudaFFTRampImageFilter', 'rtk::CudaFFTRampImageFilter', 'rtkCudaFFTRampImageFilter', False),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIF3CIF3FPCIF3CIF3', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, rtk::ForwardProjectionImageFilter< itk::CudaImage<float, 3>, itk::CudaImage<float, 3> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF23CIVF23FPCIVF23CIVF23', True, 'itk::CudaImage<itk::Vector< float,2 >, 3>, itk::CudaImage<itk::Vector< float,2 >, 3>, rtk::ForwardProjectionImageFilter< itk::CudaImage<itk::Vector< float,2 >, 3>, itk::CudaImage<itk::Vector< float,2 >, 3> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF33CIVF33FPCIVF33CIVF33', True, 'itk::CudaImage<itk::Vector< float,3 >, 3>, itk::CudaImage<itk::Vector< float,3 >, 3>, rtk::ForwardProjectionImageFilter< itk::CudaImage<itk::Vector< float,3 >, 3>, itk::CudaImage<itk::Vector< float,3 >, 3> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF43CIVF43FPCIVF43CIVF43', True, 'itk::CudaImage<itk::Vector< float,4 >, 3>, itk::CudaImage<itk::Vector< float,4 >, 3>, rtk::ForwardProjectionImageFilter< itk::CudaImage<itk::Vector< float,4 >, 3>, itk::CudaImage<itk::Vector< float,4 >, 3> >'),
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIVF53CIVF53FPCIVF53CIVF53', True, 'itk::CudaImage<itk::Vector< float,5 >, 3>, itk::CudaImage<itk::Vector< float,5 >, 3>, rtk::ForwardProjectionImageFilter< itk::CudaImage<itk::Vector< float,5 >, 3>, itk::CudaImage<itk::Vector< float,5 >, 3> >'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIF3CIF3FPCIF3CIF3', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, rtk::ForwardProjectionImageFilter< itk::CudaImage<float, 3>, itk::CudaImage<float, 3> >'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF23CIVF23FPCIVF23CIVF23', True, 'itk::CudaImage<itk::Vector< float,2 >, 3>, itk::CudaImage<itk::Vector< float,2 >, 3>, rtk::ForwardProjectionImageFilter< itk::CudaImage<itk::Vector< float,2 >, 3>, itk::CudaImage<itk::Vector< float,2 >, 3> >'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF33CIVF33FPCIVF33CIVF33', True, 'itk::CudaImage<itk::Vector< float,3 >, 3>, itk::CudaImage<itk::Vector< float,3 >, 3>, rtk::ForwardProjectionImageFilter< itk::CudaImage<itk::Vector< float,3 >, 3>, itk::CudaImage<itk::Vector< float,3 >, 3> >'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF43CIVF43FPCIVF43CIVF43', True, 'itk::CudaImage<itk::Vector< float,4 >, 3>, itk::CudaImage<itk::Vector< float,4 >, 3>, rtk::ForwardProjectionImageFilter< itk::CudaImage<itk::Vector< float,4 >, 3>, itk::CudaImage<itk::Vector< float,4 >, 3> >'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIVF53CIVF53FPCIVF53CIVF53', True, 'itk::CudaImage<itk::Vector< float,5 >, 3>, itk::CudaImage<itk::Vector< float,5 >, 3>, rtk::ForwardProjectionImageFilter< itk::CudaImage<itk::Vector< float,5 >, 3>, itk::CudaImage<itk::Vector< float,5 >, 3> >'),
  ...
  ('CudaParkerShortScanImageFilter', 'rtk::CudaParkerShortScanImageFilter', 'rtkCudaParkerShortScanImageFilter', False),
  ('CudaScatterGlareCorrectionImageFilter', 'rtk::CudaScatterGlareCorrectionImageFilter', 'rtkCudaScatterGlareCorrectionImageFilter', False),
  ...
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIF3CIF3DDCIF3', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, rtk::DisplacedDetectorImageFilter< itk::CudaImage<float, 3> >'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIF3CIF3DDCIF3', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, rtk::DisplacedDetectorImageFilter< itk::CudaImage<float, 3> >'),
  ...
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIF3CIF3FDKBPCIF3CIF3', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, rtk::FDKBackProjectionImageFilter< itk::CudaImage<float, 3>, itk::CudaImage<float, 3> >'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIF3CIF3FDKBPCIF3CIF3', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, rtk::FDKBackProjectionImageFilter< itk::CudaImage<float, 3>, itk::CudaImage<float, 3> >'),
  ...
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIF3CIF3FDKCIF3F', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, rtk::FDKConeBeamReconstructionFilter< itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, float >'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIF3CIF3FDKCIF3F', True, 'itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, rtk::FDKConeBeamReconstructionFilter< itk::CudaImage<float, 3>, itk::CudaImage<float, 3>, float >'),
  ...
  ('FourDROOSTERConeBeamReconstructionFilter', 'rtk::FourDROOSTERConeBeamReconstructionFilter', 'rtkFourDROOSTERConeBeamReconstructionFilterCIF4CIF3', False, 'itk::CudaImage<float, 4>, itk::CudaImage<float, 3>'),
  ...
  ('CudaImageToImageFilter', 'itk::CudaImageToImageFilter', 'itkCudaImageToImageFilterCIF4CIF4SplatCIF4CIF3', True, 'itk::CudaImage<float, 4>, itk::CudaImage<float, 4>, rtk::SplatWithKnownWeightsImageFilter< itk::CudaImage<float, 4>, itk::CudaImage<float, 3> >'),
  ('CudaInPlaceImageFilter', 'itk::CudaInPlaceImageFilter', 'itkCudaInPlaceImageFilterCIF4CIF4SplatCIF4CIF3', True, 'itk::CudaImage<float, 4>, itk::CudaImage<float, 4>, rtk::SplatWithKnownWeightsImageFilter< itk::CudaImage<float, 4>, itk::CudaImage<float, 3> >'),
