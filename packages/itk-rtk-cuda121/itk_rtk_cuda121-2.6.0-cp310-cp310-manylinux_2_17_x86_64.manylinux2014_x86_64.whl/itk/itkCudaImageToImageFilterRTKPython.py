...
def cuda_image_to_image_filter(*args: itkt.ImageLike,  gpu_enabled: bool=..., hann_cut_frequency: float=..., cosine_cut_frequency: float=..., hamming_frequency: float=..., hann_cut_frequency_y: float=..., ram_lak_cut_frequency: float=..., shepp_logan_cut_frequency: float=..., greatest_prime_factor: int=..., truncation_correction: float=..., zero_pad_factors: Sequence[int]=...,**kwargs)-> itkt.ImageSourceReturn:
