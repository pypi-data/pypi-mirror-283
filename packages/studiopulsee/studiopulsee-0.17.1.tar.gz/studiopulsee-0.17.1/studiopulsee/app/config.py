...
from studiopulsee.app.utils import dbhelpers
from studiopulsee.app.utils.env import envtobool, env_with_semicolon_to_list

PROPAGATE_EXCEPTIONS = True
DEBUG = envtobool("DEBUG", False)
DEBUG_PORT = int(os.getenv("DEBUG_PORT", 5000))

APP_NAME = "studiopulsee"
...
DATABASE = {
    ...
    "database": os.getenv("DB_DATABASE", "studiopulseedb"),
}
...
TMP_DIR = os.getenv("TMP_DIR", os.path.join(tempfile.gettempdir(), "studiopulsee"))
...
JOB_QUEUE_NOMAD_PLAYLIST_JOB = os.getenv(
    "JOB_QUEUE_NOMAD_PLAYLIST_JOB", "studiopulsee-playlist"
)
JOB_QUEUE_NOMAD_NORMALIZE_JOB = os.getenv("JOB_QUEUE_NOMAD_NORMALIZE_JOB", "")
JOB_QUEUE_NOMAD_HOST = os.getenv("JOB_QUEUE_NOMAD_HOST", "studiopulsee-nomad-01.studiopulsee")
...
LDAP_BASE_DN = os.getenv("LDAP_BASE_DN", "cn=Users,dc=studiopulsee,dc=local")
LDAP_GROUP = os.getenv("LDAP_GROUP", "")
LDAP_DOMAIN = os.getenv("LDAP_DOMAIN", "studiopulsee.local")
