...
from studiopulsee.utils import movie
from studiopulsee.app.utils import (
    events,
    fields,
    remote_job,
...
from studiopulsee.app.utils import fs
...
def prepare_and_store_movie(
    ...
    and store the files.
    """
    from studiopulsee.app import app as current_app
