...
from studiopulsee.app.blueprints.crud.asset_instance import (
    AssetInstanceResource,
    AssetInstancesResource,
)
from studiopulsee.app.blueprints.crud.attachment_file import (
    AttachmentFilesResource,
    AttachmentFileResource,
)
from studiopulsee.app.blueprints.crud.comments import CommentsResource, CommentResource
from studiopulsee.app.blueprints.crud.custom_action import (
    CustomActionsResource,
    CustomActionResource,
)
from studiopulsee.app.blueprints.crud.status_automation import (
    StatusAutomationsResource,
    StatusAutomationResource,
)
from studiopulsee.app.blueprints.crud.day_off import DayOffsResource, DayOffResource
from studiopulsee.app.blueprints.crud.department import (
    DepartmentsResource,
    DepartmentResource,
)
from studiopulsee.app.blueprints.crud.entity import EntityResource, EntitiesResource
from studiopulsee.app.blueprints.crud.entity_type import (
    EntityTypesResource,
    EntityTypeResource,
)
from studiopulsee.app.blueprints.crud.entity_link import (
    EntityLinksResource,
    EntityLinkResource,
)
from studiopulsee.app.blueprints.crud.event import EventsResource, EventResource
from studiopulsee.app.blueprints.crud.file_status import (
    FileStatusesResource,
    FileStatusResource,
)
from studiopulsee.app.blueprints.crud.metadata_descriptor import (
    MetadataDescriptorsResource,
    MetadataDescriptorResource,
)
from studiopulsee.app.blueprints.crud.milestone import (
    MilestonesResource,
    MilestoneResource,
)
from studiopulsee.app.blueprints.crud.notification import (
    NotificationsResource,
    NotificationResource,
)
from studiopulsee.app.blueprints.crud.organisation import (
    OrganisationsResource,
    OrganisationResource,
)
from studiopulsee.app.blueprints.crud.output_file import (
    OutputFilesResource,
    OutputFileResource,
)
from studiopulsee.app.blueprints.crud.output_type import (
    OutputTypeResource,
    OutputTypesResource,
)
from studiopulsee.app.blueprints.crud.news import NewssResource, NewsResource
from studiopulsee.app.blueprints.crud.person import PersonResource, PersonsResource
from studiopulsee.app.blueprints.crud.preview_file import (
    PreviewFilesResource,
    PreviewFileResource,
)
from studiopulsee.app.blueprints.crud.playlist import (
    PlaylistsResource,
    PlaylistResource,
)
from studiopulsee.app.blueprints.crud.project import (
    ProjectResource,
    ProjectsResource,
    ProjectTaskTypeLinksResource,
)
from studiopulsee.app.blueprints.crud.project_status import (
    ProjectStatusResource,
    ProjectStatussResource,
)
from studiopulsee.app.blueprints.crud.schedule_item import (
    ScheduleItemsResource,
    ScheduleItemResource,
)
from studiopulsee.app.blueprints.crud.subscription import (
    SubscriptionsResource,
    SubscriptionResource,
)
from studiopulsee.app.blueprints.crud.search_filter import (
    SearchFiltersResource,
    SearchFilterResource,
)
from studiopulsee.app.blueprints.crud.search_filter_group import (
    SearchFilterGroupsResource,
    SearchFilterGroupResource,
)
from studiopulsee.app.blueprints.crud.software import (
    SoftwaresResource,
    SoftwareResource,
)
from studiopulsee.app.blueprints.crud.task_type import (
    TaskTypesResource,
    TaskTypeResource,
)
from studiopulsee.app.blueprints.crud.task_status import (
    TaskStatusesResource,
    TaskStatusResource,
)
from studiopulsee.app.blueprints.crud.task import TasksResource, TaskResource
from studiopulsee.app.blueprints.crud.time_spent import (
    TimeSpentsResource,
    TimeSpentResource,
)
from studiopulsee.app.blueprints.crud.working_file import (
    WorkingFilesResource,
    WorkingFileResource,
)
from studiopulsee.app.blueprints.crud.preview_background_file import (
