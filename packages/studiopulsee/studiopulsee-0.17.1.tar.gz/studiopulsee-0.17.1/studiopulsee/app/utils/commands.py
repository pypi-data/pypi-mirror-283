...
from studiopulsee.app.utils import thumbnail as thumbnail_utils
from studiopulsee.app.stores import auth_tokens_store, file_store
...
def dump_database(store=False):
    ...
    filename = f"studiopulsee-db-backup-{now}.sql.gz"
    if store:
