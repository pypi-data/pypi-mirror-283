...
from studiopulseeimport __version__ as studiopulsee_version
...
def init_monitoring(app):
    ...
    if config.PROMETHEUS_METRICS_ENABLED:
        ...
        metrics.info("studiopulsee_info", "Application info", version=studiopulsee_version)
