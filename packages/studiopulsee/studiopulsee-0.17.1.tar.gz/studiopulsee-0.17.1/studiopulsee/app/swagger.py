...
swagger_template = {
    ...
    "externalDocs": {
        ...
        "url": "https://studiopulsee.cg-wire.com",
    },
    "host": "localhost:8080",
    "basePath": "/api",
    "schemes": ["http", "https"],
        ...
        "Task": {
            ...
            "properties": {
                ...
                "mandays_count": {
                    "type": "float",
                    "default": "0",
                    "description": "mandays_count of duration of task",
                },
                "count": {
                    "type": "float",
                    "default": "0",
                    "description": "count of start and stop of task",
                },
                "wip_date": {
                    "type": "float",
                    "default": "0",
                    "description": "wip_date of duration of task",
                },
                "completion_rate": {
                    "type": "integer",
                    "default": "0",
