...
from studiopulsee.app.utils import dbhelpers, auth, commands
from studiopulsee.app.services import persons_service, auth_service
...
from studiopulseeimport __file__ as root_path
...
def version():
    ...
    """
    from studiopulseeimport __version__

    print(f"studiopulseeversion: {__version__}")
...
def clear_memory_cache():
    ...
    from studiopulsee.app import cache
...
def dump_database(store=False):
    """
    Dump database described in studiopulseeenvironment variables and save it to
