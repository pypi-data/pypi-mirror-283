  ...
  'syms': { 'bellek.hf.datasets.utils': { 'bellek.hf.datasets.utils.chunk_random_dataset': ( 'hf.datasets.utils.html#chunk_random_dataset',
            ...
            'bellek.ml.vision': { 'bellek.ml.vision.Make3Channel': ('ml.vision.html#make3channel', 'bellek/ml/vision.py'),
                                  ...
                                  'bellek.ml.vision.TorchVisionTransform.encodes': ( 'ml.vision.html#torchvisiontransform.encodes',
                                                                                     'bellek/ml/vision.py')},
            'bellek.musique.baseline': { 'bellek.musique.baseline.BaselineMHQA': ( 'musique.baseline.html#baselinemhqa',
                                                                                   'bellek/musique/baseline.py'),
                                         'bellek.musique.baseline.BaselineMHQA.__init__': ( 'musique.baseline.html#baselinemhqa.__init__',
                                                                                            'bellek/musique/baseline.py'),
                                         'bellek.musique.baseline.BaselineMHQA._answer': ( 'musique.baseline.html#baselinemhqa._answer',
                                                                                           'bellek/musique/baseline.py'),
                                         'bellek.musique.baseline.BaselineMHQA.answer': ( 'musique.baseline.html#baselinemhqa.answer',
                                                                                          'bellek/musique/baseline.py'),
                                         'bellek.musique.baseline.benchmark': ( 'musique.baseline.html#benchmark',
                                                                                'bellek/musique/baseline.py'),
                                         'bellek.musique.baseline.format_question': ( 'musique.baseline.html#format_question',
                                                                                      'bellek/musique/baseline.py'),
