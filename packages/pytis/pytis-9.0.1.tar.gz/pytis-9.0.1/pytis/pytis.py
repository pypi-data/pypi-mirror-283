...
__version__ = '9.0.1' # changed 2 files, so 8.4.0 to 8.4.2
...
v9.0.1
  MINOR CHANGE                                                     July 7, 2024
    Removed dependecies (rjsmin and distutils) from setup.py

v9.0.0
  MAJOR CHANGE                                                     July 7, 2024
    I have added cssmin and jsmin.  jsmin requires rjsmin.
    I have attempted to add rjsmin and docutils to the setup.py file.
    Attempting build now with doit3.sh

v8.40                                                          January 20, 2022
  MAJOR CHANGE
