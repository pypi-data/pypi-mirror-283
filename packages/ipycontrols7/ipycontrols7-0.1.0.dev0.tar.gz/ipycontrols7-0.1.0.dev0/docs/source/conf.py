...
# -*- coding: utf-8 -*-
#
# ipycontrols7 documentation build configuration file
#
...
project = 'ipycontrols7'
copyright = '2024, martinRenou'
author = 'martinRenou'
...
_version_py = os.path.join(repo, 'ipycontrols7', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipycontrols7doc'
...
latex_documents = [
    (master_doc, 'ipycontrols7.tex', 'ipycontrols7 Documentation',
     'martinRenou', 'manual'),
]
