...
# mlflow_by_johnsnowlabs # CUSTOMER
# mlflow_by_ckl # INTERNAL
# mlflow_by_kshitiz # INTERNAL
...
def _save_jars_and_lic(dst_dir, store_license=True, gpu=False):
    ...
    suite = get_install_suite_from_jsl_home(
        ...
        ocr_secret=os.environ[_JOHNSNOWLABS_ENV_VISUAL_SECRET] if _JOHNSNOWLABS_ENV_VISUAL_SECRET in os.environ else None,
        hc_secret=os.environ[_JOHNSNOWLABS_ENV_HEALTHCARE_SECRET] if _JOHNSNOWLABS_ENV_HEALTHCARE_SECRET in os.environ else None,
...
def infer_jsl_signature(spark_model):
    ...
    if output_type == 'table':
        output_data = [d.to_json() for d in output_data]
    # elif output_type == 'file':
    #     pass
    # else:
    #     pass

    print('OUPUTPUT TYPE', output_type)

    print('ORIGINAL INPUT DATA: ', original_input_data)
