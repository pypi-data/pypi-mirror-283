...
def cli(args=sys.argv[1:]):
    desc = 'EasyPyPi. Simple and easy to use tools for creating and publishing python packages.'
    ...
    parser.add_argument('package_name', metavar='PACKAGE_NAME', help='Package name you would like to appear in PyPi. ' 
        'Prefferably use dashes to separate words like "my-package". Undescores will be replaced with dashes.')
