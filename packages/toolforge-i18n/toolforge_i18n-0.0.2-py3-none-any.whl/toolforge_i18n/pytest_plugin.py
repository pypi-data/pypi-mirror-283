...
from toolforge_i18n.translations import TranslationsConfig, load_translations
from toolforge_i18n.translations_checks import (
...
def pytest_collection(session: pytest.Session) -> None:
    ...
    translations, documentation = load_translations(translations_config)
