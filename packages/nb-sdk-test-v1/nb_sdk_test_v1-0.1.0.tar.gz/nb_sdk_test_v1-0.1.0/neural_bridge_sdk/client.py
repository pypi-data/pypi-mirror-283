...
import requests
from src.neural_bridge.types.agent import AgentSpec
from src.neural_bridge.types.feedback import Feedback, FeedbackInput
from src.neural_bridge.types.llm import LLM
from src.neural_bridge.types.run import RunResult
from src.neural_bridge.types.tool import Tool
...
class NeuralBridge:
  ...
  def run_agent(self, task_id: str, query: str) -> RunResult:
    """Run a specific task with the given query."""
    url = f"{self.base_url}/run-task/{task_id}/"
