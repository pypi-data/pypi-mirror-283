...
def main():
    ...
    Example usage:
    ibm-mq-cli put_message DEV.QUEUE.1 QM1 "Hello World"
    ibm-mq-cli put_message MyQueue MyQueueManager "Test Message"
    """
    ...
    ibm-mq-cli get_message MyQueue MyQueueManager
    """
