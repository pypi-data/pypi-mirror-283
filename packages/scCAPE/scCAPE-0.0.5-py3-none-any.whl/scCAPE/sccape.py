...
def CAPE_train(data_path, dataset_name, model_index=0, seed=0, perturbation_key='condition', split_key=None,
    ...
    perts_name_list = list(basal_adata.obs.condition.cat.categories)
    perts_name_list.remove('control')

    asw_res = scib.metrics.metrics(adata=basal_adata, adata_int=basal_adata,
    ...
    if len(perts_name_list)<=20:
        ...
        all_pert_asw_mean = 1
    if asw_res < 0.83 or all_pert_asw_mean < 0.83:
